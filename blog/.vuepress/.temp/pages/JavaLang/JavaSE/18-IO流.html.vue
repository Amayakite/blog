<template><h2 id="文件" tabindex="-1"><a class="header-anchor" href="#文件" aria-hidden="true">#</a> 文件</h2>
<p>对于这玩意我们已经习以为常了，就是保存数据的地方，比如一张图片，一个文档，一个表格，一个json数据集等</p>
<p>不过那些都不是重点，接下来说说文件流的概念</p>
<h3 id="文件流" tabindex="-1"><a class="header-anchor" href="#文件流" aria-hidden="true">#</a> 文件流</h3>
<p>文件在程序中是以流的形式来操作的</p>
<p><img src="/images/JavaSE/18-IO流/文件流的概念-16368079080021.svg" alt="文件流的概念" loading="lazy"></p>
<p>流：<strong>数据在数据源（文件）和程序（内存）之间经历的路径</strong></p>
<p>输入流：<strong>数据从数据源（文件）到程序（内存）的路径</strong></p>
<p>输出流：<strong>程序从（内存）到数据源（文件）的路径</strong></p>
<p>上面这些是比较重要的..建议倒背如流，如果背不下来就记住：输入流是把数据从文件中提取到程序里，输出流是把数据丢到文件里，如果还是不懂的话：</p>
<p><img src="/images/JavaSE/18-IO流/文件流的概念1.svg" alt="文件流的概念1" loading="lazy"></p>
<p>是不是突然就明白了</p>
<p>那么接下来说说该怎么操作文件：</p>
<p>（其实相比于集合，多线程，这玩意真的算是挺简单的）</p>
<h3 id="file-常用的文件操作" tabindex="-1"><a class="header-anchor" href="#file-常用的文件操作" aria-hidden="true">#</a> File-常用的文件操作</h3>
<blockquote>
<p>创建文件对象相关构造器和方法</p>
</blockquote>
<ul>
<li><code>new File(String pathname)</code>根据路径结构创建一个FIle对象</li>
<li><code>new File(File parent,String child)</code>根据父目录<strong>文件</strong>+子路径构建</li>
<li><code>new File(String parent,String child)</code>根据父目录+子路径构建</li>
</ul>
<p><img src="/images/JavaSE/18-IO流/image-20211113210418512.png" alt="image-20211113210418512" loading="lazy"></p>
<p>接下来简单的演示下创建文件：</p>
<p>方法1：</p>
...
<li><code>getParent</code> 获取父级路径</li>
<li><code>length</code> 文件大小(字节)</li>
<li><code>exists</code> 这个文件是否存在</li>
<li><code>isFile</code> 是不是一个文件夹</li>
<li><code>isDirectory</code> 是不是一个文件夹</li>
</ul>
<p>通常来说，想获取啥百度即可，但是也有例外：(下面这些代码全都是我刚装上的GitHub Copilot插件自动生成的..)</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">//txt: Hello 123456 你好</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br></div></div><p>关于字节：一个汉字三个字节，一个字母/数字/符号1个字节</p>
<blockquote>
<p>目录的操作和文件删除</p>
</blockquote>
<p><code>mkdir</code>创建一级目录，<code>mkdirs</code>创建多级目录，<code>delete</code>删除空目录或文件</p>
<blockquote>
<p>删除一个文件</p>
</blockquote>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">//    判断 d:/demo2目录是否存在，存在就删除，否则就创建</span>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">//    判断 d:/demo/a/b/c目录是否存在，如果存在就提示已存在，否则就创建</span>
<span class="token annotation punctuation">@Test</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">createDirectory</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><p>这些差不多就是最简单的操作文件流程了，不过真的要往里面写、读数据，就得用到IO流：</p>
<h2 id="io流原理及流的分类" tabindex="-1"><a class="header-anchor" href="#io流原理及流的分类" aria-hidden="true">#</a> IO流原理及流的分类</h2>
<p>先来说说他的原理</p>
<ul>
<li>I/O是Input/Output的缩写，I/O技术是非常实用的技术，用于处理数据传输，例如读写文件，网络通讯等</li>
<li>Java程序中，对于数据的输入、输出操作类似于<code>流(Stream)</code>方式进行</li>
<li><code>java.io</code>包下提供了各种&quot;流&quot;类和接口，用于获取不同类型的数据，并通过方法输入或输出数据</li>
<li>输入<code>input</code>：读取外部数据(磁盘，光盘，数据库，网络，另一个程序)等存储设备的数据到程序（内存）中</li>
<li>输出<code>output</code>:将(内存)数据输出到相应的存储设备中</li>
</ul>
<p><img src="/images/JavaSE/18-IO流/image-20211113223551420.png" alt="image-20211113223551420" loading="lazy"></p>
<h3 id="流的分类" tabindex="-1"><a class="header-anchor" href="#流的分类" aria-hidden="true">#</a> 流的分类</h3>
<ul>
<li>在Java编程中，按操作数据单位不同分为：字节流(8-bit)，字符流(按字符，对应几个字节跟文件编码挂钩(ASCII,UTF-8,Uncode...))
<ul>
<li>如果说从操作的单位来说，字符流的效率更高，字节流每次读取的单位比较少（一个字节一个字节的读取），效率会低一些，<strong>文本文件</strong>使用字符流来操作比较好</li>
<li>在操作<strong>二进制文件</strong>的时候(声音，视频，Word文档等文件)，使用字节流的方式来操作，能保证我们的操作是无损操作</li>
</ul>
</li>
...
<p>![image-20211113225259642](/images/JavaSE/18-IO流/image-20211113224951257.png&quot; alt=&quot;image-20211113224951257&quot; style=&quot;zoom:50%;&quot; /&gt;<img src="/images/JavaSE/18-IO流/image-20211113225003082.png" alt="image-20211113225003082" style="zoom:50%;" /><img src="/images/JavaSE/18-IO流/image-20211113225231021.png" alt="image-20211113225231021" style="zoom:50%;" />&lt;img src=&quot;/images/JavaSE/18-IO流/image-20211113225259642.png)</p>
<p>上方是这四个类的继承关系图，查看他们的源码可以发现：他们<strong>都是抽象类</strong>，没有直接实现的方法，所以一般我们操作他们都是通过他们的<strong>实现类</strong>来进行</p>
<ol>
<li>Java的IO流共涉及40多个类，实际上他们非常规则，都是从上述4个抽象基类派生的</li>
<li>由这四个类派生出来的子类名称都是以其父类名称作为子类名后缀</li>
</ol>
<p>在正式开始前，再回顾下，<code>流</code>和<code>文件</code>的关系：</p>
<p>如果说文件像是一个物流中心，我们的程序像是一个用户，那么流就像是外卖小哥一样，从物流中心把文件拿出来，送到用户手上，如果说用户要寄东西也是先让外卖小哥过来取东西，让后送到物流中心，然后传递给更多的用户，流就是一个中间件</p>
<h3 id="java-io流结构图" tabindex="-1"><a class="header-anchor" href="#java-io流结构图" aria-hidden="true">#</a> Java IO流结构图</h3>
<p><img src="/images/JavaSE/18-IO流/Java之IO流.svg" alt="Java之IO流" loading="lazy"></p>
<p>前面也说到过，这玩意子类特别多，但是实际上我们只需要掌握其中几个就行，其他的都是大同小异。</p>
<p>接下来一个一个的了解：</p>
<h2 id="inputerstream-字节输入流" tabindex="-1"><a class="header-anchor" href="#inputerstream-字节输入流" aria-hidden="true">#</a> <code>InputerStream</code> 字节输入流</h2>
<ul>
<li><code>InputStream</code>抽象类是所有类字节输入流的超类</li>
<li><code>InputStream</code>常用子类
<ol>
...
<h3 id="fileinputstream文件字节输入流" tabindex="-1"><a class="header-anchor" href="#fileinputstream文件字节输入流" aria-hidden="true">#</a> <code>FileInputStream</code>文件字节输入流</h3>
<p>文档<a href="https://www.matools.com/file/manual/jdk_api_1.8_google/java/io/FileInputStream.html" target="_blank" rel="noopener noreferrer">速链<ExternalLinkIcon/></a></p>
<p>构造方法：</p>
<p><img src="/images/JavaSE/18-IO流/image-20211113233608670.png" alt="image-20211113233608670" loading="lazy"></p>
<p>所有方法：</p>
<p><img src="/images/JavaSE/18-IO流/image-20211113233706976.png" alt="image-20211113233706976" loading="lazy"></p>
<p>可以看到，他里面包含的方法并不是很多，除去构造函数，只有9个</p>
<p>最常用的个人认为是这个：<code>read(byte[] b ,int off ,int len)</code> 将输入流中最多len个字节的数据读取入一个byte数组中</p>
<p>接下来演示下：</p>
<blockquote>
<p>单个字节读取</p>
</blockquote>
...
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">readFile02</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
    ...
    fileInputStream<span class="token punctuation">.</span><span class="token function">close</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br></div></div><h3 id="fileoutputstream-文件字节输出流" tabindex="-1"><a class="header-anchor" href="#fileoutputstream-文件字节输出流" aria-hidden="true">#</a> <code>FileOutputStream</code> 文件字节输出流</h3>
<p><img src="/images/JavaSE/18-IO流/image-20211114113542537.png" alt="image-20211114113542537" loading="lazy"></p>
<p>这个构造方法和所有方法都和<code>InputStream</code>基本没啥区别，最大的差别就它是write，<code>InputStream</code>是read，<a href="https://www.matools.com/file/manual/jdk_api_1.8_google/java/io/FileOutputStream.html" target="_blank" rel="noopener noreferrer">文档地址<ExternalLinkIcon/></a></p>
<p><img src="/images/JavaSE/18-IO流/image-20211114113328836.png" alt="image-20211114113328836" loading="lazy"></p>
<p><img src="/images/JavaSE/18-IO流/image-20211114113348070.png" alt="image-20211114113348070" loading="lazy"></p>
<p>接下来使用<code>FIleOutPutStream</code>在文件a.txt中写入 <code>hello , world. </code></p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>    <span class="token doc-comment comment">/**
...
<span class="token comment">//指定从0开始，到str.length结束（全部写进去）</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br></div></div><blockquote>
<p>小练：使用字字节输入流完成图片、音乐、软件的copy</p>
</blockquote>
<p>思路：</p>
<p><img src="/images/JavaSE/18-IO流/image-20211114121718636.png" alt="image-20211114121718636" loading="lazy"></p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">copyFile</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br></div></div><h2 id="filereader和filewriter" tabindex="-1"><a class="header-anchor" href="#filereader和filewriter" aria-hidden="true">#</a> <code>FileReader</code>和<code>FileWriter</code></h2>
<h2 id="节点流和处理流" tabindex="-1"><a class="header-anchor" href="#节点流和处理流" aria-hidden="true">#</a> 节点流和处理流</h2>
<p>节点流可以从一个特定的数据源读写数据，如<code>FileReader</code>、<code>FileWriter</code></p>
<p>节点流的所属</p>
<table>
<thead>
<tr>
...
<th style="text-align:center">字节数出流</th>
...
<p><img src="/images/JavaSE/18-IO流/image.svg" alt="image" loading="lazy"></p>
<p>节点流可以直接操作数据，好处是零距离和数据接触，坏处是他的灵活性可能会收到一些影响，功能性不是很强大</p>
<p>Java的设计者为了解决这个点，制造了一个<strong>处理流</strong>（也叫包装流），是<code>连接</code><strong>已存在的流</strong>（节点流或处理流）之上，为程序提供更为强大的读写功能，如<code>BufferedReader</code>、<code>BufferedWriter</code></p>
<p><code>BufferedReader</code>类中，有属性Reader，即可以封装一个节点流，<strong>该节点流可以是任意的</strong>，只要是Reader子类</p>
<p><img src="/images/JavaSE/18-IO流/images.svg" alt="images" loading="lazy"></p>
<p>处理流所用的模式也叫<strong>修饰器模式</strong></p>
<table>
<thead>
<tr>
<th style="text-align:center">分类</th>
...
<tr>
<td style="text-align:center">对象类</td>
...
<h3 id="节点流和处理流的区别和联系" tabindex="-1"><a class="header-anchor" href="#节点流和处理流的区别和联系" aria-hidden="true">#</a> 节点流和处理流的区别和联系</h3>
<ol>
<li>节点流是底层流/低级流，直接跟数据源相接</li>
<li>处理流（<strong>包装流</strong>）包装节点流，既可以消除不同节点流之间的差异，也可以提供更方便的方式来完成输入输出</li>
<li>处理流对节点流进行包装，采用了修饰器模式，不会直接与数据源相连</li>
</ol>
<blockquote>
<p>模拟修饰器模式</p>
</blockquote>
...
<span class="token keyword">class</span> <span class="token class-name">MyBufferedReader_</span> <span class="token keyword">extends</span> <span class="token class-name">MyReader_</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br></div></div><p>处理流的功能主要体现在以下两个方面：</p>
<ol>
<li>性能的提高：主要以增加缓冲的方式来提高输入输出的效率</li>
<li>操作的便捷：处理流可能提供了一系列便捷方式来一次输入输出大批量数据，使用更加灵活方便</li>
</ol>
<h2 id="处理流-bufferedreader和bufferedwriter" tabindex="-1"><a class="header-anchor" href="#处理流-bufferedreader和bufferedwriter" aria-hidden="true">#</a> 处理流-BufferedReader和BufferedWriter</h2>
<ul>
<li><code>BufferedReader</code>和<code>BufferedWriter</code>属于字符流，是按照字符来读取数据的</li>
<li>关闭时，只需要关闭外层流即可，即，只需要关闭处理流（根据之前的分析也可以得出，真正来操作数据的其实还是我们的节点流，处理流是帮助我们让操作数据更加简单方便，所以处理流中大概率是有封装close的）</li>
<li>详细文档：
<ul>
<li><a href="https://www.matools.com/file/manual/jdk_api_1.8_google/java/io/BufferedReader.html" target="_blank" rel="noopener noreferrer">BufferedReader中文手册<ExternalLinkIcon/></a></li>
<li><a href="https://www.matools.com/file/manual/jdk_api_1.8_google/java/io/BufferedWriter.html" target="_blank" rel="noopener noreferrer">BufferedWriter中文手册<ExternalLinkIcon/></a></li>
</ul>
</li>
</ul>
<p>这两位是用来处理字符流的，即：Reader和Writer下的流都可以经由他们之手</p>
<p><img src="/images/JavaSE/18-IO流/image-20211114175317610.png" alt="image-20211114175317610" loading="lazy"></p>
<blockquote>
<p>使用BufferedReader读取文本文件，并展示在控制台</p>
</blockquote>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<p>使用BufferedWriter和BufferedReady拷贝非二进制文件</p>
</blockquote>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br></div></div><h2 id="处理流-bufferedinputstream和bufferedoutputstream" tabindex="-1"><a class="header-anchor" href="#处理流-bufferedinputstream和bufferedoutputstream" aria-hidden="true">#</a> 处理流-BufferedInputStream和BufferedOutputStream</h2>
<p>和刚刚的那两位很像，这两个也是包装流，来包装InputStream和OutputStream中的流：</p>
<p><img src="/images/JavaSE/18-IO流/image-20211114175212713.png" alt="image-20211114175212713" loading="lazy"></p>
<blockquote>
<p>接下来使用BufferedOutputStream和BufferInputStream来完成对图片的拷贝</p>
<p>当然，使用他也可以对文本文件进行复制（无论是否有汉字） 因为他们相当于是对</p>
</blockquote>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>  <span class="token annotation punctuation">@Test</span>
...
<span class="token comment">//        本质上跟FileInputStream和FileOutputStream是一样的用法</span>
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br></div></div><h2 id="深入理解处理-包装流" tabindex="-1"><a class="header-anchor" href="#深入理解处理-包装流" aria-hidden="true">#</a> 深入理解处理/包装流</h2>
<p>在上方案例中，可以看到，无论是字符包装流还是字节包装流，使用起来的方法都跟普通的一模一样，除了字符包装流中可以进行的换行之外，并没有感觉到任何的不同，反而还让整个程序变得套娃了起来...</p>
<p>那为什么要用它呢？</p>
<p>先来看下它的原理图：</p>
<p><img src="/images/JavaSE/18-IO流/传输原理.svg" alt="传输原理" loading="lazy"></p>
<p>先来回顾下开始我们复制文件的情景</p>
<ul>
<li>当我们只使用<code>FileInputStream</code>和<code>FileOutputStream</code>来进行数据复制时，每次从数据源（文件）中读取一个字节，然后交给<code>b</code>，然后<code>b</code>再给<code>FileOutputStream</code>写入存储目的地（文件中），<strong>每此存储一个字节需要访问硬盘两次</strong>，以此往复直至存储完毕</li>
<li>如果使用了<code>BufferInputStream</code>和<code>BufferOutPutStream</code>来包装他们（作为缓冲区），<code>BufferInputStream</code>中自带一个8192大小的字节数组（可以翻看源码看到，同时在JDK文档中也可以发现，他有一个重载构造方法，传入一个int，该int的值将替换8192为缓冲数据大小），也就是说，每次可以从数据源（文件）中读取8192个字节的数据，然后一个一个的交给<code>b</code>，然后<code>b</code>存入<code>BuffetOutPutStream</code>的数组中，如果<code>BufferedOutputStream</code>中数据存放的数据满了，将会将数据写入到数据传输终点，然后<code>BufferInputStream</code>再从新从数据源读取8192大小的数据，以此往复直至存储完毕</li>
</ul>
<p>假设现在要存储一个8kb(8192个字节)大小的数据，需要复制到终点</p>
<table>
<thead>
<tr>
<th>方式</th>
...
<tr>
<td>传统方法</td>
<td>每次传输一个字节需要访问一次数据源一次数据传输终点<br />共访问两次硬存</td>
<td>8x1024x2=16384</td>
</tr>
<tr>
<td>使用处理流包装</td>
<td>BufferedInputStream一次将所有数据读取完毕存入数组中<br />然后一个一个给b再存入BufferedOutputStream的数组<br />最终一次存入硬盘</td>
<td>2次<br />读取一次<br />存储一次</td>
</tr>
</tbody>
</table>
<p>使用<code>BufferedInputStream</code>和<code>BufferedOutputStream</code>虽然传输8KB的数据只需要访问2次硬盘，但是同样也需要在内存中一个一个的进行转存，这样感觉不是没什么区别吗？</p>
<p>此时就是计算机中最重要的特点了：</p>
<ul>
<li><strong>内存的访问速度（运算效率）比硬盘的访问速度（运算效率）要高得多的多</strong></li>
<li><code>BufferedInputStream</code>和<code>BufferedOutputStream</code>的工作基本都是在内存中完成的，对硬盘的操作次数十分少，这就相对的提高了效率</li>
<li>现在举例只是以8KB为例，使用<code>BufferedInputStream</code>和<code>BufferedOutputStream</code>就能比单使用<code>FileInputStream</code>和<code>FileOutputStream</code>的效率提高很多很多</li>
<li>我们现实生活中随便一个文件基本都是以MB为单位或者GB为单位，这时两者的效率就天差地别了，所以这就是使用<code>BufferedInputStream</code>和<code>BufferedOutputStream</code>作为缓冲区传输的原因。</li>
</ul>
<h2 id="对象流-objectinputstream和objectoutputstream" tabindex="-1"><a class="header-anchor" href="#对象流-objectinputstream和objectoutputstream" aria-hidden="true">#</a> 对象流-ObjectInputStream和ObjectOutputStream</h2>
<p>先来看一个需求：</p>
<ol>
<li>将 <code>int num =100</code>这个int数据保存到文件中，注意不是100数字，而是 int 100，并且能够从文件中直接恢复 int 100</li>
<li>将<code>Dog dog = new Dog(&quot;小黄&quot;,3)</code>这个dog对象保存到文件中，并且能够从文件中恢复</li>
<li>上面的要求，就是能够将基本数据类型或者对象进行<strong>序列化</strong>和<strong>反序列化</strong>操作</li>
</ol>
<h3 id="序列化和反序列化" tabindex="-1"><a class="header-anchor" href="#序列化和反序列化" aria-hidden="true">#</a> 序列化和反序列化</h3>
<ol>
<li>序列化就是在保存数据时，<strong>保存数据的值</strong>和<strong>数据类型</strong></li>
<li>返序列化就是在恢复数据时，<strong>恢复数据的值</strong>和<strong>数据类型</strong></li>
<li>需要让某个对象支持序列化的机制，则必须让其是可序列化的，为了让某个类是可序列化的，该类必须要实现如下两个接口之一：
<ul>
<li><code> </code> 这是一个标记接口，没有方法</li>
<li><code>Externalizable</code> 这个接口有方法需要实现，因此一般都是使用<code>Serializable</code></li>
</ul>
</li>
</ol>
<h3 id="objectoutputstream和objectinputstream的简单介绍" tabindex="-1"><a class="header-anchor" href="#objectoutputstream和objectinputstream的简单介绍" aria-hidden="true">#</a> ObjectOutPutStream和ObjectInputStream的简单介绍</h3>
<ol>
<li>功能：提供了对基本类型或对象类型的序列化和反序列化功能</li>
<li><code>ObjectOutputStream</code>提供 <strong>序列化</strong>功能</li>
<li><code>ObjectInputStream</code>提供 <strong>反序列化</strong>功能</li>
<li>均为处理/包装流，因此需要传入<code>InputStream</code>和<code>OutputStream</code></li>
</ol>
<blockquote>
<p>简单演示</p>
</blockquote>
<p>序列化并存入文件</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>outputStream_</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br></div></div><blockquote>
<p>读取</p>
</blockquote>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br></div></div><h3 id="对象读写流及序列化的注意事项和使用细节" tabindex="-1"><a class="header-anchor" href="#对象读写流及序列化的注意事项和使用细节" aria-hidden="true">#</a> 对象读写流及序列化的注意事项和使用细节</h3>
<ol>
<li>
<p>读写顺序要一致</p>
</li>
<li>
<p>要求实现序列化或反序列化对象，需要实现<code>Serializable</code></p>
</li>
<li>
<p>序列化的类中建议添加<code>SerializableUID</code>，为了提高版本的兼容性</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">Dog</span> <span class="token keyword">implements</span> <span class="token class-name">Serializable</span> <span class="token punctuation">{</span>
    <span class="token keyword">private</span> <span class="token class-name">String</span> name<span class="token punctuation">;</span>
    <span class="token keyword">private</span> <span class="token keyword">int</span> age<span class="token punctuation">;</span>
    <span class="token comment">//    serialVersionUID 序列化的版本号，可以提高序列化的兼容性</span>
<span class="token comment">//    加了这个后，当我们序列化完毕时，再给Dog添加属性，如：    public int hobby = 123;</span>
<span class="token comment">//    再进行反序列化，将不会抛出异常，而是返回该类型的默认值0/null等</span>
<span class="token comment">//    也就是说，加了这个，就相当于让他们对比的时候，不会认为我后面修改的这个Dog是一个新的对象</span>
<span class="token comment">//    而是将它认为是我之前这个Dog的扩充版-高级版</span>
    <span class="token keyword">private</span> <span class="token keyword">static</span> <span class="token keyword">final</span> <span class="token keyword">long</span> serialVersionUID <span class="token operator">=</span> <span class="token number">1L</span><span class="token punctuation">;</span>
    <span class="token keyword">public</span> <span class="token keyword">int</span> hobby <span class="token operator">=</span> <span class="token number">123</span><span class="token punctuation">;</span>
    
    <span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div></li>
<li>
<p>序列化对象时，默认将里面所有属性都进行了序列化，但<code>static</code>和<code>transienet</code>修饰的成员不会被序列化（放弃对这个值的序列化，最终反序列化的时候将没有这个信息--&gt;返回这个<code>static</code>在Dog类中的值、<code>transienet</code>所属类型的默认值<code>0/null</code>）</p>
<ul>
<li>
<p><code>transienet</code>短暂的 转瞬即逝的 不可被序列化的：</p>
</li>
<li>
<p>比方说我在Dog类中添加了两个属性</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token class-name">String</span> <span class="token class-name">Blob</span> <span class="token operator">=</span> <span class="token string">"Hello World"</span><span class="token punctuation">;</span>
<span class="token keyword">public</span> <span class="token keyword">transient</span> <span class="token class-name">String</span> color<span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div></li>
<li>
<p>然后构造函数什么正常走，然后序列化，序列化完毕后我将Blob的值替换成了&quot;HHH&quot;</p>
</li>
<li>
<p>那么反序列化的后的输出结果为：</p>
<ul>
<li>toString()：Dog{name='旺财', age=10, hobby=123, color='null'}</li>
<li>Blob：HHH</li>
</ul>
</li>
</ul>
...
<ul>
<li>比方说我在Dog中添加一个属性<code>Master master =new Master()</code></li>
<li>但是我的Master类并没有实现<code>Serializable</code>接口</li>
<li>那么序列化的时候将会报错，所以实际使用的时候<code>Master</code>也需要进行序列化（实现<code>Serializable</code>接口）</li>
</ul>
</li>
<li>
<p>序列化具备可继承性，也就是如果某类已经实现了序列化，则它的所有子类也已默认实现了序列化</p>
<ul>
<li>就比如看看<code>Integer</code>，它继承自<code>Number</code> ,<code>Number</code>实现了序列化接口<code>Serializable</code>，所以<code>Integer</code>也实现了该接口</li>
</ul>
</li>
</ol>
<h2 id="标准输入输出流" tabindex="-1"><a class="header-anchor" href="#标准输入输出流" aria-hidden="true">#</a> 标准输入输出流</h2>
<p>这玩意在我们的开发中用的还是比较多的。比如一个很久前就开始使用的：<code>System.in</code>，以及天天都在用的<code>System.out.println()</code></p>
<table>
<thead>
<tr>
<th style="text-align:center"></th>
<th style="text-align:center">编译类型</th>
<th style="text-align:center">运行类型</th>
<th style="text-align:center">默认设备</th>
</tr>
</thead>
<tbody>
<tr>
<td style="text-align:center">System.in 标准输入</td>
<td style="text-align:center">InputStream</td>
<td style="text-align:center">BufferInputStream</td>
<td style="text-align:center">键盘</td>
</tr>
<tr>
<td style="text-align:center">System.out 标准输出</td>
<td style="text-align:center">PrintStream</td>
<td style="text-align:center">PrintStream</td>
...
<ul>
<li>传统方法<code>System.out.println()</code>就是使用out将对象输出到显示器</li>
<li>传统方法<code>Scanner</code>是从标准输入 键盘接收数据</li>
</ul>
<h2 id="转换流-inputstreamreader和outputstreamwriter" tabindex="-1"><a class="header-anchor" href="#转换流-inputstreamreader和outputstreamwriter" aria-hidden="true">#</a> 转换流-InputStreamReader和OutputStreamWriter</h2>
<p>接下来先放一个简单的读取文本的代码:</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">testQuestion</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
    ...
    reader<span class="token punctuation">.</span><span class="token function">close</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><p>文本内容是：Hello Fiance 世界你好</p>
<p>正常情况下，读取出的结果是没问题的，因为文本文档默认是采用了UTF-8的编码</p>
<p>但是我偏不，我重新保存了下文件，将编码设置为ASNI（国标码，根据系统决定，具体可以看<a href="https://blog.csdn.net/imxiangzi/article/details/77370160" target="_blank" rel="noopener noreferrer">这篇文档<ExternalLinkIcon/></a>，默认情况下，设置为中文的电脑国标码指向GBK编码）</p>
<p><img src="/images/JavaSE/18-IO流/image-20211114235905170.png" alt="image-20211114235905170" loading="lazy"></p>
<p>这时候再去读取：</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>接收到的内容Hello Fiance �������
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>哦豁 出现了乱码</p>
<p>也就是说，归根结底出现问题是因为我们没有去指定读取这个文件的编码方式，如果我们能去指定方式的话，就能轻松的解决这个问题了，这时候就要用到我们的<strong>转换流</strong>了</p>
<h3 id="基本介绍及使用" tabindex="-1"><a class="header-anchor" href="#基本介绍及使用" aria-hidden="true">#</a> 基本介绍及使用</h3>
<ol>
<li><code>InputStreamReader</code> Reader的子类，可以将<code>InputStream</code>(字节流)包装成<code>Reader</code>（字符流）</li>
<li><code>OutputStreamWriter</code>Writer的子类，可以将<code>OutputStream</code>(字节流)包装成<code>Reader</code>（字符流）</li>
<li>当处理纯文本数据时，如果使用字符流效率更高，并且可以有效的解决中文问题，所以建议将字节流转换成字符流</li>
<li>可以在使用指定编码格式（如:UTF-8、GBK、GB2312、ISO-8859-1等）</li>
</ol>
<blockquote>
<p>应用案例</p>
</blockquote>
<p>将字节流包装成InputStreamReader，对文件进行读取（按照utf-8,gbk格式），进而包装成BufferedReader</p>
<p>看着有点绕，但是实际上用起来并不难..</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">testQuestion</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><h2 id="打印流-printstream和printwriter" tabindex="-1"><a class="header-anchor" href="#打印流-printstream和printwriter" aria-hidden="true">#</a> 打印流-PrintStream和PrintWriter</h2>
<p>打印流只有输出流，没有输入流</p>
<p><code>PrintStream</code><strong>字节打印流</strong>直接父类：<code>FilterOutputStream</code> ，属于<code>OutputStream</code>，<a href="https://www.matools.com/file/manual/jdk_api_1.8_google/java/io/PrintStream.html" target="_blank" rel="noopener noreferrer">中文文档<ExternalLinkIcon/></a></p>
<p><code>PrintWriter</code><strong>字符打印流</strong>直接父类：<code>Writer</code>，<a href="https://www.matools.com/file/manual/jdk_api_1.8_google/java/io/PrintWriter.html" target="_blank" rel="noopener noreferrer">中文文档<ExternalLinkIcon/></a></p>
<p>接下来简单演示下怎么用：</p>
<p>字节打印流：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>    <span class="token doc-comment comment">/**
     * 演示PrintStream(字节打印流)
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br></div></div><h2 id="properties类" tabindex="-1"><a class="header-anchor" href="#properties类" aria-hidden="true">#</a> Properties类</h2>
<p>之前在集合类中提到过这个类，可以通过它来轻松的读取配置文件和写入配置文件</p>
<p>在使用之前，先看一个需求：</p>
<p>有一个配置文件<code>mysql.properties</code></p>
<p>ip=localhost</p>
<p>port=3306</p>
<p>user=root</p>
<p>password=123456</p>
<p>使用编程读写这些值</p>
<p><img src="/images/JavaSE/18-IO流/image-20211115114236906.png" alt="image-20211115114236906" loading="lazy"></p>
<p>如果不用Properties的话，就得这样：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>    <span class="token annotation punctuation">@Test</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">traditional</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
    ...
    reader<span class="token punctuation">.</span><span class="token function">close</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br></div></div><h3 id="properties的使用" tabindex="-1"><a class="header-anchor" href="#properties的使用" aria-hidden="true">#</a> Properties的使用</h3>
<p>它是专门用于读写配置文件的集合类</p>
<p>配置文件的格式：</p>
<p>key=value</p>
<p>key=value</p>
<p>键值对不需要有空格，值不需要用引号，默认类型是String</p>
<p>常用方法：</p>
<ul>
<li><code>load</code> 加载配置文件的键值对到Properties对象</li>
<li><code>list</code>将数据显示到指定设备</li>
<li><code>getProperty(key)</code> 根据键获取值</li>
<li><code>setProperty(key,value)</code> 设置键值对到Properties对象</li>
<li><code>store</code>将Properties键值对保存到配置文件中，在Idea中，保存信息的配置文件，如果含有中文，将会存储为unicode码</li>
</ul>
<blockquote>
<p>使用Properties完成对mysql.properties的读取</p>
</blockquote>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>    <span class="token doc-comment comment">/**
     * 读取
     * <span class="token keyword">@throws</span> <span class="token reference"><span class="token class-name">IOException</span></span> IO异常
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br></div></div><h3 id="扩展-小练" tabindex="-1"><a class="header-anchor" href="#扩展-小练" aria-hidden="true">#</a> 扩展-小练</h3>
<ol>
<li>
<p>HomeWork01.java</p>
<ol>
<li>在d盘下查看是否有文件夹mytemp，如果没有就创建，mytemp</li>
<li>在d:/mytemp目录下，创建文件hello.txt</li>
<li>如果hello.txt已存在，就提示该文件已存在，不重复创建</li>
</ol>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<p>HomeWork02.java</p>
<ol>
<li>使用BufferedReader读取一个文本文件，为每行添加上行号，再连同内容一并输出到屏幕上</li>
</ol>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<p>HomeWork03.java</p>
<ol>
<li>编写一个dog.properties在src目录下
<ol>
<li>name age color 三个字段</li>
</ol>
</li>
<li>编写Dog类，构造方法为上面三个字段，然后创建一个Dog对象，读取dog.properties用相应的内容完成属性初始化，并输出</li>
</ol>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
