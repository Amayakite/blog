...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当然，还要做一个JDBCUtils来更方便的获取连接</p>`,10),x={href:"https://mvnrepository.com/artifact/com.alibaba/druid",target:"_blank",rel:"noopener noreferrer"},C={href:"https://mvnrepository.com/artifact/mysql/mysql-connector-java",target:"_blank",rel:"noopener noreferrer"},E={href:"https://mvnrepository.com/artifact/commons-dbutils/commons-dbutils",target:"_blank",rel:"noopener noreferrer"},B=e('<h2 id="完成jdbcutils和读取db-properties" tabindex="-1"><a class="header-anchor" href="#完成jdbcutils和读取db-properties" aria-hidden="true">#</a> 完成JDBCUtils和读取db.properties</h2><p>这里走了一点坑：<code>db.utils</code>放在resources文件夹下</p><figure><img src="'+k+'" alt="image-20211205124137570" tabindex="0" loading="lazy"><figcaption>image-20211205124137570</figcaption></figure><p>然后再读取这个文件：</p><p>用到的方法：通过反射来读取配置文件：</p><p><code>JdbcUtils.class.getClassLoader().getResourceAsStream(&quot;db.properties&quot;)</code></p>',6),D=n("li",null,"获取JdbcUtils的class",-1),O=n("li",null,"获取类加载器(getClassLoader)",-1),R=n("li",null,"通过给定名称获取指定资源(getResourceAsStream)",-1),P=n("li",null,"这玩意具体的要到JVM底层才能了解到，目前来说上面这句话的意思就是：",-1),J=n("li",null,"当前项目根路径读取资源，如果是WebApp，那么默认就在部署后的classes文件夹下读取资源",-1),L={href:"https://www.cnblogs.com/macwhirr/p/8116583.html",target:"_blank",rel:"noopener noreferrer"},H=e(`<div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>books<span class="token punctuation">.</span>dao<span class="token punctuation">.</span>impl</span><span class="token punctuation">;</span>
