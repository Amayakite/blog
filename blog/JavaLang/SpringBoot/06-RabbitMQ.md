...
可以在官网看到入门案例https://www.rabbitmq.com/getstarted.html
...
流程是这样的 就是一个消息 可以传递到多个队列中 让多个接收方接收

![img](/images/SpringBoot/06-RabbitMQ/kuangstudy160fd9d8-2b42-4d43-b0d6-b4e47e272e8f-16407025532716.png)
...
![img](/images/SpringBoot/06-RabbitMQ/kuangstudy160fd9d8-2b42-4d43-b0d6-b4e47e272e8f-16407026060618.png)
...
然后这里面可以调整内存的分配 具体这里就不说了 可以看这个视频https://www.bilibili.com/video/BV1dX4y1V73G?p=34&spm_id_from=pageDriver
...
普通搭建看视频即可https://www.bilibili.com/video/BV1dX4y1V73G?p=35&spm_id_from=pageDriver

建议是先看一遍视频 再来开始用docker 搭建 会少蛮多坑

我这里使用docker搭建

看的教程是https://www.cnblogs.com/vipstone/p/9362388.html
