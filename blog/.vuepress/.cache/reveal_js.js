...
var w = b.default = function(e2) {
  if (e2) {
    ...
    }, i2 = 0, a2 = 1, n2 = 2, s2 = 3, r2 = [], o2 = null, l2 = "requestAnimationFrame" in e2 ? function() {
  ...
  function C2(e3, t3) {
    var i3 = y({}, E2, t3), a3 = e3.map(function(e4) {
      ...
      }(t4), { element: e4, fit: b2(t4, s2), unfreeze: R2(t4), freeze: S2(t4), unsubscribe: w2(t4) };
    });
    return l2(), a3;
  }
  function P2(e3) {
...
var R = class {
  ...
  stopEmbeddedContent(i2, a2 = {}) {
    ...
    }), a2.unloadIframes === true && t(i2, "iframe[data-src]").forEach((e2) => {
...
var E = class {
  ...
  sync(e2) {
    ...
    if (s2) {
      const t3 = A(s2);
      t3 && t3.a !== 0 && (typeof (r2 = s2) == "string" && (r2 = A(r2)), (r2 ? (299 * r2.r + 587 * r2.g + 114 * r2.b) / 1e3 : null) < 128 ? e2.classList.add("has-dark-background") : e2.classList.add("has-light-background"));
    }
    var r2;
  }
  update(e2 = false) {
    let i2 = this.Reveal.getCurrentSlide(), a2 = this.Reveal.getIndices(), n2 = null, s2 = this.Reveal.getConfig().rtl ? "future" : "past", r2 = this.Reveal.getConfig().rtl ? "past" : "future";
    if (Array.from(this.element.childNodes).forEach((i3, o2) => {
      i3.classList.remove("past", "present", "future"), o2 < a2.h ? i3.classList.add(s2) : o2 > a2.h ? i3.classList.add(r2) : (i3.classList.add("present"), n2 = i3), (e2 || o2 === a2.h) && t(i3, ".slide-background").forEach((e3, t2) => {
        e3.classList.remove("past", "present", "future"), t2 < a2.v ? e3.classList.add("past") : t2 > a2.v ? e3.classList.add("future") : (e3.classList.add("present"), o2 === a2.h && (n2 = e3));
      });
...
var C = class {
    ...
    if (e2.hasAttribute("data-auto-animate") && t2.hasAttribute("data-auto-animate") && e2.getAttribute("data-auto-animate-id") === t2.getAttribute("data-auto-animate-id") && !(a2 > n2 ? t2 : e2).hasAttribute("data-auto-animate-restart")) {
      ...
      if (t2.dataset.autoAnimateUnmatched !== "false" && this.Reveal.getConfig().autoAnimateUnmatched === true) {
        ...
        this.getUnmatchedAutoAnimateElements(t2).forEach((e4) => {
          ...
          t3.duration === i3.duration && t3.delay === i3.delay || (a4 = "unmatched-" + x++, s2.push(`[data-auto-animate="running"] [data-auto-animate-target="${a4}"] { transition: opacity ${t3.duration}s ease ${t3.delay}s; }`)), e4.dataset.autoAnimateTarget = a4;
  ...
  autoAnimateElements(e2, t2, i2, a2, n2) {
    ...
    if (i2.translate !== false || i2.scale !== false) {
      ...
      let a3 = i2.translate !== false && (t3.x !== 0 || t3.y !== 0), n3 = i2.scale !== false && (t3.scaleX !== 0 || t3.scaleY !== 0);
      if (a3 || n3) {
        let e4 = [];
        a3 && e4.push(`translate(${t3.x}px, ${t3.y}px)`), n3 && e4.push(`scale(${t3.scaleX}, ${t3.scaleY})`), r2.styles.transform = e4.join(" "), r2.styles["transform-origin"] = "top left", o2.styles.transform = "none";
      }
    }
...
var M = class {
  ...
  onDocumentKeyDown(e2) {
    ...
    h2 === false && (h2 = true, i2 === 80 || i2 === 33 ? this.Reveal.prev({ skipFragments: e2.altKey }) : i2 === 78 || i2 === 34 ? this.Reveal.next({ skipFragments: e2.altKey }) : i2 === 72 || i2 === 37 ? e2.shiftKey ? this.Reveal.slide(0) : !this.Reveal.overview.isActive() && c2 ? this.Reveal.prev({ skipFragments: e2.altKey }) : this.Reveal.left({ skipFragments: e2.altKey }) : i2 === 76 || i2 === 39 ? e2.shiftKey ? this.Reveal.slide(this.Reveal.getHorizontalSlides().length - 1) : !this.Reveal.overview.isActive() && c2 ? this.Reveal.next({ skipFragments: e2.altKey }) : this.Reveal.right({ skipFragments: e2.altKey }) : i2 === 75 || i2 === 38 ? e2.shiftKey ? this.Reveal.slide(void 0, 0) : !this.Reveal.overview.isActive() && c2 ? this.Reveal.prev({ skipFragments: e2.altKey }) : this.Reveal.up({ skipFragments: e2.altKey }) : i2 === 74 || i2 === 40 ? e2.shiftKey ? this.Reveal.slide(void 0, Number.MAX_VALUE) : !this.Reveal.overview.isActive() && c2 ? this.Reveal.next({ skipFragments: e2.altKey }) : this.Reveal.down({ skipFragments: e2.altKey }) : i2 === 36 ? this.Reveal.slide(0) : i2 === 35 ? this.Reveal.slide(this.Reveal.getHorizontalSlides().length - 1) : i2 === 32 ? (this.Reveal.overview.isActive() && this.Reveal.overview.deactivate(), e2.shiftKey ? this.Reveal.prev({ skipFragments: e2.altKey }) : this.Reveal.next({ skipFragments: e2.altKey })) : i2 === 58 || i2 === 59 || i2 === 66 || i2 === 86 || i2 === 190 || i2 === 191 ? this.Reveal.togglePause() : i2 === 70 ? ((e3) => {
      ...
      t3 && t3.apply(e3);
    })(t2.embedded ? this.Reveal.getViewportElement() : document.documentElement) : i2 === 65 ? t2.autoSlideStoppable && this.Reveal.toggleAutoSlide(a2) : h2 = false), h2 ? e2.preventDefault && e2.preventDefault() : i2 !== 27 && i2 !== 79 || (this.Reveal.closeOverlay() === false && this.Reveal.overview.toggle(), e2.preventDefault && e2.preventDefault()), this.Reveal.cueAutoSlide();
  }
};
var D = class {
  constructor(e2) {
  ...
  getIndicesFromHash(e2 = window.location.hash) {
    ...
    if (/^[0-9]*$/.test(i2[0]) || !t2.length) {
      ...
      let t3, a2 = e3.hashOneBasedIndex ? 1 : 0, n2 = parseInt(i2[0], 10) - a2 || 0, s2 = parseInt(i2[1], 10) - a2 || 0;
...
var q = class {
  ...
  async setupPDF() {
    const e2 = this.Reveal.getConfig(), i2 = t(this.Reveal.getRevealElement(), ".slides section"), a2 = e2.slideNumber && /all|print/i.test(e2.showSlideNumber), n2 = this.Reveal.getComputedSlideSize(window.innerWidth, window.innerHeight), s2 = Math.floor(n2.width * (1 + e2.margin)), r2 = Math.floor(n2.height * (1 + e2.margin)), o2 = n2.width, d2 = n2.height;
    await new Promise(requestAnimationFrame), l("@page{size:" + s2 + "px " + r2 + "px; margin: 0px;}"), l(".reveal section>img, .reveal section>video, .reveal section>iframe{max-width: " + o2 + "px; max-height:" + d2 + "px}"), document.documentElement.classList.add("print-pdf"), document.body.style.width = s2 + "px", document.body.style.height = r2 + "px";
    ...
    i2.forEach(function(i3, n3) {
      if (i3.classList.contains("stack") === false) {
        ...
        if (g2.push(m2), m2.className = "pdf-page", m2.style.height = (r2 + e2.pdfPageHeightOffset) * p2 + "px", h2 && (m2.style.background = h2), m2.appendChild(i3), i3.style.left = l2 + "px", i3.style.top = c3 + "px", i3.style.width = o2 + "px", this.Reveal.slideContent.layout(i3), i3.slideBackgroundElement && m2.insertBefore(i3.slideBackgroundElement, i3), e2.showNotes) {
          ...
          if (t2) {
            const i4 = 8, a3 = typeof e2.showNotes == "string" ? e2.showNotes : "inline", n4 = document.createElement("div");
            n4.classList.add("speaker-notes"), n4.classList.add("speaker-notes-pdf"), n4.setAttribute("data-layout", a3), n4.innerHTML = t2, a3 === "separate-page" ? g2.push(n4) : (n4.style.left = i4 + "px", n4.style.bottom = i4 + "px", n4.style.width = s2 - 2 * i4 + "px", m2.appendChild(n4));
          }
        }
        if (a2) {
  ...
  onTouchMove(e2) {
    ...
    if (this.touchCaptured)
      ...
      if (e2.touches.length === 1 && this.touchStartCount !== 2) {
        let n2 = this.Reveal.availableRoutes({ includeFragments: true }), s2 = i2 - this.touchStartX, r2 = a2 - this.touchStartY;
        s2 > 40 && Math.abs(s2) > Math.abs(r2) ? (this.touchCaptured = true, t2.navigationMode === "linear" ? t2.rtl ? this.Reveal.next() : this.Reveal.prev() : this.Reveal.left()) : s2 < -40 && Math.abs(s2) > Math.abs(r2) ? (this.touchCaptured = true, t2.navigationMode === "linear" ? t2.rtl ? this.Reveal.prev() : this.Reveal.next() : this.Reveal.right()) : r2 > 40 && n2.up ? (this.touchCaptured = true, t2.navigationMode === "linear" ? this.Reveal.prev() : this.Reveal.up()) : r2 < -40 && n2.down && (this.touchCaptured = true, t2.navigationMode === "linear" ? this.Reveal.next() : this.Reveal.down()), t2.embedded ? (this.touchCaptured || this.Reveal.isVerticalSlide()) && e2.preventDefault() : e2.preventDefault();
      }
    }
  }
  onTouchEnd(e2) {
...
var W = class {
  ...
  render() {
    ...
    const s2 = -Math.PI / 2 + e2 * (2 * Math.PI), r2 = -Math.PI / 2 + this.progressOffset * (2 * Math.PI);
    this.context.save(), this.context.clearRect(0, 0, this.diameter, this.diameter), this.context.beginPath(), this.context.arc(i2, a2, t2 + 4, 0, 2 * Math.PI, false), this.context.fillStyle = "rgba( 0, 0, 0, 0.4 )", this.context.fill(), this.context.beginPath(), this.context.arc(i2, a2, t2, 0, 2 * Math.PI, false), this.context.lineWidth = this.thickness, this.context.strokeStyle = "rgba( 255, 255, 255, 0.2 )", this.context.stroke(), this.playing && (this.context.beginPath(), this.context.arc(i2, a2, t2, r2, s2, false), this.context.lineWidth = this.thickness, this.context.strokeStyle = "#fff", this.context.stroke()), this.context.translate(i2 - 14, a2 - 14), this.playing ? (this.context.fillStyle = "#fff", this.context.fillRect(0, 0, 10, n2), this.context.fillRect(18, 0, 10, n2)) : (this.context.beginPath(), this.context.translate(4, 0), this.context.moveTo(0, 0), this.context.lineTo(24, 14), this.context.lineTo(0, n2), this.context.fillStyle = "#fff", this.context.fill()), this.context.restore();
  }
  on(e2, t2) {
...
function V(s2, l2) {
  ...
  const h2 = {};
  let u2, g2, p2, m2, b2, y2 = {}, w2 = false, A2 = { hasNavigatedHorizontally: false, hasNavigatedVertically: false }, L2 = [], x2 = 1, F2 = { layout: "", overview: "" }, V2 = {}, $2 = "idle", j2 = 0, X = 0, Y = -1, _ = false, J = new R(h2), Q = new S(h2), Z = new C(h2), G = new E(h2), ee = new P(h2), te = new N(h2), ie = new M(h2), ae = new D(h2), ne = new I(h2), se = new T(h2), re = new z(h2), oe = new H(h2), le = new q(h2), de = new U(h2), ce = new B(h2), he = new O(h2);
  function ue(e2) {
    if (!s2)
      throw 'Unable to find presentation root (<div class="reveal">).';
    if (V2.wrapper = s2, V2.slides = s2.querySelector(".slides"), !V2.slides)
      throw 'Unable to find slides container (<div class="slides">).';
    return y2 = __spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, K), y2), l2), e2), d()), ge(), window.addEventListener("load", Fe, false), oe.load(y2.plugins, y2.dependencies).then(ve), new Promise((e3) => h2.on("ready", e3));
  }
  function ge() {
    y2.embedded === true ? V2.viewport = r(s2, ".reveal-viewport") || s2 : (V2.viewport = document.body, document.documentElement.classList.add("reveal-full-page")), V2.viewport.classList.add("reveal-viewport");
  }
  function ve() {
    w2 = true, pe(), me(), Re(), we(), et(), Se(), ae.readURL(), G.update(true), setTimeout(() => {
  ...
  function me() {
    V2.slides.classList.add("no-transition"), v ? V2.wrapper.classList.add("no-hover") : V2.wrapper.classList.remove("no-hover"), G.render(), Q.render(), ne.render(), se.render(), he.render(), V2.pauseOverlay = o(V2.wrapper, "div", "pause-overlay", y2.controls ? '<button class="resume-button">Resume presentation</button>' : null), V2.statusElement = fe(), V2.wrapper.setAttribute("role", "application");
  }
  function fe() {
  ...
  function Re() {
    y2.postMessage && window.addEventListener("message", (e2) => {
      let t2 = e2.data;
  ...
  function Se(t2) {
    const a2 = __spreadValues({}, y2);
    if (typeof t2 == "object" && e(y2, t2), h2.isReady() === false)
      return;
    const n2 = V2.wrapper.querySelectorAll(".slides section").length;
    V2.wrapper.classList.remove(a2.transition), V2.wrapper.classList.add(y2.transition), V2.wrapper.setAttribute("data-transition-speed", y2.transitionSpeed), V2.wrapper.setAttribute("data-background-transition", y2.backgroundTransition), V2.viewport.style.setProperty("--slide-width", y2.width + "px"), V2.viewport.style.setProperty("--slide-height", y2.height + "px"), y2.shuffle && tt(), i(V2.wrapper, "embedded", y2.embedded), i(V2.wrapper, "rtl", y2.rtl), i(V2.wrapper, "center", y2.center), y2.pause === false && je(), y2.previewLinks ? (Ne(), Me("[data-preview-link=false]")) : (Me(), Ne("[data-preview-link]:not([data-preview-link=false])")), Z.reset(), b2 && (b2.destroy(), b2 = null), n2 > 1 && y2.autoSlide && y2.autoSlideStoppable && (b2 = new W(V2.wrapper, () => Math.min(Math.max((Date.now() - Y) / j2, 0), 1)), b2.on("click", Ft), _ = false), y2.navigationMode !== "default" ? V2.wrapper.setAttribute("data-navigation-mode", y2.navigationMode) : V2.wrapper.removeAttribute("data-navigation-mode"), he.configure(y2, a2), de.configure(y2, a2), re.configure(y2, a2), ne.configure(y2, a2), se.configure(y2, a2), ie.configure(y2, a2), ee.configure(y2, a2), Q.configure(y2, a2), Ze();
  }
  function Ae() {
    window.addEventListener("resize", It, false), y2.touch && ce.bind(), y2.keyboard && ie.bind(), y2.progress && se.bind(), y2.respondToHashChanges && ae.bind(), ne.bind(), de.bind(), V2.slides.addEventListener("click", Dt, false), V2.slides.addEventListener("transitionend", Mt, false), V2.pauseOverlay.addEventListener("click", je, false), y2.focusBodyOnPageVisibilityChange && document.addEventListener("visibilitychange", Tt, false);
  }
  function Ee() {
    ce.unbind(), de.unbind(), ie.unbind(), ne.unbind(), se.unbind(), ae.unbind(), window.removeEventListener("resize", It, false), V2.slides.removeEventListener("click", Dt, false), V2.slides.removeEventListener("transitionend", Mt, false), V2.pauseOverlay.removeEventListener("click", je, false);
  }
  ...
  function De(e2) {
    ze(), V2.overlay = document.createElement("div"), V2.overlay.classList.add("overlay"), V2.overlay.classList.add("overlay-preview"), V2.wrapper.appendChild(V2.overlay), V2.overlay.innerHTML = `<header>
  ...
  function Fe() {
    if (V2.wrapper && !le.isPrintingPDF()) {
      if (!y2.disableLayout) {
        ...
        const e2 = qe(), t2 = x2;
        He(y2.width, y2.height), V2.slides.style.width = e2.width + "px", V2.slides.style.height = e2.height + "px", x2 = Math.min(e2.presentationWidth / e2.width, e2.presentationHeight / e2.height), x2 = Math.max(x2, y2.minScale), x2 = Math.min(x2, y2.maxScale), x2 === 1 ? (V2.slides.style.zoom = "", V2.slides.style.left = "", V2.slides.style.top = "", V2.slides.style.bottom = "", V2.slides.style.right = "", xe({ layout: "" })) : x2 > 1 && f && window.devicePixelRatio < 2 ? (V2.slides.style.zoom = x2, V2.slides.style.left = "", V2.slides.style.top = "", V2.slides.style.bottom = "", V2.slides.style.right = "", xe({ layout: "" })) : (V2.slides.style.zoom = "", V2.slides.style.left = "50%", V2.slides.style.top = "50%", V2.slides.style.bottom = "auto", V2.slides.style.right = "auto", xe({ layout: "translate(-50%, -50%) scale(" + x2 + ")" }));
        const i2 = Array.from(V2.wrapper.querySelectorAll(".slides section"));
        for (let t3 = 0, a2 = i2.length; t3 < a2; t3++) {
          const a3 = i2[t3];
          a3.style.display !== "none" && (y2.center || a3.classList.contains("center") ? a3.classList.contains("stack") ? a3.style.top = 0 : a3.style.top = Math.max((e2.height - a3.scrollHeight) / 2, 0) + "px" : a3.style.top = "");
        }
  ...
  function He(e2, i2) {
    t(V2.slides, "section > .stretch, section > .r-stretch").forEach((t2) => {
      ...
      if (/(img|video)/gi.test(t2.nodeName)) {
        const i3 = t2.naturalWidth || t2.videoWidth, n2 = t2.naturalHeight || t2.videoHeight, s3 = Math.min(e2 / i3, a2 / n2);
  ...
  function Qe(e2, t2, i2, a2) {
    if (Ce({ type: "beforeslidechange", data: { indexh: e2 === void 0 ? u2 : e2, indexv: t2 === void 0 ? g2 : t2, origin: a2 } }).defaultPrevented)
      return;
    p2 = m2;
    ...
    for (; s3.length; )
      V2.viewport.classList.remove(s3.pop());
    l3 && Ce({ type: "slidechanged", data: { indexh: u2, indexv: g2, previousSlide: p2, currentSlide: m2, origin: a2 } }), !l3 && p2 || (J.stopEmbeddedContent(p2), J.startEmbeddedContent(m2)), requestAnimationFrame(() => {
      be(ye(m2));
    }), se.update(), ne.update(), he.update(), G.update(), G.updateParallax(), Q.update(), ee.update(), ae.writeURL(), wt(), h3 && (setTimeout(() => {
      V2.slides.classList.remove("disable-slide-transitions");
    }, 0), y2.autoAnimate && Z.run(p2, m2));
  }
  function Ze() {
    Ee(), Ae(), Fe(), j2 = y2.autoSlide, wt(), G.create(), ae.writeURL(), ee.sortAll(), ne.update(), se.update(), at(), he.update(), he.updateVisibility(), G.update(true), Q.update(), J.formatEmbeddedContent(), y2.autoPlayMedia === false ? J.stopEmbeddedContent(m2, { unloadIframes: false }) : J.startEmbeddedContent(m2), te.isActive() && te.layout();
  }
  function Ge(e2 = m2) {
  ...
  function it(e2, i2) {
    let a2 = t(V2.wrapper, e2), n2 = a2.length, s3 = le.isPrintingPDF();
    if (n2) {
      y2.loop && (i2 %= n2) < 0 && (i2 = n2 + i2), i2 = Math.max(Math.min(i2, n2 - 1), 0);
      for (let e4 = 0; e4 < n2; e4++) {
        let n3 = a2[e4], r3 = y2.rtl && !Oe(n3);
        n3.classList.remove("past"), n3.classList.remove("present"), n3.classList.remove("future"), n3.setAttribute("hidden", ""), n3.setAttribute("aria-hidden", "true"), n3.querySelector("section") && n3.classList.add("stack"), s3 ? n3.classList.add("present") : e4 < i2 ? (n3.classList.add(r3 ? "future" : "past"), y2.fragments && t(n3, ".fragment").forEach((e5) => {
      ...
      let e3 = a2[i2], r2 = e3.classList.contains("present");
  ...
  function at() {
    ...
    if (n2 && u2 !== void 0) {
      ...
      gt() ? V2.wrapper.classList.add("has-vertical-slides") : V2.wrapper.classList.remove("has-vertical-slides"), ut() ? V2.wrapper.classList.add("has-horizontal-slides") : V2.wrapper.classList.remove("has-horizontal-slides");
    }
  }
  function nt({ includeFragments: e2 = false } = {}) {
    let t2 = V2.wrapper.querySelectorAll(".slides>section"), i2 = V2.wrapper.querySelectorAll(".slides>section.present>section"), a2 = { left: u2 > 0, right: u2 < t2.length - 1, up: g2 > 0, down: g2 < i2.length - 1 };
    if (y2.loop && (t2.length > 1 && (a2.left = true, a2.right = true), i2.length > 1 && (a2.up = true, a2.down = true)), t2.length > 1 && y2.navigationMode === "linear" && (a2.right = a2.right || a2.down, a2.left = a2.left || a2.up), e2 === true) {
  ...
  function st(e2 = m2) {
    ...
    e:
      for (let a2 = 0; a2 < t2.length; a2++) {
        let n2 = t2[a2], s3 = n2.querySelectorAll("section");
  ...
  function ot(e2) {
    let i2, a2 = u2, n2 = g2;
    if (e2) {
      let i3 = Oe(e2), s3 = i3 ? e2.parentNode : e2, r2 = dt();
  ...
  function wt() {
    if (Rt(), m2 && y2.autoSlide !== false) {
      ...
      let i2 = e2 ? e2.getAttribute("data-autoslide") : null, a2 = m2.parentNode ? m2.parentNode.getAttribute("data-autoslide") : null, n2 = m2.getAttribute("data-autoslide");
      i2 ? j2 = parseInt(i2, 10) : n2 ? j2 = parseInt(n2, 10) : a2 ? j2 = parseInt(a2, 10) : (j2 = y2.autoSlide, m2.querySelectorAll(".fragment").length === 0 && t(m2, "video, audio").forEach((e3) => {
        e3.hasAttribute("data-autoplay") && j2 && 1e3 * e3.duration / e3.playbackRate > j2 && (j2 = 1e3 * e3.duration / e3.playbackRate + 1e3);
      })), !j2 || _ || Ye() || te.isActive() || Ve() && !ee.availableRoutes().next && y2.loop !== true || (X = setTimeout(() => {
  ...
  function Et({ skipFragments: e2 = false } = {}) {
    A2.hasNavigatedHorizontally = true, y2.rtl ? (te.isActive() || e2 || ee.next() === false) && nt().left && Qe(u2 + 1, y2.navigationMode === "grid" ? g2 : void 0) : (te.isActive() || e2 || ee.prev() === false) && nt().left && Qe(u2 - 1, y2.navigationMode === "grid" ? g2 : void 0);
  }
  function kt({ skipFragments: e2 = false } = {}) {
    A2.hasNavigatedHorizontally = true, y2.rtl ? (te.isActive() || e2 || ee.prev() === false) && nt().right && Qe(u2 - 1, y2.navigationMode === "grid" ? g2 : void 0) : (te.isActive() || e2 || ee.next() === false) && nt().right && Qe(u2 + 1, y2.navigationMode === "grid" ? g2 : void 0);
  }
  ...
  function Mt(e2) {
    $2 === "running" && /section/gi.test(e2.target.nodeName) && ($2 = "idle", Ce({ type: "slidetransitionend", data: { indexh: u2, indexv: g2, previousSlide: p2, currentSlide: m2 } }));
  }
  function Dt(e2) {
    const t2 = r(e2.target, 'a[href^="#"]');
    if (t2) {
      const i2 = t2.getAttribute("href"), a2 = ae.getIndicesFromHash(i2);
  ...
  const Ht = { VERSION: "4.2.1", initialize: ue, configure: Se, sync: Ze, syncSlide: Ge, syncFragments: ee.sync.bind(ee), slide: Qe, left: Et, right: kt, up: Lt, down: xt, prev: Ct, next: Pt, navigateLeft: Et, navigateRight: kt, navigateUp: Lt, navigateDown: xt, navigatePrev: Ct, navigateNext: Pt, navigateFragment: ee.goto.bind(ee), prevFragment: ee.prev.bind(ee), nextFragment: ee.next.bind(ee), on: ke, off: Le, addEventListener: ke, removeEventListener: Le, layout: Fe, shuffle: tt, availableRoutes: nt, availableFragments: ee.availableRoutes.bind(ee), toggleHelp: Ie, toggleOverview: te.toggle.bind(te), togglePause: Xe, toggleAutoSlide: _e, isFirstSlide: Ke, isLastSlide: Ve, isLastVerticalSlide: We, isVerticalSlide: Oe, isPaused: Ye, isAutoSliding: Je, isSpeakerNotes: he.isSpeakerNotesWindow.bind(he), isOverview: te.isActive.bind(te), isFocused: de.isFocused.bind(de), isPrintingPDF: le.isPrintingPDF.bind(le), isReady: () => w2, loadSlide: J.load.bind(J), unloadSlide: J.unload.bind(J), showPreview: De, hidePreview: ze, addEventListeners: Ae, removeEventListeners: Ee, dispatchEvent: Ce, getState: bt, setState: yt, getProgress: rt, getIndices: ot, getSlidesAttributes: vt, getSlidePastCount: st, getTotalSlides: pt, getSlide: mt, getPreviousSlide: () => p2, getCurrentSlide: () => m2, getSlideBackground: ft, getSlideNotes: he.getSlideNotes.bind(he), getSlides: lt, getHorizontalSlides: dt, getVerticalSlides: ct, hasHorizontalSlides: ut, hasVerticalSlides: gt, hasNavigatedHorizontally: () => A2.hasNavigatedHorizontally, hasNavigatedVertically: () => A2.hasNavigatedVertically, addKeyBinding: ie.addKeyBinding.bind(ie), removeKeyBinding: ie.removeKeyBinding.bind(ie), triggerKey: ie.triggerKey.bind(ie), registerKeyboardShortcut: ie.registerKeyboardShortcut.bind(ie), getComputedSlideSize: qe, getScale: () => x2, getConfig: () => y2, getQueryHash: d, getRevealElement: () => s2, getSlidesElement: () => V2.slides, getViewportElement: () => V2.viewport, getBackgroundsElement: () => G.element, registerPlugin: oe.registerPlugin.bind(oe), hasPlugin: oe.hasPlugin.bind(oe), getPlugin: oe.getPlugin.bind(oe), getPlugins: oe.getRegisteredPlugins.bind(oe) };
  return e(h2, __spreadProps(__spreadValues({}, Ht), { announceStatus: be, getStatusText: ye, print: le, focus: de, progress: se, controls: ne, location: ae, overview: te, fragments: ee, slideContent: J, slideNumber: Q, onUserInput: Nt, closeOverlay: ze, updateSlidesVisibility: at, layoutSlideContents: He, transformSlides: xe, cueAutoSlide: wt, cancelAutoSlide: Rt })), Ht;
}
var $ = V;
var j = [];
...
}), $.isReady = () => false, $.VERSION = "4.2.1";
var reveal_esm_default = $;

// dep:reveal_js
var reveal_js_default = reveal_esm_default;
export {
  reveal_js_default as default
};
/*!
* reveal.js 4.2.1
* https://revealjs.com
...
*/
//# sourceMappingURL=reveal_js.js.map
