...
![get方法](./images/Java/5-共享模型之无锁/1642395374530.png)

![修改的方法](./images/Java/5-共享模型之无锁/1642395393653.png)

那么它是如何实现的呢？

其中的关键是`compareAndSet`---比较并设置，它的简称就是CAS，它必须是原子操作

![CAS修改的过程](./images/Java/5-共享模型之无锁/1642395629797.png)
...
![volatile](./images/Java/5-共享模型之无锁/1642396441640.png)
...
![流程](./images/Java/5-共享模型之无锁/1642403974694.png)

这里代码我就懒得去敲了，非常简单，相当于用布尔值来替换了AtomicStampedReference

![代码1](./images/Java/5-共享模型之无锁/1642404415541.png)

![代码2](./images/Java/5-共享模型之无锁/1642404468737.png)
...
![images](./images/Java/5-共享模型之无锁/1642408588930.png)
...
![关键域](./images/Java/5-共享模型之无锁/1642408722696.png)
...
![运行](./images/Java/5-共享模型之无锁/1642409604449.png)

结果：

![结果](./images/Java/5-共享模型之无锁/1642409615063.png)
...
![String](./images/Java/5-共享模型之无锁/1642410390397.png)
