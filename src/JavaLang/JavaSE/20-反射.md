...
![Java程序在计算机有三个阶段2](/images/Java/JavaSE/20-反射/Java程序在计算机有三个阶段2.jpg)
...
基本数据类型和包装类在底层系统是会自动装箱和拆箱的，所以说可以理解他们为同一种类型，可以对比他们的hashcode:
...
![类加载流程图](/images/Java/JavaSE/20-反射/类加载流程图.jpg)
