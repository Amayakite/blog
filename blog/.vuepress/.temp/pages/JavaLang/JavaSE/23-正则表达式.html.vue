<template><h2 id="初始正则表达式" tabindex="-1"><a class="header-anchor" href="#初始正则表达式" aria-hidden="true">#</a> 初始正则表达式</h2>
<p>假设你现在通过爬虫之类的东西，从百度中爬取到了以下文本</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>1994年6、7月间，在经历了一场历时三天的讨论之后，团队决定再一次改变了努力的目标，这次他们决定将该技术应用于万维网。他们认为随着Mosaic浏览器的到来，因特网正在向同样的高度互动的远景演变，而这一远景正是他们在有线电视网中看到的。作为原型，帕特里克·诺顿写了一个小型万维网浏览器WebRunner。 [8]
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>现在有一个需求，获取到文章中的所有英文单词</p>
<p>使用传统的方法将要:</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">//        使用传统方法提取单词</span>
        ...
        <span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div><p>二十六个字母大小写都要过一遍，并且要识别下一个是不字母，是的话拼接，不是的话return</p>
<p>接下来使用正则表达式来解决这个问题</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><p>可以看到，完美的打印出了我想要的内容：</p>
<p><img src="/images/JavaSE/23-正则表达式/image-20211129222342967.png" alt="image-20211129222342967" loading="lazy"></p>
<p>好，接下来尝试匹配数字 只需要替换一段话即可</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>然后再匹配所有的英文单词和数字</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>可以看到，依旧完美的成功跑起来了</p>
<p>经过上面的案例，不难看出，正则表达式是处理文本的最佳选择，无论在什么情况下都是</p>
<p>接下来再提出一个需求：</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>1998年12月8日，第二代Java平台的企业版J2EE发布。1999年6月，Sun公司发布了第二代Java平台（简称为Java2）的3个版本：J2ME（Java2 Micro Edition，Java2平台的微型版），应用于移动、无线及有限资源的环境；J2SE（Java 2 Standard Edition，Java 2平台的标准版），应用于桌面环境；J2EE（Java 2Enterprise Edition，Java 2平台的企业版），应用3443于基于Java的应用服务器。Java 2平台的发布，是Java发展过程中最重要的一个里程碑，标志着Java的应用开始普及9889。
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><ol>
<li>找出所有四个数字连在一起的字串</li>
<li>找出所有四个数字连接在一起的字串，并且这四个数字要满足：第一位与第四位相同，第二位与第三位相同，比如：1221,5775</li>
<li>写一个控制台程序，要求用户输入邮箱，并验证是否符合邮箱格式(xxxxx@xx.xx)</li>
<li>验证用户输入的手机号是否符合手机号格式(19919991999)</li>
</ol>
<p>​  为了解决上述的问题，Java提供了正则表达式技术，专门用于处理类似文本问题（当然，所有语言中都有这个功能，不过就个人感知来说，Java的正则表达式算是比较难用的那一类--没有``符，需要对转义符\进行二次转义）</p>
<p>​  简单来说，<strong>正则表达式是对字符串执行模式匹配的技术</strong></p>
<p>​  正则表达式全称：regualr expression 简称 <strong>RegExp</strong></p>
<p>​  所有语言中都含有正则表达式（特别垃圾的才没有），语法基本上都大同小异，学完一个其他的也就都会了，这玩意是所有程序员必备技能，面试不会问但是实际工作中（比如爬虫。全文搜索等功能）都要用到它</p>
<h2 id="正则表达式的底层实现" tabindex="-1"><a class="header-anchor" href="#正则表达式的底层实现" aria-hidden="true">#</a> 正则表达式的底层实现</h2>
<p>案例：</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>1998年12月8日，第二代Java平台的企业版J2EE发布。1999年6月，Sun公司发布了第二代Java平台（简称为Java2）的3个版本：J2ME（Java2 Micro Edition，Java2平台的微型版），应用于移动、无线及有限资源的环境；J2SE（Java 2 Standard Edition，Java 2平台的标准版），应用于桌面环境；J2EE（Java 2Enterprise Edition，Java 2平台的企业版），应用3443于基于Java的应用服务器。Java 2平台的发布，是Java发展过程中最重要的一个里程碑，标志着Java的应用开始普及9889。
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>找出所有四个数字连在一起的字串：应该找到1998 1999 3443 9889</p>
<p>上代码<code>RegTheory.java</code>：</p>
...
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">run1</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br></div></div><h3 id="find方法和group-0-的源码分析" tabindex="-1"><a class="header-anchor" href="#find方法和group-0-的源码分析" aria-hidden="true">#</a> find方法和group(0)的源码分析</h3>
<p><code>matcher.find()</code>完成的任务</p>
<ol>
<li>
<p>根据指定的规则，定位满足规则的子字符串</p>
<ul>
<li>比如<code>世界你好1999阿啊啊</code>中，匹配四个数字，则找1和最后一个9的位置，分别为,4和7(从0开始索引)</li>
</ul>
</li>
<li>
<p>找到后，将<strong>子字符串</strong>开始的索引(4)记录到<code>mathcer</code>对象的属性 <code>int groups[]</code>当中</p>
<ol>
<li><code>groups[0]=4</code></li>
...
<p>同时记录：</p>
<ol>
<li>初始值4到<code>int first</code>中：<code>first=4</code></li>
</ol>
</li>
<li>
<p>结束的索引+1记录到<code>int last</code>和<code>int oldLast</code>中7+1，即：下次开始找的时候，从7+1这个位置开始进行匹配(下次执行<code>find()</code>方法中从8开始匹配)</p>
<ul>
<li></li>
</ul>
</li>
</ol>
<p><code>matcher.group(0)</code>完成的任务</p>
<p>先看源码：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br></div></div><h3 id="在分组情况下的源码分析" tabindex="-1"><a class="header-anchor" href="#在分组情况下的源码分析" aria-hidden="true">#</a> 在分组情况下的源码分析</h3>
<p>分组就是当我查找4个连在一起的数字，但是又想把它们的前两个和后两个分开来：</p>
<p><code>(\\d\\d)(\\d\\d)</code></p>
<p>就需要这样，比如1998，最终得出的结果为:[1998],[19],[98] 也就是有三个结果，三组内容</p>
<p>理论来说，分组的数量为括号数量+1</p>
<p>第一个小括号是第一组 19，第二个小括号是第二组 98，第0组为匹配这些内容的值：1998</p>
<p>接下来开始分析，测试内容为<code>1998年12月8日，第二代Java平台的企业版J2EE发布。......</code></p>
<p>首先进行<code>matcher.find()</code></p>
<ol>
<li>根据规则匹配<code>(\\d\\d)(\\d\\d)</code>
<ol>
<li>首先找到的子字符串是1998</li>
<li>然后记录索引位置，分别是<code>groups[0]=0,groups[1]=4</code></li>
<li>记录第一组<code>()</code>匹配到的字符串的开始索引位置记录到<code>groups[2]=?</code>，结束的索引位置记录到<code>groups[3]=?+1</code>
<ul>
<li><code>groups[2]=0</code></li>
<li><code>groups[3]=2</code></li>
</ul>
</li>
<li>第二组<code>()</code>原理同上，分别记录到<code>groups[4]=2</code>，<code>groups[5]=4</code></li>
<li>如果还有更多括号的以此类推</li>
</ol>
</li>
<li>并同时记录<code>oldLast</code>的值为该子字符串传的结束位置+1<code>oldLast=4</code></li>
</ol>
<p><img src="/images/JavaSE/23-正则表达式/image-20211130122015863.png" alt="image-20211130122015863" loading="lazy"></p>
<p>接下来看看他们是怎么截取的</p>
<p>在<code>matcher.group(int group )</code>中，可以看到最后return的值为：</p>
<p><code>getSubSequence(groups[group * 2], groups[group * 2 + 1])</code></p>
<p>也就是说，如果是第0组，结果为：0,1</p>
<p>第一组的话，结果为：2,3</p>
<p>第二组的话，结果为：4,5</p>
<p>完美对应了上一步存放的位置</p>
<p>啊，真是精妙的设计..接下来看看结果：</p>
<p><img src="/images/JavaSE/23-正则表达式/image-20211130122524760.png" alt="image-20211130122524760" loading="lazy"></p>
<p>代码片段</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token class-name">String</span> regStr <span class="token operator">=</span> <span class="token string">"(\\d\\d)(\\d\\d)"</span><span class="token punctuation">;</span>
<span class="token comment">//        创建一个正则表达式对象</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><p>总结：</p>
<ul>
<li>group(0)表示匹配到的整体的子字符串</li>
<li>group(n)表示匹配到的子字符串的第n组字串</li>
</ul>
<p>​  如果说n的数量大于括号的数量，如，只有两个括号，但是group(3)，就可以根据前面的规则发现，group(3)中对应的初始索引位置<code>groups[5]</code>和<code>groups[6]</code>分别都是-1，字符串中截取-1的值，直接抛出<strong>下标越界异常</strong></p>
<p>​  所以分组不能越界</p>
<h2 id="正则表达式语法" tabindex="-1"><a class="header-anchor" href="#正则表达式语法" aria-hidden="true">#</a> 正则表达式语法</h2>
<p>​  如果想要灵活的运用正则表达式，必须了解其中的各种语法，元字符从功能上大概分为：</p>
<ol>
<li>限定符</li>
<li>选择匹配符</li>
<li>分组组合和反向引用符</li>
...
<h3 id="元字符-转义号及常用匹配符" tabindex="-1"><a class="header-anchor" href="#元字符-转义号及常用匹配符" aria-hidden="true">#</a> 元字符-转义号及常用匹配符</h3>
<p><code>\\</code>符号 说明：当我们使用正则表达式去检索某些<strong>特殊字符</strong>的时候，需要用到转义符，否则检索不到结果，甚至会报错，比如说我们现在有一个字符串：<code>abc$(</code>，相匹配其中的<code>abc$</code>现在试图直接匹配下</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>可以看到，什么都没有匹配到</p>
<p>现在尝试加上转义符<code>\\</code>:</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token class-name">Pattern</span> pattern <span class="token operator">=</span> <span class="token class-name">Pattern</span><span class="token punctuation">.</span><span class="token function">compile</span><span class="token punctuation">(</span><span class="token string">"abc\\$"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>成功的匹配出了结果：<code>result：abc$</code></p>
<p>额外提醒：<strong>Java的正则表达式中，两个<code>\\</code>代表其他语言中的一个<code>\</code>(正则匹配这方面做的不是很好)</strong></p>
<p>需要用到转移符号的字符有以下：</p>
<p><code>. * + ( )  $ / \ ?[ ] ^ { } -</code></p>
<ul>
<li>
<p><code>.</code> 表示匹配所有字符</p>
</li>
<li>
<p><code>[]</code> 表示可接收的字符串：
例如：我想要匹配efgh中的任意一个字符，则需要：
<code>[efgh]</code> 匹配e、f、g、h中的任意一个字符</p>
</li>
<li>
<p>[^]表示不接受的字符串
例如：<code>[^abc]</code>表示除了a、b、c以外的任意一个字符，包括数字和特殊符号</p>
</li>
<li></li>
</ul>
<h2 id="正则表达式-元字符-字符匹配符" tabindex="-1"><a class="header-anchor" href="#正则表达式-元字符-字符匹配符" aria-hidden="true">#</a> 正则表达式-元字符-字符匹配符</h2>
<table>
<thead>
<tr>
...
<td style="text-align:left">表示可接收的字符列表</td>
<td style="text-align:center">[efgh]</td>
<td>匹配e、f、g、h<br />中的任意一个字符</td>
<td>e、f</td>
</tr>
<tr>
<td style="text-align:center">[^]</td>
<td style="text-align:left">表示不接受的字符列表</td>
<td style="text-align:center">[^abc]</td>
<td>表示<strong>除了</strong>a、b、c以外的<br />任意一个字符<br />包括数字和特殊符号</td>
<td>a、b</td>
</tr>
<tr>
<td style="text-align:center">-</td>
<td style="text-align:left">连字符，一般在[]内使用</td>
...
<td>以a开头，b结尾<br />中间包括2个任意字符的<br />长度为4的字符串</td>
<td>aaab 、<br />aefb</td>
</tr>
<tr>
<td style="text-align:center"><code>\\d</code></td>
<td style="text-align:left">匹配单个数字字符<br />相当于<code>[0-9]</code></td>
...
<tr>
<td style="text-align:center"><code>\\D</code></td>
<td style="text-align:left">匹配<strong>非</strong>单个数字字符<br />相当于<code>[^0-9]</code></td>
<td style="text-align:center"><code>\\D(\\d)*</code></td>
<td>以单个非数字字符开头，后<br />后面接任意个数字字符串</td>
<td>a、A315</td>
</tr>
<tr>
<td style="text-align:center"><code>\\w</code></td>
<td style="text-align:left">匹配单个数字，大小写字母<br />相当于<code>[0-9A-Za-z]</code></td>
<td style="text-align:center"><code>\\d{3}\\w{4}</code></td>
<td>以三个数字字符开头<br />长度为7的数字字母字符串</td>
<td>234abcd、<br />12345Pe</td>
</tr>
<tr>
<td style="text-align:center"><code>\\W</code></td>
<td style="text-align:left">匹配<strong>非</strong>单个数字，大小写字母<br />相当于<code>[^0-9A-Za-z]</code></td>
<td style="text-align:center"><code>\\W+\\d{2}</code></td>
<td>至少以一个非数字字母字符开头<br />2个数字字符结尾的字符串</td>
<td>#29、#?@10</td>
</tr>
<tr>
<td style="text-align:center">(?i)</td>
<td style="text-align:left">让大小写不敏感</td>
<td style="text-align:center"><code>(?i)abc</code></td>
<td>让abc都不区分大小写</td>
<td>Abc、ABc、aBC</td>
</tr>
<tr>
<td style="text-align:center"></td>
<td style="text-align:left"></td>
<td style="text-align:center"><code>a(?i)bc</code></td>
<td>表示bc不区分大小写</td>
<td>aBC、acC</td>
</tr>
<tr>
<td style="text-align:center"></td>
<td style="text-align:left"></td>
<td style="text-align:center"><code>a((?i)b)c</code></td>
<td>表示只有b不区分大小写</td>
<td>aBc、abc</td>
</tr>
<tr>
<td style="text-align:center"></td>
<td style="text-align:left">Parrtern.compile(RegExP,<br />Pattern.CASE_INSENSITIVE)<br />等同于<code>(?i)abc</code></td>
<td style="text-align:center"></td>
<td>仅在Java中有效<br />让其不区分大小写<br />在其他语言中基本是<br /><code>/abc/i</code>类似于这样</td>
<td></td>
</tr>
</tbody>
</table>
<h2 id="元字符-选择匹配符" tabindex="-1"><a class="header-anchor" href="#元字符-选择匹配符" aria-hidden="true">#</a> 元字符-选择匹配符</h2>
<p>在匹配某个字符串的时候是选择性的，即：既可以匹配这个，又可以匹配那个，这时候需要用到选择匹配符</p>
<table>
<thead>
<tr>
<th style="text-align:center">符号</th>
...
<td style="text-align:center"></td>
<td></td>
<td style="text-align:center">`川流</td>
<td>不</td>
<td>息`</td>
</tr>
</tbody>
</table>
<h2 id="元字符-限定符" tabindex="-1"><a class="header-anchor" href="#元字符-限定符" aria-hidden="true">#</a> 元字符-限定符</h2>
<table>
<thead>
<tr>
<th style="text-align:center">符号</th>
...
<tr>
<td style="text-align:center">*</td>
<td>指定字符重复0次或者n次（无要求）<br />零到多次</td>
<td style="text-align:center"><code>(abc)*</code></td>
<td>仅包含任意个abc的字符串<br />等效于<code>\w*</code></td>
<td>abc<br />abcabcabc</td>
</tr>
<tr>
<td style="text-align:center">+</td>
<td>指定字符串重复一次或n次（字少一次）<br />1到多</td>
<td style="text-align:center"><code>m+(abc)*</code></td>
<td>至少以1个m开头，后面接任意个abc的字符串</td>
<td>m<br />mabc<br />mabcabc</td>
</tr>
<tr>
<td style="text-align:center">?</td>
<td>指定字符重复0次或者1一次<br />最多一次</td>
<td style="text-align:center"><code>m+abc?</code></td>
<td>至少以一个m开头，后接ab或者abc的字符串<br />(c可以没有)，但是ab一定要有<br />如果abc加了括号包裹，abc也可以没有</td>
<td>mab<br />mabc</td>
</tr>
<tr>
...
<td>abc<br />abd<br />bdc</td>
</tr>
<tr>
<td style="text-align:center">{n,m}</td>
<td>指定至少n个但不多于m个匹配</td>
<td style="text-align:center"><code>[abcd]{3,5}</code></td>
<td>abcd中字母组成的任意长度<br />不小于3且不大于5的字符</td>
<td>abc<br />abcd<br />abcda</td>
</tr>
</tbody>
</table>
<h2 id="元字符-定位符" tabindex="-1"><a class="header-anchor" href="#元字符-定位符" aria-hidden="true">#</a> 元字符-定位符</h2>
<table>
<thead>
<tr>
<th style="text-align:center">符号</th>
...
<td>指定结束字符</td>
<td style="text-align:center"><code>^[0-9]+\\-[a-z]+$</code></td>
<td>至少以一个数字开头<br />后连接<code>-</code>符，并以至少一个小写<br />字母结束字符</td>
<td>1-a<br />6-z<br />61111-zqqqqq</td>
</tr>
<tr>
<td style="text-align:center"><code>\\b</code></td>
<td>匹配目标字符串<br />的边界</td>
<td style="text-align:center"><code>run\\b</code></td>
<td>这里说的字符串边界指的是<br />字符串间有空格<br />或者是目标字符串的结束位置</td>
<td>runI want <strong>run</strong> <strong>run</strong> <strong>run</strong></td>
</tr>
<tr>
<td style="text-align:center"><code>\\B</code></td>
<td>匹配目标字符串<br />的<strong>非边界</strong></td>
<td style="text-align:center"><code>run\\b</code></td>
<td>和<code>\\b</code>的含义相反</td>
<td><strong>run</strong>I want run run run</td>
</tr>
</tbody>
</table>
<h2 id="分组和捕获" tabindex="-1"><a class="header-anchor" href="#分组和捕获" aria-hidden="true">#</a> 分组和捕获</h2>
<table>
<thead>
<tr>
<th>常用分组构造形式</th>
...
<td>非命名捕获。<br />捕获匹配的子字符串，编号为0的第一个捕获是由整个正则表达式模式匹配的文本<br />其他捕获的结果则<strong>根据左括号的顺序从1开始自动编号</strong></td>
</tr>
<tr>
<td><code>(?&lt;name&gt;pattern)</code></td>
<td>命名捕获。<br />将匹配到的子字符串捕获到一个组名或编号中。<br />用于name的字符串不能包含任何标点符号，并且不能以数字开头<br />可以使用单引号代替尖括号，如：<code>?'name'</code></td>
</tr>
</tbody>
</table>
<p>非命名捕获<code>(\\d)(\\d)(\\d\\d)</code>就是这样的格式，这里不多写了，之前已经写了一大截</p>
<p>命名捕获：使用起来就是这样，也就是说可以在使用的时候通过分组名更方便的获取想要的分组</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br></div></div><h2 id="几个常用的分组形式-非捕获匹配" tabindex="-1"><a class="header-anchor" href="#几个常用的分组形式-非捕获匹配" aria-hidden="true">#</a> 几个常用的分组形式-非捕获匹配</h2>
<table>
<thead>
<tr>
...
<td style="text-align:left">匹配pattern但不捕获该匹配的子表达式，即：它是一个非捕获匹配，不存储以后使用的匹配。<br />这对于用<code>or</code>字符(`</td>
</tr>
<tr>
<td style="text-align:center">(?=pattern)</td>
<td style="text-align:left">它是一个非捕获匹配。<br />例如：`Windows(?=95</td>
</tr>
<tr>
<td style="text-align:center">(?!pattern)</td>
<td style="text-align:left">该表达式匹配不处于匹配<code>pattern</code>字符串的起始点的搜索字符串。<br />他是一个非捕获匹配。<br />例如：`Windows(?!95</td>
</tr>
</tbody>
</table>
<p>演示：</p>
...
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">testRegF</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br></div></div><h2 id="正则表达式一览表-全" tabindex="-1"><a class="header-anchor" href="#正则表达式一览表-全" aria-hidden="true">#</a> 正则表达式一览表（全）</h2>
<table>
<thead>
<tr>
...
<tr>
<td style="text-align:left">\</td>
<td style="text-align:left">将下一字符标记为特殊字符、文本、反向引用或八进制转义符。例如， <strong>n</strong>匹配字符 <strong>n</strong>。<strong>\n</strong> 匹配换行符。序列 <strong>\\</strong> 匹配 <strong>\</strong> ，<strong>\(</strong> 匹配 <strong>(</strong>。</td>
</tr>
<tr>
<td style="text-align:left">^</td>
...
<tr>
<td style="text-align:left">?</td>
<td style="text-align:left">当此字符紧随任何其他限定符（*、+、?、{<em>n</em>}、{<em>n</em>,}、{<em>n</em>,<em>m</em>}）之后时，匹配模式是&quot;非贪心的&quot;。<br /><strong>&quot;非贪心的&quot;模式匹配搜索到的、尽可能短的字符串</strong>，而默认的&quot;贪心的&quot;模式匹配搜索到的、尽可能长的字符串。例如，在字符串&quot;oooo&quot;中，&quot;o+?&quot;只匹配单个&quot;o&quot;，而&quot;o+&quot;匹配所有&quot;o&quot;。</td>
</tr>
<tr>
<td style="text-align:left">.</td>
...
<tr>
<td style="text-align:left">[^<em>xyz</em>]</td>
<td style="text-align:left">反向字符集。匹配未包含的任何字符。例如，<code>[^abc]</code>匹配&quot;plain&quot;中&quot;p&quot;，&quot;l&quot;，&quot;i&quot;，&quot;n&quot;。</td>
</tr>
<tr>
...
<tr>
<td style="text-align:left">[^<em>a-z</em>]</td>
<td style="text-align:left">反向范围字符。匹配不在指定的范围内的任何字符。例如，<code>[^a-z]</code>匹配任何不在&quot;a&quot;到&quot;z&quot;范围内的任何字符。</td>
</tr>
<tr>
<td style="text-align:left">[?=&amp;/%#.]</td>
<td style="text-align:left">可以通过中括号来匹配任意的符号：比如 - ? = % . 这些字符有的在其他情况下是作为一个特殊的符号来使用的，比如 . 在其他情况下是通配符<br />常见的如下：<code>@``#$%^&amp;*()_\-+=&lt;&gt;?:&quot;{}</code></td>
</tr>
<tr>
...
<tr>
<td style="text-align:left">\W</td>
<td style="text-align:left">与任何非单词字符匹配。与<code>[^A-Za-z0-9_]</code>等效。</td>
</tr>
<tr>
...
<td style="text-align:left">匹配 \*num*，此处的 \*num* 是一个正整数。到捕获匹配的反向引用。例如，&quot;(.)\1&quot;匹配两个连续的相同字符。</td>
</tr>
<tr>
...
<td style="text-align:left">标识一个八进制转义码或反向引用。如果 \*nm* 前面至少有 <em>nm</em> 个捕获子表达式，那么 <em>nm</em> 是反向引用。如果 *nm<em>前面至少有</em>n<em>个捕获，则</em>n<em>是反向引用，后面跟有字符</em>m*。如果两种前面的情况都不存在，则 \*nm* 匹配八进制值 <em>nm</em>，其中 <em>n</em> 和 <em>m</em> 是八进制数字 (0-7)。</td>
</tr>
<tr>
<td style="text-align:left">\nml</td>
...
<h3 id="补充-贪婪匹配和非贪婪匹配" tabindex="-1"><a class="header-anchor" href="#补充-贪婪匹配和非贪婪匹配" aria-hidden="true">#</a> 补充-贪婪匹配和非贪婪匹配</h3>
<p>一段代码说明白：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">regExpNoS</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><p>贪婪匹配结果：111111</p>
<p>非贪婪匹配结果：</p>
<p><img src="/images/JavaSE/23-正则表达式/image-20211130195455434.png" alt="image-20211130195455434" loading="lazy"></p>
<h2 id="正则匹配实例" tabindex="-1"><a class="header-anchor" href="#正则匹配实例" aria-hidden="true">#</a> 正则匹配实例</h2>
<h3 id="匹配汉字" tabindex="-1"><a class="header-anchor" href="#匹配汉字" aria-hidden="true">#</a> 匹配汉字</h3>
...
<span class="token comment">//        汉字的范围，\u4E00-\u9FA5  或者\u0931-uffe5 可以匹配中间的符号之类的</span>
...
<span class="token comment">//        至少要有一个汉字，必须为汉字开头，汉字结尾</span>
        ...
        <span class="token punctuation">}</span>
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br></div></div><h3 id="邮政编码" tabindex="-1"><a class="header-anchor" href="#邮政编码" aria-hidden="true">#</a> 邮政编码</h3>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>    <span class="token doc-comment comment">/**
    ...
    <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">run2</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        <span class="token punctuation">}</span>
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br></div></div><h3 id="qq号码" tabindex="-1"><a class="header-anchor" href="#qq号码" aria-hidden="true">#</a> QQ号码</h3>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
...
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">run3</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br></div></div><h3 id="手机号码" tabindex="-1"><a class="header-anchor" href="#手机号码" aria-hidden="true">#</a> 手机号码</h3>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
     * 验证是否为一个手机号：
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br></div></div><h3 id="url链接" tabindex="-1"><a class="header-anchor" href="#url链接" aria-hidden="true">#</a> URL链接</h3>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">run5</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br></div></div><h3 id="邮箱" tabindex="-1"><a class="header-anchor" href="#邮箱" aria-hidden="true">#</a> 邮箱</h3>
<p>这个是瞎写的，真要用还是去网上抄即可</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>    <span class="token doc-comment comment">/**
     * 验证是否为一个邮箱
     */</span>
    <span class="token annotation punctuation">@Test</span>
    <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">run6</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        <span class="token punctuation">}</span>
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br></div></div><h2 id="正则表达式三个常用类" tabindex="-1"><a class="header-anchor" href="#正则表达式三个常用类" aria-hidden="true">#</a> 正则表达式三个常用类</h2>
<p><code>java.util.regex</code> 包主要包括如下三个类</p>
<ul>
<li><code>Pattern</code>类</li>
<li><code>Mathcer</code>类</li>
<li><code>PatternSyntaxExeception</code> 异常类</li>
</ul>
<h3 id="pattern类" tabindex="-1"><a class="header-anchor" href="#pattern类" aria-hidden="true">#</a> Pattern类</h3>
<p><code>pattern</code>对象是一个正则表达式对象，Pattern类没有公共构造方法，要创建一个Pattern对象，需要调用其公共静态方法<code>Pattern.compile(String regExp)</code>，它返回一个Pattern对象，该方法接受一个正则表达式作为它的第一个参数</p>
<h3 id="matcher类" tabindex="-1"><a class="header-anchor" href="#matcher类" aria-hidden="true">#</a> Matcher类</h3>
<p>Matcher对象是对输入字符串的解析和匹配的引擎，与Pattern类一样，Matcher也没有公共构造方法，需要调用Pattern对象的matcher方法来获取一个Matcher对象</p>
<p><img src="/images/JavaSE/23-正则表达式/image-20211130215948471.png" alt="image-20211130215948471" loading="lazy"></p>
<p>常用的替换方法</p>
<table>
<thead>
<tr>
...
<tr>
<td><code>String replaceAll(String replacement)</code> 比较常用</td>
...
<tr>
<td><code>static String quoteReplacement(String s)</code></td>
<td>返回指定字符串的字面替换字符串。这个方法返回一个字符串，就像传递给Matcher类的<code>appendReplacement</code> 方法一个字面字符串一样工作</td>
</tr>
</tbody>
</table>
<p>也可以通过如下方法来直接的返回一个字符串是否能和表达式匹配，匹配返回true，不匹配返回false</p>
<p>一般工作情况下这样用的多，简洁方便（如果想去验证某一个字符串是否满足某一个正则匹配块）</p>
<p>当然，这种方式是整体匹配---传入的字符串必须完全满足该条件才回返回true（regExp中可以不加上^或者&amp;这两个头尾符）</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><h3 id="patternsyntaxexeception" tabindex="-1"><a class="header-anchor" href="#patternsyntaxexeception" aria-hidden="true">#</a> PatternSyntaxExeception</h3>
<p>PatternSyntaxExeception是一个非强制异常类，它表示一个正则表达式模式中的语法错误</p>
<h2 id="分组、捕获、反向引用" tabindex="-1"><a class="header-anchor" href="#分组、捕获、反向引用" aria-hidden="true">#</a> 分组、捕获、反向引用</h2>
<p>先来看看一个问题:</p>
<p>给你一段文本，找出所有四个数字连接在一起的字符串，并且这四个数字要满足</p>
<ol>
<li>第一位与第四位相同</li>
<li>第二位与第三位相同</li>
<li>例如：1441 2332</li>
</ol>
<p>分组和捕获之前已经说过了，大概就是<code>(?&lt;number1&gt;\\d)</code> 这样</p>
<p><img src="/images/JavaSE/23-正则表达式/image-20211130220750736.png" alt="image-20211130220750736" loading="lazy"></p>
<p>看到这里，很清晰的就知道，反向引用的语法为：<code>(\\d)\\1</code></p>
<p>也就是：比如说我现在捕获了三个字段</p>
<p><code>(\\d)(\\d)(\\d)</code> 那么我要捕获第一个字段则需要：<code>(\\d)(\\d)(\\d)\\1</code></p>
<p>三个全部捕获即：<code>(\\d)(\\d)(\\d)\\1\\2\\3</code>就可以了，1,2,3是根据括号的顺序决定的</p>
<p>这里三个全部捕获能获取到的为：123123、456456、789789等</p>
<ol>
<li>匹配两个连续相同的数字:<code>(\\d)\\1</code></li>
...
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">run8</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><h3 id="外部反向引用使用-使用外部反向引用解决结巴的问题" tabindex="-1"><a class="header-anchor" href="#外部反向引用使用-使用外部反向引用解决结巴的问题" aria-hidden="true">#</a> 外部反向引用使用-使用外部反向引用解决结巴的问题</h3>
<p>先说下，在<code>matcher.group()</code>时，也可以通过外部反向引用快速获取，且不需要加上($)号，详情看下面的<a href="###%E6%89%A9%E5%B1%95-%E8%A7%A3%E6%9E%90%E5%87%BA%E4%B8%80%E4%B8%AAURL%E4%B8%AD%E7%9A%84%E5%AD%97%E6%AE%B5">扩展-解析出一个URL中的字段</a></p>
<p><img src="/images/JavaSE/23-正则表达式/image-20211130223553382.png" alt="image-20211130223553382" loading="lazy"></p>
<p>现在有一段话：<code>我我我我我我我我.....我要.....看看看看......杰哥！</code></p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>    <span class="token annotation punctuation">@Test</span>
...
<span class="token comment">//        再使用一条语句去掉重复的汉字</span>
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br></div></div><h2 id="在string类中使用正则表达式" tabindex="-1"><a class="header-anchor" href="#在string类中使用正则表达式" aria-hidden="true">#</a> 在String类中使用正则表达式</h2>
<p>String类中的replaceAll是可以直接使用正则表达式替换的</p>
<p>比方说，现在有一段话，我想将其的1.?全部替换为1.8：</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>2000年5月，JDK1.3、JDK1.4和J2SE1.3相继发布，几周后其获得了Apple公司Mac OS X的工业标准的支持。2001年9月24日，J2EE1.3发布。2002年2月26日，J2SE1.4发布。自此Java的计算能力有了大幅提升，与J2SE1.3相比，其多了近62%的类和接口。在这些新特性当中，还提供了广泛的XML支持、安全套接字（Socket）支持（通过SSL与TLS协议）、全新的I/OAPI、正则表达式、日志与断言。2004年9月30日，J2SE1.5发布，成为Java语言发展史上的又一里程碑。为了表示该版本的重要性，J2SE 1.5更名为Java SE 5.0（内部版本号1.5.0），代号为“Tiger”，Tiger包含了从1996年发布1.0版本以来的最重大的更新，其中包括泛型支持、基本类型的自动装箱、改进的循环、枚举类型、格式化I/O及可变参数。
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>非常简单：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>也可以通过调用器的matcher方法验证数据：</p>
<p>比方说验证一个手机号，要求必须是138,139开头的手机号</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>也可以结合split来进行分割数据</p>
<p>比方说，这段话中，通过所有特殊字符进行分割字符串</p>
<p><code>11111@22222#33333$44444-55555&amp;66666*77777.88888</code></p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>    <span class="token annotation punctuation">@Test</span>
    <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">run12</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        <span class="token punctuation">}</span>
    <span class="token punctuation">}</span> 
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><h2 id="扩展-验证一个数字是否是整数或者小数" tabindex="-1"><a class="header-anchor" href="#扩展-验证一个数字是否是整数或者小数" aria-hidden="true">#</a> 扩展-验证一个数字是否是整数或者小数</h2>
<p>目标：<code>123 -456 34.89 -87.9 -0.01 0.45</code></p>
<p>需要区分正负</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">run13</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>解析：<code>([1-9]\\d*|0)</code>就是要么以1~9开头任意数量的数字，或者是个0，防止0098这样的事情</p>
<h2 id="扩展-解析出一个url中的字段" tabindex="-1"><a class="header-anchor" href="#扩展-解析出一个url中的字段" aria-hidden="true">#</a> 扩展-解析出一个URL中的字段</h2>
<p><img src="/images/JavaSE/23-正则表达式/image-20211130234627965.png" alt="image-20211130234627965" loading="lazy"></p>
<p>思路：分组，分成4个组，然后分别获取对应的值即可</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">run14</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token class-name">String</span> url <span class="token operator">=</span> <span class="token string">"http://81.68.162.137:8080/user/article?id=1003#title"</span><span class="token punctuation">;</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><h2 id="扩展-java正则表达式大全" tabindex="-1"><a class="header-anchor" href="#扩展-java正则表达式大全" aria-hidden="true">#</a> 扩展-Java正则表达式大全</h2>
<p><a href="https://blog.csdn.net/zpz2411232428/article/details/83549502" target="_blank" rel="noopener noreferrer">https://blog.csdn.net/zpz2411232428/article/details/83549502<ExternalLinkIcon/></a> 这篇文章上啥都有</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>一、校验数字的表达式
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br><span class="line-number">62</span><br><span class="line-number">63</span><br><span class="line-number">64</span><br><span class="line-number">65</span><br><span class="line-number">66</span><br><span class="line-number">67</span><br><span class="line-number">68</span><br><span class="line-number">69</span><br><span class="line-number">70</span><br><span class="line-number">71</span><br><span class="line-number">72</span><br><span class="line-number">73</span><br><span class="line-number">74</span><br><span class="line-number">75</span><br><span class="line-number">76</span><br><span class="line-number">77</span><br><span class="line-number">78</span><br><span class="line-number">79</span><br><span class="line-number">80</span><br><span class="line-number">81</span><br><span class="line-number">82</span><br><span class="line-number">83</span><br><span class="line-number">84</span><br></div></div></template>
