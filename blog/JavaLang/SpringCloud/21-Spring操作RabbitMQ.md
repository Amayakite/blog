...
![image-20220205184528032](http://81.68.162.137:9300/blog-notes/images/SpringCloud/21-Spring操作RabbitMQ/image-20220205184528032.png)
...
![image-20220205195053992](http://81.68.162.137:9300/blog-notes/images/SpringCloud/21-Spring操作RabbitMQ/image-20220205195053992.png)

## 可靠投递

开一个设置即可

![image-20220205195732361](http://81.68.162.137:9300/blog-notes/images/SpringCloud/21-Spring操作RabbitMQ/image-20220205195732361.png)
...
![image-20220205201946676](http://81.68.162.137:9300/blog-notes/images/SpringCloud/21-Spring操作RabbitMQ/image-20220205201946676.png)
...
![image-20220205210226231](http://81.68.162.137:9300/blog-notes/images/SpringCloud/21-Spring操作RabbitMQ/image-20220205210226231.png)
...
![image-20220205210531384](http://81.68.162.137:9300/blog-notes/images/SpringCloud/21-Spring操作RabbitMQ/image-20220205210531384.png)
...
![image-20220205211904110](http://81.68.162.137:9300/blog-notes/images/SpringCloud/21-Spring操作RabbitMQ/image-20220205211904110.png)

## 延时队列

![image-20220206150949655](http://81.68.162.137:9300/blog-notes/images/SpringCloud/21-Spring操作RabbitMQ/image-20220206150949655.png)

就是想定时的去做什么事情，例如订单的删除之类的，自己整又不太精确，所以就可以这样

首先回顾下RabbitMQ的TTL 存活时间

![image-20220206151113888](http://81.68.162.137:9300/blog-notes/images/SpringCloud/21-Spring操作RabbitMQ/image-20220206151113888.png)

以及死信队列

![image-20220206151604776](http://81.68.162.137:9300/blog-notes/images/SpringCloud/21-Spring操作RabbitMQ/image-20220206151604776.png)

所以说，我们可以让消费者读取死信队列来完成这一套操作

![image-20220206151929790](http://81.68.162.137:9300/blog-notes/images/SpringCloud/21-Spring操作RabbitMQ/image-20220206151929790.png)

例如：

![image-20220206152351536](http://81.68.162.137:9300/blog-notes/images/SpringCloud/21-Spring操作RabbitMQ/image-20220206152351536.png)

也就是：

![image-20220206153004294](http://81.68.162.137:9300/blog-notes/images/SpringCloud/21-Spring操作RabbitMQ/image-20220206153004294.png)
...
![image-20220206160845719](http://81.68.162.137:9300/blog-notes/images/SpringCloud/21-Spring操作RabbitMQ/image-20220206160845719.png)
