...
![image-20211025174538882](/images/Java/02-开始使用Java/image-20211025174538882.png)
...
8. 一个源文件中最多只能有个Public类，其他类的个数不限，也可以将`main`方法写在非public类中，然后指定运行非public类，这样入口方法就是非public的`main`方法，例如
   ...
   ![image-20211025181532560](/images/Java/02-开始使用Java/image-20211025181532560.png)
...
3. 文档注释
   ...
   ![image-20211025190340940](/images/Java/02-开始使用Java/image-20211025190340940.png)
...
7. 代码编写次行风格和行尾风格，推荐使用行尾风格
   ![image-20211025191508343](/images/image-20211025191508343.png)
