...
![Java程序在计算机有三个阶段](/images/Java/20-反射/Java程序在计算机有三个阶段.jpg)
...
![image-20211118165137762](/images/Java/20-反射/image-20211118165137762.png)
...
![image-20211118213624822](/images/Java/20-反射/image-20211118213624822.png)

![Java程序在计算机有三个阶段2](/images/Java/20-反射/Java程序在计算机有三个阶段2.jpg)
...
5. 通过Class可以完整地得到一个类的完整结构，通过一系列API
   ![image-20211118223315199](/images/Java/20-反射/image-20211118223315199.png)

6. Class对象是存放在堆的

7. 类的字节码二进制数据，是放在方法区的，有的地方称之为类的元数据（包括 方法代码，变量名，方法名，访问权限等等）

![Java程序在计算机有三个阶段3](/images/Java/20-反射/Java程序在计算机有三个阶段3.jpg)
...
![Java程序在计算机的三个阶段4](/images/Java/20-反射/Java程序在计算机的三个阶段4.jpg)
...
<img src="/images/Java/20-反射/Java程序在计算机的三个阶段4.jpg" alt="Java程序在计算机的三个阶段4" style="zoom: 67%;" />
...
![image-20211119120654574](/images/Java/20-反射/image-20211119120654574.png)
...
![image-20211119121448484](/images/Java/20-反射/image-20211119121448484.png)

接下来运行试试

![image-20211119121523198](/images/Java/20-反射/image-20211119121523198.png)
...
![image-20211119123723609](/images/Java/20-反射/image-20211119123723609.png)
...
![类加载流程图](/images/Java/20-反射/类加载流程图.jpg)

### 类加载各个阶段完成任务

![类加载流程图-类加载各个阶段完成任务](/images/Java/20-反射/类加载流程图-类加载各个阶段完成任务.jpg)
...
![image-20211119144256423](/images/Java/20-反射/image-20211119144256423.png)
...
![类加载流程图-解析阶段](/images/Java/20-反射/类加载流程图-解析阶段.jpg)
