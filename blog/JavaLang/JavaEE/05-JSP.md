...
![image-20211206120843372](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206120843372.png)
...
![image-20211206123334428](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206123334428.png)我们先进入这个文件夹，然后访问a.jsp，看看会发生什么：

![image-20211206123425700](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206123425700.png)可以看到，未访问的时候，该文件夹下的`work\Catalina\localhost\jsp\org\apache\jsp`这个路境内首先只有一个index_jsp.class

访问后：

![image-20211206123540480](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206123540480.png)
...
![image-20211206141244413](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206141244413.png)
...
![image-20211206140558244](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206140558244.png)
...
![image-20211206142755283](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206142755283.png)

编译后的Java文件

![image-20211206142845918](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206142845918.png)
...
![image-20211206144442202](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206144442202.png)
...
![image-20211206145400795](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206145400795.png)

emm遇事不决先看源码：

![image-20211206145505903](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206145505903.png)

源码似乎并没有什么问题，接下来分析下

![image-20211206150030961](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206150030961.png) 说以说，我们可以通过提前调用out.flush的方式来让out中的内容比res中的内容先一步渲染出去
...
![image-20211206150147744](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206150147744.png)

### out.write和out.print的区别

如果你试图这样：`out.write(12)`，就能发现页面上啥都没显示

![image-20211206150649757](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206150649757.png)
...
![image-20211206151722723](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206151722723.png)
...
![image-20211206152007851](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206152007851.png)
...
![image-20211206152620654](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206152620654.png)

分析下源码：

![image-20211206152719104](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206152719104.png)
...
2. 动态包含底层使用如下代码去调用被包含的jsp页面执行输出
   ...
   ![image-20211206154103227](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206154103227.png)
...
![image-20211206154340122](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206154340122.png)

和静态包含不同的是，他会生成被包含的文件的编译文件：

![image-20211206153413808](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206153413808.png)
...
![image-20211206162047442](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206162047442.png)
...
![image-20211206164556420](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206164556420.png)
...
![image-20211206165002714](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206165002714.png)
...
![image-20211206171508674](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206171508674.png)

### EL表达式-运算

#### 关系运算

![image-20211206171750922](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206171750922.png)

关系运算是通过方法内的equals来决定的

#### 逻辑运算

![image-20211206171800762](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206171800762.png)
...
![image-20211206172946529](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206172946529.png)
...
- varStatus
  ...
  - status是一个LoopTagStatus对象：
    ![image-20211206223248677](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206223248677.png)
...
![image-20211206230851372](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206230851372.png)
...
![image-20211206231744235](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211206231744235.png)
...
![image-20211207121352017](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211207121352017.png)
...
![image-20211207121932296](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211207121932296.png)
...
![image-20211207153825970](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211207153825970.png)
...
![image-20211207161617663](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211207161617663.png)

上面那个是全局的，如果想要设置单个会话的话：

![image-20211207161818205](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211207161818205.png)
...
![image-20211207163532641](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211207163532641.png)
...
![image-20211207180618388](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211207180618388.png)
...
![image-20211207214110480](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211207214110480.png)

使用Thread.currentThread.getName()查看线程

![image-20211207214130720](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211207214130720.png)
...
![image-20211207215653754](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211207215653754.png)
...
![image-20211207215731561](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211207215731561.png)
...
![image-20211207221430453](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211207221430453.png)
...
![image-20211207223958124](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211207223958124.png)
...
![image-20211207224718369](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211207224718369.png)
...
![image-20211207225744152](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211207225744152.png)
...
![image-20211207231512239](http://81.68.162.137:9300/blog-notes/images/JavaEE/05-JSP/image-20211207231512239.png)
