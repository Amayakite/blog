...
<p>首先我们打开官方文档</p>
<p><a href="https://docs.spring.io/spring-boot/docs/current/reference/html/using.html#using.build-systems.starters" target="_blank" rel="noopener noreferrer">https://docs.spring.io/spring-boot/docs/current/reference/html/using.html#using.build-systems.starters<ExternalLinkIcon/></a></p>
<p>发现跟操作数据库有关的 全都有一个data</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211221150913345.png" alt="image-20211221150913345" loading="lazy"></p>
<p>接下来我们要用jdbc 于是看看有哪些jdbc相关的</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211221151209917.png" alt="image-20211221151209917" loading="lazy"></p>
<p>看到了个名字最短的 应该就是他了</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>然后可以看到如下内容</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211221151310736.png" alt="image-20211221151310736" loading="lazy"></p>
<p>貌似少了点什么？</p>
<p>我们的mysql数据库驱动呢？</p>
<p>因为官方不知道我们接下来要用哪个数据库..</p>
<p>所以我们接下里我们要操作什么数据库 就安装什么数据库的驱动即可</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>groupId</span><span class="token punctuation">></span></span>mysql<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>groupId</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>artifactId</span><span class="token punctuation">></span></span>mysql-connector-java<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>artifactId</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>如果你用的是最新版本 这里可以不用写版本号</p>
<p>因为spring官方已经对它做了一个版本仲裁（最新的版本）</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211221151826037.png" alt="image-20211221151826037" loading="lazy"></p>
<p>如果你还在用5.x  那么可以自定仲裁 版本号为了规范写在这里即可</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211221151640601.png" alt="image-20211221151640601" loading="lazy"></p>
<h3 id="分析自动配置" tabindex="-1"><a class="header-anchor" href="#分析自动配置" aria-hidden="true">#</a> 分析自动配置</h3>
<p>首先我们能看到springboot 的 autoconfiguration内有一个jdbc的包</p>
<p>并且里面第一个就是DataSourceAutoconfiguration</p>
<p>连接池相关 可以看到</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>当我们没有配置任何连接池相关的bean的时候 就会使用它默认的</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211221152823431.png" alt="image-20211221152823431" loading="lazy"></p>
<p>而且还能看到一个DataSourceTransactionManagerAutoConfiguration 看着就是是事务管理器的配置</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211221153017125.png" alt="image-20211221153017125" loading="lazy"></p>
<p>还有一个jdbcTemplate</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211221153229580.png" alt="image-20211221153229580" loading="lazy"></p>
<p>额外说下 还有个分布式事务的相关控制 XADataSourceAutoConfiguration这个我们目前暂时用不到 之后学spring cloud的时候应该用得上</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211221153348274.png" alt="image-20211221153348274" loading="lazy"></p>
<p>接着我们看看DataSource的Properteis</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211221154104327.png" alt="image-20211221154104327" loading="lazy"></p>
<p>可以看到很多熟悉的东西 也就是说我们可以直接按照上面的来配置数据源了</p>
<h3 id="配置数据源" tabindex="-1"><a class="header-anchor" href="#配置数据源" aria-hidden="true">#</a> 配置数据源</h3>
<p>我这里就直接在yaml最终配置了（虽然说这样的写在properties里面看起来更规范一些）</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><h3 id="测试使用" tabindex="-1"><a class="header-anchor" href="#测试使用" aria-hidden="true">#</a> 测试使用</h3>
<p>因为spring boot直接给我们提供好了 test 文件 所以我们只需要直接注入jdbctemplate即可</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br></div></div><p>测试结果：</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211221160137403.png" alt="image-20211221160137403" loading="lazy"></p>
<p>接着 我们发现它这里貌似有一个数据源相关的东西</p>
<p>HikariDataSource</p>
<p>搜了下 貌似是当前世界上最快的数据源管理包</p>
<p>但是我们平常可能因为一些别的需要</p>
<p>例如Druid：主要是德鲁伊会提供数据监控等等   后边分布式的时候监控很有用</p>
<p>接下里安装下druid吧</p>
<h2 id="使用druid数据源" tabindex="-1"><a class="header-anchor" href="#使用druid数据源" aria-hidden="true">#</a> 使用Druid数据源</h2>
<p>我们整合第三方数据源有两种方式</p>
<ul>
<li>自定义
<ul>
<li>引入下druid的包</li>
<li>以前的方法就是在xml或者bean中或者注册一个DruidDataSource</li>
<li>就是我们之前的配置的方式。。然后要额外配置蛮多东西..</li>
<li>详情的可以看<a href="https://www.bilibili.com/video/BV19K4y1L7MT?p=61&amp;spm_id_from=pageDriver" target="_blank" rel="noopener noreferrer">https://www.bilibili.com/video/BV19K4y1L7MT?p=61&amp;spm_id_from=pageDriver<ExternalLinkIcon/></a></li>
</ul>
</li>
<li>找starter</li>
</ul>
<h3 id="才用传统方法配置druid" tabindex="-1"><a class="header-anchor" href="#才用传统方法配置druid" aria-hidden="true">#</a> 才用传统方法配置druid</h3>
<p>全部按照官方文档来<a href="https://github.com/alibaba/druid/wiki/%E5%B8%B8%E8%A7%81%E9%97%AE%E9%A2%98" target="_blank" rel="noopener noreferrer">https://github.com/alibaba/druid/wiki/常见问题<ExternalLinkIcon/></a></p>
<p>我们首先安装下druid的依赖</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>接下来配置</p>
<p>自己配肯定是懒得配的 于是乎去druid的wiki上面找了找</p>
<p><a href="https://github.com/alibaba/druid/wiki/%E5%B8%B8%E8%A7%81%E9%97%AE%E9%A2%98" target="_blank" rel="noopener noreferrer">https://github.com/alibaba/druid/wiki/常见问题<ExternalLinkIcon/></a></p>
<p>发现上面都有现成的了 于是乎我们按照它那里的顺序来做即可</p>
<div class="language-yaml ext-yml line-numbers-mode"><pre v-pre class="language-yaml"><code><span class="token key atrule">spring</span><span class="token punctuation">:</span>
  <span class="token key atrule">datasource</span><span class="token punctuation">:</span>
    <span class="token key atrule">driver-class-name</span><span class="token punctuation">:</span> com.mysql.cj.jdbc.Driver
    <span class="token key atrule">url</span><span class="token punctuation">:</span> jdbc<span class="token punctuation">:</span>mysql<span class="token punctuation">:</span>//localhost<span class="token punctuation">:</span>3306/db1
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br></div></div><p>程序启动后，我们访问下</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211221204925951.png" alt="image-20211221204925951" loading="lazy"></p>
<h3 id="通过state方式来使用druid" tabindex="-1"><a class="header-anchor" href="#通过state方式来使用druid" aria-hidden="true">#</a> 通过state方式来使用druid</h3>
<p>于是还真的发现了</p>
<p><a href="https://github.com/alibaba/druid/tree/master/druid-spring-boot-starter" target="_blank" rel="noopener noreferrer">https://github.com/alibaba/druid/tree/master/druid-spring-boot-starter<ExternalLinkIcon/></a></p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>groupId</span><span class="token punctuation">></span></span>com.alibaba<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>groupId</span><span class="token punctuation">></span></span>
 ...
 --></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><p>接下来我们看看这玩意有什么东西</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211221205315712.png" alt="image-20211221205315712" loading="lazy"></p>
<p>首先是druid 然后是slf4j 然后是 autoconfig</p>
<p>我们就直奔autoconfig</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211221205429053.png" alt="image-20211221205429053" loading="lazy"></p>
<p>我们首先可以看到它有如下注解</p>
...
</code></pre><div class="highlight-lines"><br><div class="highlight-line">&nbsp;</div><br></div><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>这里重点看第二行 自动配置应在其他指定的自动配置类之前应用</p>
<p>我们可以知道 官方的哪个DataSource注册有一个条件：当前容器内没有dataSource的@Bean才注册</p>
<p>接着它倒入了四个包</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Import</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
    ...
    <span class="token class-name">DruidFilterConfiguration</span><span class="token punctuation">.</span><span class="token keyword">class</span>
        <span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>第一个是监控SpringBean的（AOP），配置项是<code>spring.datasource.druid.aop-patterns</code></p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211221210024410.png" alt="image-20211221210024410" loading="lazy"></p>
<p>第二个是监控页的配置相关 默认开启了(havingValue)</p>
<p><code>spring.datasource.druid.stat-view-servlet.enabled</code></p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211221210211177.png" alt="image-20211221210211177" loading="lazy"></p>
<p>第三个是配置了监控页 默认开启</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211221210338604.png" alt="image-20211221210338604" loading="lazy"></p>
<p>第四个给容器中添加了蛮多的组件</p>
<p>这些的作用是开启防火墙之类的功能</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211221210417054.png" alt="image-20211221210417054" loading="lazy"></p>
<h3 id="配置druid" tabindex="-1"><a class="header-anchor" href="#配置druid" aria-hidden="true">#</a> 配置druid</h3>
<div class="language-yaml ext-yml line-numbers-mode"><pre v-pre class="language-yaml"><code><span class="token comment"># 数据源的绑定</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br></div></div><p>接下来尝试访问下项目路径内的druid</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211221213429121.png" alt="image-20211221213429121" loading="lazy"></p>
<p>看起来没问题了</p>
<p>当然也可以自定义访问路径</p>
<div class="language-yaml ext-yml line-numbers-mode"><pre v-pre class="language-yaml"><code><span class="token comment"># 数据源的绑定</span>
<span class="token key atrule">spring</span><span class="token punctuation">:</span>
...
<span class="token comment">#            update-allow:</span>
  ...
  <span class="token key atrule">jdbc</span><span class="token punctuation">:</span>
    <span class="token key atrule">template</span><span class="token punctuation">:</span>
      <span class="token comment"># 设置查询超时时间 单位为秒</span>
      <span class="token key atrule">query-timeout</span><span class="token punctuation">:</span> <span class="token number">30</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br></div></div><h2 id="整合mybatis" tabindex="-1"><a class="header-anchor" href="#整合mybatis" aria-hidden="true">#</a> 整合Mybatis</h2>
<h3 id="准备依赖" tabindex="-1"><a class="header-anchor" href="#准备依赖" aria-hidden="true">#</a> 准备依赖</h3>
<p><a href="https://github.com/mybatis/spring-boot-starter" target="_blank" rel="noopener noreferrer">https://github.com/mybatis/spring-boot-starter<ExternalLinkIcon/></a></p>
<p>在这上面的spring-boot-stater文件夹内可以获取到我们想要的pom</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!-- https://mvnrepository.com/artifact/org.mybatis.spring.boot/mybatis-spring-boot-starter --></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>当然 我还是选择在maven仓库内的</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211221223203128.png" alt="image-20211221223203128" loading="lazy"></p>
<p>可以看到最终引入了springbootstate和jdbc 以及自动配置文件之类的</p>
<p>回想下我们之前还是怎么用mybatis的</p>
<ul>
<li>准备全局mapper配置器</li>
<li>然后准备单个文件的mapper映射</li>
<li>然后准备mapper准建</li>
<li>然后注册SqlSessionFactory工厂</li>
</ul>
<p>接下来我们老样子 先看看mybatis的autoconfig</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211221223606137.png" alt="image-20211221223606137" loading="lazy"></p>
<p>首先这玩意的判断是</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><p>接着我们看下MybatisProperties这个文件内绑定的是什么字段的配置</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@ConfigurationProperties</span><span class="token punctuation">(</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MybatisProperties</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">final</span> <span class="token class-name">String</span> MYBATIS_PREFIX <span class="token operator">=</span> <span class="token string">"mybatis"</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br></div></div><p>接着我们看看是否有配置好SQLsessionFactory</p>
<p>在autoconfig中发现了</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211221224057991.png" alt="image-20211221224057991" loading="lazy"></p>
<p>@ConditionalOnMissingBean是在容器内找datasource并放进去 其他东西都是在配置文件中取的</p>
<p>紧接着 我们在这个配置文件的最底下发现了这些</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@org.springframework.context.annotation.Configuration</span>
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div><p>其他的倒是没什么</p>
<p>只有这个<code>@Import(AutoConfiguredMapperScannerRegistrar.class)</code></p>
<p>我们之前整合SSM的时候 mybatis需要配置一个扫包路径 这玩意就是来帮助我们扫包的 默认情况下会扫描项目路径下的所有包 也就是说 我们无须手动再编写扫mapper包的代码了</p>
<p>也就是说 只要我们写的操作mybatis的接口标注了@Mapper注解 就会被扫进来</p>
<h3 id="使用mybatis-配置文件" tabindex="-1"><a class="header-anchor" href="#使用mybatis-配置文件" aria-hidden="true">#</a> 使用mybatis-配置文件</h3>
<p>我们先创建如下配置文件</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211222002928765.png" alt="image-20211222002928765" loading="lazy"></p>
<p>一个mybatis-config</p>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>configuration</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>还有一个admin的mapper</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token prolog">&lt;?xml version="1.0" encoding="UTF-8" ?></span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><p>接着在spring的配置文件中增加这两项</p>
<div class="language-yaml ext-yml line-numbers-mode"><pre v-pre class="language-yaml"><code><span class="token comment"># 配置mybatis的规则</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><h3 id="使用mybatis" tabindex="-1"><a class="header-anchor" href="#使用mybatis" aria-hidden="true">#</a> 使用mybatis</h3>
<p>三层架构</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211222003213478.png" alt="image-20211222003213478" loading="lazy"></p>
<p>这里我查的是admin表 对应字段</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>写一个mapper来完成数据访问</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Mapper</span> <span class="token comment">//注意 这个mapper不能省略</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>再写一个service来完成操作</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><p>接着写一个请求测试</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br></div></div><p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211222003302412-16401043826611.png" alt="image-20211222003302412" loading="lazy"></p>
<p>成功</p>
<h3 id="整合mybatis的一些配置-驼峰命名等" tabindex="-1"><a class="header-anchor" href="#整合mybatis的一些配置-驼峰命名等" aria-hidden="true">#</a> 整合Mybatis的一些配置（驼峰命名等）</h3>
<p>在官方文档中<a href="https://mybatis.org/mybatis-3/zh/configuration.html#settings" target="_blank" rel="noopener noreferrer">https://mybatis.org/mybatis-3/zh/configuration.html#settings<ExternalLinkIcon/></a></p>
<p>可以看到，设置驼峰命名是通过设置mapUnderscoreToCamelCase为true来完成的</p>
<p>所以我们有两个选择--在xml或者在spring配置文件中配置</p>
<p>注意 这两个不能同时存在</p>
<p>例如：</p>
<ul>
<li>
<p>在XML中配置了，则不能再yaml之类的配置文件中配置configuration</p>
</li>
<li>
<p>反之亦然，如果说两者一齐存在，会报错</p>
</li>
<li>
<p>通常情况下 我们并不会创建mybatis的核心配置文件，而是像这样，全部都在spring的配置文件中配置核心设置</p>
<div class="language-yaml ext-yml line-numbers-mode"><pre v-pre class="language-yaml"><code><span class="token comment"># 配置mybatis的规则</span>
<span class="token key atrule">mybatis</span><span class="token punctuation">:</span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>configuration</span><span class="token punctuation">></span></span>
    ...
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>settings</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>configuration</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><p>在spring配置文件中</p>
<div class="language-yaml ext-yml line-numbers-mode"><pre v-pre class="language-yaml"><code><span class="token comment"># 配置mybatis的规则</span>
<span class="token key atrule">mybatis</span><span class="token punctuation">:</span>
  <span class="token comment"># 配置mybatis的全局配置文件</span>
  <span class="token key atrule">config-location</span><span class="token punctuation">:</span> classpath<span class="token punctuation">:</span>mybatis/mybatis<span class="token punctuation">-</span>config.xml
  ...
  <span class="token key atrule">configuration</span><span class="token punctuation">:</span>
    <span class="token key atrule">map-underscore-to-camel-case</span><span class="token punctuation">:</span> <span class="token boolean important">true</span>
</code></pre><div class="highlight-lines"><br><br><br><br><br><br><div class="highlight-line">&nbsp;</div><div class="highlight-line">&nbsp;</div></div><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><p>当然 你可以选择删掉mybatis核心配置xml文件 全部都在spring内进行配置</p>
<p>这个通常根据项目情况来决定</p>
<p>但是，XXXMapper--表的查询文件最好不要删 一般情况下来说 简单的查询用注解 ，复杂的一定要用xxxMapper.xml的</p>
<h2 id="整合mybatisplus" tabindex="-1"><a class="header-anchor" href="#整合mybatisplus" aria-hidden="true">#</a> 整合MybatisPlus</h2>
<p>MybatisPlus是一个Mybatis的增强工具，在Mybatis的基础上只做增强不做改变，为简化开发，提高效率而生</p>
<p>国人制作的，官网<a href="https://baomidou.com/" target="_blank" rel="noopener noreferrer">https://baomidou.com/<ExternalLinkIcon/></a></p>
<p>封装了很多基本的增删改查</p>
<p>我们就直接按照官方文档的上手操作了</p>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>接着我们可以发现它引入了如下的依赖</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211222122423789.png" alt="image-20211222122423789" loading="lazy"></p>
<p>引入了mybatis jdbc以及额外的autoconfiguration</p>
<p>说明这里已经给我们引入了mybatis 不需要额外的引入其他内容</p>
<p>可以在autoconfiguration中看到如下内容</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211222122531840.png" alt="image-20211222122531840" loading="lazy"></p>
<div class="language-properties ext-properties line-numbers-mode"><pre v-pre class="language-properties"><code><span class="token comment"># Auto Configure</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><p>EnableAutoConfiguration是启动时额外要加载的类</p>
<p>接下来我们看看MybatisPlusAutoConfiguration</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@ConditionalOnClass</span><span class="token punctuation">(</span><span class="token punctuation">{</span><span class="token class-name">SqlSessionFactory</span><span class="token punctuation">.</span><span class="token keyword">class</span><span class="token punctuation">,</span> <span class="token class-name">SqlSessionFactoryBean</span><span class="token punctuation">.</span><span class="token keyword">class</span><span class="token punctuation">}</span><span class="token punctuation">)</span>
<span class="token annotation punctuation">@ConditionalOnSingleCandidate</span><span class="token punctuation">(</span><span class="token class-name">DataSource</span><span class="token punctuation">.</span><span class="token keyword">class</span><span class="token punctuation">)</span>
...
</code></pre><div class="highlight-lines"><br><br><br><div class="highlight-line">&nbsp;</div><br></div><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>这个自动配置类在容器中放了一堆Bean，关联了MybatisPlusProperties，也就是说，我们以后要更改的话 只需要修改<code>mybatis-plus</code>的配置即可</p>
<p>接着我们继续看看AutoConciguration配置 了哪些bean</p>
<p>首先是一个</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211222123148327.png" alt="image-20211222123148327" loading="lazy"></p>
<p>设置好了Mybatis的SqlSessionFactory</p>
<p>@Bean标注的对象，如果参数是一个对象，那么就会从容器中自动的传入这个组件</p>
<p>而我们此时的容器中正好是一个Druid的是数据源</p>
<p>所以使用的将是我们的druid数据源</p>
<p>接着我们看看第一个if</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>这个是我们有没有mybatis的全局配置文件 如果没有配 就不用管了</p>
<p>接下来还有非常多的配置</p>
<p>例如一个configuration</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>接下来我们再看看这个MybatisPlusProperties</p>
<p>首先就能看到配置了一个mapper的位置-mapperLocations</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211222123917205.png" alt="image-20211222123917205" loading="lazy"></p>
<p><code>classpath*:/mapper/**/*.xml</code></p>
<p>任意包下的类路径下的所有mapper文件夹下任意路径下的xml都是sql映射文件</p>
<p>相当于给我们把mapper的映射也配置好了</p>
<p>所以说我们以后需要增加mapper配置文件 只需要在我们的resources文件夹下的mapper文件夹里一放就可以了</p>
<p>接着我们还可以发现 它给我们配置好了sqlsessionTemplate</p>
...
<span class="token keyword">public</span> <span class="token class-name">SqlSessionTemplate</span> <span class="token function">sqlSessionTemplate</span><span class="token punctuation">(</span><span class="token class-name">SqlSessionFactory</span> sqlSessionFactory<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>我们继续下翻</p>
<p>看到了有一个额外的静态内部类，并且导入了一个AutoConfiguredMapperScannerRegistrar</p>
...
<span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">class</span> <span class="token class-name">MapperScannerRegistrarNotFoundConfiguration</span> <span class="token keyword">implements</span> <span class="token class-name">InitializingBean</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="highlight-lines"><br><div class="highlight-line">&nbsp;</div><br><br><br><br><br><br><br><br><br></div><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><p>接下来看看这个AutoConfiguredMapperScannerRegistrar</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211222124513280.png" alt="image-20211222124513280" loading="lazy"></p>
<p>可以发现 是和@mapper注解有关的，也就是说，我们无需额外的配置mapper注解的少报位置 它将会自动给我们进行扫描@mapper标注的接口</p>
<h3 id="使用mybatis-plus" tabindex="-1"><a class="header-anchor" href="#使用mybatis-plus" aria-hidden="true">#</a> 使用Mybatis-Plus</h3>
<p>我们参照官方文档 先在main文件中额外加一个扫描的路径</p>
...
</code></pre><div class="highlight-lines"><br><div class="highlight-line">&nbsp;</div><br><br><br><br><br><br><br><br></div><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>这样在写mapper的时候就无需额外标注@mapper了</p>
<p>接下来我们依旧是创建一个admin类</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Data</span>
<span class="token annotation punctuation">@NoArgsConstructor</span>
<span class="token annotation punctuation">@AllArgsConstructor</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Admin</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><p>对应的数据源</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211222125419223.png" alt="image-20211222125419223" loading="lazy"></p>
<p>接着我们编写一个mapper接口AdminMapper</p>
<p>接着让其继承BaseMapper接口，并传入我们的Admin类泛型</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>在BaseMapper中，我们可以看到有非常多的定义好的封装好的东西，基本的增删改查全部都有的</p>
<p>（注意 如果说要对数据库进行优化 则不太建议使用这里面的一些东西 还是建议手写）</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211222125657921.png" alt="image-20211222125657921" loading="lazy"></p>
<p>也就是我们现在无需对自己的AdminMapper再进行额外的任何操作 就可以拥有CRUD的功能</p>
<p>接下来我们简单使用下</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@SpringBootTest</span>
<span class="token annotation punctuation">@Slf4j</span>
<span class="token keyword">class</span> <span class="token class-name">ApplicationTests</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><p>接着喜闻热见的报错了--我们的表名是admin_2，这里用的类是admin 默认情况下它会去找admin2的表 所以说我们根据官方文档</p>
<h3 id="注解标注表名、字段名等" tabindex="-1"><a class="header-anchor" href="#注解标注表名、字段名等" aria-hidden="true">#</a> 注解标注表名、字段名等</h3>
<p><a href="https://baomidou.com/pages/223848/#tablename" target="_blank" rel="noopener noreferrer">https://baomidou.com/pages/223848/#tablename<ExternalLinkIcon/></a></p>
<p>发现可以指定表名</p>
<p>于是乎在admin上标注下表名</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Data</span>
<span class="token annotation punctuation">@NoArgsConstructor</span>
...
</code></pre><div class="highlight-lines"><br><br><br><div class="highlight-line">&nbsp;</div><br><br><br><br><br><br><br></div><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><p>运行：</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211222130736751.png" alt="image-20211222130736751" loading="lazy"></p>
<h3 id="规范的使用mybatis-plus" tabindex="-1"><a class="header-anchor" href="#规范的使用mybatis-plus" aria-hidden="true">#</a> 规范的使用Mybatis-plus</h3>
<p>我们正常的使用过程中 应该是这样的</p>
<p>Java Bean</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Data</span>
<span class="token annotation punctuation">@NoArgsConstructor</span>
<span class="token annotation punctuation">@AllArgsConstructor</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><p>然后是mapper</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>这个时候我们突然想起 应该规范的开发</p>
<p>也就是service分为两个 一个 接口 一个impl</p>
<p>但是这样又引出了一个问题 因为我们要使用BaseMapper所提供的查询，所以说要手动给service写一堆BaseMapper中的方法 并且让Impl再实现这个借口，再调用AdminMapper的一些方法不太现实</p>
<p>所以Mybatis-plus提供了一个神器接口</p>
<p><code>IService&lt;T&gt;</code></p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211222152228461.png" alt="image-20211222152228461" loading="lazy"></p>
<p>这个接口里面定义了超多的方法和返回值，和baseMapper几乎一一对应 需要传入一个泛型</p>
<p>所以我们只需要这样：</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>但是问题又来了</p>
<p>我们总不可能在IMPL中一个一个的去实现这么多方法吧</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211222152412179.png" alt="image-20211222152412179" loading="lazy"></p>
<p>所以mybatis也做了一个超级强大的类</p>
<p><code>ServiceImpl&lt;M,T&gt;</code>  这是一个对顶级Service接口的实现类</p>
<p>使用它的时候 继承它并传入两个泛型即可</p>
<p>第一个泛型M----Mapper接口</p>
<p>第二个泛型T----实体domain类</p>
<p>所以我们只需要</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Service</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>这里有相当多的增删改查方法 这里就不展示了 接下来使用它</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@SpringBootTest</span>
<span class="token annotation punctuation">@Slf4j</span>
<span class="token keyword">class</span> <span class="token class-name">ApplicationTests</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br></div></div><p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211222153704752.png" alt="image-20211222153704752" loading="lazy"></p>
<h3 id="mybatis-plus的分页功能的使用" tabindex="-1"><a class="header-anchor" href="#mybatis-plus的分页功能的使用" aria-hidden="true">#</a> Mybatis-Plus的分页功能的使用</h3>
<p>官方是这样说明的</p>
<p><a href="https://baomidou.com/pages/8f40ae/" target="_blank" rel="noopener noreferrer">https://baomidou.com/pages/8f40ae/<ExternalLinkIcon/></a></p>
<p>说以我们要先注册一个Bean 这里官方文有分新旧版本 我们就用新版即可</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">//Spring boot方式</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br></div></div><p>我们使用最新版本的</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Configuration</span>
<span class="token annotation punctuation">@MapperScan</span><span class="token punctuation">(</span><span class="token string">"com.MyProject.webadmin.mapper"</span><span class="token punctuation">)</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MybatisConfiguration</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">public</span> <span class="token class-name">MybatisPlusInterceptor</span> <span class="token function">mybatisPlusInterceptor</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        <span class="token class-name">PaginationInnerInterceptor</span> interceptor1 <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">PaginationInnerInterceptor</span><span class="token punctuation">(</span><span class="token class-name">DbType</span><span class="token punctuation">.</span>H2<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br></div></div><p>接下来写个代码测试一下：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@SpringBootTest</span>
<span class="token annotation punctuation">@Slf4j</span>
<span class="token keyword">class</span> <span class="token class-name">ApplicationTests</span> <span class="token punctuation">{</span>
...
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211222172853573.png" alt="image-20211222172853573" loading="lazy"></p>
<h3 id="扩展-ieda的mybatisx插件的使用" tabindex="-1"><a class="header-anchor" href="#扩展-ieda的mybatisx插件的使用" aria-hidden="true">#</a> 扩展-IEDA的MybatisX插件的使用</h3>
<p>这玩意非常方便..</p>
<p>比方说我们现在有一张表</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211222132241034.png" alt="image-20211222132241034" loading="lazy"></p>
<p>右键</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211222132256102.png" alt="image-20211222132256102" loading="lazy"></p>
<p>接着几个设置大概这样 其他的都可以不动</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211222132633012.png" alt="image-20211222132633012" loading="lazy"></p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211222132850756.png" alt="image-20211222132850756" loading="lazy"></p>
<p>接着你就能在你的项目中额外得到这些东西</p>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211222132956925.png" alt="image-20211222132956925" loading="lazy"></p>
<p>Domain</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">webadmin<span class="token punctuation">.</span>domain</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Mes</span> <span class="token keyword">implements</span> <span class="token class-name">Serializable</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br><span class="line-number">62</span><br><span class="line-number">63</span><br><span class="line-number">64</span><br><span class="line-number">65</span><br><span class="line-number">66</span><br></div></div><p>Mapper</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>service</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>serviceImpl</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>    <span class="token annotation punctuation">@Service</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><h3 id="扩展-junit5的额外注解" tabindex="-1"><a class="header-anchor" href="#扩展-junit5的额外注解" aria-hidden="true">#</a> 扩展-Junit5的额外注解</h3>
<p><img src="/images/SpringBoot/03-Spring_Boot整合数据访问/image-20211222174450513.png" alt="image-20211222174450513" loading="lazy"></p>
<p>注意 在所有springboot的相关项目中 要使用spring容器内的内容 都需要：</p>
<p>在类名处加上@SpringBootTest注解</p>
<p>还有一些其他的东西暂时先不学 了 等过了spring cloud再说</p>
</template>
