<template><h2 id="servlet简介" tabindex="-1"><a class="header-anchor" href="#servlet简介" aria-hidden="true">#</a> Servlet简介</h2>
<ul>
...
<p>有点绕的一句话：<code>实现了Servlet接口的Java程序，叫做Servlet</code></p>
<p>为了测试这个点，我们创建一个空的Maven项目来测试下，并删掉里面src及其目录下的所有东西</p>
<h3 id="开始学习前的准备工作" tabindex="-1"><a class="header-anchor" href="#开始学习前的准备工作" aria-hidden="true">#</a> 开始学习前的准备工作</h3>
<p><img src="/images/JavaEE/03-Servlet/image-20211202192644896.png" alt="image-20211202192644896" loading="lazy"></p>
<p>这里起我们学习就在这个Project内了，有了maven的管理，写程序来还是挺简单的</p>
<p>然后我们要分别去添加两个依赖：<code>servlet</code>和<code>jsp</code>的，这里我们选择和Tomcat版本兼容的（还是用Tomcat家的）</p>
<p><a href="https://mvnrepository.com/artifact/org.apache.tomcat/tomcat-servlet-api" target="_blank" rel="noopener noreferrer">https://mvnrepository.com/artifact/org.apache.tomcat/tomcat-servlet-api<ExternalLinkIcon/></a></p>
<p><a href="https://mvnrepository.com/artifact/org.apache.tomcat/tomcat-jsp-api" target="_blank" rel="noopener noreferrer">https://mvnrepository.com/artifact/org.apache.tomcat/tomcat-jsp-api<ExternalLinkIcon/></a></p>
<p>当然，我这里先不用，用现在最多人用的，留个坑</p>
<p>下面这里是我找到的最多人用的两个jar包依赖，添加到pom.xml中</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!-- https://mvnrepository.com/artifact/javax.servlet/javax.servlet-api --></span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><p>从这里开始，我们将模块化编程-每个章节都是一个模块，减少Project的创建数量</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211202193140078.png" alt="image-20211202193140078" loading="lazy"></p>
<p>然后新建一个Maven JavaWeb APP模块，名字随意，Maven版本按照自己的来</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211202193505154.png" alt="image-20211202193505154" loading="lazy"></p>
<p>然后得到了这些东西</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211202193610872.png" alt="image-20211202193610872" loading="lazy"></p>
<h3 id="扩展-maven父子工程的理解" tabindex="-1"><a class="header-anchor" href="#扩展-maven父子工程的理解" aria-hidden="true">#</a> 扩展-Maven父子工程的理解</h3>
<p>刚刚创建完那个模块后，在Maven管理页面看到多出了这些内容，他们之间pom,xml呈以下关系</p>
<ul>
<li>父模块（工程）的Jar包（依赖）子模块可以随意使用</li>
<li>子模块的Jar包父模块无法调用</li>
</ul>
<p><img src="/images/JavaEE/03-Servlet/image-20211202193657420.png" alt="image-20211202193657420" loading="lazy"></p>
<p>好了，言归正传，继续我们的操作</p>
<p>继续新建几个软件包java和res：遵循约定大于配置</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211202194512307.png" alt="image-20211202194512307" loading="lazy"></p>
<p>然后修改<code>WEB-INF</code>中的<code>web.xml</code></p>
<p>再配置下HelloWorld之类的，根据我之前那个章节的方式来做，Router设置为/hello</p>
<p>然后配置Tomcat启动试试</p>
<p>不出意外的出意外了</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211202195331544.png" alt="image-20211202195331544" loading="lazy"></p>
<p>这就是之前挖的坑，接下来用回适合我们tomcat版本的Servlet和jsp吧</p>
<p>我这里用的是10.0.13版本的tomcat，所以用的版本也是这样</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br></div></div><p>配置这一步的时候，把之前的那两个包删了（直接在xml文件中删除即可）</p>
<p>然后再更新下MyApps.java中的依赖，重启下服务，完美解决</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211202195743249.png" alt="image-20211202195743249" loading="lazy"></p>
<p>好了，准备工作结束，接下来分析以下我们使用的<code>HttpServlet</code>的结构</p>
<h2 id="httpservlet源码分析" tabindex="-1"><a class="header-anchor" href="#httpservlet源码分析" aria-hidden="true">#</a> HttpServlet源码分析</h2>
<p><img src="/images/JavaEE/03-Servlet/image-20211202211103009.png" alt="image-20211202211103009" loading="lazy"></p>
<p>首先看类图，这个类是直接继承GenericServlet类</p>
<p>GenericServlet实现了三个接口：</p>
<ul>
<li>Serialzable 序列化</li>
<li>Servlet接口</li>
<li>ServletConfig接口</li>
</ul>
<p>接下来我们看下Servlet接口都有哪些内容：</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br></div></div><p>然后再看下ServletConfig的信息</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">ServletConfig</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br></div></div><p>然后看看GenericServlet这个实现类中都有哪些东西</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>
<span class="token keyword">package</span> <span class="token namespace">jakarta<span class="token punctuation">.</span>servlet</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br><span class="line-number">62</span><br><span class="line-number">63</span><br><span class="line-number">64</span><br><span class="line-number">65</span><br><span class="line-number">66</span><br><span class="line-number">67</span><br><span class="line-number">68</span><br><span class="line-number">69</span><br><span class="line-number">70</span><br><span class="line-number">71</span><br><span class="line-number">72</span><br><span class="line-number">73</span><br><span class="line-number">74</span><br><span class="line-number">75</span><br><span class="line-number">76</span><br><span class="line-number">77</span><br><span class="line-number">78</span><br><span class="line-number">79</span><br><span class="line-number">80</span><br><span class="line-number">81</span><br><span class="line-number">82</span><br><span class="line-number">83</span><br><span class="line-number">84</span><br><span class="line-number">85</span><br><span class="line-number">86</span><br><span class="line-number">87</span><br><span class="line-number">88</span><br><span class="line-number">89</span><br><span class="line-number">90</span><br></div></div><p>可以非常清晰的了解到，这家伙实际上也没有做什么，看来主要的实现还是<code>HttpServlet</code></p>
<p>接下来看看那家伙的源码吧</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span>
<span class="token keyword">public</span> <span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">HttpServlet</span> <span class="token keyword">extends</span> <span class="token class-name">GenericServlet</span> <span class="token punctuation">{</span>
 <span class="token comment">//这里定义的都是一些常量</span>
    ...
    <span class="token keyword">private</span> <span class="token keyword">static</span> <span class="token keyword">final</span> <span class="token class-name">String</span> METHOD_DELETE <span class="token operator">=</span> <span class="token string">"DELETE"</span><span class="token punctuation">;</span>
    <span class="token keyword">private</span> <span class="token keyword">static</span> <span class="token keyword">final</span> <span class="token class-name">String</span> METHOD_HEAD <span class="token operator">=</span> <span class="token string">"HEAD"</span><span class="token punctuation">;</span>
    <span class="token keyword">private</span> <span class="token keyword">static</span> <span class="token keyword">final</span> <span class="token class-name">String</span> METHOD_GET <span class="token operator">=</span> <span class="token string">"GET"</span><span class="token punctuation">;</span>
    <span class="token keyword">private</span> <span class="token keyword">static</span> <span class="token keyword">final</span> <span class="token class-name">String</span> METHOD_OPTIONS <span class="token operator">=</span> <span class="token string">"OPTIONS"</span><span class="token punctuation">;</span>
    <span class="token keyword">private</span> <span class="token keyword">static</span> <span class="token keyword">final</span> <span class="token class-name">String</span> METHOD_POST <span class="token operator">=</span> <span class="token string">"POST"</span><span class="token punctuation">;</span>
    <span class="token keyword">private</span> <span class="token keyword">static</span> <span class="token keyword">final</span> <span class="token class-name">String</span> METHOD_PUT <span class="token operator">=</span> <span class="token string">"PUT"</span><span class="token punctuation">;</span>
    <span class="token keyword">private</span> <span class="token keyword">static</span> <span class="token keyword">final</span> <span class="token class-name">String</span> METHOD_TRACE <span class="token operator">=</span> <span class="token string">"TRACE"</span><span class="token punctuation">;</span>

    <span class="token keyword">private</span> <span class="token keyword">static</span> <span class="token keyword">final</span> <span class="token class-name">String</span> HEADER_IFMODSINCE <span class="token operator">=</span> <span class="token string">"If-Modified-Since"</span><span class="token punctuation">;</span>
    <span class="token keyword">private</span> <span class="token keyword">static</span> <span class="token keyword">final</span> <span class="token class-name">String</span> HEADER_LASTMOD <span class="token operator">=</span> <span class="token string">"Last-Modified"</span><span class="token punctuation">;</span>

    <span class="token keyword">private</span> <span class="token keyword">static</span> <span class="token keyword">final</span> <span class="token class-name">String</span> LSTRING_FILE <span class="token operator">=</span> <span class="token string">"jakarta.servlet.http.LocalStrings"</span><span class="token punctuation">;</span>
    <span class="token keyword">private</span> <span class="token keyword">static</span> <span class="token keyword">final</span> <span class="token class-name">ResourceBundle</span> lStrings <span class="token operator">=</span> <span class="token class-name">ResourceBundle</span><span class="token punctuation">.</span><span class="token function">getBundle</span><span class="token punctuation">(</span>LSTRING_FILE<span class="token punctuation">)</span><span class="token punctuation">;</span>
 ...
 <span class="token comment">//get方法</span>
    ...
    <span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">doHead</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> req<span class="token punctuation">,</span> <span class="token class-name">HttpServletResponse</span> resp<span class="token punctuation">)</span>
        ...
        <span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token class-name">DispatcherType</span><span class="token punctuation">.</span>INCLUDE<span class="token punctuation">.</span><span class="token function">equals</span><span class="token punctuation">(</span>req<span class="token punctuation">.</span><span class="token function">getDispatcherType</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        <span class="token keyword">if</span> <span class="token punctuation">(</span>method<span class="token punctuation">.</span><span class="token function">equals</span><span class="token punctuation">(</span>METHOD_GET<span class="token punctuation">)</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
            ...
            <span class="token punctuation">}</span> <span class="token keyword">else</span> <span class="token punctuation">{</span>
                ...
                <span class="token keyword">try</span> <span class="token punctuation">{</span>
                    ifModifiedSince <span class="token operator">=</span> req<span class="token punctuation">.</span><span class="token function">getDateHeader</span><span class="token punctuation">(</span>HEADER_IFMODSINCE<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br></div></div><p><img src="/images/JavaEE/03-Servlet/image-20211202222857926.png" alt="image-20211202222857926" loading="lazy"></p>
<p>完美！</p>
<h3 id="配置servlet的映射-router" tabindex="-1"><a class="header-anchor" href="#配置servlet的映射-router" aria-hidden="true">#</a> 配置Servlet的映射(Router)</h3>
<p>​  这是一个非常简单的道理，刚刚我们是处理了Servlet的请求和响应，接下来要正式在Java应用程序去处理它，也就是配置我们的web.xml文件</p>
<p>​  就好比我写了一个NodeJS的后端接口，但是没有给他配置他属于哪个路由，那不就废了吗~</p>
<p>​  Java同理，一个Java程序，我们需要通过浏览器访问，而浏览器需要连接WEb服务器，所以我们需要在Web服务中注册我们写的Servlet，还需要给他一个能够访问的路径</p>
<p>​  这就跟注册Router是一个道理，就是流程稍微变了一点</p>
<p>在web.xml中，我们之前编写了这些内容</p>
<p>servlet：就相当于一个路由所对应的Java程序</p>
<p>servlet-mapping：就相当于<code>一个路由</code>：访问到哪个页面-需要交给哪些Java程序来处理</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!--    注册一个Servlet 这个就相当于注册一个路由一样--></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet-mapping</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><p>如果你学过NodeJs，这里就非常明白了，大概就是一个没封装的Koa请求：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">//演示KOA的get请求</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><h2 id="servlet访问流程详解-未涉及tomcat底层" tabindex="-1"><a class="header-anchor" href="#servlet访问流程详解-未涉及tomcat底层" aria-hidden="true">#</a> Servlet访问流程详解（未涉及tomcat底层）</h2>
<p>虽然 但是 我就是想刨根问底</p>
<p>目前来说，我们的浏览器是访问了<code>localhost:8080/Servlet_01_war/hello</code></p>
<p>我们返回了一个世界你好，这之中到底经历了什么？</p>
<p>就目前按照我找到的资料来说，访问经历了四个步骤</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211202232840370.png" alt="image-20211202232840370" loading="lazy"></p>
<ul>
<li>
<p>浏览器：</p>
<ul>
<li>第一步：浏览器输入访问路径后，携带了请求行，头，体</li>
</ul>
</li>
<li>
<p>服务器：</p>
<ul>
<li>第二步：根据访问路径找到已注册的servlet名称，既图中的<code>MyApps</code></li>
<li>第三步：根据映射找到对应的servlet名<code>MyApps</code></li>
<li>第四步：根据根据servlet名找到我们全限定类名，既我们自己写的类<code>MyApp</code></li>
</ul>
</li>
</ul>
<p>​  服务器：<strong>我们所用的服务器是Tomcat</strong>，所以下文中的服务器实际上指的是tomcat</p>
<p>​  也就是说，浏览器就是发起了一次请求，剩余的步骤都是服务器来完成的（这也是基本常识了）</p>
<p>​  那么，服务器找到该类名后，又做了什么呢？</p>
<p>​  它会通过<strong>反射</strong>创建这个对象，同时创建一个<code>ServletConfig</code>，里面存放了一些初始化信息（服务器只会创建一次Servlet对象，所以ServletConfig也只有一个）</p>
<p>​  当对象创建好了之后，<code>tomcat</code>会执行<code>init</code>方法，此时我们知道，我们自己没有重写过init方法，同时HttpServlet也没有重写init方法，根据动态绑定，会调用GenericServlet的init方法：</p>
...
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">init</span><span class="token punctuation">(</span><span class="token class-name">ServletConfig</span> config<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">this</span><span class="token punctuation">.</span><span class="token function">init</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><p>​  由于前面提到了，在反射创建我们的Servlet对象时，创建了一个Servlet对象，所以此时传入的ServletConfig为之前创建的（这一切都是由tomcat来完成的，之后有空了得了解下tomcat的源码）</p>
<p>​  这里额外说下，那个无参无返回值的<code>init()</code>方法，实际上是这玩意的开发者给我们留的后路，当我们想在服务器创建时额外做点什么，只需要在我们的代码中重写下这个无参或者有参的构造方法即可，例如：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">init</span><span class="token punctuation">(</span><span class="token class-name">ServletConfig</span> config<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>最终他们的执行顺序（动态绑定机制）</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211202234232512.png" alt="image-20211202234232512" loading="lazy"></p>
<p>这里的流程大概就是</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211202234647857.png" alt="image-20211202234647857" loading="lazy"></p>
<p>​  紧接着，我们就该很清晰的知道服务器下一步该调用哪个代码了：</p>
<p>​  那当让是Service方法！</p>
<p>先再来看看Service方法 草看到的第一眼就非常清晰了</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">service</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> req<span class="token punctuation">,</span> <span class="token class-name">HttpServletResponse</span> resp<span class="token punctuation">)</span><span class="token keyword">throws</span> <span class="token class-name">ServletException</span><span class="token punctuation">,</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
 ...
 <span class="token comment">//执行其他相对应的方法</span>
  ...
  <span class="token comment">//如果说都不是的话，抛出异常给客户端</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br></div></div><p>这里的流程是这样的：</p>
<ol>
<li>服务器创建两个对象：<code>ServletRequest</code>请求对象和<code>ServletResponse</code>响应对象，用来封装浏览器的请求数据和封装向浏览器的响应数据</li>
<li>接着服务器会默认在我们写的类里寻找service(ServletRequest req, ServletResponse res)方法，但是DemoServlet中不存在，那么会到其父类中寻找</li>
<li>到父类HttpServlet中发现有此方法，则直接调用此方法，并将之前创建好的两个对象传入</li>
...
<p>这里就非常简单明了，那为什么我们不重写个service方法呢？</p>
<ul>
<li>如果不是业务需求，谁愿意重写这玩意</li>
<li>重写这玩意的话，我们需要将强转，以及一系列的安全保护判断重写一遍，存在安全隐患</li>
</ul>
<p>这里的流程画一张图就是：</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211202235846846.png" alt="image-20211202235846846" loading="lazy"></p>
<p>紧接着，处理响应，返回给浏览器：</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211202235908042.png" alt="image-20211202235908042" loading="lazy"></p>
<p>可以看到，这之中大部分的工作都是tomcat在帮我们做</p>
<p>​  这也印证了一点：我在开头的时候故意用的别的包的时候，引发了tomcat的报错，因为数据类型根本不是同一种的，其他包的实现功能虽然和这玩意差不多，但是一些细节的东西肯定跟tomcat的有偏差</p>
<p>​  比如说返回值要经过tomcat的处理，如果是其他的包，返回值的类型可能就不一样了</p>
<p>​  当然这只是初步的分析源码，如果能吃透这个tomcat应该对工作很有帮助</p>
<p>​  它里面应该涉及到了高并发之类的以及程序和程序之间的联系</p>
<p>既然了解完这个了，接下来了解下它的Servlet-mapping配置项吧</p>
<h2 id="web-xml中servlet-mapping配置项可以兼容的地方" tabindex="-1"><a class="header-anchor" href="#web-xml中servlet-mapping配置项可以兼容的地方" aria-hidden="true">#</a> web.xml中Servlet-mapping配置项可以兼容的地方</h2>
<p>这玩意其实不难，只要你不把多个Servlet（子路由）绑定到同一个Servlet-mapping（主路由）上就行</p>
<h3 id="单个servlet绑定单个servlet-mapping" tabindex="-1"><a class="header-anchor" href="#单个servlet绑定单个servlet-mapping" aria-hidden="true">#</a> 单个Servlet绑定单个Servlet-mapping</h3>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>servlet-mapping</span><span class="token punctuation">></span></span>
    ...
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>url-pattern</span><span class="token punctuation">></span></span>/hello<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>url-pattern</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet-mapping</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><p>就是我们最常用的，访问<code>/hello</code>即可访问</p>
<h3 id="单个servlet绑定多个servlet-mapping" tabindex="-1"><a class="header-anchor" href="#单个servlet绑定多个servlet-mapping" aria-hidden="true">#</a> 单个Servlet绑定多个Servlet-mapping</h3>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>servlet</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>servlet-name</span><span class="token punctuation">></span></span>MyApps<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet-name</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>servlet-class</span><span class="token punctuation">></span></span>MyApp<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet-class</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet-mapping</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br></div></div><p>然后我们访问<code>/hello1</code>、<code>/hello2</code>都可以访问到我们设定的内容</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211203002325098.png" alt="image-20211203002325098" loading="lazy"></p>
<h3 id="单个servlet绑定某个字段下的所有路径" tabindex="-1"><a class="header-anchor" href="#单个servlet绑定某个字段下的所有路径" aria-hidden="true">#</a> 单个Servlet绑定某个字段下的所有路径</h3>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>servlet</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>servlet-name</span><span class="token punctuation">></span></span>MyApps<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet-name</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>servlet-class</span><span class="token punctuation">></span></span>MyApp<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet-class</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet-mapping</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><p>这样你访问<code>/adminer</code>下的所有内容，都是在访问同一个Servlet</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211203002315118.png" alt="image-20211203002315118" loading="lazy"></p>
<h3 id="覆盖所有页面" tabindex="-1"><a class="header-anchor" href="#覆盖所有页面" aria-hidden="true">#</a> 覆盖所有页面</h3>
<p>这玩意不可能用得上</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>servlet</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>servlet-name</span><span class="token punctuation">></span></span>MyApps<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet-name</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>servlet-class</span><span class="token punctuation">></span></span>MyApp<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet-class</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet-mapping</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><h3 id="自定义后缀" tabindex="-1"><a class="header-anchor" href="#自定义后缀" aria-hidden="true">#</a> 自定义后缀</h3>
<p>这个偶尔可能会用得上，注意点：不能加上<code>/</code></p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>servlet</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>servlet-name</span><span class="token punctuation">></span></span>MyApps<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet-name</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>servlet-class</span><span class="token punctuation">></span></span>MyApp<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet-class</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>servlet-mapping</span><span class="token punctuation">></span></span>
    ...
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>url-pattern</span><span class="token punctuation">></span></span>/users*.aua<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>url-pattern</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet-mapping</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br></div></div><p><img src="/images/JavaEE/03-Servlet/image-20211203002251355.png" alt="image-20211203002251355" loading="lazy"></p>
<h3 id="mapping的优先级问题" tabindex="-1"><a class="header-anchor" href="#mapping的优先级问题" aria-hidden="true">#</a> Mapping的优先级问题</h3>
<p>指定了固有路径的优先级最高，如果找不到就会找默认的处理请求</p>
<p>固有路径&gt;泛路径&gt;默认处理请求</p>
<p>比方说我现在有两个Apps</p>
<p>第一个是访问输出:世界你好</p>
<p>第二个是访问输出：世界你好sss</p>
<p>现在我的xml是这样配置的：</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code>第一个app
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>servlet-mapping</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>servlet-name</span><span class="token punctuation">></span></span>MyApps<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet-name</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>url-pattern</span><span class="token punctuation">></span></span>/adminer/*<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>url-pattern</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet-mapping</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet-mapping</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>那么，当我访问<code>/adminer/uuu</code>的时候获取到的页面时</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211203002953422.png" alt="image-20211203002953422" loading="lazy"></p>
<p>访问该路径下的通常页面是：</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211203003010310.png" alt="image-20211203003010310" loading="lazy"></p>
<p>访问其他没有指定的路径是：Tomcat的默认处理</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211203003024542.png" alt="image-20211203003024542" loading="lazy"></p>
<h2 id="servlet的生命周期" tabindex="-1"><a class="header-anchor" href="#servlet的生命周期" aria-hidden="true">#</a> Servlet的生命周期</h2>
<p>Servlet 生命周期可被定义为从创建直到毁灭的整个过程。以下是 Servlet 遵循的过程，也对应三个阶段：</p>
<ul>
<li>
<p>初始化阶段：Servlet 通过调用 init () 方法进行初始化；</p>
</li>
<li>
<p>运行阶段：Servlet 调用 service() 方法来处理客户端的请求；</p>
</li>
<li>
<p>销毁阶段：Servlet 通过调用 destroy() 方法终止（结束），并由 JVM 的垃圾回收器进行垃圾回收的。</p>
<p>其中的init()方法应只调用一次，Servlet创建后，在其运行阶段，便可通过service方法来处理来自客户端的请求，通过，当服务器关闭（tomcat停止运行）或者应用被移除容器（tomcat下webapps目录中的文件被移除）时，调用destory()方法来终止Servlet。应其生命周期如下图所示：</p>
</li>
</ul>
<p><img src="/images/JavaEE/03-Servlet/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzM0NjY2ODU3,size_16,color_FFFFFF,t_70.jpeg" alt="资源分配图" loading="lazy"></p>
<h2 id="正式开始servlet" tabindex="-1"><a class="header-anchor" href="#正式开始servlet" aria-hidden="true">#</a> 正式开始Servlet</h2>
<p>经过上面的分析，我们目前来说对Servlet已经了解了一些了，接下来开始正式学习它</p>
<p>新建一个<code>module</code>:<code>Servlet-02</code></p>
<p>里面配置好相关的文件，及写好一个继承自<code>HttpServlet</code>的App.java</p>
<p>然后重写doGet 方法，我们可以尝试在这个方法中获取一些相应的东西</p>
<p>比如通过<code>this</code></p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
<span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">doGet</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> req<span class="token punctuation">,</span> <span class="token class-name">HttpServletResponse</span> resp<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span><span class="token punctuation">,</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><p>这里能通过this能获取到的东西挺多的，不过目前来看貌似其他的都没有啥用，除了context上下文，接下来先了解下这玩意是干嘛用的</p>
<h2 id="servletcontext" tabindex="-1"><a class="header-anchor" href="#servletcontext" aria-hidden="true">#</a> ServletContext</h2>
<p>​  在容器(Tomcat)启动的时候，他会为<strong>每一个web程序</strong>都创建一个对应的Servletcontext对象，他代表了当前的web应用，这个对象是全局唯一，而且在所有工程内部的所有Servlet都共享这个对象</p>
<p>所以它也被称为：全局应用程序共享对象</p>
<p><img src="/images/JavaEE/03-Servlet/ServletContent.jpg" alt="ServletContent" loading="lazy"></p>
<p>他的用途：</p>
<ul>
<li>是一个<strong>域对象</strong></li>
<li>可以读取全局配置参数</li>
<li>可以搜索当前工程目录下的资源文件</li>
<li>可以获取当前工程名字</li>
<li>共享数据
<ul>
<li>在这个Servlet中保存的数据，可以在另一个Servlet中拿到</li>
</ul>
</li>
</ul>
<h3 id="域对象介绍" tabindex="-1"><a class="header-anchor" href="#域对象介绍" aria-hidden="true">#</a> 域对象介绍</h3>
<p>域对象是服务器在内存上创建的存储空间，用于在不同动态资源（servlet）之间传递与共享数据。</p>
<p>​  简单来说就是：<u>应用范围-服务器范围,只要服务器不关闭,数据一致存在</u></p>
<h2 id="servletcontext中常用的方法" tabindex="-1"><a class="header-anchor" href="#servletcontext中常用的方法" aria-hidden="true">#</a> ServletContext中常用的方法</h2>
<table>
<thead>
<tr>
<th>方法名</th>
...
<tbody>
<tr>
<td><strong>Object getAttribute(String name)</strong></td>
<td>根据传入的name返回Servlet容器属性<br />（通过下面的setAttribute方法设置的）<br />如果没有对应的属性，则返回一个null；</td>
</tr>
<tr>
<td><strong>void setAttribute(String name, Object object)</strong></td>
<td>在serlvet容器中将给定的object绑定到对应的属性名name上<br />（其形如key:value）<br />如果serlvet容器中已经存在该name的属性<br />则将其原始值覆盖，如果传入的object为null<br />则和removeAttribute方法起到的效果一致<br />（注意，这点和我们使用的Map不同）</td>
</tr>
<tr>
<td><strong>void removeAttribute(String name)</strong></td>
<td>根据传入的name将对应的属性从Servlet容器中移除</td>
</tr>
<tr>
<td><strong>getAttributeNames()</strong></td>
<td>以<code>Enumeration&lt;String&gt;</code>的形式返回对应Servlet容器中可用的属性名称（其中的name，也就是key）；</td>
</tr>
<tr>
<td><strong>getResourcePaths(String path)</strong></td>
<td>返回一个包含目录列表的集合，如果web应用中所有资源的路径都不是以path开头，则返回一个空的集合。<br />参数path是用与匹配资源的起始路径，且需要以&quot;/&quot;开头；</td>
</tr>
<tr>
<td><strong>getResource(String path)</strong></td>
<td>返回映射到给定路径的资源的URL对象，path需要以&quot;/&quot;开头；</td>
</tr>
<tr>
<td><strong>getResourceAsStream(String path)</strong></td>
<td>返回映射到给定路径的资源的输入流（InputStream）<br />path需要以&quot;/&quot;开头，此方法无法获取到资源的类型和长度属性；</td>
</tr>
<tr>
<td><strong>getRealPath(String path)</strong></td>
<td>返回给定虚拟路径（相对于当前应用）的资源在主机上的真实路径，当servlet容器无法将给定的虚拟路径转换为真实路径时，返回null</td>
</tr>
<tr>
<td><strong>getRequestDispatcher(String path)</strong></td>
<td>返回一个RequestDispatcher对象，该对象可用于将请求转发到资源（指定路径）或将资源包括在响应中，path需要以&quot;/&quot;开头；</td>
</tr>
<tr>
<td><strong>String getContextPath()</strong></td>
<td>获取当前项目位于<code>/</code>的目录(应用程序上下文目录)，比如说我当前的项目为hello<br />则返回<code>/hello</code></td>
</tr>
</tbody>
</table>
<p>先来一个总代码，效果如下：</p>
<p>web.xml中添加全局资源 细节等下会说</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>context-param</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>context-param</span><span class="token punctuation">></span></span> 
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><p>然后是Java文件</p>
...
<span class="token keyword">import</span> <span class="token namespace">jakarta<span class="token punctuation">.</span>servlet<span class="token punctuation">.</span></span><span class="token class-name">ServletConfig</span><span class="token punctuation">;</span>
<span class="token keyword">import</span> <span class="token namespace">jakarta<span class="token punctuation">.</span>servlet<span class="token punctuation">.</span></span><span class="token class-name">ServletContext</span><span class="token punctuation">;</span>
<span class="token keyword">import</span> <span class="token namespace">jakarta<span class="token punctuation">.</span>servlet<span class="token punctuation">.</span></span><span class="token class-name">ServletException</span><span class="token punctuation">;</span>
<span class="token keyword">import</span> <span class="token namespace">jakarta<span class="token punctuation">.</span>servlet<span class="token punctuation">.</span>annotation<span class="token punctuation">.</span></span><span class="token class-name">WebInitParam</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br><span class="line-number">62</span><br><span class="line-number">63</span><br><span class="line-number">64</span><br><span class="line-number">65</span><br><span class="line-number">66</span><br><span class="line-number">67</span><br><span class="line-number">68</span><br><span class="line-number">69</span><br><span class="line-number">70</span><br><span class="line-number">71</span><br><span class="line-number">72</span><br><span class="line-number">73</span><br><span class="line-number">74</span><br><span class="line-number">75</span><br><span class="line-number">76</span><br><span class="line-number">77</span><br><span class="line-number">78</span><br><span class="line-number">79</span><br><span class="line-number">80</span><br><span class="line-number">81</span><br><span class="line-number">82</span><br><span class="line-number">83</span><br><span class="line-number">84</span><br><span class="line-number">85</span><br><span class="line-number">86</span><br><span class="line-number">87</span><br><span class="line-number">88</span><br><span class="line-number">89</span><br><span class="line-number">90</span><br></div></div><p>最终效果：</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211203214823062.png" alt="image-20211203214823062" loading="lazy"></p>
<h3 id="读写共享参数" tabindex="-1"><a class="header-anchor" href="#读写共享参数" aria-hidden="true">#</a> 读写共享参数</h3>
<p>但凡是域对象<strong>都有</strong>如下3个方法：</p>
<table>
<thead>
<tr>
<th>方法名</th>
...
<tbody>
<tr>
<td><strong>void</strong> setAttribute(<strong>String</strong> name,<strong>Object</strong> value);</td>
<td>往域对象里面添加数据，添加时以key-value形式添加</td>
</tr>
<tr>
<td><strong>Object</strong> getAttribute(<strong>String</strong> name);</td>
<td>根据指定的key读取域对象里面的数据</td>
</tr>
<tr>
<td><strong>void</strong> removeAttribute(<strong>String</strong> name);</td>
<td>根据指定的key从域对象里面删除数据</td>
</tr>
</tbody>
</table>
<p>接下来简单使用以下它</p>
<p>我们再创建一个<code>MyApp2</code></p>
<p>然后在<code>web.xml</code>中建立下相关的映射：</p>
<ul>
<li>MyAPP对应路径：test1</li>
<li>MyApp2对应路径：test2</li>
</ul>
<p>然后在MyApp1的<code>doGet</code>方法中写入如下内容</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
<span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">doGet</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> req<span class="token punctuation">,</span> <span class="token class-name">HttpServletResponse</span> resp<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span><span class="token punctuation">,</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>然后在MyApp2的doGet中写入如下内容</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
<span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">doGet</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> req<span class="token punctuation">,</span> <span class="token class-name">HttpServletResponse</span> resp<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span><span class="token punctuation">,</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>此时，如果我们直接访问/test2 可以看到是null（未赋值）:</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211203131349218.png" alt="image-20211203131349218" loading="lazy"></p>
<p>访问下test1</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211203131536087.png" alt="image-20211203131536087" loading="lazy"></p>
<p>在访问下test2：</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211203131553703.png" alt="image-20211203131553703" loading="lazy"></p>
<p>成功读取到了该对象！</p>
<p>如果你学过相应的前端框架，应该在这时就能够反应过来：这玩意跟<code>rudex</code>的性质非常相似</p>
<h3 id="读取全局配置参数-web-xml中的内容" tabindex="-1"><a class="header-anchor" href="#读取全局配置参数-web-xml中的内容" aria-hidden="true">#</a> 读取全局配置参数（web.xml中的内容）</h3>
<table>
<thead>
<tr>
<th>方法名</th>
...
<tbody>
<tr>
<td><code>String</code> getServletContext().getInitParameter(name);</td>
<td>根据指定的参数名获取参数值</td>
</tr>
<tr>
<td>Enumeration<code>&lt;String&gt;</code> getServletContext().getInitParameterNames();</td>
<td>获取所有参数名称列表</td>
</tr>
</tbody>
</table>
<p>首先，我们在<code>web.xml</code>添加如下内容</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code>    <span class="token comment">&lt;!-- 全局配置参数，因为不属于任何一个servlet，但是所有的servlet都可以通过servletContext读取这个数据 --></span>
<span class="token comment">&lt;!--每个contenxt-param理论上来说应该对应不同的数据--></span>
    ...
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>context-param</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br></div></div><p>然后新建一个MyApp3.java，继承HttpServlet，重写get方法，然后获取相应的内容</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
<span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">doGet</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> req<span class="token punctuation">,</span> <span class="token class-name">HttpServletResponse</span> resp<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span><span class="token punctuation">,</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br></div></div><p>然后配置下xml的路径，为test3</p>
<p>访问test3：成功获取到我们想要的对象</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211203150156627.png" alt="image-20211203150156627" loading="lazy"></p>
<h3 id="使用servletcontext完成请求转发-不是重定向" tabindex="-1"><a class="header-anchor" href="#使用servletcontext完成请求转发-不是重定向" aria-hidden="true">#</a> 使用ServletContext完成请求转发（不是重定向）</h3>
<p>这玩意实际工作中用的比较少，一般都是用重定向，重定向后面再说，这里先放一下原理图</p>
<p><img src="/images/JavaEE/03-Servlet/请求转发和重定向.jpg" alt="请求转发和重定向" loading="lazy"></p>
<p>我们新建两个Java文件：testForward1和testForward2</p>
<p>将他们的路径分配为：<code>/forward1</code>和<code>/forward2</code></p>
<p>然后将1的内容设置为随便返回点什么给客户端，比如返回一个“ServletContext 测试请求转发”</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
<span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">doGet</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> req<span class="token punctuation">,</span> <span class="token class-name">HttpServletResponse</span> resp<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span><span class="token punctuation">,</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
    resp<span class="token punctuation">.</span><span class="token function">setContentType</span><span class="token punctuation">(</span><span class="token string">"text/html;charset=utf-8"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>然后编写testForward2</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
<span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">doGet</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> req<span class="token punctuation">,</span> <span class="token class-name">HttpServletResponse</span> resp<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span><span class="token punctuation">,</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><p>然后我们启动服务、访问forward2，重新定向到了forward1页面的内容，但是链接不变</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211203152524708.png" alt="image-20211203152524708" loading="lazy"></p>
<h3 id="使用servletcontext搜索当前工程目录下面的资源文件-xml-properties" tabindex="-1"><a class="header-anchor" href="#使用servletcontext搜索当前工程目录下面的资源文件-xml-properties" aria-hidden="true">#</a> 使用ServletContext搜索当前工程目录下面的资源文件(XML/Properties)</h3>
<h4 id="基本概念以及classpath-classess" tabindex="-1"><a class="header-anchor" href="#基本概念以及classpath-classess" aria-hidden="true">#</a> 基本概念以及ClassPath（classess）</h4>
<p>还记得我们在老早之前创建的那个resources文件夹吗，资源文件就是放在那里的，我们先新建一个<code>db.properties</code>到该文件夹下：</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211203155322875.png" alt="image-20211203155322875" loading="lazy"></p>
<p>然后填写一些内容：(在这一步你可以先装个mysql-java，名称：mysql-connector-java)</p>
<div class="language-properties ext-properties line-numbers-mode"><pre v-pre class="language-properties"><code><span class="token attr-name">username</span><span class="token punctuation">=</span><span class="token attr-value">root</span>
...
<span class="token attr-name">url</span><span class="token punctuation">=</span><span class="token attr-value">jdbc:mysql://localhost:3306/db1?useUnicode=true&amp;characterEncoding=utf8</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>然后我们点击运行，查看下打包后的路径，这里有可能会出现一个问题，你在相同的路径下找不到那个文件</p>
<p>点击运行，等待运行完毕后，点开当前项目的target文件夹，可以看到我们刚刚写的db文件现在在<strong>classes</strong>目录下存放，我们在java文件夹内写的文件同理</p>
<p>这个classess路径也被称之为<strong>classpath（类路径）</strong></p>
<p><img src="/images/JavaEE/03-Servlet/image-20211203155802117.png" alt="image-20211203155802117" loading="lazy"></p>
<h4 id="可能会遇到的导出问题" tabindex="-1"><a class="header-anchor" href="#可能会遇到的导出问题" aria-hidden="true">#</a> 可能会遇到的导出问题</h4>
<p>​  没有遇到这个问题就不要改<code>pom.xml</code>!</p>
<p>​  没有遇到这个问题就不要改<code>pom.xml</code>!</p>
<p>​  没有遇到这个问题就不要改<code>pom.xml</code>!</p>
<p>​  如果说你在这一部没有看到这个db.properties文件，那么百分之八十是maven的配置有问题（貌似新版不按照下面这样配置也不会出现这样的问题），在当前<code>module</code>的maven配置文件<code>pom.xml</code>中加上如下内容再重新打包即可（如果pom.xml中已经有<code>&lt;build&gt;&lt;/build&gt;</code>了，就在build中加入这两个resources，如果没有，就直接整个copy过去），即可解决该问题</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br></div></div><p><img src="/images/JavaEE/03-Servlet/image-20211203162311727.png" alt="image-20211203162311727" loading="lazy"></p>
<p>看起来没问题，接下来再尝试修改一下，看看是否能生效</p>
<h2 id="使用注解的方式绕重复在xml中写内容来注册servlet" tabindex="-1"><a class="header-anchor" href="#使用注解的方式绕重复在xml中写内容来注册servlet" aria-hidden="true">#</a> 使用注解的方式绕重复在xml中写内容来注册Servlet</h2>
<p>TMD，我说咋感觉缺了点什么，合计又是这p网课老师漏了这最重要的东西</p>
<p>我们先前每注册一个Servlet，就要在web.xml中添加两条记录</p>
<p>这样非常不舒服</p>
<p>现在就有一个解决的方法，可以无需在web.xml中浪费这么多时间的事情，非常方便的 让我们注册好Servlet</p>
<p>首先，随便建一个java文件，然后覆盖粘贴如下内容：</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br></div></div><p>访问这个页面，草有内容！</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211203175447989.png" alt="image-20211203175447989" loading="lazy"></p>
<p>接下来详细讲下这个注解是干什么的吧：</p>
<h3 id="webservlet注解" tabindex="-1"><a class="header-anchor" href="#webservlet注解" aria-hidden="true">#</a> @WebServlet注解</h3>
<p>​  从上面的代码中，我们可以看到，顶部是一个@WebServlet注解，这个也是<strong>Servlet3.0</strong>之后的一个特点，配置注解化了，<strong>不用在web.xml</strong>中在去一个个配置了，但是<strong>实现的功能是相同的</strong>，我们可以看到，<strong>@WebServlet中的一些属性就是我们在创建的过程中设置的</strong>。其中@WebServlet中的每个属性的解释如下：</p>
<p>这些标签名（没见过的）会在之后的学习中逐一解释</p>
<table>
<thead>
<tr>
<th>属性名</th>
...
<td>name</td>
<td>String</td>
<td>指定Servlet 的 name 属性，等价于<code>&lt;servlet-name&gt;</code>标签</td>
</tr>
<tr>
<td>value</td>
<td>String[]</td>
...
<td>loadOnStartup</td>
<td>int</td>
<td>指定 Servlet 的加载顺序，等价于 <code>&lt;load-on-startup&gt;</code>标签，0或者大于0，项目启动是就加载，大于0时，数字越小，启动优先级越高</td>
</tr>
<tr>
<td>initParams</td>
<td>WebInitParam[]</td>
<td>一组 Servlet 初始化参数，等价于<code>&lt;init-param&gt;</code>标签</td>
</tr>
<tr>
<td>asyncSupported</td>
<td>boolean</td>
<td>声明 Servlet 是否支持异步操作模式，等价于<code>&lt;async-supported&gt;</code> 标签，不设置时默认值为false</td>
</tr>
<tr>
<td>description</td>
<td>String</td>
<td>Servlet 的描述信息，等价于 <code>&lt;description&gt;</code>标签</td>
</tr>
<tr>
<td>displayName</td>
<td>String</td>
<td>Servlet 的显示名，等价于<code>&lt;display-name&gt;</code>标签</td>
</tr>
</tbody>
</table>
<p>接下来只先讲解以下urlPatterns属性</p>
<h3 id="urlpatterns" tabindex="-1"><a class="header-anchor" href="#urlpatterns" aria-hidden="true">#</a> urlPatterns</h3>
<p>我们之前配置的是</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span>
  description <span class="token operator">=</span> <span class="token string">"My First Servlet"</span><span class="token punctuation">,</span> 
  urlPatterns <span class="token operator">=</span> <span class="token punctuation">{</span> <span class="token string">"/HelloServlet"</span><span class="token punctuation">}</span><span class="token punctuation">,</span> 
  initParams <span class="token operator">=</span> <span class="token punctuation">{</span> 
    <span class="token annotation punctuation">@WebInitParam</span><span class="token punctuation">(</span>name <span class="token operator">=</span> <span class="token string">"name"</span><span class="token punctuation">,</span> value <span class="token operator">=</span> <span class="token string">"join"</span><span class="token punctuation">)</span>
  <span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>如果改成这样：那么访问<code>/StillMe</code>也可以到这，就像是之前xml配置多个mapping一样</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span>
  description <span class="token operator">=</span> <span class="token string">"My First Servlet"</span><span class="token punctuation">,</span> 
  ...
  initParams <span class="token operator">=</span> <span class="token punctuation">{</span> 
    <span class="token annotation punctuation">@WebInitParam</span><span class="token punctuation">(</span>name <span class="token operator">=</span> <span class="token string">"name"</span><span class="token punctuation">,</span> value <span class="token operator">=</span> <span class="token string">"join"</span><span class="token punctuation">)</span>
  <span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>接下来详细说下它的匹配规则</p>
<ul>
<li>
<p><code>精确匹配</code>：也就是我们在上面配置的匹配规则，需要完全相等才能匹配成功，这也是我们经常发生错误的地方，请求Servlet时的大小写拼写错误导致404；</p>
</li>
<li>
<p><code>路径匹配</code>：比如想匹配以rest开头的所有请求，可以写成&quot;/rest/<em>&quot;，其格式为以’/‘字符开头，并以’/</em>'结尾；</p>
</li>
<li>
<p><code>扩展名匹配</code>：比如想匹配所有以.do结尾的请求，可以写成&quot;<em>.do&quot;，其格式为以’</em>.’，后面跟上扩展名；</p>
</li>
<li>
<p><code>缺省匹配</code>：映射路径为&quot;/&quot;，那么这个Servlet就是当前应用的缺省Servlet，默认处理无法匹配到虚拟路径的请求。</p>
<p>需要注意的是，<strong>路径匹配和扩展匹配无法混合使用</strong>，即urlPattern无法写成&quot;<code>/rest/*.do&quot;</code>；</p>
</li>
</ul>
<p>​  这也是初学者容易感到困惑的地方</p>
<p>​  Servlet的虚拟路径匹配并不是完全的按照正则来匹配的</p>
<p>​  虽然路径匹配和扩展匹配是按照正则中的通配符(*)来匹配的，这也是部分人可以会写出特定的正则，但是却不是一个合法的虚拟路径</p>
<p>​  Servlet容器收到请求后，会将请求从上下文路径（通过<code>request.getContextPath()</code>获取的）处截断，<strong>使用剩余的部分来进行路径匹配</strong></p>
<p>​  比如请求url为<a href="http://localhost:8080/FirstProject/HelloServlet" target="_blank" rel="noopener noreferrer">http://localhost:8080/FirstProject/HelloServlet<ExternalLinkIcon/></a>，<strong>那么Servlet容器就会使用&quot;/HelloServlet&quot;来匹配Servlet</strong></p>
<h4 id="优先级问题" tabindex="-1"><a class="header-anchor" href="#优先级问题" aria-hidden="true">#</a> 优先级问题</h4>
<p>优先级为：</p>
<p>​  精确匹配&gt;路径匹配&gt;扩展名匹配&gt;缺省匹配，<strong>Servlet容器会从优先级高的虚拟路径开始匹配，匹配到后就会立刻将请求交给对应的Servlet来处理</strong>，不会再关心其他Servlet的虚拟路径是否会匹配成功。</p>
<p>下面来一组例子：</p>
<table>
<thead>
<tr>
<th style="text-align:center">urlPatterns</th>
<th style="text-align:center">Servlet Name</th>
</tr>
</thead>
<tbody>
<tr>
<td style="text-align:center"><code>/abc/*</code>---路径匹配</td>
<td style="text-align:center">Servlet1</td>
</tr>
<tr>
<td style="text-align:center"><code>/</code>---缺省匹配</td>
<td style="text-align:center">Servlet2</td>
</tr>
<tr>
<td style="text-align:center"><code>/abc</code>---精准匹配</td>
<td style="text-align:center">Servlet3</td>
</tr>
<tr>
<td style="text-align:center"><code>*.do</code>---扩展名匹配</td>
<td style="text-align:center">Servlet4</td>
</tr>
</tbody>
</table>
<ul>
<li>当请求去除上下文路径后路径为：<code>/abc/a.html</code>时，根据上述规则，会调用<strong>Servlet1</strong>；</li>
<li>请求为：<code>/abc</code>，根据匹配优先级，会调用<strong>Servlet3</strong>；</li>
<li>请求为：<code>/abc/a.do</code>，会匹配到<code>/abc/*</code>、<code>*.do</code>，但根据匹配优先级，会调用<strong>Servlet1</strong>；</li>
<li>请求为：<code>/a.do</code>，会匹配到<code>/</code>、<code>*.do</code>，但根据匹配优先级，会调用<strong>Servlet4</strong>；</li>
</ul>
<h4 id="测试缺省匹配" tabindex="-1"><a class="header-anchor" href="#测试缺省匹配" aria-hidden="true">#</a> 测试缺省匹配</h4>
<p>为了验证下缺省匹配，我们创建两个文件</p>
<p>第一个文件使用精准匹配：<code>/mybuild</code></p>
<p>第二个文件使用缺省匹配：<code>/</code></p>
<p>接下来打来浏览器尝试下访问<code>/mybuild</code>，看是哪个文件匹配上了</p>
<p>代码部分：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">//缺省的</span>
<span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br></div></div><p>当我们访问到<code>mybuild</code>时，显示的内容</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211203202601697.png" alt="image-20211203202601697" loading="lazy"></p>
<p>好了，下一个问题，到我们访问一个不存在的页面时，返回的404是怎么来的</p>
<p>在此之前，我们先把那个缺省匹配删掉</p>
<h3 id="缺省-关于静态文件和404-not-found界面的处理方式" tabindex="-1"><a class="header-anchor" href="#缺省-关于静态文件和404-not-found界面的处理方式" aria-hidden="true">#</a> 缺省-关于静态文件和404 Not Found界面的处理方式</h3>
<p>当我们访问一个我们未定义的页面</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211203202937866.png" alt="image-20211203202937866" loading="lazy"></p>
<p>这里会抛出一个404，提示没有该文件，这个玩意是怎么来的？我们又该怎么样去自定义？</p>
<p>在此之前，我们先回顾一个点：</p>
<p>我们先在web目录下新建一个文件<code>mybuild.html</code></p>
<p>文件内容随意：</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211203203311535.png" alt="image-20211203203311535" loading="lazy"></p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>然后定义一个java文件，指向<code>/mybuild</code></p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span>
        urlPatterns <span class="token operator">=</span> <span class="token punctuation">{</span><span class="token string">"/mybuild"</span><span class="token punctuation">}</span><span class="token punctuation">,</span>
        name <span class="token operator">=</span> <span class="token string">"myBuild"</span><span class="token punctuation">,</span>
        description <span class="token operator">=</span> <span class="token string">"testBuild"</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> testparrten1 <span class="token keyword">extends</span> <span class="token class-name">HttpServlet</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div><p>接下来，我们访问mybuild</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211203203541935.png" alt="image-20211203203541935" loading="lazy"></p>
<p>跳出了一个这个</p>
<p>那访问mybuild.html呢？</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211203203608836.png" alt="image-20211203203608836" loading="lazy"></p>
<p>其实我们这个时候的想法应该是，服务器遵循文件的意愿，在用户输入<code>/mybuild</code>时访问<code>mybuild.html</code>，因为没多少人愿意花心情去整一个Java文件写多美观的页面，更多时候我们的Java文件应该是作为一个数据接口使用的</p>
<p>​  其实，<strong>客户端的每个请求，都是由Servlet容器根据虚拟路径的匹配规则来进行处理的，包括静态资源</strong>。</p>
<p>​  我们能通过servlet方便简单的开发网站，是因为我们站在了巨人的肩膀上，下面我们一起来看下Sun公司都为我们开发者提前做了些什么工作。</p>
<ul>
<li>Tomcat会为项目配置一个缺省的Servlet（如果项目中自行配置，则不会生效），配置文件在tomcat安装目录下conf目录中的web.xml文件中，具体内容如下，缺省的Servlet名为<code>DefaultServlet</code>。</li>
</ul>
<p>打开这个文件，能看到如下内容</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>servlet</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><p>​   客户端请求静态资源文件时，也是由缺省的Servlet处理的（自己单独配置Servlet除外），如果请求文件能找到，就会将页面通过HttpServletResponse对象以流的方式返回给客户端，否则报404错误。</p>
<p>​  不过讲到这里，大家可以自己试一试配置了缺省Servelt时</p>
<p>​  访问<code>mybuild.html</code>的情况（会调用SelfDefaultServlet），但是，如果我们在浏览器中输入<code>http://localhost:8080/项目名称/index.jsp</code>（index.jsp是创建的第一个jsp页面）呢？会是什么样一个结果？也是调用缺省的Servlet么？真是的运行结果如下：</p>
<p><img src="/images/JavaEE/03-Servlet/image-20211203204139560.png" alt="image-20211203204139560" loading="lazy"></p>
<p>​  这是什么原因？</p>
<p>​  为什么不是调用缺省的servlet了？</p>
<p>​  这是因为<strong>tomcat除了缺省Serlvet外</strong>，还给我们<strong>提供一个处理jsp文件的Servlet</strong>，配置如下，因为<strong>后缀匹配的优先级高于缺省的Servlet</strong>，<strong>所以访问JSP的时候需要交由JspServlet来处理</strong>（JSP因为可能包含Java代码，所以第一次执行的时候需要先编译，这个工作由JspServlet完成）</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token generics"><span class="token punctuation">&lt;</span>servlet<span class="token punctuation">></span></span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><p>接着来看下他们两的mapping</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token operator">&lt;</span>servlet<span class="token operator">-</span>mapping<span class="token operator">></span>
...
<span class="token operator">&lt;</span><span class="token operator">/</span>servlet<span class="token operator">-</span>mapping<span class="token operator">></span>
    ...
    <span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span> <span class="token class-name">The</span> mappings <span class="token keyword">for</span> the JSP servlet <span class="token operator">--</span><span class="token operator">></span>
<span class="token operator">&lt;</span>servlet<span class="token operator">-</span>mapping<span class="token operator">></span>
 ...
 <span class="token operator">&lt;</span><span class="token operator">/</span>servlet<span class="token operator">-</span>mapping<span class="token operator">></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><p>是不是发现了什么</p>
<p>jsp的匹配是<code>&lt;url-pattern&gt;*.jsp&lt;/url-pattern&gt;</code></p>
<p>而默认缺省处理是<code>&lt;url-pattern&gt;/&lt;/url-pattern&gt;</code></p>
<p>一个是扩展名匹配，一个是缺省匹配</p>
<p>到这里也就好说明404这个玩意是怎么来的了</p>
<p>就是通过缺省匹配查找相应的文件，找不到？那就返回404</p>
<p>​同时，我们可以自由的覆盖它，因为它的优先级是最低的，所以我们在测试<code>mybuild</code>和<code>mybuild.html</code>时，<code>mybuild</code>会优先展示的原因</p>
</template>
