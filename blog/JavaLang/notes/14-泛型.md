...
![image-20211109130551071](/images/Java/14-泛型/image-20211109130551071.png)
...
1. `interface List<T>`,`public class HashSet<E>{}`...
   - **说明: `T,E`只能是引用类型**
   - 看看下面哪条语句是正确的
     - [x] `List<Inetger> list = new ArrayList<Integer>()` 正确
...
![image-20211109204858150](/images/Java/14-泛型/image-20211109204858150.png)

这里选择5.7即可,原理先不管

![image-20211109204922665](/images/Java/14-泛型/image-20211109204922665.png)

会提示下载,确定即可

![image-20211109205151728](/images/Java/14-泛型/image-20211109205151728.png)

这里要等待他下载一波,不挂梯子的话速度比较慢..

下载完毕后按照正常情况下来说他的左边应该会出现一个绿色的小箭头,表示可以直接运行这个

![image-20211109210410535](/images/Java/14-泛型/image-20211109210410535.png)

但是可以看到,并没有

![image-20211109210437887](/images/Java/14-泛型/image-20211109210437887.png)
...
![image-20211109210659613](/images/Java/14-泛型/image-20211109210659613.png)

然后就能得到这些,好了,接下来直接点箭头或者快捷键跑就行了

![image-20211109210745362](/images/Java/14-泛型/image-20211109210745362.png)
