...
![image-20211105201849329](/images/Java/13-集合/image-20211105201849329.png)
...
4. iterator的执行原理
   ![image-20211105213808338](/images/Java/13-集合/image-20211105213808338.png)
...
![image-20211105214454452](/images/Java/13-集合/image-20211105214454452.png)
...
3. 实现了List接口的类有很多很多，不仅仅只有三个
   ![image-20211105224009265](/images/Java/13-集合/image-20211105224009265.png)
...
![image-20211106140335834](/images/Java/13-集合/image-20211106140335834.png)
...
3. JdkDocs中Set接口的实现类有：
   ![image-20211106162421987](/images/Java/13-集合/image-20211106162421987.png)
...
![image-20211106220412281](/images/Java/13-集合/image-20211106220412281.png)
...
![image-20211107141822683](/images/Java/13-集合/image-20211107141822683.png)
...
9. 补充说明：我们每加入一个元素（Node(key,value,next,hash)），都会调用的一个方法：
   ...
   - 复现添加元素调用
     ...
     ![image-20211107220801856](/images/Java/13-集合/image-20211107220801856.png)
     可以看到，每添加一个元素下面的size就会+1，直到13的时候
     ![image-20211107220911453](/images/Java/13-集合/image-20211107220911453.png)
...
6. 第一次添加时，直接将table数组扩容到16，存放的节点类型是LinkedHashSet$Entry，table的数据类型为LinkedHashSet$Node[]（数组的多态,Entry继承于Node，继承关系是在静态内部类完成的）
7. 总结，底层的添加和扩容机制和HashMap一样，唯一不同的就是，他有一套双向链表结构关联着每个元素

![image-20211107224244465](/images/Java/13-集合/image-20211107224244465.png)
...
![image-20211107230539472](/images/Java/13-集合/image-20211107230539472.png)
...
9. Map存放数据的key-value示意图，一对k-v是放在一个Node中，又因为Node实现了Entry接口，所以有些书上也说一对k-v就是一个Entry
   ![image-20211108140724685](/images/Java/13-集合/image-20211108140724685.png)
...
![image-20211108170235532](/images/Java/13-集合/image-20211108170235532.png)
...
![image](/images/Java/13-集合/image-mind.svg)
