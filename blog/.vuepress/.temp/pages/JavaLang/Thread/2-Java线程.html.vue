<template><h2 id="创建和运行线程" tabindex="-1"><a class="header-anchor" href="#创建和运行线程" aria-hidden="true">#</a> 创建和运行线程</h2>
<h3 id="方法一直接使用thread" tabindex="-1"><a class="header-anchor" href="#方法一直接使用thread" aria-hidden="true">#</a> 方法一直接使用Thread</h3>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><h3 id="方法二使用runnable配合thread" tabindex="-1"><a class="header-anchor" href="#方法二使用runnable配合thread" aria-hidden="true">#</a> 方法二使用Runnable配合Thread</h3>
<p>把<em>线程</em>和<em>任务</em>(要执行的代码分开)</p>
<ul>
<li>Thread代表线程</li>
<li>Runnable可运行的任务（线程要执行的代码）</li>
</ul>
...
<span class="token comment">//        启动线程</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><p>当然，我们可以用<code>lambda</code>表达式来精简代码</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MyThread</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><h3 id="方法三futuretask配合thread" tabindex="-1"><a class="header-anchor" href="#方法三futuretask配合thread" aria-hidden="true">#</a> 方法三FutureTask配合Thread</h3>
<p><code>FutureTask</code>能够接收<code>Callable</code>类型的参数，用来处理有返回结果的情况</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">import</span> <span class="token namespace">lombok<span class="token punctuation">.</span>extern<span class="token punctuation">.</span>slf4j<span class="token punctuation">.</span></span><span class="token class-name">Slf4j</span><span class="token punctuation">;</span>
...
<span class="token comment">//        主线程阻塞，同步等待task执行完毕的结果</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br></div></div><p>运行结果：</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>16:30:47.991 [t3] DEBUG c.FutureTask - Hello

16:30:47.995 [main] DEBUG c.FutureTask - 结果是：100
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><h3 id="查看进程线程的方法" tabindex="-1"><a class="header-anchor" href="#查看进程线程的方法" aria-hidden="true">#</a> 查看进程线程的方法</h3>
<ul>
<li>Windows</li>
</ul>
<blockquote>
<p>Windows下，可以使用<code>tasklist</code>查看进程线程, 但是这个命令不能查看到线程的状态,可以使用<code>tasklist /FI &quot;STATUS eq RUNNING&quot;</code>来查看进程线程的状态</p>
<p>可以使用<code>taskkill</code>来杀死进程</p>
</blockquote>
<ul>
<li>Linux</li>
</ul>
<blockquote>
<p>Linux下，可以使用<code>ps -ef</code>查看进程线程, 但是这个命令不能查看到线程的状态,可以使用<code>ps -ef | grep java</code>来查看进程线程的状态</p>
<p>可以使用<code>kill -9</code>来杀死进程</p>
<p>可以使用<code>top</code>命令来动态的查看线程的目前状态</p>
<p>可以使用<code>top</code>按大写H切换是否显示进程，<code>top -H -p &lt;PID&gt;</code>查看某个进程(PID)的所有信息</p>
</blockquote>
<ul>
<li>Java</li>
</ul>
<blockquote>
<p>Java可以使用<code>jps</code>查看所有Java进程</p>
<p><code>jstack &lt;PID&gt;</code> 用来看某个Java进程(PID)的所有线程状态(只能抓取这个瞬间的快照)</p>
<p><code>jconsole</code> 来查看某个java进程中线程的运行情况(图形页面 之前用过这里就不做说明了)</p>
</blockquote>
<h2 id="原理之线程运行" tabindex="-1"><a class="header-anchor" href="#原理之线程运行" aria-hidden="true">#</a> 原理之线程运行</h2>
<h3 id="栈与栈帧" tabindex="-1"><a class="header-anchor" href="#栈与栈帧" aria-hidden="true">#</a> 栈与栈帧</h3>
<p>Java Virtual Machine Stacks(Java虚拟栈)</p>
<p>在JVM中，由堆、栈、方法区所组成，其中栈内存是给谁用的呢？其实就是给线程用的， 每个线程启动后，虚拟机就会为其分配一块栈内存</p>
<ul>
<li>每个栈由多个栈帧(Frame)组成，对应每次方法调用所占的内存</li>
<li>每个线程只能有一个活动栈帧，对应着当前正在执行的那个方法</li>
</ul>
<p>为了更好地了解这个内容，我们来写一写代码</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">import</span> <span class="token namespace">lombok<span class="token punctuation">.</span>extern<span class="token punctuation">.</span>slf4j<span class="token punctuation">.</span></span><span class="token class-name">Slf4j</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MyThread</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">private</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">method1</span><span class="token punctuation">(</span><span class="token keyword">int</span> x<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        <span class="token class-name">Object</span> method2 <span class="token operator">=</span> <span class="token function">method2</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span>method2<span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="highlight-lines"><br><br><br><br><br><div class="highlight-line">&nbsp;</div><br><br><br><br><br><br><br><br><br><br><br><br><br><br></div><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br></div></div><p>接着，我们在main方法上打debug，然后看看内容</p>
<p>首先是可以看到x在栈帧内部的值</p>
<p><img src="/images/JavaThread/2-Java线程/1642237335675.png" alt="栈帧1" loading="lazy"></p>
<p>接着能看到y的值</p>
<p><img src="/images/JavaThread/2-Java线程/1642237476489.png" alt="栈帧2" loading="lazy"></p>
<p>继续执行，就可以看到我们的Object被创建出来了，栈帧内同理显示了对应的值</p>
<p><img src="/images/JavaThread/2-Java线程/1642237536732.png" alt="栈帧3" loading="lazy"></p>
<p>可能这样不是特别直观，接下来用图解的方式来说明</p>
<ul>
<li>首先在加载的时候，我们的所有内容都会被加载到方法区</li>
</ul>
<p><img src="/images/JavaThread/2-Java线程/1642237635205.png" alt="原理1" loading="lazy"></p>
<p>然后我们的main线程启动，并调用method1的画风是这样的</p>
<p><img src="/images/JavaThread/2-Java线程/1642237846435.png" alt="原理2" loading="lazy"></p>
<p>这里的程序计数器是用来记录下一个要执行啥，我们在这一步已经执行完method1的main中的method方法，接下来要调用method中的对应方法</p>
<p><img src="/images/JavaThread/2-Java线程/1642237953000.png" alt="原理3" loading="lazy"></p>
<p>自此，已经执行完毕method1内的<code>int y = x +1;</code>接下来要执行它之中调用method2的方法</p>
<p><img src="/images/JavaThread/2-Java线程/1642238083279.png" alt="原理4" loading="lazy"></p>
<p>在method2被调用完毕后，它这里面的内存就没啥用了，因此会被释放掉</p>
<p><img src="/images/JavaThread/2-Java线程/1642238125268.png" alt="原理5" loading="lazy"></p>
<p>接下来是执行打印，打印完毕后，我们的method1也完成了，它的内存也会被释放掉</p>
<p><img src="/images/JavaThread/2-Java线程/1642238196793.png" alt="原理6" loading="lazy"></p>
<p>接下来主方法也没啥要做的，自此程序结束</p>
<h3 id="线程的上下文切换-thread-context-switch" tabindex="-1"><a class="header-anchor" href="#线程的上下文切换-thread-context-switch" aria-hidden="true">#</a> 线程的上下文切换(Thread Context Switch)</h3>
<p>因为如下原因导致CPU不再执行当前线程，转而执行另一个线程的代码</p>
<ul>
<li>线程的CPU时间用完</li>
<li>垃圾回收</li>
<li>有更高优先级的线程需要运行</li>
...
<p>当Thread Context Switch发生时，需要由操作系统保存当前线程状态，并恢复另一个线程的状态，Java中对应的概念就是程序计数器(Program Counter Register)，
它的作用是记住下一条JVM指令的执行地址，是线程私有的</p>
<ul>
<li>状态程序包括程序计数器，虚拟机栈内存中的每个栈帧信息，如局部变量、操作数栈、返回地址等</li>
<li>Context Switch频繁发生会影响性能</li>
</ul>
<p><img src="/images/JavaThread/2-Java线程/1642238680325.png" alt="Context Switch" loading="lazy"></p>
<h2 id="线程的方法" tabindex="-1"><a class="header-anchor" href="#线程的方法" aria-hidden="true">#</a> 线程的方法</h2>
<h3 id="常用方法一览" tabindex="-1"><a class="header-anchor" href="#常用方法一览" aria-hidden="true">#</a> 常用方法一览</h3>
<table>
<thead>
<tr>
...
<td style="text-align:left">启动一个新线程</td>
<td>启动一个新线程，在新的线程 运行run方法中的代码</td>
<td>start 方法只是让线程进入就绪，里面代码不一定立刻 运行（CPU 的时间片还没分给它）。<br/>每个线程对象的 start方法只能调用一次，如果调用了多次会出现IllegalThreadStateException</td>
</tr>
<tr>
<td style="text-align:center">run()</td>
<td style="text-align:left"></td>
<td>新线程启动后会调用的方法</td>
<td>如果在构造 Thread 对象时传递了 Runnable 参数，则线程启动后会调用 Runnable 中的 run 方法，否则默 认不执行任何操作。但可以创建 Thread 的子类对象， 来覆盖默认行为</td>
</tr>
<tr>
<td style="text-align:center">join()</td>
<td style="text-align:left"></td>
<td>等待线程运行结束 join(long n)</td>
...
<td style="text-align:left"></td>
<td>获取线程状态 Java 中线程状态</td>
<td>Java 中线程状态是用 6 个 enum 表示，分别为：<br /><code>NEW</code><br /><code>RUNNABLE</code><br /><code>BLOCKEDWAITING</code><br /><code>TIMED_WAITING</code><br /><code>TERMINATED</code></td>
</tr>
<tr>
...
<td style="text-align:left"></td>
<td>打断线程</td>
<td>如果被打断线程正在 sleep，wait，join状态下 <br />会导致被打断的线程抛出 InterruptedException，并清除 打断标记<br />如果打断的正在运行的线程，则会设置打断标记<br />park 的线程被打断，也会设置打断标记</td>
</tr>
<tr>
...
<td>休眠时让出cpu的时间片给其它线程</td>
</tr>
<tr>
<td style="text-align:center">yield()</td>
<td style="text-align:left">static</td>
<td>提示线程调度器 让出当前线程对 CPU的使用</td>
<td>主要是为了测试和调试 不一定成功</td>
</tr>
</tbody>
</table>
<h3 id="sleep" tabindex="-1"><a class="header-anchor" href="#sleep" aria-hidden="true">#</a> Sleep</h3>
<ol>
<li>调用Sleep会让当前线程从Running进入Time Waiting状态</li>
<li>其他线程可以使用<code>interrupt</code>方法打断正在睡眠的线程，这时sleep会抛出<code>InterruptedException</code></li>
<li>睡眠结束后的线程未必能立刻得到执行</li>
<li>建议用<code>TimeUnit</code>的<code>sleep</code>代替<code>Thread.sleep</code>来获取更好的可读性</li>
</ol>
<blockquote>
<p>实例</p>
</blockquote>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MyThread</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br></div></div><p>结果：</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>17:50:13.539 [MyThread] INFO c.MyThread - MyThreadStart!
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><p>当然，我们可以通过<code>TimeUnit</code>来更优雅的休眠</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">import</span> <span class="token namespace">lombok<span class="token punctuation">.</span>extern<span class="token punctuation">.</span>slf4j<span class="token punctuation">.</span></span><span class="token class-name">Slf4j</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MyThread</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token class-name">Thread</span> myThread <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Thread</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">-></span> <span class="token punctuation">{</span>
            ...
            log<span class="token punctuation">.</span><span class="token function">info</span><span class="token punctuation">(</span><span class="token string">"{}Start!"</span><span class="token punctuation">,</span> name<span class="token punctuation">)</span><span class="token punctuation">;</span>
            <span class="token keyword">try</span> <span class="token punctuation">{</span>
<span class="token comment">//                这里是 延迟两秒 更美观</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="highlight-lines"><br><br><br><br><br><br><br><br><br><br><div class="highlight-line">&nbsp;</div><div class="highlight-line">&nbsp;</div><br><br><br><br><br><br><br><br><br><br><br></div><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br></div></div><h3 id="yield" tabindex="-1"><a class="header-anchor" href="#yield" aria-hidden="true">#</a> Yield</h3>
<ol>
<li>调用yield会让当前线程从running状态进入到Runnable状态，然后调度器执行其他线程</li>
<li>礼让，不一定成功，具体地实现由CPU来决定</li>
</ol>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MyThread</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><h3 id="线程优先级" tabindex="-1"><a class="header-anchor" href="#线程优先级" aria-hidden="true">#</a> 线程优先级</h3>
<ul>
<li>线程优先级会提示(hint)调度器会优先调度该线程，但它仅仅只是一个提示，调度区(CPU)可以忽略它</li>
<li>如果CPU比较忙，那么优先级高的线程将会获取更多的时间片，但CPU闲暇的时候，这玩意没有任何作用</li>
<li>比较不靠谱，一般情况下用的也比较少</li>
</ul>
<blockquote>
<p>例子</p>
</blockquote>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">TestHint</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br></div></div><p>正常情况下他们两应该是差不多的时间执行完毕，你可以在Thread2内加一个<code>Thread.yield()</code>来手动让出查看效果，这里我就不演示了</p>
<p>或者说通过设定线程优先级的方式，来让我们的Thread2优先执行</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">import</span> <span class="token namespace">lombok<span class="token punctuation">.</span>extern<span class="token punctuation">.</span>slf4j<span class="token punctuation">.</span></span><span class="token class-name">Slf4j</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">TestHint</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        thread1<span class="token punctuation">.</span><span class="token function">setPriority</span><span class="token punctuation">(</span><span class="token class-name">Thread</span><span class="token punctuation">.</span>MIN_PRIORITY<span class="token punctuation">)</span><span class="token punctuation">;</span>
        thread2<span class="token punctuation">.</span><span class="token function">setPriority</span><span class="token punctuation">(</span><span class="token class-name">Thread</span><span class="token punctuation">.</span>MAX_PRIORITY<span class="token punctuation">)</span><span class="token punctuation">;</span>
        thread1<span class="token punctuation">.</span><span class="token function">start</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        thread2<span class="token punctuation">.</span><span class="token function">start</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>

    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="highlight-lines"><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><div class="highlight-line">&nbsp;</div><div class="highlight-line">&nbsp;</div><br><br><br><br><br></div><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br></div></div><p>这里很明显地能看到，线程2比线程1早了一大堆数值提前完成内容</p>
<p><img src="/images/JavaThread/2-Java线程/1642241640367.png" alt="Thread" loading="lazy"></p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br></div></div><p>运行结果是非常显而易见的，主线程最终获取到的i的值为0，因为子线程休眠1秒，要1秒后才能取到数据</p>
<p>那如果我想要主线程获取到最行的值呢？目前有两种解决方法</p>
<ul>
<li>主线程也用Thread.sleep，但是这样的话耦合性就太高了，因为我们并不知道我子线程执行到底要多少时间...</li>
<li>所以就可以用上join了
<ul>
<li>join：让当前线程等待某个线程执行完毕，也就是阻塞</li>
</ul>
</li>
</ul>
<p>代码：</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><h3 id="join的应用实例-同步应用" tabindex="-1"><a class="header-anchor" href="#join的应用实例-同步应用" aria-hidden="true">#</a> Join的应用实例：同步应用</h3>
<p>我们实际开发过程中，往往会遇到一堆线程需要同步的，这里简单演示下，如何使用join更高效的完成线程同步</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span></span><span class="token class-name">Project</span><span class="token punctuation">.</span>thread<span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MyThread</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br></div></div><p>你觉得主线程的耗时是多少呢？现在无非就两个选择，2s和3s，接下来看看实际情况</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>18:47:28.266 [thread1] INFO c.MyThread - thread1启动了
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><p>也就是</p>
<p><img src="/images/JavaThread/2-Java线程/1642243700670.png" alt="ThreadJoin" loading="lazy"></p>
<h3 id="join设定最大时间" tabindex="-1"><a class="header-anchor" href="#join设定最大时间" aria-hidden="true">#</a> Join设定最大时间</h3>
<p>语法：<code>thread实例对象.join(毫秒数)</code>即可，如果说超过了时间，就不等了，继续运行当前线程（join不会打断线程）</p>
<h3 id="interrupt打断阻塞中的sleep、wait、join的线程" tabindex="-1"><a class="header-anchor" href="#interrupt打断阻塞中的sleep、wait、join的线程" aria-hidden="true">#</a> interrupt打断阻塞中的sleep、wait、join的线程</h3>
<p>如果说打断阻塞状态的线程，会触发线程内部的InterruptedException异常抛出</p>
<p>这里以sleep为例</p>
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>18:59:07.786 [Thread-0] INFO c.MyThread - 子线程执行异常，sleep interrupted
18:59:07.786 [main] DEBUG c.MyThread - 打断状态：false
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>首先 可以知道的是，打断了一个处于阻塞状态的线程，然后获取<strong>打断标记</strong>的时候<code>thread.isInterrupted()</code>返回结果为false</p>
<p>相当于可以知道我们这个子线程在被打断后是一个继续运行(没有阻塞的内容)还是说终止(有阻塞内容)的情况</p>
<p>并且，该操作会造成线程内的<code>InterruptedException</code>异常触发</p>
<h3 id="interrupt打断正常的线程" tabindex="-1"><a class="header-anchor" href="#interrupt打断正常的线程" aria-hidden="true">#</a> interrupt打断正常的线程</h3>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>
<span class="token annotation punctuation">@Slf4j</span><span class="token punctuation">(</span>topic <span class="token operator">=</span> <span class="token string">"c.MyThread"</span><span class="token punctuation">)</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MyThread</span> <span class="token punctuation">{</span>
...
<span class="token comment">//                DO Nothing</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br></div></div><p>可以看到，我们获取到的打断状态为<strong>true</strong>，但是该线程却并没有因此而结束运行，而是一直再运行</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>9:01:58.559 [main] DEBUG c.MyThread - 打断状态：true
......程序并未停止，因为子线程没有结束，打断不等于将线程结束
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>那么有没有办法让被打断的普通线程停止运行呢？</p>
<p>其实是有的，因为打断标记在我我们调用了打断之后，其值将会变为true(如果没有调用的话则是false)，所以说可以通过这一点来在线程内部做一点事情</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>
<span class="token annotation punctuation">@Slf4j</span><span class="token punctuation">(</span>topic <span class="token operator">=</span> <span class="token string">"c.MyThread"</span><span class="token punctuation">)</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MyThread</span> <span class="token punctuation">{</span>
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>19:10:37.056 [main] DEBUG c.MyThread - 打断状态：true
19:10:37.056 [t1] INFO c.MyThread - 线程被中断
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h3 id="interrupt实例-两阶段终止模式" tabindex="-1"><a class="header-anchor" href="#interrupt实例-两阶段终止模式" aria-hidden="true">#</a> interrupt实例：两阶段终止模式</h3>
<blockquote>
<p>两阶段种终止模式(Two Phase Termination)</p>
<p>例如我们想在一个线程T1内优雅地终止T2线程（这里优雅指的是是给T2一个料理后事的机会）</p>
</blockquote>
<p>先来看看错误的思路：</p>
<ol>
<li>使用线程对象的<code>stop()</code>方法停止线程
<ul>
<li>stop方法会真正地杀死线程，这个时候如果线程锁住了共享资源，那么它在被杀死后就再也没有机会释放锁，其他线程将永远无法获取锁</li>
</ul>
</li>
<li>使用System.exit(int)方法停止线程
<ul>
<li>目的仅仅是停止一个线程，如果使用了这个方法，会结束当前的所有线程，让进程终止</li>
</ul>
</li>
</ol>
<p>再来看看两阶段终止模式</p>
<p><img src="/images/JavaThread/2-Java线程/1642245490789.png" alt="两阶段终止模式" loading="lazy"></p>
<p>实现也是非常地简单，注意这个两阶段终止模式，以后要用的</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>
<span class="token annotation punctuation">@Slf4j</span><span class="token punctuation">(</span>topic <span class="token operator">=</span> <span class="token string">"c.MyThread"</span><span class="token punctuation">)</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MyThread</span> <span class="token punctuation">{</span>
...
<span class="token comment">//                  在 log.info("执行监控线程");这行代码内也是</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br></div></div><p>运行结果：</p>
<p><img src="/images/JavaThread/2-Java线程/1642246422569.png" alt="两阶段终止打断模式" loading="lazy"></p>
<h3 id="thread-isinterrupted和普通的isinterrupted的区别" tabindex="-1"><a class="header-anchor" href="#thread-isinterrupted和普通的isinterrupted的区别" aria-hidden="true">#</a> Thread.isInterrupted和普通的isInterrupted的区别</h3>
<p>正常情况下不会直接用<code>Thread.isInterrupted</code>而是用<code>Thread.currentThread().isInterrupted()</code>，除非你对线程非常熟悉，否则不要直接用</p>
<p><code>Thread.isInterrupted</code>会将当前线程的打断标记清除，清除是什么概念呢？</p>
<ul>
<li>如果当前线程的打断标记为<code>true</code>,则用了这个方法后,获取到的值为<code>true</code>，同时线程的打断标记将会变为<code>false</code></li>
<li>如果当前线程当前的打断标记为<code>false</code>,则不变动,获取到的值也为<code>false</code></li>
</ul>
<p>打断标记的清空与否就是true和false的区别，<strong>如果被打断了就是true，还没有被打断过就是false</strong></p>
<h3 id="interrupt打断park线程" tabindex="-1"><a class="header-anchor" href="#interrupt打断park线程" aria-hidden="true">#</a> interrupt打断park线程</h3>
<p>park并不是一个基础的玩意，是JUC(之后会学到)中的一个玩意，打断它将不会清空打断状态，这里先简单模拟下，具体的以后再说</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>
<span class="token annotation punctuation">@Slf4j</span><span class="token punctuation">(</span>topic <span class="token operator">=</span> <span class="token string">"c.MyThread"</span><span class="token punctuation">)</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MyThread</span> <span class="token punctuation">{</span>
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>19:50:00.916 [Thread-0] DEBUG c.MyThread - park...
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>这个park你可以理解为当当前打断标记为false的时候，他将会阻塞</p>
<p>如果说我们想让第二个<code>park</code>正常的阻塞，只需要将他前面的那行代码改成<code>log.debug(&quot;打断状态:{}&quot;, Thread.isInterrupted());</code></p>
<p>刚刚也说过，<code>Thread.isInterrupted()</code>这个方法是会清除打断标记，即获取到true后又将打断标记设置为false，所以说可以让后面的park继续阻塞</p>
<h3 id="不推荐使用的方法" tabindex="-1"><a class="header-anchor" href="#不推荐使用的方法" aria-hidden="true">#</a> 不推荐使用的方法</h3>
<table>
<thead>
<tr>
<th>方法名</th>
...
<p>不推荐使用的原因非常简单，他们都是直接暂停之类的，<strong>会造成对象的锁得不到释放，从而导致线程死锁，程序出问题</strong></p>
<p>当然他们也都有对应的解决方案，其中<code>stop</code>的解决方案就是我们的<strong>两阶段终止模式</strong>，其余的解决方案在之后也都会说明</p>
<p>我们也可以在方法上看到不推荐使用的原因</p>
<p><img src="/images/JavaThread/2-Java线程/1642247789049.png" alt="不推荐使用的线程方法" loading="lazy"></p>
<h3 id="主线程和守护线程" tabindex="-1"><a class="header-anchor" href="#主线程和守护线程" aria-hidden="true">#</a> 主线程和守护线程</h3>
<p>默认的情况下，Java进程需要等待所有程序都运行结束，才会结束</p>
<p>当然有一种特殊的线程叫做守护线程，只要其他的非守护线程都结束了，即使守护线程的代码没有执行完毕，也会强制结束</p>
<p>我们先来看下正常情况下的线程</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>
<span class="token annotation punctuation">@Slf4j</span><span class="token punctuation">(</span>topic <span class="token operator">=</span> <span class="token string">"c.MyThread"</span><span class="token punctuation">)</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MyThread</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br></div></div><p>运行：</p>
<p><img src="/images/JavaThread/2-Java线程/1642248115066.png" alt="主线程和守护线程1" loading="lazy"></p>
<p>可以看到，虽然我们的主线程结束了，但是我们的附属线程t1并没有结束，所以整个Java进程还没有结束</p>
<p>接下来我们用用守护线程</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MyThread</span> <span class="token punctuation">{</span>
...
<span class="token comment">//        设置该线程为守护线程</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="highlight-lines"><br><br><br><br><br><br><br><br><br><br><br><br><div class="highlight-line">&nbsp;</div><div class="highlight-line">&nbsp;</div><br><br><br><br><br><br></div><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br></div></div><p>然后你就能看到</p>
<p><img src="/images/JavaThread/2-Java线程/1642248337058.png" alt="主线程和守护线程2" loading="lazy"></p>
<p>你可以看到，t1方法内的最后一句话没有打印出来，因为他是在循环内直接强制结束的，所以后续的代码也不会继续执行</p>
<blockquote>
<p>注意</p>
</blockquote>
<ol>
<li>垃圾回收(GC)就是一种守护线程</li>
<li>Tomcat中的Accept和Poller线程都是守护线程，所以在tomcat接收到shutdown命令后，不会等待他们处理完成当前请求</li>
</ol>
<h3 id="线程的五种状态" tabindex="-1"><a class="header-anchor" href="#线程的五种状态" aria-hidden="true">#</a> 线程的五种状态</h3>
<p>这是从操作系统的角度来看的</p>
<p><img src="/images/JavaThread/2-Java线程/1642248656488.png" alt="线程的五种状态" loading="lazy"></p>
<ul>
<li>【初始状态-NEW】：仅仅是在语言层面创建了线程对象，还未与操作系统线程关联</li>
<li>【可运行状态-RUNNABLE】：也就是就绪状态，说明线程准备好了，CPU可以来执行它了</li>
<li>【运行状态--RUNNING】：指获取了CPU时间片正在运行中的状态
<ul>
<li>当CPU时间片用完后，会从【运行状态】转换至【可运行状态】，会导致线程的上下文切换</li>
</ul>
</li>
<li>【阻塞状态】
<ul>
<li>如果调用了阻塞API，例如BIO读写文件，这个时候该线程实际不会用到CPU，会导致线程上下文切换，进入【阻塞状态】</li>
<li>等BIO操作完毕，会由操作系统唤醒阻塞线程，转换至【可运行状态】</li>
</ul>
</li>
<li>【终止状态】：表示线程已经运行完毕，生命周期已经结束，不再会转变为其他状态</li>
</ul>
<h3 id="线程的六种状态" tabindex="-1"><a class="header-anchor" href="#线程的六种状态" aria-hidden="true">#</a> 线程的六种状态</h3>
<p>这是从Java API层面来描述的，根据<code>Thread.State</code>枚举，分为六种状态</p>
<p><img src="/images/JavaThread/2-Java线程/1642249035413.png" alt="线程的六种状态" loading="lazy"></p>
<p>当然这个我们在之前的Java基础中也完完整整的了解过了，这里还是搬出韩顺平老师的那张图片</p>
<p><img src="/images/JavaThread/2-Java线程/Java线程生命周期-16367276068553.svg" alt="线程的完整状态" loading="lazy"></p>
<ul>
<li>NEW 线程刚刚被创建的时候，但是还没有调用<code>start()</code>方法</li>
<li>RUNNABLE 当调用了<code>start()</code>方法之后，注意，<strong>Java API</strong>层面导致的<code>RUNNABLE</code>状态涵盖了操作系统层面的【可运行状态】、【运行状态】和【阻塞状态】（由于BIO导致的线程阻塞，在Java内无法区分，依旧认为是可运行）</li>
<li>BLOCKED，WAITING，TIMED_WAITING都是<strong>Java API</strong>层面对【阻塞状态】的部分</li>
