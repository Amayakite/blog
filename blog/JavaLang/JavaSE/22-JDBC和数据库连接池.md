...
3. JBDC的原理图
   ![image-20211123163155802](/images/JavaSE/22-JDBC和数据库连接池/image-20211123163155802.png)
4. 模拟一个简单的JDBC
...
![image-20211123203656610](/images/JavaSE/22-JDBC和数据库连接池/image-20211123203656610.png)

![image-20211123204121562](/images/JavaSE/22-JDBC和数据库连接池/image-20211123204121562.png)
...
![image-20211123205837625](/images/JavaSE/22-JDBC和数据库连接池/image-20211123205837625.png)

下载即可，如果不是的话，则点击那个[Archives](https://downloads.mysql.com/archives/c-j/)

然后选择自己当前的版本，并选择Platform Independent，然后下载第一个

![image-20211123210114928](/images/JavaSE/22-JDBC和数据库连接池/image-20211123210114928.png)

当然，通常来说，下载目前自己数据库的大纲版本最新的即可（8的话直接下载最新，5的的话找到5版本里面最新的版本号），比方我这里数据库是8.0.26，但是我依旧可以正常使用8.0.27

下载好后，是一个压缩包文件，解压可以得到一个.jar文件

![image-20211123210625478](/images/JavaSE/22-JDBC和数据库连接池/image-20211123210625478.png)

把这个jar包取出来，丢到桌面

然后返回IEDA，新建一个根级目录libs

![image-20211123210829006](/images/JavaSE/22-JDBC和数据库连接池/image-20211123210829006.png)

然后把刚刚的那个.jar文件拷贝到这个目录下（Ctrl+c，Ctrl+v） 并点击确定

![image-20211123210928542](/images/JavaSE/22-JDBC和数据库连接池/image-20211123210928542.png)

然后右键它，添加为库(Add as Library)

<img src="/images/JavaSE/22-JDBC和数据库连接池/image-20211123211051078.png" alt="image-20211123211051078" style="zoom:50%;" />

点确定

![image-20211123211116995](/images/JavaSE/22-JDBC和数据库连接池/image-20211123211116995.png)

完毕后，能看到点击这个jar包，可以看到里面的源码了

![image-20211123211417667](/images/JavaSE/22-JDBC和数据库连接池/image-20211123211417667.png)
...
![image-20211123213046551](/images/JavaSE/22-JDBC和数据库连接池/image-20211123213046551.png)
...
![image-20211123220140370](/images/JavaSE/22-JDBC和数据库连接池/image-20211123220140370.png)

![image-20211123220146702](/images/JavaSE/22-JDBC和数据库连接池/image-20211123220146702.png)

![image-20211123221245388](/images/JavaSE/22-JDBC和数据库连接池/image-20211123221245388.png)

最推荐使用的方式：第四种和第五种，按需使用，一般是用第五种方式

![image-20211123223644245](/images/JavaSE/22-JDBC和数据库连接池/image-20211123223644245.png)

![image-20211123223744099](/images/JavaSE/22-JDBC和数据库连接池/image-20211123223744099.png)
...
<img src="/images/JavaSE/22-JDBC和数据库连接池/image-20211124002353136.png" alt="image-20211124002353136" style="zoom:50%;" />

![image-20211123233401976](/images/JavaSE/22-JDBC和数据库连接池/image-20211123233401976.png)
...
<img src="/images/JavaSE/22-JDBC和数据库连接池/image-20211124145728361.png" alt="image-20211124145728361" style="zoom:50%;" />
...
![JDBC API](/images/JavaSE/22-JDBC和数据库连接池/JDBC API.svg)
...
![image-20211124163943411](/images/JavaSE/22-JDBC和数据库连接池/image-20211124163943411.png)
...
![image-20211128163346872](/images/JavaSE/22-JDBC和数据库连接池/image-20211128163346872.png)

![image-20211128163922051](/images/JavaSE/22-JDBC和数据库连接池/image-20211128163922051.png)
...
![image-20211128182349488](/images/JavaSE/22-JDBC和数据库连接池/image-20211128182349488.png)
...
![image-20211128185137727](/images/JavaSE/22-JDBC和数据库连接池/image-20211128185137727.png)
...
<img src="/images/JavaSE/22-JDBC和数据库连接池/image-20211128202718243.png" alt="image-20211128202718243" style="zoom:50%;" />

![image-20211128203247533](/images/JavaSE/22-JDBC和数据库连接池/image-20211128203247533.png)
...
![image-20211128223747850](/images/JavaSE/22-JDBC和数据库连接池/image-20211128223747850.png)

然后再到里面找到只有名字和版本号的jar下载即可，当然也可以再下载第一个(带JavaDoc的)，使用起来更看得懂在做啥

![image-20211128223821947](/images/JavaSE/22-JDBC和数据库连接池/image-20211128223821947.png)
...
![image-20211129001607820](/images/JavaSE/22-JDBC和数据库连接池/image-20211129001607820.png)

自己尝试用代码来解决这个问题

测试表为admin3，数据：

<img src="/images/JavaSE/22-JDBC和数据库连接池/image-20211129001714487.png" alt="image-20211129001714487" style="zoom:50%;" />
...
![image-20211129135236273](/images/JavaSE/22-JDBC和数据库连接池/image-20211129135236273.png)

### Apache-DButils安装及使用

先到[这里](https://commons.apache.org/proper/commons-dbutils/download_dbutils.cgi)下载压缩包，下载带bin的

![image-20211129153536045](/images/JavaSE/22-JDBC和数据库连接池/image-20211129153536045.png)

然后解压出

![image-20211129153605252](/images/JavaSE/22-JDBC和数据库连接池/image-20211129153605252.png)
...
![image-20211129165329057](/images/JavaSE/22-JDBC和数据库连接池/image-20211129165329057.png)
...
![image-20211129171051364](/images/JavaSE/22-JDBC和数据库连接池/image-20211129171051364.png)

![image-20211129171857970](/images/JavaSE/22-JDBC和数据库连接池/image-20211129171857970.png)
