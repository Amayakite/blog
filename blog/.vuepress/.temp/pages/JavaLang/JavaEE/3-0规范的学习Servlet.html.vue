<template><p>日了，服了某些自己都没搞明白的人怎么敢来放网课教程（虽然是免费的），我假设你看过我的前一个文章，知道了它的基本用法</p>
<p>接下来系统的学习下这玩意</p>
<h2 id="servlet的简介和基本使用" tabindex="-1"><a class="header-anchor" href="#servlet的简介和基本使用" aria-hidden="true">#</a> Servlet的简介和基本使用</h2>
<h3 id="什么是servlet" tabindex="-1"><a class="header-anchor" href="#什么是servlet" aria-hidden="true">#</a> 什么是Servlet</h3>
<ol>
...
<h3 id="自己实现一个servlet" tabindex="-1"><a class="header-anchor" href="#自己实现一个servlet" aria-hidden="true">#</a> 自己实现一个Servlet</h3>
<p>首先，我们要引入tomcat中的相对应Jar包，这里我假设你已经看过了我之前的Maven文章，把相关的Jar包都以依赖的形式导入到了package中，如果没有，那就去看看，把前几个文章都看一遍，模仿着敲一遍，以及上一篇文章最后的@Servlet注解也看过了一遍</p>
<p>过程分为三步：</p>
<ol>
<li>编写一个类去实现Servlet接口</li>
<li>实现<code>service</code>方法，处理请求，并响应数据
<ol>
<li>service方法是专门来处理请求和响应的，是最核心的方法</li>
</ol>
</li>
<li>到web.xml中去配置Servlet的访问地址（或者在注解中直接加上访问地址）</li>
</ol>
<p>如果说你要在web.xml中配置：</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!--Servlet标签给tomcat配置一个Servlet程序--></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet-mapping</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><p>补充：工程路径就是我们在tomcat中部署那里设置的应用程序上下文，比如我设置个03，则访问地址为<a href="http://localhost:8080/03/myServlet%EF%BC%8C%E9%9C%80%E8%A6%81%E4%BB%A5/%E5%BC%80%E5%A4%B4%EF%BC%8C%E5%BD%93%E8%AE%A9%E8%BF%98%E6%9C%89%E6%9B%B4%E5%A4%9A%E7%9A%84%E6%96%B9%E6%B3%95%EF%BC%8C%E8%AF%A6%E6%83%85%E7%9C%8B%E6%88%91%E4%B8%8A%E4%B8%80%E4%B8%AA%E6%96%87%E7%AB%A0%EF%BC%88%E5%9C%A8%E6%9C%80%E5%90%8E@Servlet" target="_blank" rel="noopener noreferrer">http://localhost:8080/03/myServlet，需要以/开头，当让还有更多的方法，详情看我上一个文章（在最后@Servlet<ExternalLinkIcon/></a>那里有说明四种）</p>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204133523223.png" alt="image-20211204133523223" loading="lazy"></p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MyServlet</span> <span class="token keyword">implements</span> <span class="token class-name">Servlet</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br></div></div><p>访问结果：</p>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204132730182.png" alt="image-20211204132730182" loading="lazy"></p>
<h2 id="servlet原理" tabindex="-1"><a class="header-anchor" href="#servlet原理" aria-hidden="true">#</a> Servlet原理</h2>
<p>一张图概括</p>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204135640694.png" alt="image-20211204135640694" loading="lazy"></p>
<p>详细的看我上一个文章，里面有写详细的内容，底层通过反射调用</p>
...
<p>第一、第二步是在第一次访问时创建Servlet程序时被调用</p>
<p>第三步是每次访问都会调用</p>
<p>第四步是在web工程停止的时候才会被调用</p>
<p>代码验证：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span>
        name <span class="token operator">=</span> <span class="token string">"myServlet"</span><span class="token punctuation">,</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">MyServlet</span> <span class="token keyword">implements</span> <span class="token class-name">Servlet</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br></div></div><p>当我们访问后，出现了如下内容：</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>MyServlet()构造器被调用了
...
MyServlet()service()方法被调用了
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>当我们尝试终止这个程序的时候：</p>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204140606812.png" alt="image-20211204140606812" loading="lazy"></p>
<h2 id="引出doget和dopost" tabindex="-1"><a class="header-anchor" href="#引出doget和dopost" aria-hidden="true">#</a> 引出doGet和doPost</h2>
<p>在我们学习HTML的时候，已经使用过这些东西了，现在我们来尝试写个网页来发送相应的请求</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br></div></div><p>我们现在分别输入相应的内容，然后点击两个提交</p>
<p>发现他们两个返回的内容都是一样的---我之前写的Hello Servlet</p>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204141409097.png" alt="image-20211204141409097" loading="lazy"></p>
<p>按照我们对于前端的学习，这个时候应该清楚的认识到，这两个玩意应该返回不一样的东西</p>
<p>为此，我们需要更改下service中的方法</p>
<p>首先，我们看下<code>ServletRequest req, ServletResponse res</code>这两个的运行类型是什么--因为实际上是tomcat创建了这两个对象给我们的Servlet处理，在service中加入如下代码</p>
<p>（因为ServletRequest  实际上是一个接口，没有具体的实现方法，我们需要一个实现方法）</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">//        获取req res 的运行类型</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>获取结果：</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>req.getClass() = class org.apache.catalina.connector.RequestFacade
res.getClass() = class org.apache.catalina.connector.ResponseFacade
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>哦豁，是我们没见过的类型，转换也找不到这个类-因为是tomcat中的</p>
<p>那我们得换一个思路，看下这个<code>ServletRequest</code>有没有什么子类</p>
<p>发现有一个：</p>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204142629615.png" alt="image-20211204142629615" loading="lazy"></p>
<p>那这两个类能不能互相转换呢？</p>
<p>于是我打开了百度，查到了这个<a href="https://blog.csdn.net/m0_38039437/article/details/75271692" target="_blank" rel="noopener noreferrer">结果<ExternalLinkIcon/></a></p>
<p>原来Tomcat中的<code>RequestFacade</code>是<code>HttpServletRequest</code>的实现类，说明该类拥有ServletRequest中的所有方法和<code>HttpServletRequest</code>中的所有方法</p>
<p>我们接着看看这两个接口中有没有关于获取用户请求方法的定义：</p>
<p>在HttpServlet中找到了这个</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><p>那不就简单了，强转一波并判断</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br></div></div><p>验证：</p>
<p>点击get按钮：</p>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204143309321.png" alt="image-20211204143309321" loading="lazy"></p>
<p>点击post按钮</p>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204143320053.png" alt="image-20211204143320053" loading="lazy"></p>
<p>但是感觉这样又不太美观，我决定自己额外写两个方法来处理这些东西：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">service</span><span class="token punctuation">(</span><span class="token class-name">ServletRequest</span> req<span class="token punctuation">,</span> <span class="token class-name">ServletResponse</span> res<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span><span class="token punctuation">,</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
    <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"MyServlet()service()方法被调用了"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    res<span class="token punctuation">.</span><span class="token function">setContentType</span><span class="token punctuation">(</span><span class="token string">"text/html;charset=utf-8"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br></div></div><p>然后尝试运行，依旧完美！</p>
<p>解决后，我又想到了一个问题：既然<code>ServletRequest</code> 有子接口，那么<code>Servlet</code>有没有子接口呢？</p>
<p>发现有两个实现类</p>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204143505902.png" alt="image-20211204143505902" loading="lazy"></p>
<p>接着，我们看看在JavaEE手册中关于Servlet接口的详解：</p>
<p><a href="https://javaee.github.io/javaee-spec/javadocs/" target="_blank" rel="noopener noreferrer">官方英文手册<ExternalLinkIcon/></a></p>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204144840470.png" alt="image-20211204144840470" loading="lazy"></p>
<p>关于这个接口，官方给出了如下定义：</p>
<p>​  定义所有servlet必须实现的方法。
​  servlet是在Web服务器中运行的小型Java程序。servlet接收并响应来自Web客户机的请求，通常是通过HTTP(超文本传输协议)。</p>
<p>​  要实现这个接口，<strong>你可以编写一个扩展javax.servlet.GenericServlet的通用servlet，或者一个扩展javax.servlet.http.HttpServlet的HTTP servlet。</strong></p>
<p>​  该接口定义了用于初始化servlet、服务请求和从服务器中删除servlet的方法。这些被称为生命周期方法，按以下顺序调用:</p>
<ol>
<li>servlet被构造，然后用init方法初始化。</li>
<li>客户端对服务方法的任何调用都会被处理。</li>
<li>servlet从服务中取出，然后使用destroy方法销毁，然后进行垃圾收集并最终完成。</li>
</ol>
<p>​  除了生命周期方法外，该接口还提供getServletConfig方法和getServletInfo方法，servlet可以使用该方法获取任何启动信息，getServletInfo方法允许servlet返回关于自身的基本信息，如作者、版本和版权。</p>
<p>也就是说，我们可以通过HttpServlet更方便的使用Servlet，接下来说说这玩意该怎么用吧</p>
<h2 id="httpservlet的使用" tabindex="-1"><a class="header-anchor" href="#httpservlet的使用" aria-hidden="true">#</a> HttpServlet的使用</h2>
<ol>
<li>编写一个类去继承HttpServlet类</li>
<li>根据业务需求重写<code>doGet</code>或者<code>doPost</code>方法</li>
<li>到<code>web.xml</code>或者在<code>@Servlet</code>中配置相关的信息及访问地址</li>
</ol>
<p>这个玩意的源码我们已经在之前一讲中分析过了，实际上他就是完成了一系列的封装，让我们可以更方便的使用其内容</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@WebServlet</span><span class="token punctuation">(</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br></div></div><p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204150014567.png" alt="image-20211204150014567" loading="lazy"></p>
<p>可以看到，非常的方便</p>
<h3 id="扩展-通过ieda快速的的创建相关的httpservlet及配置web-xml" tabindex="-1"><a class="header-anchor" href="#扩展-通过ieda快速的的创建相关的httpservlet及配置web-xml" aria-hidden="true">#</a> 扩展-通过IEDA快速的的创建相关的HttpServlet及配置web.xml</h3>
<p>在项目结构（ctrl+alt+shift+s）中的facet中配置如下内容：</p>
<p>如果你没有设置中文：File-Project Struture-facets-Source Roots</p>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204150526370.png" alt="image-20211204150526370" loading="lazy"></p>
<p>然后点击这个就能快速创建并在xml中声明</p>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204150622245.png" alt="image-20211204150622245" loading="lazy"></p>
<p>然后在这两个地方填上内容即可</p>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204150805807.png" alt="image-20211204150805807" loading="lazy"></p>
<p>然后你会发现自动生成了一个带注解的</p>
<p>如果说不把那个<code>创建Java EE 6+</code>注解类勾上的话，就会在web.xml中生成相应的Servlet标签</p>
<p>如果不勾选注解的话，需要自己手动创建一下Servlet-mapping标签</p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> testIedacreate <span class="token keyword">extends</span> <span class="token class-name">HttpServlet</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div><h2 id="httpservlet的继承关系" tabindex="-1"><a class="header-anchor" href="#httpservlet的继承关系" aria-hidden="true">#</a> HttpServlet的继承关系</h2>
<p>一张图概括</p>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204152154991.png" alt="image-20211204152154991" loading="lazy"></p>
<h2 id="servletconfig类" tabindex="-1"><a class="header-anchor" href="#servletconfig类" aria-hidden="true">#</a> ServletConfig类</h2>
<p>​  在这之前额外声明：Servlet程序和ServletConfig对象都是由Tomcat服务器创建，我们负责使用</p>
<p>​  <strong>Servlet程序默认是第一次访问时创建，这个Servletconfig在其创建后立刻创建，主要存放一些我们的初始化参数</strong></p>
<p>这玩意是在GenericServlet中就开始了引用的，从字面意义上来看，就知道是Servlet程序的配置信息类</p>
<p>他主要有三个用途：</p>
<ol>
<li>
<p>获取到Servlet程序的别名 Servlet-name的值（也就是我们在xml/注解中给Servlet中配置的name）</p>
</li>
<li>
<p>获取初始化参数 init-param</p>
<ul>
<li>
<p>这里分别说下两种方式创建初始化参数</p>
</li>
<li>
<p>在web.xml中创建这个web.xml时指定：</p>
...
<p>我们再代码中重写带参数的<code>init(Serverconfig config)</code></p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">init</span><span class="token punctuation">(</span><span class="token class-name">ServletConfig</span> config<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><p>然后访问一下，看看控制台会输出什么：</p>
<p>获取到了如下结果，和我们的预想结果一样：</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>Servlet-name:ServlettestIedacreate
init-param-username:root
init-param-password:123456
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><h3 id="servletconfig的注意事项" tabindex="-1"><a class="header-anchor" href="#servletconfig的注意事项" aria-hidden="true">#</a> ServletConfig的注意事项</h3>
<p>每个Servlet对应自己的ServletConfig----<strong>ServletConfig不在所有的Servlet之中互通</strong></p>
<p>比方说我现在有两个Servlet</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>servlet</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>servlet</span><span class="token punctuation">></span></span>
        ...
        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>init-param</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br></div></div><p>我<strong>只能在t1的ServletConfig中获取JDBC属性，t2的ServletConfig中获取username属性，他们是不能相互获取的</strong></p>
<p>比如试图在t1中获取username属性，那么会返回null（不存在）</p>
<p>t2中获取Jdbc属性同理</p>
<p>并且在重写init带有config参数的方法时，必须显示调用其<code>super(config)</code></p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">init</span><span class="token punctuation">(</span><span class="token class-name">ServletConfig</span> config<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span> <span class="token punctuation">{</span>
    <span class="token keyword">super</span><span class="token punctuation">.</span><span class="token function">init</span><span class="token punctuation">(</span>config<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>不然在后续试图访问其初始化属性<code>init-param</code>：<code>getInitParameter(参数名称)</code>时会报错</p>
<p>一般情况下，我们都是重写空参数的init()，而非有参的init()</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>为啥呢？看下源码：非常清晰的说明了若有自己的逻辑写在这里就行了，init(config)会自动调用这个无参的init</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br></div></div><p>ServletConfig还可以在doget、dopost中随意调用：<code>this.getServletConfig()</code></p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>    <span class="token annotation punctuation">@Override</span>
    <span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">doGet</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> request<span class="token punctuation">,</span> <span class="token class-name">HttpServletResponse</span> response<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span><span class="token punctuation">,</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><h2 id="servletcontext-上下文" tabindex="-1"><a class="header-anchor" href="#servletcontext-上下文" aria-hidden="true">#</a> ServletContext(上下文)</h2>
<p>在刚刚的ServletConfig中，ServletContext我们只是提了一嘴，并没有具体的使用他，接下来具体的介绍一下他，这玩意蛮有用的（用处比ServletConfig多多了）</p>
<ol>
<li>这是一个接口，具体的功能由tomcat实现，它表示Servlet上下文</li>
<li>一个web工程（无论有多少个Servlet），只有一个ServletContext实例</li>
<li>ServletContext对象是一个域对象</li>
<li>它在Web工程启动的时候创建，在Web工程停止的时候销毁</li>
</ol>
<h3 id="域对象" tabindex="-1"><a class="header-anchor" href="#域对象" aria-hidden="true">#</a> 域对象</h3>
<p>域对象的定义是：</p>
<ol>
<li>可以像Map一样存取数据的对象</li>
<li>这里的域指的是操作范围</li>
</ol>
<table>
<thead>
...
<th style="text-align:center">存数据</th>
<th style="text-align:center">取数据</th>
<th style="text-align:center">删除数据</th>
</tr>
</thead>
<tbody>
<tr>
...
<td style="text-align:center"><code>setAttribute()</code></td>
<td style="text-align:center"><code>getAttribute()</code></td>
<td style="text-align:center"><code>removeAttribute()</code></td>
</tr>
</tbody>
</table>
<h3 id="servletcontext类的四个作用" tabindex="-1"><a class="header-anchor" href="#servletcontext类的四个作用" aria-hidden="true">#</a> ServletContext类的四个作用</h3>
<ol>
<li>获取web.xml中配置的上下文参数
<ol>
<li>如果值不存在，则返回null</li>
</ol>
</li>
<li>获取当前的工程路径
<ol>
<li>格式：<code>/工程路径</code></li>
</ol>
</li>
<li>获取工程部署后在服务器硬盘上的绝对路径</li>
<li>像Map一样存储数据</li>
</ol>
<h3 id="servlet常用方法一-读取上下文-工程路径-绝对路径" tabindex="-1"><a class="header-anchor" href="#servlet常用方法一-读取上下文-工程路径-绝对路径" aria-hidden="true">#</a> Servlet常用方法一：读取上下文，工程路径，绝对路径</h3>
<p>我们先在<code>web.xml</code>填加如下内容：当然和<code>init-param</code>一样，它也可以添加多个</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>然后读取：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
<span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">doGet</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> request<span class="token punctuation">,</span> <span class="token class-name">HttpServletResponse</span> response<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span><span class="token punctuation">,</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br></div></div><p>结果：</p>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204162409182.png" alt="image-20211204162409182" loading="lazy"></p>
<p>可能你会有疑惑：这个工程部署路径有啥用呢？</p>
<p>​  emm这样说吧，比如说你要发送个文件(图片、视频等二进制文件)给客户端，就要通过它来将一个相对路径转换为一个绝对路径，来让FileInput流读取</p>
<p>​  我们的惯例应该是：除了一些隐私级别的文件，静态文件（html css 资源文件）同意放置在webapp目录下：</p>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204162732455.png" alt="image-20211204162732455" loading="lazy"></p>
<p>用户访问这些也很简单，比如说一个01.jpg，访问地址则为<code>localhost:8080/工程路径/static/images/01.jpg</code></p>
<p>结果：</p>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204162850284.png" alt="image-20211204162850284" loading="lazy"></p>
<p>java中获取这个图片的绝对路径的方式：</p>
...
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204163134313.png" alt="image-20211204163134313" loading="lazy"></p>
<h3 id="servlet常用方法二-让servlet通信" tabindex="-1"><a class="header-anchor" href="#servlet常用方法二-让servlet通信" aria-hidden="true">#</a> Servlet常用方法二：让Servlet通信</h3>
<p>ps：若视图读取不存在的数据，会返回null=</p>
<p>context1存放了数据 key 是一个string value是一个Object</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
<span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">doGet</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> request<span class="token punctuation">,</span> <span class="token class-name">HttpServletResponse</span> response<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span><span class="token punctuation">,</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>context2读取数据(PS:读取数据的时候有个方法:getAttributeNames()可以获取当前所有上下文数据的名字，但是那里面会包含一些其他的内容，这里就不演示了，真正要用的话或许可以通过加个判定名字的长度来限制性输出)</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
<span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">doGet</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> request<span class="token punctuation">,</span> <span class="token class-name">HttpServletResponse</span> response<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span><span class="token punctuation">,</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
 ...
 response<span class="token punctuation">.</span><span class="token function">getWriter</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">write</span><span class="token punctuation">(</span>servletContext<span class="token punctuation">.</span><span class="token function">getAttribute</span><span class="token punctuation">(</span><span class="token string">"age"</span><span class="token punctuation">)</span> <span class="token operator">+</span> <span class="token string">"&lt;br>"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br></div></div><h3 id="servlet常用方法三-读取prperties等配置文件" tabindex="-1"><a class="header-anchor" href="#servlet常用方法三-读取prperties等配置文件" aria-hidden="true">#</a> Servlet常用方法三：读取prperties等配置文件</h3>
<p>先说方法：<code>getResourceAsStream(&quot;/WEB-INF/classes/路径/文件名或文件名&quot;);</code>可以读取<code>resources</code>目录下的配置文件</p>
<p>如果要读取java文件夹中的文件（比如包名为：<code>com.abc.AAA.testA</code>）:</p>
<p>则：<code>getResourceAsStream(&quot;/WEB-INF/classes/com/abc/aaa/testA.class&quot;)</code></p>
<p>还记得我们在老早之前创建的那个resources文件夹吗，资源文件就是放在那里的，我们先新建一个<code>db.properties</code>到该文件夹下：</p>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211203155322875-16386087059881.png" alt="image-20211203155322875" loading="lazy"></p>
...
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211203155802117-16386087059892.png" alt="image-20211203155802117" loading="lazy"></p>
<p>可能会遇到的导出问题：</p>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>build</span><span class="token punctuation">></span></span>
    ...
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>resources</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>build</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br></div></div><p>然后读取即可：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
<span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">doGet</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> req<span class="token punctuation">,</span> <span class="token class-name">HttpServletResponse</span> resp<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span><span class="token punctuation">,</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br></div></div><h2 id="http回顾" tabindex="-1"><a class="header-anchor" href="#http回顾" aria-hidden="true">#</a> HTTP回顾</h2>
<h3 id="请求的http协议格式" tabindex="-1"><a class="header-anchor" href="#请求的http协议格式" aria-hidden="true">#</a> 请求的HTTP协议格式</h3>
<p>客户端给服务端发送数据叫请求</p>
<p>服务端给客户端发数据叫相应</p>
<p>常见的请求为get和post</p>
<h4 id="get请求" tabindex="-1"><a class="header-anchor" href="#get请求" aria-hidden="true">#</a> get请求</h4>
<ol>
<li>请求行
<ol>
<li>请求的方式：get</li>
...
<li>请求头
<ol>
<li>由key-value键值对组成，不同的键值对代表不同的含义</li>
</ol>
</li>
</ol>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204171938943.png" alt="image-20211204171938943" loading="lazy"></p>
<h4 id="post请求" tabindex="-1"><a class="header-anchor" href="#post请求" aria-hidden="true">#</a> post请求</h4>
<ol>
<li>
<p>请求行</p>
<ol>
...
<li>
<p><strong>一个空行，隔开请求头和请求体</strong></p>
</li>
<li>
<p>请求体 就是发送给服务器的数据</p>
</li>
</ol>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204172617660.png" alt="image-20211204172617660" loading="lazy"></p>
<h3 id="常用请求头说明" tabindex="-1"><a class="header-anchor" href="#常用请求头说明" aria-hidden="true">#</a> 常用请求头说明</h3>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>Accept: 表示客户端可以接收的数据类型
Accept-Languege: 表示客户端可以接收的语言类型
User-Agent: 表示客户端浏览器的信息
Host: 表示客户端请求的服务器的IP和端口号
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><h3 id="get请求和post请求的区分" tabindex="-1"><a class="header-anchor" href="#get请求和post请求的区分" aria-hidden="true">#</a> Get请求和Post请求的区分</h3>
<h4 id="什么算是get请求" tabindex="-1"><a class="header-anchor" href="#什么算是get请求" aria-hidden="true">#</a> 什么算是get请求</h4>
<ol>
...
<h4 id="什么算是post请求" tabindex="-1"><a class="header-anchor" href="#什么算是post请求" aria-hidden="true">#</a> 什么算是post请求</h4>
<ol>
<li>from标签 method= get</li>
<li>ajax或者其他软件编写的post请求</li>
</ol>
<h3 id="响应的http格式" tabindex="-1"><a class="header-anchor" href="#响应的http格式" aria-hidden="true">#</a> 响应的HTTP格式</h3>
<ol>
<li>响应行
<ol>
<li>响应的协议和端口号</li>
...
<li><strong>一个空行，分割响应头和响应体</strong></li>
<li>响应体</li>
</ol>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204173630417.png" alt="image-20211204173630417" loading="lazy"></p>
<h3 id="常见的响应状态吗" tabindex="-1"><a class="header-anchor" href="#常见的响应状态吗" aria-hidden="true">#</a> 常见的响应状态吗</h3>
<ul>
<li>200/204 表示请求成功</li>
<li>302 表示重定向</li>
<li>404 资源不存在（服务器没问题）</li>
<li>500/503 服务器内部错误</li>
</ul>
<h3 id="mime类型说明-context-type" tabindex="-1"><a class="header-anchor" href="#mime类型说明-context-type" aria-hidden="true">#</a> MIME类型说明(Context-Type)</h3>
<p>Mime是HTTP协议的中的数据类型</p>
<p>MIME的英文全称是：<code>Multipurpose Internet Mail Extensions</code> 多功能Internet邮件扩充服务，MIME的格式是：</p>
<p><code>大类型/小类型</code>，并与某一种文件名的扩展名对应</p>
<table>
<thead>
<tr>
<th style="text-align:center">文件</th>
<th style="text-align:center">MIME类型</th>
</tr>
</thead>
<tbody>
<tr>
<td style="text-align:center">超文本标记语言文本</td>
...
<tr>
<td style="text-align:center">RTF文本</td>
...
<tr>
<td style="text-align:center">声音文件</td>
<td style="text-align:center">audio/basic</td>
</tr>
<tr>
<td style="text-align:center">MIDI音乐文件</td>
<td style="text-align:center">audio/midi，audio/x-midi</td>
</tr>
<tr>
<td style="text-align:center">MPEG视频文件</td>
<td style="text-align:center">video/mepg</td>
</tr>
<tr>
<td style="text-align:center">AVI视频文件</td>
<td style="text-align:center">video/x-msvideo</td>
</tr>
<tr>
<td style="text-align:center">GZIP文件</td>
<td style="text-align:center">application/x-gzip gzip就是.gz文件</td>
</tr>
<tr>
<td style="text-align:center">TAR文件</td>
<td style="text-align:center">application/x-tar</td>
</tr>
</tbody>
</table>
<p>当然，更具体的可以看<a href="https://www.w3school.com.cn/media/media_mimeref.asp" target="_blank" rel="noopener noreferrer">这个链接<ExternalLinkIcon/></a>或者<a href="https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Basics_of_HTTP/MIME_types" target="_blank" rel="noopener noreferrer">这个链接<ExternalLinkIcon/></a></p>
<h2 id="httpservletrequest类" tabindex="-1"><a class="header-anchor" href="#httpservletrequest类" aria-hidden="true">#</a> HttpServletRequest类</h2>
<h3 id="基本介绍" tabindex="-1"><a class="header-anchor" href="#基本介绍" aria-hidden="true">#</a> 基本介绍</h3>
<p>每次只要有请求进入tomcat服务器，tomcat服务器就会把请求过来的HTTP协议解析好封装到Request对象中，然后传递到service()方法中，我们的HttpServlet中的service方法接收到这个后会传递到doGet()或者doPost()中，我们可以通过HttpServletRequest对象获取到所有请求的信息</p>
...
<tr>
<td>getRequestURL()</td>
<td>获取请求的统一资源定位符（绝对路径）<br />注意，这里是L，上面那个是I</td>
</tr>
<tr>
<td>getRemoteHost()</td>
<td>获取客户端的IP地址</td>
...
<tr>
<td>setCharacterEncoding(String encoding)</td>
<td>设置请求体字符集</td>
</tr>
</tbody>
</table>
<p>注意，<strong>这个域数据的作用域并不是全局的</strong>，仅限于当前请求及当前请求转发的对象，这个等下请求转发的时候会用到</p>
<p>无论是get还是post，接收数据前最好设置下setCharacterEncoding，尤其是Post(不设置的话中文一定会乱码)，防止中文乱码的问题</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
<span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">doGet</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> request<span class="token punctuation">,</span> <span class="token class-name">HttpServletResponse</span> response<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span><span class="token punctuation">,</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br></div></div><p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204185818491.png" alt="image-20211204185818491" loading="lazy"></p>
<h3 id="请求转发" tabindex="-1"><a class="header-anchor" href="#请求转发" aria-hidden="true">#</a> 请求转发</h3>
<p>原理：</p>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204192808207.png" alt="image-20211204192808207" loading="lazy"></p>
<p>代码部分：</p>
<p>ServletDispatcher1：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
<span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">doGet</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> request<span class="token punctuation">,</span> <span class="token class-name">HttpServletResponse</span> response<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span><span class="token punctuation">,</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br></div></div><p>ServletDispatcher2：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
<span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">doGet</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> request<span class="token punctuation">,</span> <span class="token class-name">HttpServletResponse</span> response<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span><span class="token punctuation">,</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><p>访问：并携带参数</p>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204191647686.png" alt="image-20211204191647686" loading="lazy"></p>
<h3 id="解决post请求中中文参数乱码的问题" tabindex="-1"><a class="header-anchor" href="#解决post请求中中文参数乱码的问题" aria-hidden="true">#</a> 解决Post请求中中文参数乱码的问题</h3>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
<span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">doPost</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> request<span class="token punctuation">,</span> <span class="token class-name">HttpServletResponse</span> response<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span><span class="token punctuation">,</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
    request<span class="token punctuation">.</span><span class="token function">setCharacterEncoding</span><span class="token punctuation">(</span><span class="token string">"utf-8"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token comment">//        执行其他操作</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><h3 id="扩展-html-base标签的作用及解决请求转发的问题" tabindex="-1"><a class="header-anchor" href="#扩展-html-base标签的作用及解决请求转发的问题" aria-hidden="true">#</a> 扩展-HTML-Base标签的作用及解决请求转发的问题</h3>
<p>我们先在webapp目录下新建如下文件：</p>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204193232189.png" alt="image-20211204193232189" loading="lazy"></p>
<p>god.html中有个a标签，<code>herf=&quot;a/b/c/d.html&quot;</code></p>
<p>d.html中有一句话：<code>&lt;h1&gt;这是a下的b下的c下的d.html&lt;/h1&gt;</code></p>
<p>注意：这里的a标签中的<code>a/b/c/d.html</code>前面是没有<code>/</code>的（相对路径）</p>
<p>若有<code>/</code>会跳转到<code>localhost:8080/a/b/c/d.html</code>（绝对路径）</p>
<p>同时可以在d.html中添加a标签返回到<code>god.html</code>:<code>&lt;a href=&quot;../../../god.html&quot; class=&quot;herf&quot;&gt;&lt;/a&gt;</code></p>
<p>然后测试下，发现他们可以进行互相之间的跳转</p>
<p>但是我们如果再添加一个请求转发的地址：</p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ServletForward</span> <span class="token keyword">extends</span> <span class="token class-name">HttpServlet</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><p>并让god.html添加一个请求转发到d.html的标签：</p>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">DOCTYPE</span> <span class="token name">html</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>html</span> <span class="token attr-name">lang</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>en<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>head</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>meta</span> <span class="token attr-name">charset</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>UTF-8<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>body</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>html</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><p>你就会发现跳转过去没问题，但是从d.html中跳转回a却出了问题：</p>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204194727947.png" alt="image-20211204194727947" loading="lazy"></p>
<p>分析：</p>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204194958004.png" alt="image-20211204194958004" loading="lazy"></p>
<p>base是一个html标签，所以我们只需要：</p>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token doctype"><span class="token punctuation">&lt;!</span><span class="token doctype-tag">DOCTYPE</span> <span class="token name">html</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>html</span> <span class="token attr-name">lang</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>en<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>head</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>meta</span> <span class="token attr-name">charset</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>UTF-8<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>body</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>html</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br></div></div><p>就可以解决该问题</p>
<p>但是这样的话。。。我们的这个127.0.0.1:8080就写死了，所以在之后的jsp学习中，会有更好的替代品出现</p>
<h2 id="httpservletresponse" tabindex="-1"><a class="header-anchor" href="#httpservletresponse" aria-hidden="true">#</a> HttpServletResponse</h2>
<p>​  跟Request一样，都是浏览器清流服务器时，Tomcat生成的对象，Request用于获取用户发送的数据，Response用户响应用户</p>
<p>特别基础的东西</p>
<h2 id="response的两个输出流" tabindex="-1"><a class="header-anchor" href="#response的两个输出流" aria-hidden="true">#</a> Response的两个输出流</h2>
<ul>
<li><code>getWriter</code> 字符输出流 用于响应文本数据</li>
<li><code>getOutoutStream</code> 字节数出流 用于响应文件
<ul>
<li>响应字节数的时候得提前设置好Context-Type</li>
<li>比如image/jpg、image/png 等</li>
<li>具体的可以查看<a href="https://www.w3school.com.cn/media/media_mimeref.asp" target="_blank" rel="noopener noreferrer">MIME参考手册<ExternalLinkIcon/></a></li>
</ul>
</li>
</ul>
<p>注意 这两个流<strong>不能混用</strong>，即：<strong>用了字符流就不能用字节流，反之亦然，否则会报错</strong></p>
<h3 id="设置流的编码-返回格式" tabindex="-1"><a class="header-anchor" href="#设置流的编码-返回格式" aria-hidden="true">#</a> 设置流的编码，返回格式</h3>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
<span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">doPost</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> request<span class="token punctuation">,</span> <span class="token class-name">HttpServletResponse</span> response<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span><span class="token punctuation">,</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
    ...
    response<span class="token punctuation">.</span><span class="token function">setHeader</span><span class="token punctuation">(</span><span class="token string">"Content-Type"</span><span class="token punctuation">,</span> <span class="token string">"text/html;charset=utf-8"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><h3 id="请求重定向" tabindex="-1"><a class="header-anchor" href="#请求重定向" aria-hidden="true">#</a> 请求重定向</h3>
<p>原理(提一嘴，千万别手残打成304 304是永久重定向， 除非用户Ctrl+shift+R刷新页面，不然之后一直都是直接跳转到response2程序)</p>
<p><img src="/images/JavaEE/3-0规范的学习Servlet/image-20211204221219141.png" alt="image-20211204221219141" loading="lazy"></p>
<p>方法1  分别设置Status和Header中的Location</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
<span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">doGet</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> request<span class="token punctuation">,</span> <span class="token class-name">HttpServletResponse</span> response<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span><span class="token punctuation">,</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>方法2 推荐使用这种：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Override</span>
<span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">doGet</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> request<span class="token punctuation">,</span> <span class="token class-name">HttpServletResponse</span> response<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ServletException</span><span class="token punctuation">,</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
    <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"曾到此一游"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>这句话相当于封装了<code>response.setStatus(302);</code>和<code>response.setHeader(&quot;Location&quot;, url);</code></p>
</template>
