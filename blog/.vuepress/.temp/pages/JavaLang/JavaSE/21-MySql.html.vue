<template><h2 id="基本介绍" tabindex="-1"><a class="header-anchor" href="#基本介绍" aria-hidden="true">#</a> 基本介绍</h2>
<p>​  数据库嘛，懂得都懂，在我学习Java之前，已经接触过Mysql了，并使用Nodejs、Koa、Vue3、ElementUI搭建了一个个人博客，使用的数据库就是Mysql，当然在学习Java之前Mysql为我存取了超多的图片：</p>
<p><img src="/images/JavaSE/21-MySql/image-20211119220054247.png" alt="image-20211119220054247" loading="lazy"></p>
<p>​  这大概是爬取了三天的结果，共在数据库内简历了八千多条索引，也就是说我以后能够随意调用这些数据hhhh~</p>
<p>​  总之，Mysql中最为核心的就是CRUP(增删改查)，其中最重要的就是查，实际项目中往往绝大部分项目都是存在sql数据库中，例如：网页的sabbar，网页的菜单，用户的信息，用户的发言，用户所拥有的东西等等</p>
<p>​  这里开始，学的也只是基础，Mysql后面还得学些更深入的玩意...</p>
<p>​  好了，言归正传，当你访问淘宝，京东，天猫，微信等相关软件或者网页时，是否发现每次退出，再次登陆时，你的订单，聊天等信息依旧还存在</p>
<p>​  又或者说，你电脑上的原神卸载了，重装回来后，再次登陆账号后，你账号上的所有角色和物品依旧存在</p>
<p>​  这之中就是Mysql的功劳----它存储了你的所有信息，当你访问到相关的网站、软件、服务时，对方的后台搜索到你的数据并返回给你</p>
<p>​  可能这样说有点抽象，举一个生活化的案例说明---&gt; 如果说，图书馆是保存书籍的，那么数据库就是保存数据的</p>
<p>​  可能你会这样想，我现在正在用着Excel来存储数据，再不济也可以用txt文件啊之类的文件来保存数据，为什么要用Mysql</p>
<p>​  但是，假设现在有一千万条不重样的数据，我要你快速的读取或者写入或者在这些数据中查找某个符合条件的值，使用Excel.....一千万条数据可能连软件都打不开，使用普通的txt之类的文件，本人有幸试过（一个密码字典），可以说打开慢，查询慢，完全不符合我的使用需求</p>
<p>​  但是使用数据库的话，这些烦恼就没有了，我可能快速的增删改查，不过目前我还不好说，等过完一遍后大概就能知道它有多顺手了</p>
...
<p>Windows下的安装教程可以直接去看<a href="https://www.bilibili.com/video/BV1fh411y7R8?p=732&amp;t=1.5" target="_blank" rel="noopener noreferrer">老韩的视频<ExternalLinkIcon/></a>，讲的比较细，根据他的操作下来走一遍就可以使用了，Mysql的<a href="https://dev.mysql.com/downloads/mysql/" target="_blank" rel="noopener noreferrer">下载地址<ExternalLinkIcon/></a>，根据他的视频下来操作一遍即可</p>
<p><img src="/images/JavaSE/21-MySql/image-20211119224623277.png" alt="image-20211119224623277" loading="lazy"></p>
<p>小TIps：在配置<code>my.ini</code>的过程中，字符集<code>default-character-set</code>可以选择设置为<code>utf8mb4</code></p>
<p>为啥呢？比方说想在sql里存放🐂🐏子类的表情，utf-8是存放不进去的，因为这类表情占用四个字符...</p>
<h4 id="个人windows安装流程" tabindex="-1"><a class="header-anchor" href="#个人windows安装流程" aria-hidden="true">#</a> 个人Windows安装流程</h4>
<ol>
<li>
<p><a href="https://dev.mysql.com/downloads/mysql/" target="_blank" rel="noopener noreferrer">下载<ExternalLinkIcon/></a>到包，并解压</p>
</li>
<li>
<p>到解压目录，创建配置文件my.ini</p>
...
<li>
<p>进入到<code>bin</code>目录，以管理员方式打开<code>powerShell</code>或者<code>Cmd</code></p>
<ol>
<li>
<p>安装服务</p>
<div class="language-powershell ext-powershell line-numbers-mode"><pre v-pre class="language-powershell"><code><span class="token punctuation">.</span><span class="token operator">/</span>mysqld<span class="token punctuation">.</span>exe install 
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div></li>
<li>
<p>初始化：</p>
<div class="language-powershell ext-powershell line-numbers-mode"><pre v-pre class="language-powershell"><code><span class="token punctuation">.</span><span class="token operator">/</span>mysqld<span class="token punctuation">.</span>exe <span class="token operator">--</span>initialize <span class="token operator">--</span>console
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div></li>
<li>
<p>等待初始化完毕后，会在最后打印出默认的root账户密码，把密码先记下来，格式大概是这样的：
<code>root@localhost:dS8hTh)u?hAl</code>，其中<code>dS8hTh)u?hAl</code>就是初始密码</p>
</li>
<li>
<p>注意 这一步密码中可能会带有空格，别复制多了..</p>
</li>
</ol>
</li>
<li>
...
<ol>
<li>
<p>依旧是在<code>bin</code>目录中的powershell或者cmd</p>
<div class="language-powershell ext-powershell line-numbers-mode"><pre v-pre class="language-powershell"><code>mysql <span class="token operator">-</span>uroot <span class="token operator">-</span>p
...
<ul>
<li>
<p>首先输入<code>use mysql;</code></p>
</li>
<li>
<p>然后看下有没有出现一条消息</p>
<ul>
<li>
<p>如果发现屏幕中有这样的消息：You must reset your password using ALTER USER statement before executing this statement.</p>
<ul>
<li>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">alter</span> <span class="token keyword">user</span> <span class="token string">'root'</span><span class="token variable">@'localhost'</span> identified <span class="token keyword">by</span> <span class="token string">'要改成的密码'</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div></li>
</ul>
</li>
<li>
...
<ul>
<li>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 刷新权限</span>
...
<p>添加系统变量</p>
<ol>
<li>复制<code>bin</code>目录路径打开环境变量配置，配置当前用户的Path，添加该路径，关闭所有的cmd再重新打开即可</li>
</ol>
</li>
</ol>
<p>相关关闭启动命令：</p>
<div class="language-powershell ext-powershell line-numbers-mode"><pre v-pre class="language-powershell"><code><span class="token comment">#启动服务</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><h5 id="卸载mysql" tabindex="-1"><a class="header-anchor" href="#卸载mysql" aria-hidden="true">#</a> 卸载mysql</h5>
<p><a href="https://www.cnblogs.com/zhaosq/p/10469848.html" target="_blank" rel="noopener noreferrer">https://www.cnblogs.com/zhaosq/p/10469848.html<ExternalLinkIcon/></a></p>
<p><a href="https://blog.csdn.net/weixin_29348211/article/details/113163856" target="_blank" rel="noopener noreferrer">https://blog.csdn.net/weixin_29348211/article/details/113163856<ExternalLinkIcon/></a></p>
<p>两篇文章的操作都跟着做下，然后把path中的相关信息删除即可</p>
<h3 id="linux" tabindex="-1"><a class="header-anchor" href="#linux" aria-hidden="true">#</a> Linux</h3>
<p>因为我只用Ubuntu系统，所以只放出Ubuntu系统的安装方式，若要用其他系统自行百度</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br></div></div><p>修改字符集为utf8mb4:</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">vi</span> /etc/mysql/mysql.conf.d/mysqld.cnf
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><div class="language-ini ext-ini line-numbers-mode"><pre v-pre class="language-ini"><code><span class="token comment"># 注意 是修改 若原先只有[mysql]，则覆盖，其余情况参照windows安装一览的写法写</span>
<span class="token section"><span class="token punctuation">[</span><span class="token section-name selector">client</span><span class="token punctuation">]</span></span>
<span class="token key attr-name">default-character-set</span> <span class="token punctuation">=</span> <span class="token value attr-value">utf8mb4</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div><p>然后重启mysql，进入mysql插入搜索验证：</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 查看字符集</span>
...
<span class="token operator">+</span><span class="token comment">--------------------------+--------------------+</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br></div></div><p>配置远程访问：</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token function">sudo</span> mysql -uroot -p
<span class="token comment">#然后输入密码进入mysql</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 原先是这样的</span>
...
<span class="token comment">#刷新权限</span>
flush <span class="token keyword">privileges</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br></div></div><p>详细的配置外网连接可以看<a href="https://blog.csdn.net/weixx3/article/details/80782479" target="_blank" rel="noopener noreferrer">这篇文章<ExternalLinkIcon/></a>，尤其是其评论区</p>
<h4 id="卸载和重装mysql" tabindex="-1"><a class="header-anchor" href="#卸载和重装mysql" aria-hidden="true">#</a> 卸载和重装Mysql</h4>
<p>先通过<a href="https://blog.csdn.net/fanrongwoaini/article/details/107518693" target="_blank" rel="noopener noreferrer">这篇文章1<ExternalLinkIcon/></a>的操作走一遍删除，再通过<a href="https://www.cnblogs.com/zhangxuel1ang/p/13456116.html" target="_blank" rel="noopener noreferrer">这篇文章2<ExternalLinkIcon/></a>的操作走一遍删除，然后回到文章1进行安装</p>
<h3 id="docker" tabindex="-1"><a class="header-anchor" href="#docker" aria-hidden="true">#</a> Docker</h3>
<p>我还是更喜欢用Docker</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token function">docker</span> pull mysql@版本号
<span class="token comment"># 不指定版本的话默认是最新</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>创建并运行容器</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token function">docker</span> run --name mysql -p <span class="token number">3306</span>:3306 -e <span class="token assign-left variable">MYSQL_ROOT_PASSWORD</span><span class="token operator">=</span><span class="token number">123456</span> mysql
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>这里注意一下，最好不要加-d参数。-d表示后台执行，就不能看到初始化数据库过程，这个过程可能有一会儿，没经过初始化数据库不能启动服务的。</p>
<p><img src="/images/JavaSE/21-MySql/1704051-20200703164942350-177162620.png" alt="img" loading="lazy"></p>
<p>出现这条记录就说明安装成功，可以把这个控制台关掉，重新开一个</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>进入bash</p>
...
mysql -uroot -p
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>添加远程登录用户</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">CREATE</span> <span class="token keyword">USER</span> <span class="token string">'账户名'</span><span class="token variable">@'%'</span> IDENTIFIED <span class="token keyword">WITH</span> mysql_native_password <span class="token keyword">BY</span> <span class="token string">'密码'</span><span class="token punctuation">;</span> 
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><p>重启</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token function">service</span> mysql restart
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>设置字符集的方式：和Linux中一致：个人建议使用图形化方式操作</p>
<p><img src="/images/JavaSE/21-MySql/image-20211119233159061.png" alt="image-20211119233159061" loading="lazy"></p>
<div class="language-ini ext-ini line-numbers-mode"><pre v-pre class="language-ini"><code><span class="token section"><span class="token punctuation">[</span><span class="token section-name selector">client</span><span class="token punctuation">]</span></span>
<span class="token key attr-name">default-character-set</span> <span class="token punctuation">=</span> <span class="token value attr-value">utf8mb4</span>
...
<span class="token key attr-name">collation-server</span> <span class="token punctuation">=</span> <span class="token value attr-value">utf8mb4_unicode_ci</span>
<span class="token key attr-name">init_connect</span><span class="token punctuation">=</span><span class="token value attr-value">'<span class="token inner-value">SET NAMES utf8mb4</span>'</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><p>配置完毕后，重启mysql</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><h2 id="mysql的基本使用" tabindex="-1"><a class="header-anchor" href="#mysql的基本使用" aria-hidden="true">#</a> Mysql的基本使用</h2>
<p>连接到任意的mysql数据库的指令</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>mysql -h 主机IP -P 端口 -u 用户名 -p密码
...
mysql -h localhost -P <span class="token number">3306</span> -u root -p123456

<span class="token comment">#当然默认的情况下前两个参数分别是 localhost 和 3306</span>
mysql -uroot -p123456

</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><p>当然默认情况下，在实际使用过程中，都会将Mysql的默认端口改成别的，如53146（3306容易被黑客攻击）</p>
<h3 id="使用图形化管理软件来操作mysql" tabindex="-1"><a class="header-anchor" href="#使用图形化管理软件来操作mysql" aria-hidden="true">#</a> 使用图形化管理软件来操作Mysql</h3>
<p><a href="https://www.navicat.com.cn/products" target="_blank" rel="noopener noreferrer">NaviCat<ExternalLinkIcon/></a>应该是目前为止最好的Mysql管理软件，虽然贵，但是超好用</p>
<p>当然，贴心的<a href="https://github.com/gitccl/Navicat-key" target="_blank" rel="noopener noreferrer">链接<ExternalLinkIcon/></a>也是不可少的</p>
<p><a href="https://github.com/webyog/sqlyog-community/wiki/Downloads" target="_blank" rel="noopener noreferrer">SQlyog<ExternalLinkIcon/></a>也不错，社区版本免费试用</p>
<p>他们两的功能都大同小异</p>
<p>....然后这太基础的地方（图形化创建db，图形化创建table，图形化insert数据）就不过多赘述了，可以去<a href="https://www.bilibili.com/video/BV1fh411y7R8?p=734&amp;t=0.9" target="_blank" rel="noopener noreferrer">老韩的视频<ExternalLinkIcon/></a>看看，我选择性撰写，他的视频中视频的是SqlYog</p>
<p>​  图形化的好处是方便直观的查看数据，但是在实际使用过程中，插入数据之类的过程一般都是才用命令模式插入（配合相关语言的相关库），试想一下，假设现在你要管理一千个用户的信息，每个用户的信息你都想要手动录入，那岂不是...</p>
<p>​  以后在Java程序中也是通过指令来操作数据库的，这里放下老韩视频中基本的操作：</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment">#Create database</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><p>​  当然，无论你是否感觉到了图形化界面的好处，我都建议你----还是用回命令行开打的那个mysql进行操作，因为实际过程中大部分的操作都是由sql语句来完成的，比如上面的那些。</p>
<p>​  所以使用命令行来操作是一个好习惯。（同时可以有效的降低一丢丢面试不通过的概率）</p>
<h3 id="mysql的结构" tabindex="-1"><a class="header-anchor" href="#mysql的结构" aria-hidden="true">#</a> Mysql的结构</h3>
<p><img src="/images/JavaSE/21-MySql/image-20211120135003148.png" alt="image-20211120135003148" loading="lazy"></p>
<p><img src="/images/JavaSE/21-MySql/image-20211120135054472.png" alt="image-20211120135054472" loading="lazy"></p>
<p><img src="/images/JavaSE/21-MySql/image-20211120135239889.png" alt="image-20211120135239889" loading="lazy"></p>
<h2 id="sql语句分类" tabindex="-1"><a class="header-anchor" href="#sql语句分类" aria-hidden="true">#</a> SQL语句分类</h2>
<ul>
<li>DDL:数据定义语句:<code>create</code>表，库...</li>
<li>DML:数据库操作语句:
<ul>
<li>增加<code>insert</code></li>
<li>修改<code>update</code></li>
<li>删除<code>delete</code></li>
</ul>
</li>
<li>DQL:数据库的查询语句<code>select</code> 查询时需指定哪个数据库
<ul>
<li>比如指定db1的user:<code>select * from db1.user</code></li>
</ul>
</li>
<li>DCL:数据库控制语句-管理数据库
<ul>
<li>给用户授权<code>grant</code></li>
<li>取消对用户的授权<code>revoke</code></li>
</ul>
</li>
</ul>
<h2 id="数据库的相关操作" tabindex="-1"><a class="header-anchor" href="#数据库的相关操作" aria-hidden="true">#</a> 数据库的相关操作</h2>
<h3 id="创建数据库" tabindex="-1"><a class="header-anchor" href="#创建数据库" aria-hidden="true">#</a> 创建数据库</h3>
<p>语法：<code>CREATE DATABASE [可选：IF NOT EXITS] 数据库名 [可选 CHARACTER SET] [可选 COLLATE]</code></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 创建一个默认类型的数据库</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><p><code>CHARACTER SET</code>:指定数据库采用的字符集，如果不指定字符集，默认为配置数据库时设置的字符集(utf8或者utf8mb4)</p>
<p><code>COLLATE</code>:指定数据库的校验规则，无论是哪种字符集，排序规则的名字都是大同小异的，utf-8默认为<code>utf8_general_ci</code>，下面举几个常用的</p>
<table>
<thead>
<tr>
...
<td style="text-align:center">校对速度快，但准确度稍差，不区分大小写</td>
</tr>
<tr>
<td style="text-align:center">utf8_general_cs</td>
<td style="text-align:center">校对速度快，但准确度稍差，区分大小写</td>
</tr>
<tr>
<td style="text-align:center">utf8_unicode_ci</td>
<td style="text-align:center">准确度高，但校对速度稍慢，不区分大小写</td>
</tr>
<tr>
<td style="text-align:center">utf8_bin</td>
<td style="text-align:center">将字符串中的每一个字符用二进制数据存储，区分大小写;</td>
</tr>
</tbody>
</table>
<p>一般来说，都是在<code>general_ci</code>和 <code>utf8_bin</code>之间来回选择，其他字符集同理，例如utf8mb4要区分大小写就：<code>utf8mb4_bin</code></p>
<h3 id="查看、删除数据库" tabindex="-1"><a class="header-anchor" href="#查看、删除数据库" aria-hidden="true">#</a> 查看、删除数据库</h3>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 显示所有数据库</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br></div></div><h3 id="备份、恢复数据库" tabindex="-1"><a class="header-anchor" href="#备份、恢复数据库" aria-hidden="true">#</a> 备份、恢复数据库</h3>
<ul>
<li>备份数据库（CMD或者Shell下执行）千万别用powerShell 千万别用powerShell 千万别用powerShell</li>
</ul>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># 备份整个数据库</span>
mysqldump -u 用户名 -p -B 数据库1 数据库2 数据库n <span class="token operator">></span> 文件名.sql或者路径/文件名.sql
<span class="token comment">#例如</span>
<span class="token builtin class-name">cd</span> d:<span class="token punctuation">\</span><span class="token punctuation">;</span>
mysqldump -u root -p -B db1 <span class="token operator">></span>my.sql

<span class="token comment">#备份数据库的某些表</span>
mysqldump -u 用户名 -p 数据库名 表1 表2 表n <span class="token operator">></span> 文件名.sql或者路径/文件名.sql

</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><p>不指定路径的话默认位置是当前shell所在同级路径下</p>
<ul>
<li>恢复数据库(要进入到MySQL命令行中执行)</li>
</ul>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># 必须得进入命令行</span>
mysql -uroot -p
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>然后再执行恢复：</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code>source 路径:文件<span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><p>或者直接把文件拖到那些图形化软件中执行也可</p>
<h2 id="表的相关操作" tabindex="-1"><a class="header-anchor" href="#表的相关操作" aria-hidden="true">#</a> 表的相关操作</h2>
<h3 id="创建、查看、删除表" tabindex="-1"><a class="header-anchor" href="#创建、查看、删除表" aria-hidden="true">#</a> 创建、查看、删除表</h3>
<p>​  mysql中，普遍的命名规则是下划线命名，而非是编程语言中常见的驼峰命名，例如<code>userMessage</code>在mysql中就要写成<code>user_message</code></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">create</span> <span class="token keyword">table</span> 表名（
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p><code>character set</code>字段的字符集，不指定为所在数据库的字符集</p>
<p><code>collate</code>字段的校验规则，不指定为所在数据库的规则</p>
<p><code>engine</code>引擎，这玩意涉及的内容有点多</p>
<p>验证规则，这个后面单独说-也被称为约束</p>
<p>查看当前库(database)中的所有表：</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 查看db1下的所有表;</span>
<span class="token keyword">use</span> db1<span class="token punctuation">;</span>
<span class="token keyword">show</span> <span class="token keyword">tables</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>删除当前库(database)中的某个表：</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 删除表：db1下的emp;</span>
<span class="token keyword">use</span> db1<span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><h3 id="mysql的数据类型" tabindex="-1"><a class="header-anchor" href="#mysql的数据类型" aria-hidden="true">#</a> MySql的数据类型</h3>
<p>大致如下，标了红旗的就是常用的，当然还有个非常罕见的bit(M)类型，M指定位数，默认值1，范围1~64</p>
<p>如果精度要求比价高的话就用Deicmal来存放数值</p>
<p>一般情况下不会用到二进制类型，文件一般都是直接存到一般，数据库中建个索引路径</p>
<p><img src="/images/JavaSE/21-MySql/MySql数据类型.svg" alt="MySql数据类型" loading="lazy"></p>
<p><img src="/images/JavaSE/21-MySql/image-20211120185628320.png" alt="image-20211120185628320" loading="lazy"></p>
<p><img src="/images/JavaSE/21-MySql/image-20211120185641114.png" alt="image-20211120185641114" loading="lazy"></p>
<p><img src="/images/JavaSE/21-MySql/image-20211120192745001.png" alt="image-20211120192745001" loading="lazy"></p>
<p><img src="/images/JavaSE/21-MySql/image-20211120192825877.png" alt="image-20211120192825877" loading="lazy"></p>
<p>Char和Varchar的长度（比如varchar(255)）表示的是255个字符，而并非是255个字节</p>
<p>反正用的时候只要知道，定义多长，就能放多少个字即可</p>
<p><img src="/images/JavaSE/21-MySql/image-20211120205829953.png" alt="image-20211120205829953" loading="lazy"></p>
<p><img src="/images/JavaSE/21-MySql/image-20211120205914839.png" alt="image-20211120205914839" loading="lazy"></p>
<h4 id="decimal类型额外说明" tabindex="-1"><a class="header-anchor" href="#decimal类型额外说明" aria-hidden="true">#</a> Decimal类型额外说明</h4>
<p>这个东西得额外提出来说一嘴</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">CREATE</span> <span class="token keyword">TABLE</span> db3<span class="token punctuation">(</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br></div></div><p><img src="/images/JavaSE/21-MySql/image-20211120190547035.png" alt="image-20211120190547035" loading="lazy"></p>
<p>![image-20211120185843253](/images/JavaSE/21-MySql/image-20211120185726028.png&quot; alt=&quot;image-20211120185726028&quot; style=&quot;zoom:50%;&quot; /&gt;&lt;img src=&quot;/images/JavaSE/21-MySql/image-20211120185843253.png)</p>
<h4 id="时间相关类型额外说明default值和on-update值" tabindex="-1"><a class="header-anchor" href="#时间相关类型额外说明default值和on-update值" aria-hidden="true">#</a> 时间相关类型额外说明default值和on update值</h4>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">CREATE</span> <span class="token keyword">TABLE</span> test_time <span class="token punctuation">(</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br></div></div><h3 id="修改表-字段的增删改" tabindex="-1"><a class="header-anchor" href="#修改表-字段的增删改" aria-hidden="true">#</a> 修改表-字段的增删改</h3>
<p>增加字段<code>alter table 表名 add 字段1 字段类型 [可选约束] [after 字段2]</code></p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>修改字段属性<code>alter table 表名 modify 字段1 字段类型 [可选约束] [after 字段2]</code></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><p>修改字段名及字段类型<code>alter table 表名 change 旧字段名 新字段名 新字段类型 [可选约束] [after 字段2]</code></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">alter</span> <span class="token keyword">table</span> emp change name user_name <span class="token keyword">varchar</span><span class="token punctuation">(</span><span class="token number">255</span><span class="token punctuation">)</span> <span class="token operator">not</span> <span class="token boolean">null</span> <span class="token keyword">comment</span> <span class="token string">'用户名'</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>删除字段<code>alter table 表名 drop 字段名</code></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">alter</span> <span class="token keyword">table</span> emp <span class="token keyword">drop</span> name<span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>查看表的结构:<code>desc 表名;</code></p>
<p>修改表名：<code>Rename table 表名 to 新表名;</code></p>
<p>修改表字符集：<code>alter table 表名 character set 字符集</code></p>
<h2 id="crud-增删改查" tabindex="-1"><a class="header-anchor" href="#crud-增删改查" aria-hidden="true">#</a> CRUD-增删改查</h2>
<h3 id="insert添加数据" tabindex="-1"><a class="header-anchor" href="#insert添加数据" aria-hidden="true">#</a> Insert添加数据</h3>
<p>语法：<code>insert into 表名 [可选(数据项目)] values(数据),[可选 (数据)]</code></p>
<p>插入数据的原则：校验用户的数据是否合发，是否在符合预期内，需前后端双重验证+防注入处理；</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">create</span> <span class="token keyword">table</span> person<span class="token punctuation">(</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br></div></div><h3 id="update更新数据" tabindex="-1"><a class="header-anchor" href="#update更新数据" aria-hidden="true">#</a> Update更新数据</h3>
<p>语法：<code>update 表名 set 字段名=字段值,字段名=字段值 [可选： where筛选器]</code></p>
<p>update 语法可以用于更新原有表行中的各列</p>
<p>set字句指示要修改那些行和要给予哪些值</p>
<p><strong>where字句指定应该更新哪些行，如果没有where，则更新所有行</strong>，实际工作中绝对不能犯这种错误......</p>
<p>如果要修改多个字段 可以<code>set 字段1=值1,字段2=值2....</code></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment">#将表中的所有条目的price字段修改为1000</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br></div></div><h3 id="delete删除数据" tabindex="-1"><a class="header-anchor" href="#delete删除数据" aria-hidden="true">#</a> Delete删除数据</h3>
<p>语法：<code>delete from 表名 [可选 where 筛选器]</code></p>
<p>如果没有带where，则删除表中的所有数据</p>
<p>使用delete语句仅删除记录，不删除表的本身，如果说要删除一个表，一般都是直接使用<code>drop table 表名</code>语句</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 删除表中name=王老五的人;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br></div></div><h3 id="删除表数据增强" tabindex="-1"><a class="header-anchor" href="#删除表数据增强" aria-hidden="true">#</a> 删除表数据增强</h3>
<ol>
<li>
<p>当你不再需要该表时， 用 drop：<code>drop table表名</code></p>
<ul>
<li>drop 是直接将表格删除，无法找回。例如删除 user 表：</li>
</ul>
</li>
<li>
<p>当你仍要保留该表，但要删除所有记录时，用truncate
<code>truncate （table） 表名</code></p>
<ul>
<li>truncate 是删除表中所有数据，但不能与where一起使用；</li>
</ul>
</li>
<li>
<p>当你要删除部分记录或者有可能会后悔的话， 用 delete
<code>delete from 表名 [where]</code></p>
<ul>
<li>delete 也是删除表中数据，但可以与where连用，删除特定行；</li>
</ul>
</li>
</ol>
<p>它们三者更详细的说明可以看<a href="https://www.cnblogs.com/fcc-123/p/10672604.html" target="_blank" rel="noopener noreferrer">这里<ExternalLinkIcon/></a></p>
<p>如果说想要删除某个表并且不留有缓存，但是又先使用了delete删除，那么再补一次truncate 即可</p>
<h1 id="select-查找-单表查询" tabindex="-1"><a class="header-anchor" href="#select-查找-单表查询" aria-hidden="true">#</a> Select 查找-单表查询</h1>
<p>​  看到这个H1标题了吗，是整个sql中最重要的玩意。没有任何东西比他更重要了。在任何类型、任何种类的数据库中，查找永远都是最重要的部分，查找对于数据库来说就好比，饭对于人的重要性一般。</p>
<h2 id="基本语法" tabindex="-1"><a class="header-anchor" href="#基本语法" aria-hidden="true">#</a> 基本语法</h2>
<p>基本语法很简单：</p>
<p><code>select [可选：distinct] *号或者字段名1，字段名2，字段名3... from 表名</code></p>
<p>distinct: 去重，当结果中有重复值的时候自动合并去重</p>
<p>也可以给字段取个别名：<code>select 字段1 as '别名1',字段2 as '别名2'... from 表名</code></p>
<p><strong>字段名是使用运算符的</strong></p>
<p>然后在表名后面可以跟where语句：<code>select 相关数据 from 表名 where 相关逻辑表达式</code></p>
<p>下面会演示的表达式：（代码块最后）运算，大小等于，and 和模糊匹配与正则表达式</p>
<p><a href="https://www.runoob.com/mysql/mysql-operator.html" target="_blank" rel="noopener noreferrer">运算符链接<ExternalLinkIcon/></a>，<a href="https://www.runoob.com/mysql/mysql-regexp.html" target="_blank" rel="noopener noreferrer">正则表达式链接<ExternalLinkIcon/></a>，<a href="https://www.runoob.com/mysql/mysql-like-clause.html" target="_blank" rel="noopener noreferrer">Like模糊匹配链接<ExternalLinkIcon/></a></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">use</span> db1<span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br><span class="line-number">62</span><br><span class="line-number">63</span><br><span class="line-number">64</span><br><span class="line-number">65</span><br><span class="line-number">66</span><br><span class="line-number">67</span><br><span class="line-number">68</span><br><span class="line-number">69</span><br><span class="line-number">70</span><br><span class="line-number">71</span><br><span class="line-number">72</span><br><span class="line-number">73</span><br><span class="line-number">74</span><br><span class="line-number">75</span><br><span class="line-number">76</span><br><span class="line-number">77</span><br><span class="line-number">78</span><br><span class="line-number">79</span><br><span class="line-number">80</span><br><span class="line-number">81</span><br><span class="line-number">82</span><br><span class="line-number">83</span><br><span class="line-number">84</span><br><span class="line-number">85</span><br><span class="line-number">86</span><br><span class="line-number">87</span><br><span class="line-number">88</span><br><span class="line-number">89</span><br><span class="line-number">90</span><br><span class="line-number">91</span><br><span class="line-number">92</span><br><span class="line-number">93</span><br><span class="line-number">94</span><br><span class="line-number">95</span><br><span class="line-number">96</span><br><span class="line-number">97</span><br><span class="line-number">98</span><br><span class="line-number">99</span><br><span class="line-number">100</span><br><span class="line-number">101</span><br><span class="line-number">102</span><br><span class="line-number">103</span><br><span class="line-number">104</span><br><span class="line-number">105</span><br><span class="line-number">106</span><br><span class="line-number">107</span><br><span class="line-number">108</span><br><span class="line-number">109</span><br><span class="line-number">110</span><br><span class="line-number">111</span><br><span class="line-number">112</span><br><span class="line-number">113</span><br><span class="line-number">114</span><br><span class="line-number">115</span><br><span class="line-number">116</span><br><span class="line-number">117</span><br><span class="line-number">118</span><br><span class="line-number">119</span><br><span class="line-number">120</span><br><span class="line-number">121</span><br><span class="line-number">122</span><br><span class="line-number">123</span><br><span class="line-number">124</span><br><span class="line-number">125</span><br><span class="line-number">126</span><br><span class="line-number">127</span><br><span class="line-number">128</span><br><span class="line-number">129</span><br><span class="line-number">130</span><br><span class="line-number">131</span><br><span class="line-number">132</span><br><span class="line-number">133</span><br><span class="line-number">134</span><br><span class="line-number">135</span><br><span class="line-number">136</span><br><span class="line-number">137</span><br><span class="line-number">138</span><br><span class="line-number">139</span><br><span class="line-number">140</span><br><span class="line-number">141</span><br><span class="line-number">142</span><br><span class="line-number">143</span><br><span class="line-number">144</span><br><span class="line-number">145</span><br><span class="line-number">146</span><br><span class="line-number">147</span><br><span class="line-number">148</span><br><span class="line-number">149</span><br><span class="line-number">150</span><br><span class="line-number">151</span><br><span class="line-number">152</span><br><span class="line-number">153</span><br><span class="line-number">154</span><br><span class="line-number">155</span><br><span class="line-number">156</span><br><span class="line-number">157</span><br><span class="line-number">158</span><br><span class="line-number">159</span><br><span class="line-number">160</span><br><span class="line-number">161</span><br><span class="line-number">162</span><br><span class="line-number">163</span><br><span class="line-number">164</span><br><span class="line-number">165</span><br><span class="line-number">166</span><br><span class="line-number">167</span><br><span class="line-number">168</span><br><span class="line-number">169</span><br><span class="line-number">170</span><br><span class="line-number">171</span><br><span class="line-number">172</span><br><span class="line-number">173</span><br><span class="line-number">174</span><br></div></div><h2 id="统计函数" tabindex="-1"><a class="header-anchor" href="#统计函数" aria-hidden="true">#</a> 统计函数</h2>
<h3 id="order-by-对结果进行排序" tabindex="-1"><a class="header-anchor" href="#order-by-对结果进行排序" aria-hidden="true">#</a> Order By 对结果进行排序</h3>
<p>语法：<code>select 条目 from 表名 [条件筛选 where] order by 根据哪个字段 asc|desc</code></p>
<p>ASC 升序（默认） 、DESC 降序</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 根据数学成绩升序排列</span>
...
<span class="token operator">|</span> 王老五    <span class="token operator">|</span>         <span class="token number">279</span> <span class="token operator">|</span>
<span class="token operator">+</span><span class="token comment">-----------+-------------+</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br></div></div><h3 id="count-合并、统计函数" tabindex="-1"><a class="header-anchor" href="#count-合并、统计函数" aria-hidden="true">#</a> Count-合并、统计函数</h3>
<p>语法：<code>select count(*)|count(列名) from 表名 [可选 where等]</code></p>
<p>count(*)和count(列名)的区别</p>
<ul>
<li>count(*) 返回满足条件的记录的行数，不会排除值为null的
<ul>
<li>比如说一个人姓名年龄age之类的所有信息都为null，依然也会计入+1</li>
</ul>
</li>
<li>count(列名) 统计满足条件的某列有多少个，会排除值为null的
<ul>
<li>比如说要统计age 然后有一个人的age为null，则这个人将不会算入其中，不会+1</li>
</ul>
</li>
</ul>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment">#统计学生表共有多少行</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br></div></div><h3 id="sum-合计函数-计算数值的总合" tabindex="-1"><a class="header-anchor" href="#sum-合计函数-计算数值的总合" aria-hidden="true">#</a> SUM- 合计函数-计算数值的总合</h3>
<p>该函数满足where条件的行的和，一般用于数值列</p>
<p>语法：<code>select sum(列名)，{sum(列名)...} from 表名 [where筛选器]</code></p>
<p>只能对数值使用，否则会报错</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 计算数学的总成绩</span>
...
<span class="token operator">+</span><span class="token comment">-----------+</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br></div></div><h3 id="avg-合计函数-求平均值" tabindex="-1"><a class="header-anchor" href="#avg-合计函数-求平均值" aria-hidden="true">#</a> AVG-合计函数-求平均值</h3>
<p>返回满足where条件的一列的平均值</p>
<p>语法：<code>select avg(列名){avg(列名)...} from 表名 [where]</code></p>
<p>只能对数值使用</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 求数学平均分;</span>
...
<span class="token operator">|</span>     <span class="token number">199.3750</span> <span class="token operator">|</span>
<span class="token operator">+</span><span class="token comment">--------------+</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><h3 id="max-min-合计函数-返回最大最小值" tabindex="-1"><a class="header-anchor" href="#max-min-合计函数-返回最大最小值" aria-hidden="true">#</a> Max/Min-合计函数-返回最大最小值</h3>
<p>返回满足where条件列的最大、最小值</p>
<p>语法：<code>select max|min(列名) from 表名 [where]</code></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment">#求一个班级的总最高分和总最低分</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><h3 id="group-by-having-分组-过滤" tabindex="-1"><a class="header-anchor" href="#group-by-having-分组-过滤" aria-hidden="true">#</a> Group By+Having-分组+过滤</h3>
<p>语法：<code>select 字段1,字段2,... from 表名 [where筛选器] group by 字段</code></p>
<p>可选，使用having字句对分组后的结果进行过滤 一般情况下group by和having是形影不离的</p>
<p><code>select 字段1,字段2,... from 表名 group by 字段 having...</code></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 先分别建立好几张表</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br></div></div><p>接下来使用Group By+Having完成一系列操作</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 显示每个部门的平均和最高工资,按照部门来分组查询 并从低到高排序</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br></div></div><p><img src="/images/JavaSE/21-MySql/image-20211121154510850.png" alt="image-20211121154510850" loading="lazy"></p>
<h2 id="字符串函数" tabindex="-1"><a class="header-anchor" href="#字符串函数" aria-hidden="true">#</a> 字符串函数</h2>
<p><img src="/images/JavaSE/21-MySql/image-20211121154625191.png" alt="image-20211121154625191" loading="lazy"></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment">#返回字串字符集</span>
...
<span class="token operator">|</span> Miller       <span class="token operator">|</span>
<span class="token operator">+</span><span class="token comment">--------------+</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br><span class="line-number">62</span><br><span class="line-number">63</span><br><span class="line-number">64</span><br><span class="line-number">65</span><br><span class="line-number">66</span><br><span class="line-number">67</span><br><span class="line-number">68</span><br><span class="line-number">69</span><br><span class="line-number">70</span><br><span class="line-number">71</span><br><span class="line-number">72</span><br><span class="line-number">73</span><br><span class="line-number">74</span><br><span class="line-number">75</span><br><span class="line-number">76</span><br><span class="line-number">77</span><br><span class="line-number">78</span><br><span class="line-number">79</span><br><span class="line-number">80</span><br><span class="line-number">81</span><br><span class="line-number">82</span><br><span class="line-number">83</span><br><span class="line-number">84</span><br><span class="line-number">85</span><br><span class="line-number">86</span><br><span class="line-number">87</span><br><span class="line-number">88</span><br><span class="line-number">89</span><br><span class="line-number">90</span><br><span class="line-number">91</span><br><span class="line-number">92</span><br><span class="line-number">93</span><br><span class="line-number">94</span><br><span class="line-number">95</span><br><span class="line-number">96</span><br><span class="line-number">97</span><br><span class="line-number">98</span><br><span class="line-number">99</span><br><span class="line-number">100</span><br><span class="line-number">101</span><br><span class="line-number">102</span><br><span class="line-number">103</span><br><span class="line-number">104</span><br><span class="line-number">105</span><br><span class="line-number">106</span><br><span class="line-number">107</span><br><span class="line-number">108</span><br><span class="line-number">109</span><br><span class="line-number">110</span><br><span class="line-number">111</span><br><span class="line-number">112</span><br><span class="line-number">113</span><br><span class="line-number">114</span><br><span class="line-number">115</span><br><span class="line-number">116</span><br><span class="line-number">117</span><br><span class="line-number">118</span><br><span class="line-number">119</span><br><span class="line-number">120</span><br><span class="line-number">121</span><br><span class="line-number">122</span><br><span class="line-number">123</span><br><span class="line-number">124</span><br><span class="line-number">125</span><br><span class="line-number">126</span><br><span class="line-number">127</span><br><span class="line-number">128</span><br><span class="line-number">129</span><br><span class="line-number">130</span><br><span class="line-number">131</span><br><span class="line-number">132</span><br><span class="line-number">133</span><br><span class="line-number">134</span><br><span class="line-number">135</span><br><span class="line-number">136</span><br><span class="line-number">137</span><br><span class="line-number">138</span><br></div></div><h2 id="数学相关函数" tabindex="-1"><a class="header-anchor" href="#数学相关函数" aria-hidden="true">#</a> 数学相关函数</h2>
<p><img src="/images/JavaSE/21-MySql/image-20211121163030748.png" alt="image-20211121163030748" loading="lazy"></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 比较简单的这里不写了，写一些看起来难理解的</span>
...
<span class="token operator">+</span><span class="token comment">---------------------+</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br></div></div><h2 id="时间日期相关函数" tabindex="-1"><a class="header-anchor" href="#时间日期相关函数" aria-hidden="true">#</a> 时间日期相关函数</h2>
<p><img src="/images/JavaSE/21-MySql/image-20211121165926182.png" alt="image-20211121165926182" loading="lazy"></p>
<p><img src="/images/JavaSE/21-MySql/image-20211121172736581.png" alt="image-20211121172736581" loading="lazy"><img src="/images/JavaSE/21-MySql/image-20211121172709333.png" alt="image-20211121172709333" loading="lazy"></p>
<p><img src="/images/JavaSE/21-MySql/image-20211121173857683.png" alt="image-20211121173857683" loading="lazy"></p>
<p><img src="/images/JavaSE/21-MySql/image-20211121173952348.png" alt="image-20211121173952348" loading="lazy"></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">create</span> <span class="token keyword">table</span> mes<span class="token punctuation">(</span>id <span class="token keyword">int</span><span class="token punctuation">,</span>content <span class="token keyword">varchar</span><span class="token punctuation">(</span><span class="token number">30</span><span class="token punctuation">)</span><span class="token punctuation">,</span>send_time <span class="token keyword">DATETIME</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br><span class="line-number">62</span><br><span class="line-number">63</span><br><span class="line-number">64</span><br></div></div><h2 id="加密函数和系统函数" tabindex="-1"><a class="header-anchor" href="#加密函数和系统函数" aria-hidden="true">#</a> 加密函数和系统函数</h2>
<p><img src="/images/JavaSE/21-MySql/image-20211121174113576.png" alt="image-20211121174113576" loading="lazy"></p>
<p>补充：<a href="https://blog.csdn.net/rocky1996/article/details/75283826" target="_blank" rel="noopener noreferrer">mysql加密数据的几种方法<ExternalLinkIcon/></a>、<a href="https://www.cnblogs.com/gjc592/p/9681093.html" target="_blank" rel="noopener noreferrer">mysql8更该的用户信息加密方式<ExternalLinkIcon/></a></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 查询用户</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br></div></div><h2 id="流程控制函数-if-ifnull-case" tabindex="-1"><a class="header-anchor" href="#流程控制函数-if-ifnull-case" aria-hidden="true">#</a> 流程控制函数-IF-IFNULL-CASE</h2>
<p>if类似于三元表达式</p>
<p>ifnull类似于if</p>
<p>case类似于 套娃版三元表达式</p>
<p><img src="/images/JavaSE/21-MySql/image-20211121205018177.png" alt="image-20211121205018177" loading="lazy"></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># if语句的基本使用：</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br><span class="line-number">62</span><br><span class="line-number">63</span><br><span class="line-number">64</span><br><span class="line-number">65</span><br><span class="line-number">66</span><br><span class="line-number">67</span><br><span class="line-number">68</span><br><span class="line-number">69</span><br><span class="line-number">70</span><br><span class="line-number">71</span><br><span class="line-number">72</span><br><span class="line-number">73</span><br><span class="line-number">74</span><br><span class="line-number">75</span><br><span class="line-number">76</span><br><span class="line-number">77</span><br><span class="line-number">78</span><br><span class="line-number">79</span><br><span class="line-number">80</span><br><span class="line-number">81</span><br><span class="line-number">82</span><br><span class="line-number">83</span><br><span class="line-number">84</span><br><span class="line-number">85</span><br></div></div><h2 id="单表补充-加强查询" tabindex="-1"><a class="header-anchor" href="#单表补充-加强查询" aria-hidden="true">#</a> 单表补充-加强查询</h2>
<h3 id="where比较日期" tabindex="-1"><a class="header-anchor" href="#where比较日期" aria-hidden="true">#</a> Where比较日期</h3>
<p>在Mysql中，日期类型可以直接比较</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 查找1992.10.1后入职的员工-使用where完成</span>
...
<span class="token operator">+</span><span class="token comment">-------+------------+</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><h3 id="like模糊查询规则" tabindex="-1"><a class="header-anchor" href="#like模糊查询规则" aria-hidden="true">#</a> Like模糊查询规则</h3>
<ul>
<li><code>%</code>表示0到多个字符</li>
<li><code>_</code>表示单个字符</li>
</ul>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 查找首字母为S的员工姓名和工资 这里因为表格是非严格匹配大小写的，所以可以直接用小写的s</span>
...
<span class="token operator">+</span><span class="token comment">-------+---------+</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br></div></div><h3 id="判断值是否为null" tabindex="-1"><a class="header-anchor" href="#判断值是否为null" aria-hidden="true">#</a> 判断值是否为NULl</h3>
<p>使用 <code>select * from xxx where xxx IS NULL</code></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 显示没有上级雇员的情况</span>
...
<span class="token operator">|</span>  <span class="token number">7900</span> <span class="token operator">|</span> TURNER <span class="token operator">|</span> PRESIDENT <span class="token operator">|</span> <span class="token boolean">NULL</span> <span class="token operator">|</span> <span class="token number">1888</span><span class="token operator">-</span><span class="token number">01</span><span class="token operator">-</span><span class="token number">01</span> <span class="token operator">|</span> <span class="token number">2435.00</span> <span class="token operator">|</span> <span class="token boolean">NULL</span> <span class="token operator">|</span>     <span class="token number">30</span> <span class="token operator">|</span>
<span class="token operator">+</span><span class="token comment">-------+--------+-----------+------+------------+---------+------+--------+</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><h3 id="查询表的结构" tabindex="-1"><a class="header-anchor" href="#查询表的结构" aria-hidden="true">#</a> 查询表的结构</h3>
<p><code>desc 表名称</code></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 查看emp表的表结构;</span>
...
<span class="token operator">|</span> deptno   <span class="token operator">|</span> <span class="token keyword">mediumint</span> <span class="token keyword">unsigned</span> <span class="token operator">|</span> <span class="token keyword">NO</span>   <span class="token operator">|</span>     <span class="token operator">|</span> <span class="token number">0</span>       <span class="token operator">|</span>       <span class="token operator">|</span>
<span class="token operator">+</span><span class="token comment">----------+--------------------+------+-----+---------+-------+</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br></div></div><h3 id="order-by排序-多重排序" tabindex="-1"><a class="header-anchor" href="#order-by排序-多重排序" aria-hidden="true">#</a> Order By排序-多重排序</h3>
<p>语法：<code>select * from 表名 [where] order by 字段1 字段1排序规则, 字段2 字段2排序规则...</code></p>
<p>字段1 中相同的按照字段2的排序规则进行排序 字段2中相同的字段按照字段3的规则进行排序...以此类推</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 按照部门号升序而雇员的工资降序的顺序排列</span>
...
<span class="token operator">+</span><span class="token comment">--------+---------+--------+</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br></div></div><h3 id="limit-分页查询" tabindex="-1"><a class="header-anchor" href="#limit-分页查询" aria-hidden="true">#</a> LIMIT 分页查询</h3>
<p>在实际工作中，<strong>做任何项目时都要用到分页</strong>，因为正常情况下，一张表的数据往往是几万几十万几百万，不可能说每次查询都把全部查询下来：</p>
<p>基本语法：<code>select ... from 表名 [where order  group 等语句] LIMIT 位置,数量</code></p>
<p>位置(index)从零开始计数</p>
<p>嘛，也就是说 实际上是index+1</p>
<ul>
<li>0,10，表示第一条到第十条</li>
<li>10,20表示第十一条到第二十条</li>
<li>20，30表示第二十一条到第三十条</li>
</ul>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 按照员工的id号升序取出，每页显示三条记录，分别显示1,2,3页</span>
...
<span class="token operator">|</span>  <span class="token number">7900</span> <span class="token operator">|</span> TURNER <span class="token operator">|</span> PRESIDENT <span class="token operator">|</span> <span class="token boolean">NULL</span> <span class="token operator">|</span> <span class="token number">1888</span><span class="token operator">-</span><span class="token number">01</span><span class="token operator">-</span><span class="token number">01</span> <span class="token operator">|</span> <span class="token number">2435.00</span> <span class="token operator">|</span>    <span class="token boolean">NULL</span> <span class="token operator">|</span>     <span class="token number">30</span> <span class="token operator">|</span>
<span class="token operator">+</span><span class="token comment">-------+--------+-----------+------+------------+---------+---------+--------+</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br></div></div><h3 id="使用分组函数和分组字句、流程控制增强-group-by、if" tabindex="-1"><a class="header-anchor" href="#使用分组函数和分组字句、流程控制增强-group-by、if" aria-hidden="true">#</a> 使用分组函数和分组字句、流程控制增强 GROUP BY、IF</h3>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 显示 每种岗位 的 雇员总数、平均工资</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br></div></div><h3 id="group-having-limit-order-的使用顺序" tabindex="-1"><a class="header-anchor" href="#group-having-limit-order-的使用顺序" aria-hidden="true">#</a> Group Having limit order 的使用顺序</h3>
<p>首先他们必须在where之后，</p>
<p>这之后的顺序就是</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">select</span> 字段 <span class="token keyword">from</span> 表名 <span class="token keyword">where</span> 条件
...
<span class="token operator">|</span> <span class="token number">1690.005000</span> <span class="token operator">|</span>     <span class="token number">30</span> <span class="token operator">|</span>
<span class="token operator">+</span><span class="token comment">-------------+--------+</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br></div></div><h1 id="select-查找-多表查询" tabindex="-1"><a class="header-anchor" href="#select-查找-多表查询" aria-hidden="true">#</a> Select 查找-多表查询</h1>
<p>实际上开发过程中多表用的多一些（指七八个表一块查..）</p>
<p><img src="/images/JavaSE/21-MySql/image-20211121223552978.png" alt="image-20211121223552978" loading="lazy"></p>
<p>接下来过程中要用到的三张表</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code>mysql<span class="token operator">></span> <span class="token keyword">select</span> <span class="token operator">*</span> <span class="token keyword">from</span> dept<span class="token punctuation">;</span>
<span class="token operator">+</span><span class="token comment">--------+------------+----------+</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br></div></div><p><img src="/images/JavaSE/21-MySql/image-20211121223951951.png" alt="image-20211121223951951" loading="lazy"></p>
<p><img src="/images/JavaSE/21-MySql/image-20211121224339699.png" alt="image-20211121224339699" loading="lazy"></p>
<p>这样多表查询默认处理返回的结果，称为笛卡尔集</p>
<h2 id="多表查询-where过滤" tabindex="-1"><a class="header-anchor" href="#多表查询-where过滤" aria-hidden="true">#</a> 多表查询-where过滤</h2>
<p>解决这个多表的关键就是要写出正确的过滤条件 where</p>
<p><img src="/images/JavaSE/21-MySql/image-20211121230457415.png" alt="image-20211121230457415" loading="lazy"></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br><span class="line-number">62</span><br><span class="line-number">63</span><br><span class="line-number">64</span><br><span class="line-number">65</span><br><span class="line-number">66</span><br><span class="line-number">67</span><br><span class="line-number">68</span><br><span class="line-number">69</span><br><span class="line-number">70</span><br><span class="line-number">71</span><br><span class="line-number">72</span><br><span class="line-number">73</span><br><span class="line-number">74</span><br><span class="line-number">75</span><br><span class="line-number">76</span><br><span class="line-number">77</span><br><span class="line-number">78</span><br><span class="line-number">79</span><br><span class="line-number">80</span><br><span class="line-number">81</span><br><span class="line-number">82</span><br><span class="line-number">83</span><br><span class="line-number">84</span><br></div></div><h2 id="mysql-多表查询-自连接" tabindex="-1"><a class="header-anchor" href="#mysql-多表查询-自连接" aria-hidden="true">#</a> Mysql 多表查询-自连接</h2>
<p>自连接指的是在同一张表的连接查询个（将同一张表看做两张表）</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 显示公示员工和他上级的名字</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br></div></div><h2 id="mysql多表查询-子查询-查询结果当做临时表使用" tabindex="-1"><a class="header-anchor" href="#mysql多表查询-子查询-查询结果当做临时表使用" aria-hidden="true">#</a> Mysql多表查询-子查询-查询结果当做临时表使用</h2>
<p>就是结果当成表来使用</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 查询emp各个comm分组中 工资最高的人 并按照类别升序排序</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br></div></div><h2 id="mysql多表查询-all、any匹配操作符" tabindex="-1"><a class="header-anchor" href="#mysql多表查询-all、any匹配操作符" aria-hidden="true">#</a> Mysql多表查询-All、Any匹配操作符</h2>
<p>all就是匹配某个值是否为另一个列表返回的所有字段或者一个子查询返回的所有字段的值</p>
<p>all前面一般是大于小于或者等于号</p>
<p>all 就是匹配全部</p>
<p>any 就是匹配上其中一个即可</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 显示工资比部门30的 所有员工 的工资高的员工姓名、工资和部门号</span>
...
<span class="token operator">|</span> MILLER <span class="token operator">|</span>  <span class="token number">735.05</span> <span class="token operator">|</span>     <span class="token number">20</span> <span class="token operator">|</span>
<span class="token operator">+</span><span class="token comment">--------+---------+--------+</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br></div></div><h2 id="mysql多表查询-多列子查询" tabindex="-1"><a class="header-anchor" href="#mysql多表查询-多列子查询" aria-hidden="true">#</a> Mysql多表查询-多列子查询</h2>
<p>就是多个值同时进行匹配，可以有效降低查询时候的资源浪费</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment">#查询与 SMITH 的部门和岗位完全相同的所有雇员（不包括smith本人）</span>
...
<span class="token operator">+</span><span class="token comment">--------------+--------------+--------------+-----------------------+</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br></div></div><h3 id="多表查询细节1-as的省略-返回某个表的全部内容" tabindex="-1"><a class="header-anchor" href="#多表查询细节1-as的省略-返回某个表的全部内容" aria-hidden="true">#</a> 多表查询细节1 -as的省略，*返回某个表的全部内容</h3>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># as 可以省略</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><h2 id="表复制-蠕虫复制、复制表的结构、去除表中的重复记录" tabindex="-1"><a class="header-anchor" href="#表复制-蠕虫复制、复制表的结构、去除表中的重复记录" aria-hidden="true">#</a> 表复制-蠕虫复制、复制表的结构、去除表中的重复记录</h2>
<p>有的时候，为了对某个sql语句进行效率测试，我们需要海量数据时，可以使用此方法为表创建海量数据</p>
<h3 id="复制表" tabindex="-1"><a class="header-anchor" href="#复制表" aria-hidden="true">#</a> 复制表</h3>
<ul>
<li><code>insert into 表1 select * from 表1</code> 自我复制</li>
<li><code>insert into 表1(字段1 字段2...) select 字段1,字段2... from 表2</code> 两个表之间的复制
<ul>
<li>把表2中相应字段的值按照顺序复制到表1的相应字段（按照字段1，字段2相互相对应）</li>
</ul>
</li>
</ul>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 先来个测试的表</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br></div></div><h3 id="复制表的结构" tabindex="-1"><a class="header-anchor" href="#复制表的结构" aria-hidden="true">#</a> 复制表的结构</h3>
<p>语法：<code>create table 表2 like 表1</code> 把表1的结构完整的复制给表2</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 复制表的结构</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br></div></div><h3 id="表的去重" tabindex="-1"><a class="header-anchor" href="#表的去重" aria-hidden="true">#</a> 表的去重</h3>
<p>去重方式网上应该有更多种，这里举例一种最笨的方法</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 表的去重</span>
...
<span class="token operator">|</span>  <span class="token number">7966</span> <span class="token operator">|</span> MILLER <span class="token operator">|</span> CLERK     <span class="token operator">|</span> <span class="token number">7782</span> <span class="token operator">|</span> <span class="token number">1991</span><span class="token operator">-</span><span class="token number">10</span><span class="token operator">-</span><span class="token number">12</span> <span class="token operator">|</span>  <span class="token number">735.05</span> <span class="token operator">|</span>  <span class="token number">453.25</span> <span class="token operator">|</span>     <span class="token number">20</span> <span class="token operator">|</span>
<span class="token operator">+</span><span class="token comment">-------+--------+-----------+------+------------+---------+---------+--------+</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br></div></div><h2 id="合并查询-union、union-all" tabindex="-1"><a class="header-anchor" href="#合并查询-union、union-all" aria-hidden="true">#</a> 合并查询-UNION、UNION ALL</h2>
<p><img src="/images/JavaSE/21-MySql/image-20211122154537661.png" alt="image-20211122154537661" loading="lazy"></p>
<p><img src="/images/JavaSE/21-MySql/image-20211122154637130.png" alt="image-20211122154637130" loading="lazy"></p>
<h2 id="多表查询-外连接" tabindex="-1"><a class="header-anchor" href="#多表查询-外连接" aria-hidden="true">#</a> 多表查询-外连接</h2>
<p><img src="/images/JavaSE/21-MySql/image-20211122154827000.png" alt="image-20211122154827000" loading="lazy"></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 这里使用mgr  上级名称来演示</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br></div></div><p>Mysql中外连接分为两种</p>
<h3 id="左外连接" tabindex="-1"><a class="header-anchor" href="#左外连接" aria-hidden="true">#</a> 左外连接</h3>
<ul>
<li>
<p>左外连接 如果<code>左侧的表能够完全显示</code>就是左外连接</p>
<ul>
<li>
<p><strong>左边的表即使和右边的表</strong>没有完全匹配的记录也能完全显示出来</p>
</li>
<li>
<p>语法：</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">select</span> 字段  <span class="token keyword">from</span>
...
<h3 id="右外连接" tabindex="-1"><a class="header-anchor" href="#右外连接" aria-hidden="true">#</a> 右外连接</h3>
<ul>
<li>
<p>右外连接 如果<code>右侧的表能完全显示</code>就是右外连接</p>
<ul>
<li>
<p><strong>右边的表即使和左边的表</strong>没有完全匹配的记录也能完全显示出来</p>
</li>
<li>
<p>语法</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">select</span> 字段  <span class="token keyword">from</span>
...
<h1 id="mysql约束" tabindex="-1"><a class="header-anchor" href="#mysql约束" aria-hidden="true">#</a> Mysql约束</h1>
<p>嘛，这玩意可能是sql中创建表时必备的玩意了</p>
<h2 id="primary-key-主键约束" tabindex="-1"><a class="header-anchor" href="#primary-key-主键约束" aria-hidden="true">#</a> Primary key 主键约束</h2>
<p>语法：<code>字段名 字段类型 PRIMARY KEY</code></p>
<p>用于唯一的标识该字段（表行）的数据当定义主键后，该列<strong>不能重复</strong></p>
<p>这个 。。。只能说是一张表都得用它</p>
<p><img src="/images/JavaSE/21-MySql/image-20211122163807238.png" alt="image-20211122163807238" loading="lazy"></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 前面添加主键</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br></div></div><h2 id="not-null-非空约束" tabindex="-1"><a class="header-anchor" href="#not-null-非空约束" aria-hidden="true">#</a> NOT NULL 非空约束</h2>
<p>这个不多说了</p>
...
<span class="token punctuation">)</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><h2 id="unique-唯一约束" tabindex="-1"><a class="header-anchor" href="#unique-唯一约束" aria-hidden="true">#</a> UNIQUE 唯一约束</h2>
<p>让某个字段不能有重复值</p>
<p>注意，这玩意一定要配合非空约束<code>not null</code>来使用</p>
<p>如果没有指定<code>not null</code>，则<code>unique</code>字段可以有多个null</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">create</span> <span class="token keyword">table</span> 表名<span class="token punctuation">(</span>
 字段值 字段类型 <span class="token operator">NOT</span> <span class="token boolean">NULL</span> <span class="token keyword">UNIQUE</span>
<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><h2 id="foreign-key-外键约束" tabindex="-1"><a class="header-anchor" href="#foreign-key-外键约束" aria-hidden="true">#</a> FOREIGN KEY 外键约束</h2>
<p>语法：<code>FOREIGN KEY (本表字段名) REFERENCES 主表名(主键名或UNIQUE字段名)</code></p>
<p>用语定义主表和从表之间 关系，外键约束要定义在从表上，且主表必须具有主键约束或是<code>unique</code>约束，当定义外键约束后，要求外键约束的字段（列）的数据（值）必须在主表的主键列存在或是为null</p>
<p>外键约束定义后，若主表要删除某个值，且该值正在外界约束的影响下，且从表正在使用他，需要先删除正在使用它的从表中用了它的内容，才能删除它的值</p>
<p><strong>一个从表中，外键可以有多个，任何表都可以是从表</strong></p>
<p><img src="/images/JavaSE/21-MySql/image-20211122170615206.png" alt="image-20211122170615206" loading="lazy"></p>
<p>![image-20211122164935895](/images/JavaSE/21-MySql/image-20211122164902068.png&quot; alt=&quot;image-20211122164902068&quot; style=&quot;zoom: 25%;&quot; /&gt;&lt;img src=&quot;/images/JavaSE/21-MySql/image-20211122164935895.png)</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">create</span> <span class="token keyword">table</span> class_tab<span class="token punctuation">(</span>
 id <span class="token keyword">int</span> <span class="token keyword">primary</span> <span class="token keyword">key</span><span class="token punctuation">,</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br></div></div><p>图形化界面可以轻松地选择外键</p>
<p><img src="/images/JavaSE/21-MySql/image-20211122170505505.png" alt="image-20211122170505505" loading="lazy"></p>
<h2 id="check约束-要求字段满足指定条件-枚举约定" tabindex="-1"><a class="header-anchor" href="#check约束-要求字段满足指定条件-枚举约定" aria-hidden="true">#</a> Check约束 -要求字段满足指定条件（枚举约定）</h2>
<p><img src="/images/JavaSE/21-MySql/image-20211122171017894.png" alt="image-20211122171017894" loading="lazy"></p>
<p>在Mysql8.0中，已经可以支持验证了，插入不合法的值，将插入失效</p>
<p>在<code>oracle</code>、<code>sql server</code>中，这个约束是一定会生效的</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">create</span> <span class="token keyword">table</span> my_test_nx<span class="token punctuation">(</span>
 id <span class="token keyword">int</span> <span class="token keyword">primary</span> <span class="token keyword">key</span><span class="token punctuation">,</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br></div></div><h2 id="auto-increment-自增长" tabindex="-1"><a class="header-anchor" href="#auto-increment-自增长" aria-hidden="true">#</a> Auto_increment-自增长</h2>
<p>如其名，自动增长，适用于主键等 通常情况下主键都会用它</p>
<p>也得名：主键自增</p>
<p><img src="/images/JavaSE/21-MySql/image-20211122173148429.png" alt="image-20211122173148429" loading="lazy"></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment">#自增长</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><h3 id="自增长增归零" tabindex="-1"><a class="header-anchor" href="#自增长增归零" aria-hidden="true">#</a> 自增长增归零</h3>
<p>·如果曾经的数据都不需要的话，可以直接清空所有数据，并将自增字段恢复从1开始计数
<code>truncate table 表名</code></p>
<p>或者要保留数据，但是后插入的数据都是按照新的值来开始计算</p>
<p><code>ALTER TABLE 表名 AUTO_INCREMENT = 值;</code></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">insert</span> <span class="token keyword">into</span> test_auto<span class="token punctuation">(</span>name<span class="token punctuation">)</span> <span class="token keyword">values</span><span class="token punctuation">(</span><span class="token string">'jock'</span><span class="token punctuation">)</span><span class="token punctuation">,</span><span class="token punctuation">(</span><span class="token string">'having'</span><span class="token punctuation">)</span><span class="token punctuation">,</span><span class="token punctuation">(</span><span class="token string">'booluse'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token operator">+</span><span class="token comment">------+---------+</span>
<span class="token operator">|</span> id   <span class="token operator">|</span> name    <span class="token operator">|</span>
<span class="token operator">+</span><span class="token comment">------+---------+</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br></div></div><h1 id="mysql索引" tabindex="-1"><a class="header-anchor" href="#mysql索引" aria-hidden="true">#</a> Mysql索引</h1>
<p><img src="/images/JavaSE/21-MySql/image-20211122173232565.png" alt="image-20211122173232565" loading="lazy"></p>
<p>先按照<a href="https://blog.csdn.net/qq_40530040/article/details/107623254" target="_blank" rel="noopener noreferrer">这个教程<ExternalLinkIcon/></a>创建一个海量表</p>
<p>或者按照下方代码顺序的运行( 分开运行)</p>
<p>第一步： 这一步可能会出错，出错的话就三个建表的分开执行即可</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 第一行代码的用途：https://blog.csdn.net/topasstem8/article/details/8216740/</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br></div></div><p>第二步</p>
...
<span class="token comment">#set autocommit =0 把autocommit设置成0</span>
 ...
 <span class="token comment">#commit整体提交所有sql语句，提高效率</span>
   <span class="token keyword">commit</span><span class="token punctuation">;</span>
 <span class="token keyword">end</span> $$
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br><span class="line-number">62</span><br><span class="line-number">63</span><br><span class="line-number">64</span><br><span class="line-number">65</span><br><span class="line-number">66</span><br><span class="line-number">67</span><br><span class="line-number">68</span><br><span class="line-number">69</span><br><span class="line-number">70</span><br><span class="line-number">71</span><br><span class="line-number">72</span><br><span class="line-number">73</span><br></div></div><p>第三步：</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">delimiter</span> $$
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>对自己电脑有信心的话可以1000w，千万不要1个亿，除非你的时间和硬盘空间是真滴多</p>
<p>接下来尝试查询下：</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><p>接下来使用索引优化下表</p>
<p><img src="/images/JavaSE/21-MySql/image-20211122204414063.png" alt="image-20211122204414063" loading="lazy"></p>
<p>优化前，这个表是72mb，查询一次大概要1s的时间</p>
<h2 id="创建索引" tabindex="-1"><a class="header-anchor" href="#创建索引" aria-hidden="true">#</a> 创建索引</h2>
<p>语法：<code>CREATE INDEX 索引名 ON 表名(字段);</code></p>
<p>索引创建需要时间，索引跟数据一样，也占用空间</p>
<p>但是能对查询速度有显著提升</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">CREATE</span> <span class="token keyword">INDEX</span> empno_index <span class="token keyword">ON</span> emp<span class="token punctuation">(</span>empno<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p><img src="/images/JavaSE/21-MySql/image-20211122204942231.png" alt="image-20211122204942231" loading="lazy"></p>
<p>创建完毕后，文件大了10mb</p>
<p>索引本身也是会占用磁盘空间</p>
<p>接下来尝试搜索下</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br></div></div><p>当然，目前也有很多不良程序员，会直接把产品给用户用，直到用户发觉很慢的时候，让用户加钱优化</p>
<h2 id="索引机制" tabindex="-1"><a class="header-anchor" href="#索引机制" aria-hidden="true">#</a> 索引机制</h2>
<p>下图到查询到1后不确定后面还没有没有id=1的，所以要全表扫描</p>
<p><img src="/images/JavaSE/21-MySql/image-20211122211047180.png" alt="image-20211122211047180" loading="lazy"></p>
<p><img src="/images/JavaSE/21-MySql/image-20211122212123404.png" alt="image-20211122212123404" loading="lazy"></p>
<p>索引快的原因</p>
<ul>
<li>形成了二叉树或B树等 数据结构，让查询起来变得高效快捷
<ul>
<li>二叉树这玩意以后一定得学</li>
</ul>
</li>
...
<p>磁盘占用增加</p>
<ul>
<li>索引的数据结构也是要占用空间的</li>
</ul>
</li>
<li>
<p>DML(update delete insert)效率变慢（影响不是很大）</p>
<ul>
<li>增删改一个数据后，要重新的去维护这个索引</li>
</ul>
<p><img src="/images/JavaSE/21-MySql/image-20211122212421742.png" alt="image-20211122212421742" loading="lazy"></p>
</li>
</ul>
<p>当然，在实际项目中，实际上90%左右的业务都是在进行查询，只有10%左右的业务在进行增删改</p>
<h2 id="索引的类型" tabindex="-1"><a class="header-anchor" href="#索引的类型" aria-hidden="true">#</a> 索引的类型</h2>
<ol>
<li>
<p>主键索引，主键自动为主索引（加了<code>primary key</code>的字段就不需要加其他的索引了）</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code>crate <span class="token keyword">table</span> t1<span class="token punctuation">(</span>
...
<li>
<p>唯一索引<code>unique</code> 同上</p>
</li>
<li>
<p>普通索引<code>index</code></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">CREATE</span> <span class="token keyword">INDEX</span> 索引名 <span class="token keyword">ON</span> 表名<span class="token punctuation">(</span>字段<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div></li>
<li>
<p>全文索引(<code>fulltext</code>)</p>
<ul>
<li>mysq自带这玩意，但是不好用，效率也比较低</li>
<li>在实际开发中，很少会用mysql自带的全文索引，一般都是用一些框架的全文搜索：
<ul>
<li>比如Java的<code>Solr</code>和<code>ElasticSearch</code>框架</li>
</ul>
</li>
<li>一般开发中不使用mysql自带的全文索引（任何语言都是如此）</li>
</ul>
</li>
</ol>
<h2 id="各种类型的索引添加、查询、删除、修改" tabindex="-1"><a class="header-anchor" href="#各种类型的索引添加、查询、删除、修改" aria-hidden="true">#</a> 各种类型的索引添加、查询、删除、修改</h2>
<p><strong>添加索引：</strong></p>
<p><code>create [可选 UNIQUE] index 索引名 on 表名(字段1 [可选：length]  [可选 ASC|DESC], 字段2...  )</code></p>
<p>如果某列的值是不会重复的，则优先考虑unique索引</p>
<p>添加unique索引的同时也会添加唯一约束</p>
<p>或者</p>
<p><code>alter table 表名 add index 索引名 (字段名...)</code></p>
<p>这里也可以通过这种方式来添加主键索引<code>alter table 表名 add primary key (字段);</code></p>
...
<p>三种方式都是相同的结果</p>
<ul>
<li><code>desc 表名</code> 中的KEY字段就是索引 通过这种方式查找出来的索引信息没有前面的那么详细</li>
</ul>
<p><strong>删除普通索引：</strong></p>
<p><code>drop index 索引名称 on 表名;</code></p>
<p>删除主键索引：<code>alter table 表名 drop primary key;</code></p>
<p>修改索引：先删除，然后添加新的索引~</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">create</span> <span class="token keyword">table</span> ts<span class="token punctuation">(</span>
 id <span class="token keyword">int</span><span class="token punctuation">,</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br></div></div><p>添加完索引后查看：唯一索引和普通索引的：</p>
<p><img src="/images/JavaSE/21-MySql/image-20211122220117209.png" alt="image-20211122220117209" loading="lazy"></p>
<p>主键索引的：</p>
<p><img src="/images/JavaSE/21-MySql/image-20211122220509463.png" alt="image-20211122220509463" loading="lazy"></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 删除普通索引</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><h2 id="索引使用原则" tabindex="-1"><a class="header-anchor" href="#索引使用原则" aria-hidden="true">#</a> 索引使用原则</h2>
<p>创建索引前，先看看是否遵循以下原则（当然上司特别要求的玩意的话，啥索引都可以放上去）</p>
<ol>
<li>
<p>较频繁作为查询条件字段<strong>应该</strong>创建索引</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">select</span> <span class="token operator">*</span> <span class="token keyword">from</span> emp <span class="token keyword">where</span> empno <span class="token operator">=</span> <span class="token number">1</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div></li>
<li>
<p>唯一性太差的字段<strong>不适合</strong>单独创建索引，即使该字段频繁的作为查询条件</p>
...
<li>
<p>更新非常频繁的字段<strong>不适合</strong>创建索引</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">select</span> <span class="token operator">*</span> <span class="token keyword">from</span> emp <span class="token keyword">where</span> logincount <span class="token operator">=</span> <span class="token number">1</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div></li>
<li>
<p>不会出现在where字句中的字段<strong>不该</strong>创建索引</p>
</li>
</ol>
<h1 id="mysql事务" tabindex="-1"><a class="header-anchor" href="#mysql事务" aria-hidden="true">#</a> Mysql事务</h1>
<p>事务用于保证数据的一致性，它由一组相关的dml语句构成，该组的dml语句要么全部成功，要么全部失败
如：转账就要用事务来处理，用以确保事务的一致性</p>
<p>当执行事务操作时(DML语句)，MYSQL会在表上加锁，防止其他用户修改表的数据，这对用户来讲是非常重要的</p>
<p><img src="/images/JavaSE/21-MySql/image-20211122222616278.png" alt="image-20211122222616278" loading="lazy"></p>
<p>使用MySQL的事务，第一步<strong>必须得确保</strong>Mysql当前是是innodb引擎，查看方式</p>
<p><code>show engines</code></p>
<p><img src="/images/JavaSE/21-MySql/image-20211122225446144.png" alt="image-20211122225446144" loading="lazy"></p>
<p>看到innoDB这里的support是default即可；如果不是就要百度自行开启</p>
<h2 id="基本语法-1" tabindex="-1"><a class="header-anchor" href="#基本语法-1" aria-hidden="true">#</a> 基本语法</h2>
<ul>
<li><code>start transaction</code> 开始一个事务
<ul>
<li>或者<code>set autocommit=off</code></li>
</ul>
</li>
<li><code>savepoint</code> 保存点名 设置保存点</li>
<li><code>rollback to</code> 保存点名 回退事务</li>
<li><code>rollback</code> 回退全部事物</li>
<li><code>commit</code> 提交事务，所有的操作生效，不能回退</li>
</ul>
<p><img src="/images/JavaSE/21-MySql/image-20211122224421237.png" alt="image-20211122224421237" loading="lazy"></p>
<p><img src="/images/JavaSE/21-MySql/image-20211122223136404.png" alt="image-20211122223136404" loading="lazy"></p>
<p>回滚可以让事务能吃后悔药</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 1  测试表</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br></div></div><h2 id="事务的细节" tabindex="-1"><a class="header-anchor" href="#事务的细节" aria-hidden="true">#</a> 事务的细节</h2>
<p><img src="/images/JavaSE/21-MySql/image-20211122224643847.png" alt="image-20211122224643847" loading="lazy"></p>
<p>数据库的存储引擎一定要是innodb！</p>
<h2 id="mysql的事务隔离级别" tabindex="-1"><a class="header-anchor" href="#mysql的事务隔离级别" aria-hidden="true">#</a> Mysql的事务隔离级别</h2>
<ol>
<li>多个连接开启各自事务操作数据库中数据时，数据库系统要负责隔离性，以保证各个连接在获取数据时的准确性</li>
<li>如果不考虑隔离性，可能会引发如下问题：
<ul>
<li>脏读
当一个事务读取另一个事务尚未提交的改变(增删改)时，产生脏读</li>
<li>不可重复读
同一查询在同一事务中多次进行，由于其他提交事务所做的修改或删除，每次返回不同的结果集，此时发生不可重复度</li>
<li>幻读
同一查询在同一事务中多次进行，由于其他提交事务所做的插入操作，每次返回不同的结果，此时发生幻读</li>
</ul>
</li>
</ol>
<p><img src="/images/JavaSE/21-MySql/image-20211122230850135.png" alt="image-20211122230850135" loading="lazy"></p>
<p><img src="/images/JavaSE/21-MySql/image-20211122231201037.png" alt="image-20211122231201037" loading="lazy"></p>
<p>查看当前Mysql的隔离级别：</p>
<ul>
<li>Mysql5.7:
<ul>
...
<p>可以看到，当前Mysql的隔离级别是(Mysql 8):</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><h3 id="读未提交-read-uncommitted" tabindex="-1"><a class="header-anchor" href="#读未提交-read-uncommitted" aria-hidden="true">#</a> 读未提交（Read uncommitted）</h3>
<p>为了演示，先把其中一个控制台（第二个控制台）的隔离级别改成读未提交（Read uncommitted）</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>然后查看其隔离级别：</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 第一个控制台： 可重复度</span>
<span class="token operator">+</span><span class="token comment">-----------------------+-----------------+</span>
<span class="token operator">|</span> Variable_name         <span class="token operator">|</span> <span class="token keyword">Value</span>           <span class="token operator">|</span>
<span class="token operator">+</span><span class="token comment">-----------------------+-----------------+</span>
...
<span class="token operator">+</span><span class="token comment">-----------------------+------------------+</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><p>隔离级别是跟事务相关的，一定要先启动事务，才能谈隔离级别的问题，离开事务就不要谈隔离级别的问题</p>
<p>首先创建一个表</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">use</span> <span class="token keyword">table</span> db1<span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>然后两个控制台均开启一个事务，</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>然后console1 写入一个数据</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>insert into account values(1,"张三",1000);
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>然后两个表同时查询这一个表，发现：</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># console 1</span>
<span class="token operator">+</span><span class="token comment">------+--------+-------+</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br></div></div><p>这就是脏读：<strong>当一个事务读取另一个事务尚未提交的改变(增删改)时，产生脏读</strong></p>
<p>然后我再往console 1中修改下内容，再添加一个新的value</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">update</span> account <span class="token keyword">set</span> money <span class="token operator">=</span><span class="token number">800</span> <span class="token keyword">where</span> id <span class="token operator">=</span> <span class="token number">100</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>此时再查看console2</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token operator">+</span><span class="token comment">------+--------+-------+</span>
<span class="token operator">|</span> id   <span class="token operator">|</span> name   <span class="token operator">|</span> money <span class="token operator">|</span>
<span class="token operator">+</span><span class="token comment">------+--------+-------+</span>
<span class="token operator">|</span>    <span class="token number">1</span> <span class="token operator">|</span> 张三   <span class="token operator">|</span>  <span class="token number">1000</span> <span class="token operator">|</span>
...
<span class="token operator">+</span><span class="token comment">------+--------+-------+</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>发现他这之中显示了console1对表操作的结果</p>
<p>这个本应该是不存在的------</p>
<p>​ 这里把console 1 叫做A，console 2叫做B</p>
<p>​ 事务的本意(潜台词)是：让B在进入事务的时间点，只展示改时间点有的内容，即：一个空的account表，而不是每次A操作，B就能同步感知A操作的结果，进而影响B的查询，只要B还没有提交<code>commit</code>，B读取到的就应该是它开启事务时SQL所拥有的数据，而不受到其他事务对SQL的影响</p>
<p>​ 事务的最理想效果：当B开启后连接到ACCOUNT表并对其操作时，B不会接收到A操作带来的影响，B的操作同时也不回影响A，也不希望互相影响到C 、D、E.....的操作和其带来的影响</p>
<p>其实到这一步的时候，已经可以发现，读未提交（Read uncommitted）已经出现了 脏读、不可重复读和幻读</p>
<h3 id="读已提交-read-committed" tabindex="-1"><a class="header-anchor" href="#读已提交-read-committed" aria-hidden="true">#</a> 读已提交(Read committed)</h3>
<p>​  接下来将A和B的事务都提交，然后A重新开启一个新的事务，B将隔离级别改变为读已提交(Read committed) 并开启一个新的事务</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># A &amp; B</span>
<span class="token keyword">commit</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>然后A添加一条数据，A、B再进行查找这个表</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># A </span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br></div></div><p>可以看到B的表中并没有出现A的表中所出现的第三条数据，即：读已提交(Read committed)隔离开启后，将不会出现脏读了</p>
<p>然后A再修改一条数据并提交，查看B此时的数据：</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># A</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br></div></div><p>可以发现 ，B表中的不可重复读，和幻读问题依旧存在</p>
<p>由上可知，在读已提交(Read committed)级别下，脏读已经不复存在，但是依旧出现了不可重复读和幻读</p>
<h3 id="可重复读-repeatable-read" tabindex="-1"><a class="header-anchor" href="#可重复读-repeatable-read" aria-hidden="true">#</a> 可重复读(Repeatable read)</h3>
<p>接下来把B改为可重复读(Repeatable read)并开启新的事务</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># A</span>
 <span class="token keyword">start</span> <span class="token keyword">transaction</span><span class="token punctuation">;</span>
...
<span class="token keyword">start</span> <span class="token keyword">transaction</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>然后A添加一条数据 ，B进行select</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># A</span>
...
<span class="token operator">|</span>    <span class="token number">3</span> <span class="token operator">|</span> scott  <span class="token operator">|</span>  <span class="token number">8000</span> <span class="token operator">|</span>
<span class="token operator">+</span><span class="token comment">------+--------+-------+</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>可以看到并未受A的影响</p>
<p>然后A修改一条数据</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># A</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div><p>然后A commit</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># A </span>
<span class="token keyword">commit</span><span class="token punctuation">;</span>
...
<span class="token operator">|</span>    <span class="token number">3</span> <span class="token operator">|</span> scott  <span class="token operator">|</span>  <span class="token number">8000</span> <span class="token operator">|</span>
<span class="token operator">+</span><span class="token comment">------+--------+-------+</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><p>可以发现B没有受到影响，看不到A的变化</p>
<p>这就是可重复读(Repeatable read)，它将不会出现以上三种问题；</p>
<p>当然，还有最后一个：</p>
<h3 id="可串行化-serializable" tabindex="-1"><a class="header-anchor" href="#可串行化-serializable" aria-hidden="true">#</a> 可串行化(Serializable)</h3>
<p>​ 这个继承了可重复读(Repeatable read)的优良传统，并且有一个新的特点：加锁：</p>
<p>​ 如果说他发现有一张表正在被操作且没有被提交<code>commit</code>，它会卡在这个地方，不会对表进行任何实际操作，非常神奇</p>
<p>将B表隔离级别设定为可串行化，A表不变</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># A &amp; B</span>
<span class="token keyword">commit</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><p>A 添加内容</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">insert</span> <span class="token keyword">into</span> account <span class="token keyword">values</span><span class="token punctuation">(</span><span class="token number">5</span><span class="token punctuation">,</span><span class="token string">'trray'</span><span class="token punctuation">,</span><span class="token number">600</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>此时 ，B查询内容</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>select * from account;
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>可以发现，B的终端卡住了，并且过了一会儿弹出：</p>
<p><code>ERROR 1205 (HY000): Lock wait timeout exceeded; try restarting transaction</code></p>
<p>锁定等待超时;试着重新启动事务；</p>
<p>然后我再次进行查询，并在10s后在A中commit</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># B </span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br></div></div><p>可以看到，几乎是A一提交，B就出了结果</p>
<p>这就是可串行化(Serializable)</p>
<h2 id="事务隔离级别-指令" tabindex="-1"><a class="header-anchor" href="#事务隔离级别-指令" aria-hidden="true">#</a> 事务隔离级别-指令</h2>
<ol>
<li>
<p>查看当前回话隔离级别：</p>
<ul>
...
<li>Mysql8+
<ul>
<li><code>select @@global.transaction_isolation;</code></li>
</ul>
</li>
</ul>
</li>
...
<p>设置当前回话隔离级别</p>
<ul>
<li><code>SET session transaction isolation LEVEL 隔离级别</code>
<ul>
...
<ul>
<li>
<p><code>set global transaction isolation level 隔离级别</code></p>
</li>
<li>
<p>也可以在<code>my.ini</code>或者<code>my.cfg</code>中的[mysqld]加上并重启mysql来设置全局默认隔离级别</p>
<div class="language-ini ext-ini line-numbers-mode"><pre v-pre class="language-ini"><code><span class="token section"><span class="token punctuation">[</span><span class="token section-name selector">mysqld</span><span class="token punctuation">]</span></span>
...其他内容
...
<li>
<p>Mysql默认的事务隔离级别是 <code>repatable read</code>，一般情况下，没有特殊要求，没有必要修改（因为该级别可以满足绝大部门项目要求）</p>
</li>
</ol>
<h3 id="事务的acid特性" tabindex="-1"><a class="header-anchor" href="#事务的acid特性" aria-hidden="true">#</a> 事务的ACID特性</h3>
<p><img src="/images/JavaSE/21-MySql/image-20211123004055233.png" alt="image-20211123004055233" loading="lazy"></p>
<h1 id="mysql表类型和存储引擎" tabindex="-1"><a class="header-anchor" href="#mysql表类型和存储引擎" aria-hidden="true">#</a> Mysql表类型和存储引擎</h1>
<ol>
<li>Mysql的表类型由存储引擎（Storage Engines）决定，主要包括MyISAM、innoDB、Memory等</li>
<li>Mysql数据表主要支持六种类型，分别是：CSV、Memory、ARCHIVE、MRG_MYISAM、MYISAM、InnoDB</li>
<li>这六种分为两类
<ul>
<li>事务安全型(transaction-safe)---支持事务
<ul>
<li>innoDB 系统默认是这个</li>
</ul>
</li>
<li>非事物安全型（non-transaction-safe）---不支持事务
<ul>
<li>CSV</li>
<li>Memory</li>
<li>ARCHIVE</li>
...
<img src="/images/JavaSE/21-MySql/image-20211123121320164.png" alt="image-20211123121320164" loading="lazy"></li>
</ul>
<h2 id="引擎的选择" tabindex="-1"><a class="header-anchor" href="#引擎的选择" aria-hidden="true">#</a> 引擎的选择</h2>
<p>一般情况会选择的</p>
<p><img src="/images/JavaSE/21-MySql/image-20211123121826094.png" alt="image-20211123121826094" loading="lazy"></p>
<p><img src="/images/JavaSE/21-MySql/image-20211123122055639.png" alt="image-20211123122055639" loading="lazy"></p>
<p><img src="/images/JavaSE/21-MySql/image-20211123122248185.png" alt="image-20211123122248185" loading="lazy"><img src="/images/JavaSE/21-MySql/image-20211123132241153.png" alt="image-20211123132241153" loading="lazy"></p>
<h2 id="引擎使用" tabindex="-1"><a class="header-anchor" href="#引擎使用" aria-hidden="true">#</a> 引擎使用</h2>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 默认就是innodb，这里不做演示</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br></div></div><h2 id="修改存储引擎" tabindex="-1"><a class="header-anchor" href="#修改存储引擎" aria-hidden="true">#</a> 修改存储引擎</h2>
<p>语法：<code>alter table 表名 engine = 存储引擎</code></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 修改前得确定表是否符合要转到的引擎的规定</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h1 id="视图-view" tabindex="-1"><a class="header-anchor" href="#视图-view" aria-hidden="true">#</a> 视图(View)</h1>
<ul>
<li>先看一个需求：emp表的列(字段)信息很多，有些信息是个人重要信息，比如sal、comm、mgr、hiredate
<img src="/images/JavaSE/21-MySql/image-20211123132622996.png" alt="image-20211123132622996" loading="lazy"></li>
<li>如果我们希望<strong>某个用户只能查询</strong>emp表的 empno、 ename、job和deptno信息</li>
<li>这个时候有很多方案，但是最好用的大概就是视图了</li>
</ul>
<p>视图的基本概念：</p>
<ol>
<li>视图是一个虚拟表。其内容由查询定义。和真实的表一样，视图包含列(字段)，<strong>其数据来源对应真实的表</strong>(基表)</li>
<li>视图和基表的关系示意图
<img src="/images/JavaSE/21-MySql/image-20211123133743001.png" alt="image-20211123133743001" loading="lazy"></li>
</ol>
<h2 id="视图的基本使用" tabindex="-1"><a class="header-anchor" href="#视图的基本使用" aria-hidden="true">#</a> 视图的基本使用</h2>
<ol>
<li>创建<code>create view 视图名 as select语句</code></li>
<li>修改(更新视图) <code>alter view 视图名 as select语句</code></li>
<li>显示视图的结构<code>show create view 视图名</code></li>
<li>删除视图 <code>drop view 视图名1,视图名2...</code></li>
</ol>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 视图的增删改查</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br></div></div><h2 id="视图的使用细节" tabindex="-1"><a class="header-anchor" href="#视图的使用细节" aria-hidden="true">#</a> 视图的使用细节</h2>
<p><img src="/images/JavaSE/21-MySql/image-20211123135455381.png" alt="image-20211123135455381" loading="lazy"></p>
<p><img src="/images/JavaSE/21-MySql/image-20211123140408719.png" alt="image-20211123140408719" loading="lazy"></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 视图1号</span>
<span class="token keyword">desc</span> emp_view01<span class="token punctuation">;</span>
<span class="token operator">+</span><span class="token comment">--------+--------------------+------+-----+---------+-------+</span>
<span class="token operator">|</span> Field  <span class="token operator">|</span> <span class="token keyword">Type</span>               <span class="token operator">|</span> <span class="token boolean">Null</span> <span class="token operator">|</span> <span class="token keyword">Key</span> <span class="token operator">|</span> <span class="token keyword">Default</span> <span class="token operator">|</span> Extra <span class="token operator">|</span>
<span class="token operator">+</span><span class="token comment">--------+--------------------+------+-----+---------+-------+</span>
...
<span class="token operator">+</span><span class="token comment">--------+--------+----------+-----+------------+---------+--------+--------+</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br></div></div><h1 id="mysql管理-用户管理" tabindex="-1"><a class="header-anchor" href="#mysql管理-用户管理" aria-hidden="true">#</a> Mysql管理-用户管理</h1>
<p>mysql中的用户，都存储在系统数据库mysql中的user表中</p>
<p><img src="/images/JavaSE/21-MySql/image-20211123140910846.png" alt="image-20211123140910846" loading="lazy"></p>
<p>其中user表的重要字段说明：</p>
<ol>
<li><code>host</code>： 运行登陆的位置，localhost表示本机，也可以指定Ip地址，比如：172.17.0.1，115.15.15.15....</li>
<li><code>user</code>：用户名</li>
<li><code>authentication_string</code>密码
<ul>
<li>Mysql8前，是通过Mysql的password()函数加密之后的密码（mysql_native_password）</li>
<li>Mysql8后，可以通过caching_sha2_password加密密码
<ul>
<li>当然，默认还是(mysql_native_password)加密密码</li>
</ul>
</li>
<li>密码字段左边会显示密码的加密方式
<img src="/images/JavaSE/21-MySql/image-20211123143351050.png" alt="image-20211123143351050" loading="lazy"></li>
</ul>
</li>
</ol>
<h2 id="创建、删除用户" tabindex="-1"><a class="header-anchor" href="#创建、删除用户" aria-hidden="true">#</a> 创建、删除用户</h2>
<p>如果创建的时候没有指定host，则默认为%:在任何地方都可以登陆</p>
<p><code>create user xxx</code>;</p>
<p>指定host：<code>create user 'xxx'@xxx</code></p>
<ul>
<li>host指定方式：
<ul>
<li><code>%</code> :所有地方</li>
<li><code>127.0.0.5</code> 特定地方</li>
<li><code>192.168.1.%</code> 192.168.1下的所有地址都可链接</li>
<li><code>255.255.%.%</code> 255.255下的所有地址都可连接</li>
</ul>
</li>
</ul>
<p>在删除用户的时候，如果host不是%，则必须要明确指定<code>用户名@登录位置</code></p>
<p><code>drop user jack</code> 等价于<code>drop user 'jack'@'%'</code></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># 创建用户</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br></div></div><p>登陆：</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>mysql -u mycom -p123456<span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><h2 id="修改密码" tabindex="-1"><a class="header-anchor" href="#修改密码" aria-hidden="true">#</a> 修改密码</h2>
<p>Mysql5.7</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>Mysql8+</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">ALTER</span> <span class="token keyword">USER</span> <span class="token string">'用户名'</span><span class="token variable">@'登陆位置'</span> IDENTIFIED <span class="token keyword">WITH</span> MYSQL_NATIVE_PASSWORD <span class="token keyword">BY</span> <span class="token string">'新密码'</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><h2 id="用户权限" tabindex="-1"><a class="header-anchor" href="#用户权限" aria-hidden="true">#</a> 用户权限</h2>
<p>在登陆到mycom用户后，查看数据库，发现了如下信息</p>
...
<span class="token operator">+</span><span class="token comment">--------------------+</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p><img src="/images/JavaSE/21-MySql/image-20211123144656109.png" alt="image-20211123144656109" loading="lazy"></p>
<p>Mysql的权限大概有这些：</p>
<p><img src="/images/JavaSE/21-MySql/image-20211123145819580.png" alt="image-20211123145819580" loading="lazy"></p>
<h3 id="给用户授权、回收权限" tabindex="-1"><a class="header-anchor" href="#给用户授权、回收权限" aria-hidden="true">#</a> 给用户授权、回收权限</h3>
<h4 id="授权" tabindex="-1"><a class="header-anchor" href="#授权" aria-hidden="true">#</a> 授权</h4>
<p>语法：<code>grant  权限对象 on 库.对象名 to '用户名'@'登录位置'</code></p>
<p>在mysql5.7中在授权时可以修改密码:</p>
<p><code>grant  权限对象 on 库.对象名 to '用户名'@'登录位置' [identified by '密码']</code></p>
<ul>
<li>identified by可以省略就是修改用户密码
<ul>
<li>如果该用户存在，就修改用户的密码</li>
<li>如果用户不存在，就创建该用户</li>
</ul>
</li>
<li>在mysql8之前应该都是有效的，mysql8后不允许这样，授权，创建用户，给用户修改密码是三档事情</li>
</ul>
<p><code>权限列表</code>，多个权限用逗号分开</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">grant</span> <span class="token keyword">select</span> <span class="token keyword">on</span> <span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span><span class="token punctuation">.</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p><code>库.对象名</code>的特别说明</p>
<ul>
<li><code>*.*</code> ：代表本系统中所有数据库的所有对象（表，视图，存储过程等）</li>
<li><code>库名.*</code> ：表示某个数据库中的所有数据对象（表，视图，存储过程等）</li>
<li><code>库名.对象名</code>: 表示某个数据库中的单个对象，对象名可以是表，视图，存储过程等 ，一般都是表名</li>
</ul>
<p>授权完毕如果没有生效的话：刷新权限<code>flush privileges;</code></p>
<h4 id="回收权限" tabindex="-1"><a class="header-anchor" href="#回收权限" aria-hidden="true">#</a> 回收权限</h4>
<p>基本语法: <code>revoke 权限列表 on 库.对象名 from '用户名'@'登录位置'</code></p>
<p>也可以：<code>revoke all on 库.对象名 from '用户名'@'登录位置'</code> 直接回收某个用户的所有权限</p>
<p>撤销授权后如果没有生效的话：刷新权限<code>flush privileges;</code></p>
<p><img src="/images/JavaSE/21-MySql/image-20211123152210307.png" alt="image-20211123152210307" loading="lazy"></p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment"># mysql8.0.1 ROOT USER</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br></div></div><p>然后用户登陆</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>mysql -ua - p <span class="token number">12345</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>进入后增删改查数据</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">show</span> <span class="token keyword">databases</span><span class="token punctuation">;</span>
<span class="token operator">+</span><span class="token comment">--------------------+</span>
<span class="token operator">|</span> <span class="token keyword">Database</span>           <span class="token operator">|</span>
<span class="token operator">+</span><span class="token comment">--------------------+</span>
...
<span class="token keyword">exit</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br></div></div><p>使用root用户删除该用户;</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token comment">## ROOT </span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>自此，Mysql初级部分就过完了，Mysql实际上还有复杂的东西，以后有机会的话去了解下;</p>
</template>
