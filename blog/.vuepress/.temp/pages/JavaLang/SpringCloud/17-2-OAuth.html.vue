<template><h2 id="关于oauth" tabindex="-1"><a class="header-anchor" href="#关于oauth" aria-hidden="true">#</a> 关于OAuth</h2>
<p>总之，如果涉及到微信小程序之类的，基本上这个玩意是首选的</p>
<p>简单来讲，OAuth2.0的应用场景可以理解为单点登录的升级版，单点登录解决了多个系统间会话的共享，OAuth2.0在此基础上增加了应用之间的权限控制</p>
<p>这玩意整体来说有点绕，不过你可以参考下面的介绍很快的了解这玩意（摘抄自阮一峰老师的<a href="https://www.ruanyifeng.com/blog/2019/04/oauth_design.html" target="_blank" rel="noopener noreferrer">博客<ExternalLinkIcon/></a>）</p>
<h3 id="oauth概述-快递员问题" tabindex="-1"><a class="header-anchor" href="#oauth概述-快递员问题" aria-hidden="true">#</a> OAuth概述-快递员问题</h3>
<ol>
<li>我住在一个大型的居民小区</li>
<li>小区有门禁系统</li>
<li>进入的时候需要输入密码</li>
<li>我经常网购和外卖，每天都有快递员来送货。我必须找到一个办法，让快递员通过门禁系统，进入小区</li>
</ol>
<blockquote>
...
<p>于是，我设计了一套授权机制</p>
<ol>
<li>门禁系统的密码输入器下面，增加一个按钮，叫做&quot;<strong>获取授权</strong>&quot;。快递员需要首先按这个按钮，去申请授权</li>
<li>他按下按钮以后，屋主（也就是我）的手机就会跳出对话框：有人正在要求授权。系统还会显示该快递员的姓名、工号和所属的快递公司
<ul>
<li>我确认请求属实，就点击按钮，告诉门禁系统，我同意给予他进入小区的授权</li>
</ul>
</li>
<li>门禁系统得到我的确认以后，向快递员显示一个进入小区的令牌（access token）。令牌就是类似密码的一串数字，只在短期内（比如七天）有效</li>
<li>快递员向门禁系统输入令牌，进入小区</li>
</ol>
<p>有人可能会问，为什么不是远程为快递员开门，而要为他单独生成一个令牌？</p>
<p>这是因为快递员可能每天都会来送货，第二天他还可以复用这个令牌。另外，有的小区有多重门禁，快递员可以使用同一个令牌通过它们</p>
<blockquote>
<p>互联网场景</p>
</blockquote>
<p>我们把上面的例子搬到互联网，就是 OAuth 的设计了。</p>
<p>首先，居民小区就是<strong>储存用户数据的网络服务</strong>。比如，微信储存了我的好友信息，获取这些信息，就必须经过微信的&quot;门禁系统&quot;。</p>
<p>其次，快递员（或者说快递公司）就是<strong>第三方应用</strong>，想要穿过门禁系统，进入小区。</p>
<p>最后，我就是用户本人，<strong>同意授权第三方应用</strong>进入小区，获取我的数据</p>
<p><strong>简单说，OAuth 就是一种授权机制。数据的所有者告诉系统，同意授权第三方应用进入系统，获取这些数据。系统从而产生一个短期的进入令牌（token），用来代替密码，供第三方应用使用。</strong></p>
<blockquote>
<p>令牌(Token)与密码(Password)</p>
</blockquote>
...
<h3 id="rfc-6749标准" tabindex="-1"><a class="header-anchor" href="#rfc-6749标准" aria-hidden="true">#</a> RFC-6749标准</h3>
<p>OAuth 2.0 的标准是 <a href="https://tools.ietf.org/html/rfc6749" target="_blank" rel="noopener noreferrer">RFC 6749<ExternalLinkIcon/></a> 文件。该文件先解释了 OAuth 是什么。</p>
<blockquote>
...
<p>注意，不管哪一种授权方式，第三方应用申请令牌之前，<strong>都必须先到系统备案</strong>，说明自己的身份，然后会拿到<strong>两个身份识别码</strong>：客户端 ID（client ID）和客户端密钥（client secret）。这是为了防止令牌被滥用，没有备案过的第三方应用，是不会拿到令牌的。</p>
<h3 id="方式一-授权码" tabindex="-1"><a class="header-anchor" href="#方式一-授权码" aria-hidden="true">#</a> 方式一：授权码</h3>
...
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>https://b.com/oauth/authorize?
      response_type=code&amp;
      client_id=CLIENT_ID&amp;
      redirect_uri=CALLBACK_URL&amp;
      scope=read
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>上面 URL 中</p>
<ul>
<li><code>response_type</code>参数表示要求返回授权码(code)</li>
<li><code>client_id</code>参数让B知道是谁在请求</li>
<li><code>redirect_uri</code>参数是B接受或拒绝请求后跳转的网址</li>
<li><code>scope</code>参数表示要求的授权范围（这里是只读read）</li>
</ul>
<p><img src="/images/SpringCloud/17-2-OAuth/bg2019040902.jpg" alt="img" loading="lazy"></p>
<blockquote>
<p>第二步：用户跳转后，B 网站会要求用户登录，然后询问是否同意给予 A 网站授权。用户表示同意，这时 B 网站就会跳回<code>redirect_uri</code>参数指定的网址。跳转时，会传回一个授权码，就像下面这样。</p>
</blockquote>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>https://a.com/callback?code=AUTHORIZATION_CODE
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>上面 URL 中，<code>code</code>参数就是授权码</p>
<p><img src="/images/SpringCloud/17-2-OAuth/bg2019040907.jpg" alt="img" loading="lazy"></p>
<blockquote>
<p>第三步，A 网站拿到授权码以后，就可以在后端，向 B 网站请求令牌</p>
</blockquote>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>https://b.com/oauth/token?
     client_id=CLIENT_ID&amp;
     client_secret=CLIENT_SECRET&amp;
     grant_type=authorization_code&amp;
     code=AUTHORIZATION_CODE&amp;
     redirect_uri=CALLBACK_URL
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>上面的URL中</p>
<ul>
<li><code>client_id</code>和<code>client_secret</code>参数用来让B确认A的身份
<ul>
<li><code>client_sercet</code>参数是保密的，因此只能在后端发起请求</li>
</ul>
</li>
<li><code>grant_type</code>的值是<code>AUTHORIZATION_CODE</code>，表示使用的授权方式是授权码</li>
<li><code>code</code>是第二步中拿到的授权码</li>
<li><code>redirect_uri</code>参数是令牌颁发后的回调网址</li>
</ul>
<p><img src="/images/SpringCloud/17-2-OAuth/bg2019040904.jpg" alt="img" loading="lazy"></p>
<blockquote>
<p>第四步，B网站收到请求后，就会颁发令牌，具体做法是向<code>rediect_uri</code>指定的网段，发送一段json数据</p>
</blockquote>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><p>上面 JSON 数据中，<code>access_token</code>字段就是令牌，A 网站在后端拿到了。</p>
<p><img src="/images/SpringCloud/17-2-OAuth/bg2019040905.jpg" alt="img" loading="lazy"></p>
<h3 id="方式二-隐藏式" tabindex="-1"><a class="header-anchor" href="#方式二-隐藏式" aria-hidden="true">#</a> 方式二：隐藏式</h3>
...
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>https://b.com/oauth/authorize?
      ...
      redirect_uri=CALLBACK_URL&amp;
      scope=read
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>上面 URL 中，<code>response_type</code>参数为<code>token</code>，表示要求直接返回令牌，其他几个参数和方式一致分别是声明自己的<code>id</code>和<code>uri</code>以及需要的<code>权限</code></p>
<blockquote>
<p>第二步，用户跳转到 B 网站，登录后同意给予 A 网站授权。这时，B 网站就会跳回<code>redirect_uri</code>参数指定的跳转网址，并且把令牌作为 URL 参数，传给 A 网站。</p>
</blockquote>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>https://a.com/callback#token=ACCESS_TOKEN
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>上面 URL 中，<code>token</code>参数就是令牌，A 网站因此直接在前端拿到令牌</p>
...
<p><img src="/images/SpringCloud/17-2-OAuth/bg2019040906.jpg" alt="img" loading="lazy"></p>
<p>这种方式把令牌直接传给前端，是很不安全的。因此，只能用于一些安全要求不高的场景，并且令牌的有效期必须非常短，通常就是会话期间（session）有效，浏览器关掉，令牌就失效了。</p>
<h3 id="方式三-密码式" tabindex="-1"><a class="header-anchor" href="#方式三-密码式" aria-hidden="true">#</a> 方式三：密码式</h3>
...
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>https://oauth.b.com/token?
      grant_type=password&amp;
      username=USERNAME&amp;
      password=PASSWORD&amp;
      client_id=CLIENT_ID
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>上面 URL 中，<code>grant_type</code>参数是授权方式，这里的<code>password</code>表示&quot;密码式&quot;，<code>username</code>和<code>password</code>是 B 的用户名和密码。</p>
<blockquote>
...
<h3 id="方式四-凭证式" tabindex="-1"><a class="header-anchor" href="#方式四-凭证式" aria-hidden="true">#</a> 方式四：凭证式</h3>
...
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>https://oauth.b.com/token?
      ...
      client_id=CLIENT_ID&amp;
      client_secret=CLIENT_SECRET
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>上面 URL 中，<code>grant_type</code>参数等于<code>client_credentials</code>表示采用凭证式，<code>client_id</code>和<code>client_secret</code>用来让 B 确认 A 的身份</p>
<blockquote>
<p>第二步，B 网站验证通过以后，直接返回令牌。</p>
</blockquote>
<p>这种方式给出的令牌，是针对第三方应用的，而不是针对用户的，即有可能多个用户共享同一个令牌</p>
<h3 id="获取到令牌后的使用" tabindex="-1"><a class="header-anchor" href="#获取到令牌后的使用" aria-hidden="true">#</a> 获取到令牌后的使用</h3>
<blockquote>
<p>A 网站拿到令牌以后，就可以向 B 网站的 API 请求数据了</p>
</blockquote>
<p>此时，每个发到 API 的请求，都必须带有令牌。具体做法是在请求的头信息，加上一个<code>Authorization</code>字段，令牌就放在这个字段里面</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token function">curl</span> -H <span class="token string">"Authorization: Bearer ACCESS_TOKEN"</span> <span class="token punctuation">\</span>
<span class="token string">"https://api.b.com"</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>上面命令中，<code>ACCESS_TOKEN</code>就是拿到的令牌。</p>
<h3 id="更新令牌" tabindex="-1"><a class="header-anchor" href="#更新令牌" aria-hidden="true">#</a> 更新令牌</h3>
<blockquote>
...
<p>B网站验证通过后，就会办法新的令牌</p>
<h3 id="实例-使用github来实现一个最简单的第三方登陆" tabindex="-1"><a class="header-anchor" href="#实例-使用github来实现一个最简单的第三方登陆" aria-hidden="true">#</a> 实例：使用GitHub来实现一个最简单的第三方登陆</h3>
<p>所谓第三方登录，实质就是 OAuth 授权。</p>
<p>用户想要登录 A 网站，A 网站让用户提供第三方网站的数据，证明自己的身份。获取第三方网站的身份数据，就需要 OAuth 授权。</p>
...
<p>首先，我们通过前面的了解，已经知道一个应用要求OAuth授权，必须先到对方网站登记，让对方知道是谁在请求</p>
<p>所以，我们要先去GitHub<a href="https://github.com/settings/applications/new" target="_blank" rel="noopener noreferrer">登记<ExternalLinkIcon/></a>一下</p>
<p>这样填写</p>
<p><img src="/images/SpringCloud/17-2-OAuth/image-20220122132204686.png" alt="image-20220122132204686" loading="lazy"></p>
<p>应用的名称随便填</p>
<p>主页 URL 填写<code>http://localhost:8080</code></p>
...
<p><img src="/images/SpringCloud/17-2-OAuth/image-20220122132511389.png" alt="image-20220122132511389" loading="lazy"></p>
<p>id： 5c87602a9e7c5818af38</p>
<p>secrect：06cc126ea698f7a931647aa1761f684efed603a6</p>
<p>接着，clone下阮一峰老师的下面这个仓库，这是一个Nodejs+Koa的仓库</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/ruanyf/node-oauth-demo.git
<span class="token builtin class-name">cd</span> node-oauth-demo
<span class="token comment">#自行使用yarn或者npm install安装</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>然后在<code>index.js</code>内填入你的clientID和clientSecret</p>
<p>以及<code>public/index.html</code>中的client_id改成你的</p>
<p>接着启动</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>然后浏览器访问<a href="http://localhost:8080/" target="_blank" rel="noopener noreferrer">http://localhost:8080/<ExternalLinkIcon/></a></p>
<p>就能看到这个页面</p>
<p><img src="/images/SpringCloud/17-2-OAuth/image-20220122135418708.png" alt="image-20220122135418708" loading="lazy"></p>
<p>示例的首页很简单，就是一个链接，让用户跳转到 GitHub。</p>
<p>跳转的 URL 如下。</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>https://github.com/login/oauth/authorize?
  client_id=你的client_id
  redirect_uri=http://localhost:8080/oauth/redirect
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>这个 URL 指向 GitHub 的 OAuth 授权网址，带有两个参数：<code>client_id</code>告诉 GitHub 谁在请求，<code>redirect_uri</code>是稍后跳转回来的网址</p>
<blockquote>
<p>用户点击到了 GitHub，GitHub 会要求用户登录，确保是本人在操作。</p>
</blockquote>
<p>你点击之后，会跳转到github</p>
<p><img src="/images/SpringCloud/17-2-OAuth/image-20220122135555575.png" alt="image-20220122135555575" loading="lazy"></p>
<p>这里同意授权</p>
<p>接着你就能看到</p>
<p><img src="/images/SpringCloud/17-2-OAuth/image-20220122135652611.png" alt="image-20220122135652611" loading="lazy"></p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>http://localhost:8080/oauth/redirect?
  code=授权码
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>后端收到这个请求以后，就拿到了授权码（<code>code</code>参数）</p>
<p>同时你的后端也能获取到对应的内容</p>
<p>然后看看这个时候后端的实现</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 0. 你的对应的id和Secret</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br><span class="line-number">62</span><br><span class="line-number">63</span><br></div></div><p>然后你的浏览器中，就可以看到这样的内容</p>
<p><img src="/images/SpringCloud/17-2-OAuth/image-20220122140647710.png" alt="image-20220122140647710" loading="lazy"></p>
<p>并且在控制台上，能看到我们用户的相关信息</p>
<p><img src="/images/SpringCloud/17-2-OAuth/image-20220122140716682.png" alt="image-20220122140716682" loading="lazy"></p>
<p>拆解下</p>
<p>这里的关键是针对<code>/oauth/redirect</code>的请求，编写一个路由，完成 OAuth 认证。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> <span class="token function-variable function">oauth</span> <span class="token operator">=</span> <span class="token keyword">async</span> <span class="token parameter">ctx</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
  <span class="token comment">// ...</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>

app<span class="token punctuation">.</span><span class="token function">use</span><span class="token punctuation">(</span>route<span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token string">'/oauth/redirect'</span><span class="token punctuation">,</span> oauth<span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>上面代码中，<code>oauth</code>函数就是路由的处理函数。下面的代码都写在这个函数里面。</p>
<p>路由函数的第一件事，是从 URL 取出授权码。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> requestToken <span class="token operator">=</span> ctx<span class="token punctuation">.</span>request<span class="token punctuation">.</span>query<span class="token punctuation">.</span>code<span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>接着，后端使用这个授权码，向 GitHub 请求令牌。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> tokenResponse <span class="token operator">=</span> <span class="token keyword">await</span> <span class="token function">axios</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
  <span class="token literal-property property">method</span><span class="token operator">:</span> <span class="token string">'post'</span><span class="token punctuation">,</span>
  <span class="token literal-property property">url</span><span class="token operator">:</span> <span class="token string">'https://github.com/login/oauth/access_token?'</span> <span class="token operator">+</span>
    <span class="token template-string"><span class="token template-punctuation string">`</span><span class="token string">client_id=</span><span class="token interpolation"><span class="token interpolation-punctuation punctuation">${</span>clientID<span class="token interpolation-punctuation punctuation">}</span></span><span class="token string">&amp;</span><span class="token template-punctuation string">`</span></span> <span class="token operator">+</span>
    <span class="token template-string"><span class="token template-punctuation string">`</span><span class="token string">client_secret=</span><span class="token interpolation"><span class="token interpolation-punctuation punctuation">${</span>clientSecret<span class="token interpolation-punctuation punctuation">}</span></span><span class="token string">&amp;</span><span class="token template-punctuation string">`</span></span> <span class="token operator">+</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>面代码中，GitHub 的令牌接口<code>https://github.com/login/oauth/access_token</code>需要提供三个参数。</p>
<blockquote>
<ul>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> accessToken <span class="token operator">=</span> tokenResponse<span class="token punctuation">.</span>data<span class="token punctuation">.</span>access_token<span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>有了令牌以后，就可以向 API 请求数据了。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> result <span class="token operator">=</span> <span class="token keyword">await</span> <span class="token function">axios</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><p>上面代码中，GitHub API 的地址是<code>https://api.github.com/user</code>，请求的时候必须在 HTTP 头信息里面带上令牌<code>Authorization: token 361507da</code></p>
<p>然后，就可以拿到用户数据，得到用户的身份。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> name <span class="token operator">=</span> result<span class="token punctuation">.</span>data<span class="token punctuation">.</span>name<span class="token punctuation">;</span>
ctx<span class="token punctuation">.</span>response<span class="token punctuation">.</span><span class="token function">redirect</span><span class="token punctuation">(</span><span class="token template-string"><span class="token template-punctuation string">`</span><span class="token string">/welcome.html?name=</span><span class="token interpolation"><span class="token interpolation-punctuation punctuation">${</span>name<span class="token interpolation-punctuation punctuation">}</span></span><span class="token template-punctuation string">`</span></span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h3 id="oauth和单点登陆如何选择" tabindex="-1"><a class="header-anchor" href="#oauth和单点登陆如何选择" aria-hidden="true">#</a> OAuth和单点登陆如何选择？</h3>
<table>
<thead>
<tr>
<th>功能点</th>
...
<p>按需选择即可</p>
<p>注：以上仅为在 Sa-Token 中两种技术的差异度比较，不同框架的实现可能略有差异，但整体思想是一致的。</p>
<h2 id="使用sa-oauth搭建oauth2-server" tabindex="-1"><a class="header-anchor" href="#使用sa-oauth搭建oauth2-server" aria-hidden="true">#</a> 使用Sa-OAuth搭建OAuth2-Server</h2>
<p>之前的过程中，我们已经使用了github给我们提供的对应的接口</p>
<p>那么如何自己实现一个呢？</p>
<p>注意：OAuth2和单点登录之间选型是比较重要的，单点登录的特点就是说一个账户密码可以在多个地方登陆</p>
<p>虽然说OAuth2也可以通过密码式来这样做，但是就有了一种杀鸡焉用宰牛刀的感觉…</p>
<p>a-OAuth2 模块基于 <a href="https://tools.ietf.org/html/rfc6749" target="_blank" rel="noopener noreferrer">RFC-6749 标准<ExternalLinkIcon/></a> 编写，基于不同的使用场景，OAuth2.0设计了四种模式：</p>
<ol>
<li>授权码（Authorization Code）：OAuth2.0标准授权步骤，Server端向Client端下放Code码，Client端再用Code码换取授权Token</li>
<li>隐藏式（Implicit）：无法使用授权码模式时的备用选择，Server端使用URL重定向方式直接将Token下放到Client端页面</li>
<li>密码式（Password）：Client直接拿着用户的账号密码换取授权Token</li>
<li>客户端凭证（Client Credentials）：Server端针对Client级别的Token，代表应用自身的资源授权</li>
</ol>
<p><img src="/images/SpringCloud/17-2-OAuth/sa-oauth2-setup.png" alt="https://oss.dev33.cn/sa-token/doc/oauth2/sa-oauth2-setup.png" loading="lazy"></p>
...
<p>方便之后的测试</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>127.0.0.1 sa-oauth-server.com
127.0.0.1 sa-oauth-client.com
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h3 id="依赖准备" tabindex="-1"><a class="header-anchor" href="#依赖准备" aria-hidden="true">#</a> 依赖准备</h3>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br></div></div><h3 id="配置文件" tabindex="-1"><a class="header-anchor" href="#配置文件" aria-hidden="true">#</a> 配置文件</h3>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br></div></div><h3 id="开放服务-saoauth2templateimpl" tabindex="-1"><a class="header-anchor" href="#开放服务-saoauth2templateimpl" aria-hidden="true">#</a> 开放服务-SaOAuth2TemplateImpl</h3>
<p>路径：<code>template/SaOAuth2TemplateImpl</code></p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br></div></div><h3 id="开放路由-saoauth2servercontroller" tabindex="-1"><a class="header-anchor" href="#开放路由-saoauth2servercontroller" aria-hidden="true">#</a> 开放路由-SaOAuth2ServerController</h3>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br></div></div><h3 id="访问测试" tabindex="-1"><a class="header-anchor" href="#访问测试" aria-hidden="true">#</a> 访问测试</h3>
<p>对，只要经过上面的配置就可以了…</p>
<p>由于暂未搭建Client端，我们可以使用Sa-Token官网作为重定向URL进行测试：</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>http://sa-oauth-server.com:8001/oauth2/authorize?response_type=code&amp;client_id=1001&amp;redirect_uri=http://sa-token.dev33.cn/&amp;scope=userinfo
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>由于首次访问，我们在OAuth-Server端暂未登录，会被转发到登录视图</p>
<p><img src="/images/SpringCloud/17-2-OAuth/image-20220122145439501.png" alt="image-20220122145439501" loading="lazy"></p>
<p>点击doLogin进行登录之后刷新页面，会提示我们确认授权</p>
<p><img src="/images/SpringCloud/17-2-OAuth/sa-oauth2-server-scope.png" alt="sa-oauth2-server-login-view" loading="lazy"></p>
<p>点击确认授权之后刷新页面，我们会被重定向至 redirect_uri 页面，并携带了code参数</p>
<p><img src="/images/SpringCloud/17-2-OAuth/sa-oauth2-server-code.png" alt="sa-oauth2-server-code" loading="lazy"></p>
<p>我们拿着code参数，访问以下地址：</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>http://sa-oauth-server.com:8001/oauth2/token?grant_type=authorization_code&amp;client_id=1001&amp;client_secret=aaaa-bbbb-cccc-dddd-eeee&amp;code=你刚刚获取到的code
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>就可以获取如下内容： <code>Access-Token</code>、<code>Refresh-Token</code>、<code>openid</code>等授权信息</p>
<p><img src="/images/SpringCloud/17-2-OAuth/image-20220122150139471.png" alt="image-20220122150139471" loading="lazy"></p>
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><p>接着就可以用这个做很多事情了..</p>
<h2 id="api列表" tabindex="-1"><a class="header-anchor" href="#api列表" aria-hidden="true">#</a> API列表</h2>
<h3 id="方式一-授权码-1" tabindex="-1"><a class="header-anchor" href="#方式一-授权码-1" aria-hidden="true">#</a> 方式一：授权码</h3>
<h4 id="获取获取授权码" tabindex="-1"><a class="header-anchor" href="#获取获取授权码" aria-hidden="true">#</a> 获取获取授权码</h4>
<p>根据以下格式构建URL，引导用户访问 （复制时请注意删减掉相应空格和换行符）</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>http://sa-oauth-server.com:8001/oauth2/authorize
    ?response_type=code
    &amp;client_id={value}
    &amp;redirect_uri={value}
    &amp;scope={value}
    $state={value}
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>参数详解：</p>
<table>
<thead>
<tr>
<th>参数</th>
...
<td>redirect_uri</td>
<td>是</td>
<td>用户确认授权后，重定向的url地址</td>
</tr>
<tr>
<td>scope</td>
<td>否</td>
<td>具体请求的权限，多个用逗号隔开</td>
</tr>
<tr>
<td>state</td>
<td>否</td>
<td>随机值，此参数会在重定向时追加到url末尾，不填不追加</td>
</tr>
</tbody>
</table>
<p>注意点：</p>
<ol>
<li>如果用户在Server端尚未登录：会被转发到登录视图，你可以参照文档或官方示例自定义登录页面</li>
<li>如果scope参数为空，或者请求的权限用户近期已确认过，则无需用户再次确认，达到静默授权的效果，否则需要用户手动确认，服务器才可以下放code授权码</li>
</ol>
<p>用户确认授权之后，会被重定向至<code>redirect_uri</code>，并追加code参数与state参数，形如：</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>redirect_uri?code={code}&amp;state={state}
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>Code授权码具有以下特点：</p>
<ol>
<li>每次授权产生的Code码都不一样</li>
<li>Code码用完即废，不能二次使用</li>
<li>一个Code的有效期默认为五分钟，超时自动作废</li>
<li>每次授权产生新Code码，会导致旧Code码立即作废，即使旧Code码尚未使用</li>
</ol>
<h4 id="根据授权码获取access-token" tabindex="-1"><a class="header-anchor" href="#根据授权码获取access-token" aria-hidden="true">#</a> 根据授权码获取access-token</h4>
<p>获得Code码后，我们可以通过以下接口，获取到用户的<code>Access-Token</code>、<code>Refresh-Token</code>、<code>openid</code>等关键信息</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>http://sa-oauth-server.com:8001/oauth2/token
    ?grant_type=authorization_code
    &amp;client_id={value}
    &amp;client_secret={value}
    &amp;code={value}
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>参数详解：</p>
<table>
<thead>
<tr>
<th>参数</th>
...
<td>grant_type</td>
<td>是</td>
<td>授权类型，这里请填写：authorization_code</td>
</tr>
<tr>
<td>client_id</td>
<td>是</td>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br></div></div><h4 id="刷新token" tabindex="-1"><a class="header-anchor" href="#刷新token" aria-hidden="true">#</a> 刷新Token</h4>
<p>Access-Token的有效期较短，如果每次过期都需要重新授权的话，会比较影响用户体验，因此我们可以在后台通过<code>Refresh-Token</code> 刷新 <code>Access-Token</code></p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>http://sa-oauth-server.com:8001/oauth2/refresh
    ?grant_type=refresh_token
    &amp;client_id={value}
    &amp;client_secret={value}
    &amp;refresh_token={value}
...
<td>grant_type</td>
<td>是</td>
<td>授权类型，这里请填写：refresh_token</td>
</tr>
<tr>
<td>client_id</td>
<td>是</td>
...
<td>refresh_token</td>
<td>是</td>
<td>步骤1.2中获取到的<code>Refresh-Token</code>值</td>
</tr>
</tbody>
</table>
<h4 id="在access-token过期前主动将其回收" tabindex="-1"><a class="header-anchor" href="#在access-token过期前主动将其回收" aria-hidden="true">#</a> 在Access-Token过期前主动将其回收</h4>
<blockquote>
<p>也就是回收Token，如果需要的话：</p>
</blockquote>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>http://sa-oauth-server.com:8001/oauth2/revoke
    ?client_id={value}
    &amp;client_secret={value}
    &amp;access_token={value}
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>参数详解：</p>
<table>
<thead>
<tr>
<th>参数</th>
...
<td>access_token</td>
<td>是</td>
<td>步骤1.2中获取到的<code>Access-Token</code>值</td>
</tr>
</tbody>
</table>
<p>返回值样例：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><h4 id="根据-access-token-获取相应用户的账号信息" tabindex="-1"><a class="header-anchor" href="#根据-access-token-获取相应用户的账号信息" aria-hidden="true">#</a> 根据 Access-Token 获取相应用户的账号信息</h4>
<blockquote>
<p>注：此接口为官方仓库模拟接口，正式项目中大家可以根据此样例，自定义需要的接口及参数</p>
</blockquote>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>http://sa-oauth-server.com:8001/oauth2/userinfo?access_token={value}
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>返回值：</p>
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
    <span class="token property">"code"</span><span class="token operator">:</span> <span class="token number">200</span><span class="token punctuation">,</span>
    <span class="token property">"msg"</span><span class="token operator">:</span> <span class="token string">"ok"</span><span class="token punctuation">,</span>
    <span class="token property">"data"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><h4 id="方式二-隐藏式-1" tabindex="-1"><a class="header-anchor" href="#方式二-隐藏式-1" aria-hidden="true">#</a> 方式二：隐藏式</h4>
<p>根据以下格式构建URL，引导用户访问：</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>http://sa-oauth-server.com:8001/oauth2/authorize
    ?response_type=token
    &amp;client_id={value}
    &amp;redirect_uri={value}
...
<p>此模式会越过授权码的步骤，直接返回Access-Token到前端页面，形如：</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>redirect_uri#token=xxxx-xxxx-xxxx-xxxx
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><h4 id="方式三-密码式-1" tabindex="-1"><a class="header-anchor" href="#方式三-密码式-1" aria-hidden="true">#</a> 方式三：密码式</h4>
<p>首先在Client端构建表单，让用户输入Server端的账号和密码，然后在Client端访问接口</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>http://sa-oauth-server.com:8001/oauth2/token
    ?grant_type=password
    &amp;client_id={value}
    &amp;username={value}
...
<div class="language-json ext-json line-numbers-mode"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><h4 id="方式四-凭证式-1" tabindex="-1"><a class="header-anchor" href="#方式四-凭证式-1" aria-hidden="true">#</a> 方式四：凭证式</h4>
<p>以上三种模式获取的都是用户的 <code>Access-Token</code>，代表用户对第三方应用的授权， 在OAuth2.0中还有一种针对 Client级别的授权， 即：<code>Client-Token</code>，代表应用自身的资源授权</p>
<p>在Client端的后台访问以下接口：</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>http://sa-oauth-server.com:8001/oauth2/client_token
    ?grant_type=client_credentials
    &amp;client_id={value}
    &amp;client_secret={value}
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>参数详解：</p>
...
<td>grant_type</td>
<td>是</td>
<td>返回类型，这里请填写：client_credentials</td>
</tr>
<tr>
<td>client_id</td>
<td>是</td>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>注：<code>Client-Token</code>具有延迟作废特性，即：在每次获取最新<code>Client-Token</code>的时候，旧<code>Client-Token</code>不会立即过期，而是作为<code>Past-Token</code>再次储存起来， 资源请求方只要携带其中之一便可通过Token校验，这种特性保证了在大量并发请求时不会出现“新旧Token交替造成的授权失效”， 保证了服务的高可用</p>
<h2 id="sa-oauth2模块常用方法" tabindex="-1"><a class="header-anchor" href="#sa-oauth2模块常用方法" aria-hidden="true">#</a> Sa-OAuth2模块常用方法</h2>
<p>官方示例只提供了基本的授权流程，以及userinfo资源的开放，如果您需要开放更多的接口，则二次开发时用到以下相关API方法</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// 根据 id 获取 Client 信息, 如果 Client 为空，则抛出异常 </span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br></div></div><h2 id="相关的配置表" tabindex="-1"><a class="header-anchor" href="#相关的配置表" aria-hidden="true">#</a> 相关的配置表</h2>
<table>
<thead>
<tr>
<th>参数名称</th>
...
<td>Boolean</td>
<td>true</td>
<td>是否打开模式：授权码（Authorization Code）</td>
</tr>
<tr>
<td>isImplicit</td>
<td>Boolean</td>
<td>false</td>
<td>是否打开模式：隐藏式（Implicit）</td>
</tr>
<tr>
<td>isPassword</td>
<td>Boolean</td>
<td>false</td>
<td>是否打开模式：密码式（Password）</td>
</tr>
<tr>
<td>isClient</td>
<td>Boolean</td>
<td>false</td>
<td>是否打开模式：凭证式（Client Credentials）</td>
</tr>
<tr>
<td>isNewRefresh</td>
<td>Boolean</td>
<td>false</td>
<td>是否在每次 Refresh-Token 刷新 Access-Token 时，产生一个新的 Refresh-Token</td>
</tr>
<tr>
<td>codeTimeout</td>
<td>long</td>
<td>300</td>
<td>Code授权码 保存的时间(单位秒) 默认五分钟</td>
</tr>
<tr>
<td>accessTokenTimeout</td>
<td>long</td>
<td>7200</td>
<td>Access-Token 保存的时间(单位秒) 默认两个小时</td>
</tr>
<tr>
<td>refreshTokenTimeout</td>
<td>long</td>
<td>2592000</td>
<td>Refresh-Token 保存的时间(单位秒) 默认30 天</td>
</tr>
<tr>
<td>clientTokenTimeout</td>
<td>long</td>
<td>7200</td>
<td>Client-Token 保存的时间(单位秒) 默认两个小时</td>
</tr>
</tbody>
</table>
<p>配置示例：</p>
