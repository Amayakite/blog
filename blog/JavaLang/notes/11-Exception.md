...
![image-20211103143937071](/images/Java/11-Exception/image-20211103143937071.png)
...
![image-20211103145516146](/images/Java/11-Exception/image-20211103145516146.png)
...
![image-20211103160838379](/images/Java/11-Exception/image-20211103160838379.png)

![image-20211103161052235](/images/Java/11-Exception/image-20211103161052235.png)
...
![image-20211103162250515](/images/Java/11-Exception/image-20211103162250515.png)
...
![image-20211103162939406](/images/Java/11-Exception/image-20211103162939406.png)
...
![image-20211103164117438](/images/Java/11-Exception/image-20211103164117438.png)
...
3. 子类重写父类方法时，对抛出异常的规定：子类重写的方法：**所抛出的异常类型要么和父类抛出的异常一致，要么为父类抛出的异常类型的子类型**，**<u>抛出的异常类型绝不能是父类异常的父类型或者跟父类异常无关的同级异常类型/子类型</u>**
   ...
   ![image-20211103174900422](/images/Java/11-Exception/image-20211103174900422.png)
