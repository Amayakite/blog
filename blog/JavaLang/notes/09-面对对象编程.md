...
![image-20211031221216473](/images/Java/09-面对对象编程/image-20211031221216473.png)
...
![image-20211031222443639](/images/Java/09-面对对象编程/image-20211031222443639.png)

CSDN上有位[大佬对此做了详细的到底层的分析](https://blog.csdn.net/x_iya/article/details/81260154/)，可以看到最后写着：

![image-20211031222657513](/images/Java/09-面对对象编程/image-20211031222657513.png)
...
4. 该方法接收String类型的数组参数，该数组中保存执行Java命令时**传递给所运行的类的参数，接收参数**
   ...
   ![image-20211101010125723](/images/Java/09-面对对象编程/image-20211101010125723.png)
...
![image-20211101010721104](/images/Java/09-面对对象编程/image-20211101010721104.png)

找到这个叫程序实参的填进去就行了，左侧是可运行的代码（有main的）

![image-20211101010939346](/images/Java/09-面对对象编程/image-20211101010939346.png)
...
1. 当**不希望类被继承时**，可以用`final`修饰
   ...
   ![image-20211101181129030](/images/Java/09-面对对象编程/image-20211101181129030.png)
...
2. 当**不希望父类的某个方法被子类覆盖/重写时**，可以用`final`修饰
   ...
   ![image-20211101181613538](/images/Java/09-面对对象编程/image-20211101181613538.png)
...
3. 但**不希望类的某个属性的值被修改时**，可以用`final`修饰
   ...
   ![image-20211101182848146](/images/Java/09-面对对象编程/image-20211101182848146.png)
...
4. 当**不希望某个局部变量被修改**，可以使用`final`修饰
   ...
   ![image-20211101183205842](/images/Java/09-面对对象编程/image-20211101183205842.png)
...
8. **final和static往往搭配使用，效率更高，不会导致类加载， 底层编译器做了优化**
   ...
   ![image-20211101184733707](/images/Java/09-面对对象编程/image-20211101184733707.png)
...
![image-20211101224654293](/images/Java/09-面对对象编程/image-20211101224654293.png)
...
1. 现在要制造战斗机/武装直升飞机.专家只需要把飞机需要的功能/规定定下来即可,然后让别的人具体实现就可以
   ...
   ![image-20211101233415978](/images/Java/09-面对对象编程/image-20211101233415978.png)
...
2. 现在有一个项目经理,手下有三个程序猿,功能开发一个软件,为了控制和管理软件,项目经理可以定义一些接口,然后由程序猿具体负责实现
   ...
   ![image-20211101234000405](/images/Java/09-面对对象编程/image-20211101234000405.png)
...
![image-20211102001850275](/images/Java/09-面对对象编程/image-20211102001850275.png)
