...
![image-20211103210315078](/images/JavaSE/12-常用类/image-20211103210315078.png)
...
![image-20211103221003388](/images/JavaSE/12-常用类/image-20211103221003388.png)
...
1. String对象用于保存字符串，也就是一组字符(char)序列
   ...
   String的关系图：![image-20211103230909848](/images/JavaSE/12-常用类/image-20211103230909848.png)
...
4. String类常用的构造器(它有相当多的构造器，实现了构造器的多重重载):
   ...
   - ![image](/images/JavaSE/12-常用类/image-20211103231305877.png)

5. String类是一个`final`类，他不能被继承

6. String中属性`private final char value[]`，用于存放字符串内容

   - ![image-20211103232113634](/images/JavaSE/12-常用类/image-20211103232113634.png)
...
3. 内存布局图：
   ![image-20211103235127338](/images/JavaSE/12-常用类/image-20211103235127338.png)
...
3. 这里分别看下JavaDoc的文档和源码
   1. 查看源码，发现：
      ![image-20211104000459973](/images/JavaSE/12-常用类/image-20211104000459973.png)
...
![image-20211104001912357](/images/JavaSE/12-常用类/image-20211104001912357.png)
...
![image-20211104002637352](/images/JavaSE/12-常用类/image-20211104002637352.png)
...
![image-20211104002924021](/images/JavaSE/12-常用类/image-20211104002924021.png)
...
![image-20211104004803611](/images/JavaSE/12-常用类/image-20211104004803611.png)
...
![image-20211104144229377](/images/JavaSE/12-常用类/image-20211104144229377.png)
...
![image-20211104171931252](/images/JavaSE/12-常用类/image-20211104171931252.png)
...
![image-20211105005251767](/images/JavaSE/12-常用类/image-20211105005251767.png)
...
![image-20211105010014540](/images/JavaSE/12-常用类/image-20211105010014540.png)
