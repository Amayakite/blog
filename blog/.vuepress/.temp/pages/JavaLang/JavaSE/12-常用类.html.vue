<template><h2 id="包装类" tabindex="-1"><a class="header-anchor" href="#包装类" aria-hidden="true">#</a> 包装类</h2>
<p>包装类(Wrapper)可以理解为，给八种基本的数据类型定义相应的引用类型</p>
<p><strong>让基本的数据类型有了类的特点，就可以调用类中的方法</strong></p>
<table>
<thead>
<tr>
...
<p>上方，粗体写的类的父类是<strong>Number</strong></p>
<h3 id="包装类关系图" tabindex="-1"><a class="header-anchor" href="#包装类关系图" aria-hidden="true">#</a> 包装类关系图</h3>
<p><img src="/images/JavaSE/12-常用类/image-20211103210315078.png" alt="image-20211103210315078" loading="lazy"></p>
<p>上方类中<strong>Boolean和Character直接继承于Comparable，实现了Serializable，Comparable</strong></p>
<p><strong>Long、Double、Short、Byte、Integer、Float继承于Number(Number实现了Serializable)，并实现了Comparable</strong></p>
<blockquote>
<p>Q：看起来这些类很麻烦的样子，为啥要用类来包装这些玩意，普普通通的不好吗？</p>
<p>A：因为这些类封装的方法实在是太多了，比直接用起来舒服一大截，为啥不用...</p>
</blockquote>
<h3 id="包装类和基本数据类型的转换" tabindex="-1"><a class="header-anchor" href="#包装类和基本数据类型的转换" aria-hidden="true">#</a> 包装类和基本数据类型的转换</h3>
<p>使用特点：</p>
<ol>
<li>在Jdk5以前，是需要手动装箱和手动拆箱，<strong>装箱</strong>：基本类型--&gt;包装类型，反之，<strong>拆箱</strong></li>
<li>在Jdk5以后（含Jdk5）是附带了自动装箱和自动拆箱</li>
<li>自动装箱底层调用的是ValueOf方法，比如Integer.ValueOf()</li>
<li>所有包装类的装箱和拆箱方法都一样，看下面演示</li>
</ol>
<blockquote>
<p>演示Integer的装箱和拆箱，其他的几个包装类装箱拆箱方法跟这个一模一样，不一一举例了</p>
</blockquote>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>wrapper</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>可能会下意识的就觉得是1，但并非如此，它实际输出的是1.0</p>
<p>为啥呢？因为<code>true?new Integer(1):new Double(2.0)</code>这个地方是一个整体，他这之中精度最高的是double，所以结果会提升优先级，最终结果就是1</p>
<blockquote>
<p>再来看另外一道题</p>
</blockquote>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token class-name">Object</span> obj2<span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><p>这里就很一目了然了，结果是1，因为他们根本不是同一个整体<code>obj2=new Integer(1);</code>跟<code>obj2=new Double(2.0);</code>完全是两码事</p>
<h3 id="包装类型和string类型的互相装换" tabindex="-1"><a class="header-anchor" href="#包装类型和string类型的互相装换" aria-hidden="true">#</a> 包装类型和String类型的互相装换</h3>
<blockquote>
<p>在实际工作中，包装类型往往跟String之间相互转换的工作比较多，所以来看看他们是怎么相互转换的</p>
<p>这里演示Integer和String的相互转换，其他包装类同理</p>
</blockquote>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>wrapper</span><span class="token punctuation">;</span>
...
<span class="token comment">//        其他包装类也同理</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br></div></div><h3 id="integer和character类的常用方法" tabindex="-1"><a class="header-anchor" href="#integer和character类的常用方法" aria-hidden="true">#</a> Integer和Character类的常用方法</h3>
<p>这些包装类的方法，构造函数，属性之类的可以直接在IEDA的树状图中查看</p>
<p><img src="/images/JavaSE/12-常用类/image-20211103221003388.png" alt="image-20211103221003388" loading="lazy"></p>
<p>可以看到，光拿Integer就有一大堆方法和属性及常量，接下来了解下Integer和Character中那些常用的方法，当然实际开发过程中要用到哪个方法就去JDK手册中查哪个方法即可</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>wrapper</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">WrapperMethods</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token class-name">Integer</span><span class="token punctuation">.</span>MAX_VALUE<span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">//返回最大值</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token class-name">Integer</span><span class="token punctuation">.</span>MIN_VALUE<span class="token punctuation">)</span><span class="token punctuation">;</span><span class="token comment">//返回最小值</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br></div></div><h4 id="扩展-integer面试题" tabindex="-1"><a class="header-anchor" href="#扩展-integer面试题" aria-hidden="true">#</a> 扩展-Integer面试题</h4>
<blockquote>
<p>看看下面代码，输出的结果是啥，为什么？</p>
</blockquote>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">method1</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
...
<li>
<p>首先要确定的一点是，无论是什么情况下，对象和对象的比较始终都是比较地址。</p>
</li>
<li>
<p>两个对象判定是否相等（都是new出来的），所以判断的是他们两是不是同一个对象，即地址是否相等，所以为false</p>
</li>
<li>
<p>这两个不是new出来的，底层用的是<code>Integer.valueOf()</code>，先看看底层源码：</p>
<ul>
<li>
...
<li>
<p>可以看到，这个源码里有个判断，大意是判断i是否大于等于某个值，小于等于某个值，如果是的话就是直接返回一个现有的Integer，否则的话就是New一个出来，那接下来看一看这两个值分别是什么</p>
</li>
<li>
...
<li>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">static</span> <span class="token keyword">final</span> <span class="token keyword">int</span> high<span class="token punctuation">;</span>  
...
<li>
<p>由上得出，当i的值为：-128&lt;=i&lt;=127时，返回的是一个现有的对象(在cache数组中的对象，看这个静态代码块可以知道，类加载的时候这个数组就已经创建好了)，并没有真的new了一个对象，所以他们两个的比较结果为true</p>
</li>
</ul>
</li>
<li>
<p>可以看出，这里底层用的依旧是<code>Integer.valueOf()</code>，根据上一点得出的结论进行分析：</p>
<ul>
<li>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>public static Integer valueOf(int i) {
    if (i >= IntegerCache.low &amp;&amp; i &lt;= IntegerCache.high)
        return IntegerCache.cache[i + (-IntegerCache.low)];
    return new Integer(i);
}
...
<li>
<p>当i的值为：-128&lt;=i&lt;=127时，返回的是一个现有的对象，否则new一个新的对象出来，这里的两个值都是&gt;128</p>
</li>
<li>
<p>所以这两个都是new出来的对象，比较地址返回false</p>
</li>
</ul>
</li>
</ol>
<p>运行结果：</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token boolean">false</span>
<span class="token boolean">true</span>
<span class="token boolean">false</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><h2 id="string-重要" tabindex="-1"><a class="header-anchor" href="#string-重要" aria-hidden="true">#</a> String(重要)</h2>
<blockquote>
<p>截止至这里，我么貌似都用习惯了String，设置可能开始的时候，也将他认为是一个基本数据类型，但实际上他不是...</p>
</blockquote>
<h3 id="string的基本介绍" tabindex="-1"><a class="header-anchor" href="#string的基本介绍" aria-hidden="true">#</a> String的基本介绍</h3>
<ol>
<li>
<p>String对象用于保存字符串，也就是一组字符(char)序列</p>
<p>String的关系图：<img src="/images/JavaSE/12-常用类/image-20211103230909848.png" alt="image-20211103230909848" loading="lazy"></p>
</li>
<li>
<p><strong>字符串常量</strong>对象是用双引号括起来的字符序列，如：<code>&quot;Hello world&quot;,&quot;你好&quot;,&quot;How are you&quot; &quot;15.236&quot;</code>等</p>
<ul>
<li>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token function">main</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
...
<li>
<p>String类常用的构造器(它有相当多的构造器，实现了构造器的多重重载):</p>
<ul>
<li>
...
<li>
<p><img src="/images/JavaSE/12-常用类/image-20211103231305877.png" alt="image" loading="lazy"></p>
</li>
</ul>
</li>
<li>
<p>String类是一个<code>final</code>类，他不能被继承</p>
</li>
<li>
<p>String中属性<code>private final char value[]</code>，用于存放字符串内容</p>
<ul>
<li><img src="/images/JavaSE/12-常用类/image-20211103232113634.png" alt="image-20211103232113634" loading="lazy"></li>
<li>这个value的说明是：用于存储字符串，并且他的类型是char[]数组</li>
<li>说明<strong>字符串在底层本质上还是char[]数组</strong></li>
</ul>
</li>
<li>
<p>一定要注意，这个<strong>value是一个final类型</strong>，不可修改：即<strong>地址不可修改</strong></p>
<ul>
<li>
<p>比如：原先的value指向了一块数据--&gt;&quot;TOM&quot;</p>
</li>
<li>
<p><strong>在指向完&quot;TOM&quot;之后，value就不能指向另外的空间了比如我想把Value的指向改成&quot;Jack&quot;，这是不被允许的</strong></p>
</li>
<li>
<p>但是，我把value值中的&quot;TOM&quot;换成“TOH”或者&quot;TAK&quot;是被允许的</p>
</li>
<li>
<p><strong>也就是说，value的不可修改指的是它里面的单个字符依然可以正常修改(单个字符的内容是可以变化的)，但是Value不能指向一个新的对象(新的地址)</strong></p>
</li>
<li>
<p>举个例子：</p>
<ul>
<li>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span></span><span class="token class-name">String_</span><span class="token punctuation">;</span>
...
<h3 id="创建string对象的两种方式" tabindex="-1"><a class="header-anchor" href="#创建string对象的两种方式" aria-hidden="true">#</a> 创建String对象的两种方式</h3>
<ul>
<li>方式1：直接赋值<code>String str =&quot;How are YOU&quot;</code></li>
<li>方式2：调用构造器<code>String str = new String(&quot;I'm fina thank you,and you?&quot;)</code></li>
</ul>
<blockquote>
<p>这两种方式创建String对象它是不一样的(机制)...接下来说说它的区别</p>
</blockquote>
<ol>
<li>方式1：先从常量池查看是否有<code>How are YOU</code>数据空间，如果有，直接指向；如果没有则重新创建，然后指向，str最终指向的是常量池的空间地址</li>
<li>方式2：现在堆中创建空间，里面维护了value属性，指向了常量池的<code>I'm fina thank you,and you?</code>空间。如果常量池没有<code>I'm fina thank you,and you?</code>,重新创建，如果有，直接value指向，最终指向的是堆中的空间地址</li>
<li>内存布局图：
<img src="/images/JavaSE/12-常用类/image-20211103235127338.png" alt="image-20211103235127338" loading="lazy"></li>
</ol>
<blockquote>
<p>卧槽瞬间就明朗了，原来是这么一回事...接下来做一道简单的题目:</p>
</blockquote>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token class-name">String</span> a <span class="token operator">=</span><span class="token string">"abc"</span><span class="token punctuation">;</span>
...
<li>字符串重写了equals，所以这里的比较实际上是比较两个String对象的value值的所有内容是否相等，如果相等就返回true，否则就返回false</li>
<li>这里根据上面的内存布局图可以得出，a是直接创建的，b是直接创建的，所以他们连是直接指向同一个常量池中的地址，所以结果为true</li>
<li>String a 和b的创建流程：
<ol>
<li>String A 创建时，程序在常量池里面看有没有&quot;abc&quot;。发现没有，于是就创建一个，然后让A的地址指向它</li>
<li>String B 创建时，程序在常量池里面看有没有&quot;abc&quot;，发现有，于是直接让B指向它</li>
<li>加入常量池中的&quot;abc&quot;地址是0x6151564;那么A和B指向的地址都是0x6151564，即：他们完全相同</li>
</ol>
</li>
</ol>
<blockquote>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token class-name">String</span> a <span class="token operator">=</span> <span class="token string">"hsp"</span><span class="token punctuation">;</span>
...
<li>true</li>
<li>false</li>
<li>这里分别看下JavaDoc的文档和源码
<ol>
<li>查看源码，发现：
<img src="/images/JavaSE/12-常用类/image-20211104000459973.png" alt="image-20211104000459973" loading="lazy"></li>
<li>这玩意没有代码，说明是系统底层（JVM）提供的。。然后看看文档，大意是，返回String的常量池中的地址（假设是0x111）</li>
<li>完整文档：当调用intern方法时：如果池(常量池)已经包含一个等于此String对象的字符串(用equals(Object))来匹配，则返回池中的字符串(地址)，否则，将这个String添加到常量池中，并返回这个String对象的引用</li>
<li>解读：intern()方法最终返回的是常量池的地址</li>
<li>然后a的地址也是指向常量池中的(0x111)</li>
<li>所以可以得出，结果为true</li>
</ol>
</li>
<li>根据3的结果，可以得知，这里比较的是b在堆中的地址和b的value的常量池地址
<ol>
<li>所以可以得出，他们两一定是不相等的，所以返回false</li>
</ol>
</li>
</ol>
<p><img src="/images/JavaSE/12-常用类/image-20211104001912357.png" alt="image-20211104001912357" loading="lazy"></p>
<h3 id="字符串的特性" tabindex="-1"><a class="header-anchor" href="#字符串的特性" aria-hidden="true">#</a> 字符串的特性</h3>
<ol>
<li>String是一个final类，代表不可变的字符序列</li>
<li>字符串是不可变的，一个字符串一旦被匹配，其内容是不可变的</li>
</ol>
<blockquote>
<p>小练 以下语句创建了几个对象？画出内存布局图</p>
</blockquote>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token class-name">String</span> s1 <span class="token operator">=</span><span class="token string">"hello"</span><span class="token punctuation">;</span>
s1 <span class="token operator">=</span><span class="token string">"haha"</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>两个对象，在s1创建时，往常量池里面添加了hello，在s1重定向时，又往常量池添加了haha</p>
<p><img src="/images/JavaSE/12-常用类/image-20211104002637352.png" alt="image-20211104002637352" loading="lazy"></p>
<h4 id="扩展-面试题" tabindex="-1"><a class="header-anchor" href="#扩展-面试题" aria-hidden="true">#</a> 扩展-面试题</h4>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token class-name">String</span> a <span class="token operator">=</span><span class="token string">"hello"</span><span class="token operator">+</span><span class="token string">"abc"</span><span class="token punctuation">;</span>
<span class="token comment">//创建了几个对象？</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>一个，底层会自动优化，这里的&quot;hello&quot;+&quot;abc&quot;等价于&quot;helloabc&quot;，底层在运行到这里的时候会自动得到&quot;helloabc&quot;，并将其传入常量池生成(编译器不是傻子)</p>
<p><img src="/images/JavaSE/12-常用类/image-20211104002924021.png" alt="image-20211104002924021" loading="lazy"></p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token class-name">String</span> a <span class="token operator">=</span><span class="token string">"hello"</span><span class="token punctuation">;</span>
<span class="token class-name">String</span> b<span class="token operator">=</span><span class="token string">"abc"</span><span class="token punctuation">;</span>
...
<li>
<p>这个时候就要用到强大的断点工具了：</p>
<ol>
<li>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>package com.String_;
...
<li>
<p>可以在Debug中看到，执行到这一步的时候，是先创建了一个StringBuild，然后再将常量池中的hello 和 abc添加到StringBuild的末尾</p>
</li>
<li>
<p>然后再调用String Build的Tostring方法，new了一个String()，并返回给C</p>
</li>
<li>
<p>同时，根据对new String()的理解，可以得出，newString()时，是在堆中创建一个对象，然后查看池中是否有value值对应的东西，这里发现没有，于是在池中创建&quot;helloabc&quot;,并赋值给value</p>
</li>
<li>
<p>所以说，这一步中创建了两个对象</p>
</li>
<li>
<p>加上new StringBuild 总共创建了三个对象</p>
</li>
</ol>
</li>
<li>
<p>因此，总共创建了5个对象，当然，实际上最终的结果是：</p>
<ol>
<li>A指向了常量</li>
<li>B指向了常量</li>
<li>C指向了堆</li>
<li>因此，也可以理解为创建了三个对象，但是得了解到这一步到底做了哪些事情</li>
</ol>
</li>
<li>
<p>如果说这个时候在判断c==&quot;helloabc&quot;</p>
<ol>
<li>因为c指向的堆中的对象</li>
<li>而&quot;helloabc&quot;在常量池</li>
<li>所以false</li>
</ol>
</li>
</ol>
<p><img src="/images/JavaSE/12-常用类/image-20211104004803611.png" alt="image-20211104004803611" loading="lazy"></p>
<p>总结：<strong>两个常量相加，结果在池，两个变量相加，结果在堆</strong></p>
<p>常量相加，直接看池的地址，变量相加，就需要看堆，再通过value映射的地址到池</p>
<p>所以说，学这玩意，一定要尽量看着源码学（再提一嘴，韩顺平老师真的厉害）</p>
<blockquote>
<p>下一题</p>
</blockquote>
<p>请根据代码说出打印的结果：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">String01</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br></div></div><p>可能看到这道题下意识的就认为结果是：java + hava</p>
<p>接下来逐步分析下这个代码</p>
<ol>
<li>new了一个String01对象 创建了一个新的栈，指向了堆中的String实例对象
<ol>
<li>这个对象里面有个str，str是String类型的，他会指向堆中的一个String空间
<ol>
<li>这个String空间中有一个非常重要的属性value，value指向常量池中的&quot;hsp&quot;</li>
</ol>
</li>
<li>还有个char[]数组，数组指向堆中的 [<strong>j|a|v|a</strong>]大概是这样一个数组，并且这个char是final的，不能修改其指向</li>
</ol>
</li>
<li>调用了ex.change方法， 这个方法调用的时候，创建了一个新的栈（Change栈）
<ol>
<li>传入了两个值，str和ch，</li>
<li>所以相当于是new了两个值，new String ,new char[] ，并把它们指向传进来的两个值</li>
<li>到这一步就很明确的，给str修改内容就相当于让其指向一个新的常量地址，这样做并不会影响到其他东西，只会将自己的（这个方法中的）string指向的地址更该</li>
<li>然后是char，char和String一样，指向的都是开始new String01()中的地址，但是这里并没有更该他的指向，而是更该其指定的一个值，这样做并不会更该ch所指向的地址</li>
</ol>
</li>
<li>所以结果就很显而易见了，结果是hsp hava</li>
</ol>
<blockquote>
<p>个人解读change</p>
</blockquote>
<ol start="0">
<li>
<p>这里调用的change(string,ch)实际上：str为new了一个String，地址指向了ex.str的地址，然后ch是new了一个char[] 地址指向了ex.ch</p>
</li>
<li>
<p>为了方便区分，这里把change的两个参数分别命名为c1和c2</p>
</li>
<li>
<p>然后程序更该了c1的指向：c1=&quot;java&quot;，实际上是更改了c1指向的地址(在池中开辟了新的常量&quot;java&quot;,并把c1的地址指向&quot;java&quot;)</p>
</li>
<li>
<p>所以到一这一步的时候，c1实际上指向的就不是ex.str的地址了，而是一个新的地址</p>
</li>
<li>
<p>接着，程序更该了c2数组的内容,将原本的['j', 'a', 'v', 'a']，替换成了['h', 'a', 'v', 'a']</p>
</li>
<li>
<p>根据前面的知识，可以知道，数组在更该其内容时，并不会更该他本身的地址，所以这里的c2实际上还是指向了ex.ch</p>
</li>
<li>
<p>综上所述，得出结论：输出的语句为:hsp and hava</p>
</li>
</ol>
<p><img src="/images/JavaSE/12-常用类/image-20211104144229377.png" alt="image-20211104144229377" loading="lazy"></p>
<h3 id="string类常用方法" tabindex="-1"><a class="header-anchor" href="#string类常用方法" aria-hidden="true">#</a> String类常用方法</h3>
<p>String类是保存字符串常量的，每次更新都需要重新开辟空间，效率低，因此Java设计者还提供了<code>StringBuffer</code>和<code>StringBuilder</code>来增强String的功能并提高效率，在此之前，先来看看下面的的代码</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>可以看到，这里循环了80000次，每次都是在创建新的“常量”空间，第一次hello,第二次hellhello....以此类推，总共创建了80001个常量空间(包括创建s的时候)，但是我们只需要用到最后一个空间，所以前80000的就相当于白费了，且创建空间是需要时间的，效率相当的低，这个的解决方法到后面<code>StringBuffer</code>和<code>StringBuilder</code>就知道了，在此之前，必须得知道的是，虽然String在类似于这种场合效率低下，但是他本身也附带了很多很有用的方法，接下来来了解下</p>
<ul>
<li>
<p><code>equals(String str)</code> 比较两个String是否相等，比较的是value数组的值(区分大小写的判断)</p>
</li>
<li>
<p><code>equalsIgnoreCase(String str)</code>比较两个String是否相等(不区分大小写进行判断)</p>
</li>
<li>
<p><code>length()</code>获取字符的个数，字符串的长度</p>
</li>
<li>
<p><code>indexOf(String str)</code> 获取<strong>字符(char)或字符串</strong>在字符串中第一次出现的索引，索引从0开始，如果找不到就返回-1</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token class-name">String</span> s1 <span class="token operator">=</span><span class="token string">"amayakite@qq.com"</span><span class="token punctuation">;</span>
...
<li>
<p><code>lastIndexOf(参数同上)</code>获取<strong>字符(char)或字符串</strong>在字符串最后一次出现的索引，索引从0开始，如果找不到就返回-1</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token class-name">String</span> s1 <span class="token operator">=</span><span class="token string">"amayakite@qq.com"</span><span class="token punctuation">;</span>
...
<li>
<p><code>substring()</code>截取指定范围的字符串</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token class-name">String</span> name <span class="token operator">=</span><span class="token string">"Hello,张三"</span><span class="token punctuation">;</span>
...
<li>
<p><code>trim()</code>去掉前后空格</p>
</li>
<li>
<p><code>charAt()</code>获取某索引处的字符，注意，String不能通过str[index]的方式获取指定索引处的字符</p>
</li>
<li>
<p><code>toUpperCase(String str)</code>将字符串转换为全<strong>大</strong>写</p>
</li>
<li>
<p><code>toLowerCase(String str)</code>将字符串转换为全<strong>小</strong>写</p>
</li>
<li>
<p><code>concat()</code>拼接字符串</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token class-name">String</span> s1 <span class="token operator">=</span><span class="token string">"林黛玉"</span><span class="token punctuation">;</span>
...
<li>
<p><code>replace()</code>替换字符串中的字符</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>s1<span class="token operator">=</span><span class="token string">"Hello 世界你好 你好 你好"</span><span class="token punctuation">;</span>
...
<li>
<p><code>split()</code>分割字符串</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>s1 <span class="token operator">=</span><span class="token string">"锄禾日当午，汗滴禾下土，谁知盘中餐，粒粒皆辛苦"</span><span class="token punctuation">;</span>
...
<li>
<p><code>toCharArray()</code>将字符串转换成char数组</p>
</li>
<li>
<p><code>compareTo()</code>比较两个字符串的大小</p>
<ul>
<li>
<p>如果两个字符串的长度相同，且每个字符也相同，返回0</p>
</li>
<li>
<p>如果长度相同或者不相同，但是在比较时，可以区分大小写，就返回</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">if</span><span class="token punctuation">(</span>c1 <span class="token operator">!=</span>c2<span class="token punctuation">)</span><span class="token punctuation">{</span>
    <span class="token keyword">return</span> c1<span class="token operator">-</span>c2<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div></li>
<li>
<p>如果前面的部分都相同，就返回str1.len-str2.len</p>
</li>
</ul>
</li>
<li>
<p><code>format()</code>格式化字符串</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token class-name">String</span> name <span class="token operator">=</span> <span class="token string">"John"</span><span class="token punctuation">;</span>
...
<h3 id="string-format-模板字符串-补充" tabindex="-1"><a class="header-anchor" href="#string-format-模板字符串-补充" aria-hidden="true">#</a> String Format(模板字符串)补充</h3>
<p>format方法使用占位符进行格式化</p>
<p>常规类型、字符类型和数值类型的占位符格式：</p>
<p><code>%[index$][标识][最小宽度][.精度]转换符</code></p>
<p>日期和时间类型的占位符格式：</p>
<p><code>%[index$][标识][最小宽度]转换符</code></p>
<p>与参数不对应的占位符格式：</p>
<p><code>%[标识][最小宽度]转换符</code></p>
<p>其中index表示参数列表中的位置上的值</p>
<table>
<thead>
<tr>
<th>转 换 符</th>
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>Hi,王力 
Hi,王南:王力王张 
字母a的大写是：A  
3>7的结果是：false  
100的一半是：50  
...
<td>$</td>
<td>被格式化的参数索引</td>
<td>(&quot;%1<span class="katex"><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.8889em;vertical-align:-0.1944em;"></span><span class="mord mathnormal">d</span><span class="mpunct">,</span></span></span></span>s&quot;, 99,&quot;abc&quot;)</td>
<td>99,abc</td>
</tr>
</tbody>
</table>
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>格式参数$的使用：99,abc 
显示正负数的符号：+99与-99 
最牛的编号是：007 
Tab键的效果是：    7 
整数分组的效果是：9,989,997 
一本书的价格是：80000元 
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><h2 id="stringbuffer-重要" tabindex="-1"><a class="header-anchor" href="#stringbuffer-重要" aria-hidden="true">#</a> StringBuffer(重要)</h2>
<blockquote>
<p><strong>StringBuffer是对String类的增强</strong></p>
</blockquote>
...
<li>很多方法都是和String相同的，<strong>但StringBuffer是可变长度的</strong></li>
<li>StringBuffer是一个容器</li>
<li>StringBuffer的直接父类是<code>AbstractStringBuilder</code></li>
<li>StringBuffer实现了Serializable，即StringBuffer的对象可以串行化</li>
<li>在StringBuffer的父类<code>AbstractStringBuilder</code>中，<strong>有属性char[] value，且这个属性不带有任何修饰符(不是final类型)</strong>
<ul>
<li><strong>该value数组存放字符串内容</strong></li>
<li>因此，<strong>数据存放在堆中</strong>，而不是常量池</li>
</ul>
</li>
<li>StringBuffer是一个final类，不可以被继承</li>
</ul>
<h4 id="string-vs-stringbuffer" tabindex="-1"><a class="header-anchor" href="#string-vs-stringbuffer" aria-hidden="true">#</a> String Vs StringBuffer</h4>
<ol>
<li><strong><code>String</code></strong>，<u>里面的值不能更改</u>，<strong>每次String类的更新实际上就是在更改地址，效率较低</strong>
<code>private final char value[]</code> 这个放在常量池</li>
<li>**<code>StringBuffer</code>**保存的是字符串变量，<u>里面的值可以更该</u>，<strong>每次StringBuffer的更新实际上可以更新内容，不用每次更新地址，效率较高</strong>
<code>char[] value</code>这个存放在堆中</li>
<li>String每次更新--&gt;在常量池更改地址（创建新的对象），无论更新的内容是1个字符还是10个字符</li>
<li>StringBuffer更新--&gt; 不用每次都更换地址
<ol>
<li>比方说，StringBuffer原先有16个空间，第一次用了五个空间，没有用完，那么往后添加数据，只是在他的空间中追加了一个字段，直到这16个空间被填充满了，才会创建新的对象（并添加地址）</li>
<li>所以他的效率高于String</li>
</ol>
</li>
</ol>
<p><img src="/images/JavaSE/12-常用类/image-20211104171931252.png" alt="image-20211104171931252" loading="lazy"></p>
<p>可以看到它的构造方法中默认容量为16个字符</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span></span><span class="token class-name">StringBuffer_</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br></div></div><h3 id="string和stringbuffer的相互转换" tabindex="-1"><a class="header-anchor" href="#string和stringbuffer的相互转换" aria-hidden="true">#</a> String和StringBuffer的相互转换</h3>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span></span><span class="token class-name">StringBuffer_</span><span class="token punctuation">;</span>
...
<span class="token comment">//        方式2 使用构造器来搞定 String构造器可以接受StringBuffer</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br></div></div><h3 id="stringbuffer类常见方法" tabindex="-1"><a class="header-anchor" href="#stringbuffer类常见方法" aria-hidden="true">#</a> StringBuffer类常见方法</h3>
<p>在开始前，我定义了一个StringBuffer:<code>StringBuffer hello = new StringBuffer(&quot;hello&quot;);</code></p>
<ul>
<li>
<p>增 append</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// hello="hello"</span>
...
<p>删除 delete
删除索引为&gt;=start&amp;&amp;&lt;end的字符
下面是删除第5~8位的字符（不包含第八位）</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// hello="hello,张三18true1.35"</span>
...
<li>
<p>替换replace
使用World替换索引从5~7的字符（不包含7）</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// hello="hello18true1.35"</span>
...
如果找不到则返回-1</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// hello="helloWorldtrue1.35"</span>
...
<li>
<p>获取长度 length</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">// hello="hello空格Worldtrue1.35"</span>
...
<li>
<p>开发中还有可能用带其他的，用到了再去查</p>
</li>
</ul>
<h3 id="扩展-动态的给double数值添加" tabindex="-1"><a class="header-anchor" href="#扩展-动态的给double数值添加" aria-hidden="true">#</a> 扩展-动态的给double数值添加_</h3>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span></span><span class="token class-name">StringBuffer_</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br></div></div><h2 id="stringbuilder-重要" tabindex="-1"><a class="header-anchor" href="#stringbuilder-重要" aria-hidden="true">#</a> StringBuilder(重要)</h2>
<h3 id="基本介绍-1" tabindex="-1"><a class="header-anchor" href="#基本介绍-1" aria-hidden="true">#</a> 基本介绍</h3>
<ol>
<li>
<p>一个可变的字符序列，此类提供一个与StringBuffer兼容的API，但不保证同步，该类的涉及用作StringBuffer的一个简易替换，<strong>在字符串缓冲区被单个线程使用的时候，如果可能，建议优先使用<code>StringBuilder</code>，因为在大多数实现中，它都比StringBuffer更快</strong></p>
</li>
<li>
<p>在StringBuilder上主要是操作append和insert方法，可以重载这些方法，以接受任意类型的数据</p>
</li>
<li>
<p>StringBuilder和StringBuffer的区别：StringBuilder用在单线程，StringBuffer用在多线程</p>
</li>
<li>
<p>它有的方法和StringBuffer一样</p>
</li>
<li>
<p>StringBuilder的直接父类是<code>AbstractStringBuilder</code></p>
</li>
<li>
<p>StringBuilder实现了Serializable，即StringBuilder的对象可以串行化（对象可以传输到网络，也可以保存到文件）</p>
</li>
<li>
<p>是一个final类，不能被继承</p>
</li>
<li>
<p>数据也是存放在欺负类AbstractStringBuilder的char value[]，因此字符序列是存放在堆中</p>
...
<li>
<p><strong>StringBuilder的方法没有做任何互斥的处理，即没有<code>synchronized</code>关键字的包裹，所以是不安全的线程</strong>因此，只推荐在单线程的情况下使用StringBuilder</p>
...
<h3 id="string、stringbuilder、stringbuffer的比较" tabindex="-1"><a class="header-anchor" href="#string、stringbuilder、stringbuffer的比较" aria-hidden="true">#</a> String、StringBuilder、StringBuffer的比较</h3>
<ol>
<li>StringBuffer和StringBuilder非常类似，军代表可变的字符序列，且方法也一样</li>
<li>String：不可变字符序列，效率低，但是复用性高</li>
<li>StringBuffer：可变字符序列，效率较高（增删），线程安全(带有synchronized关键字，每次运行前都会进行线程判断)</li>
<li>StringBuilder：可变字符序列，效率最高，线程不安全(没有synchronized关键字)</li>
</ol>
<p>可以尝试一下比较他们：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span></span><span class="token class-name">StringBuffer_</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br></div></div><p>只能说，运行的时候一看卧槽不得了..</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>stringBuffer的所用时间是：<span class="token number">28</span>ms
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>当然我也尝试了一下拼接两千万次</p>
<p><img src="/images/JavaSE/12-常用类/image-20211105005251767.png" alt="image-20211105005251767" loading="lazy"></p>
<p>这里不敢尝试String，感觉没个半个小时它跑不完</p>
<h2 id="string的总结" tabindex="-1"><a class="header-anchor" href="#string的总结" aria-hidden="true">#</a> String的总结</h2>
<p>使用的原则：结论：</p>
<ol>
<li>如果字符串存在大量的修高操作，一般使用StringBuffer或者StringBuilder</li>
<li>如果字符串存在大量的修改操作，并在<strong>单线程</strong>的情况，使用<strong>StringBuilder</strong></li>
<li>如果字符串存在大量的修改操作，并在<strong>多线程</strong>的情况，使用<strong>StringBuffer</strong></li>
<li>如果字符串<strong>很少修改</strong>，被<strong>多个对象引用</strong>，使用<strong>String</strong>，比如配置信息等</li>
</ol>
<h2 id="math" tabindex="-1"><a class="header-anchor" href="#math" aria-hidden="true">#</a> Math</h2>
<blockquote>
<p>Math类包含用于执行基本数学运算的各种方法，比如初等指数，对数，平方根和三角函数等</p>
</blockquote>
<p><img src="/images/JavaSE/12-常用类/image-20211105010014540.png" alt="image-20211105010014540" loading="lazy"></p>
<p>可以通过它的类图发现没有继承除了Object以外的任何父类，方法有一大堆，变量有一大堆..</p>
<p><strong>它的方法均为静态方法</strong></p>
<p>常用的如下：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>math_</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br><span class="line-number">62</span><br><span class="line-number">63</span><br><span class="line-number">64</span><br><span class="line-number">65</span><br><span class="line-number">66</span><br><span class="line-number">67</span><br><span class="line-number">68</span><br></div></div><h2 id="arrays" tabindex="-1"><a class="header-anchor" href="#arrays" aria-hidden="true">#</a> Arrays</h2>
<p>Arrays里面包含了一系列静态方法，用于管理或者操作数组（比如排序和搜索）</p>
<h3 id="arrays的常用方法" tabindex="-1"><a class="header-anchor" href="#arrays的常用方法" aria-hidden="true">#</a> Arrays的常用方法</h3>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>arrays_</span><span class="token punctuation">;</span>
...
<span class="token comment">//        返回的变异类型就是左边的List&lt;Integer></span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br><span class="line-number">62</span><br><span class="line-number">63</span><br><span class="line-number">64</span><br><span class="line-number">65</span><br><span class="line-number">66</span><br><span class="line-number">67</span><br><span class="line-number">68</span><br><span class="line-number">69</span><br><span class="line-number">70</span><br><span class="line-number">71</span><br><span class="line-number">72</span><br><span class="line-number">73</span><br><span class="line-number">74</span><br><span class="line-number">75</span><br><span class="line-number">76</span><br><span class="line-number">77</span><br><span class="line-number">78</span><br><span class="line-number">79</span><br><span class="line-number">80</span><br><span class="line-number">81</span><br><span class="line-number">82</span><br><span class="line-number">83</span><br><span class="line-number">84</span><br><span class="line-number">85</span><br><span class="line-number">86</span><br><span class="line-number">87</span><br><span class="line-number">88</span><br><span class="line-number">89</span><br><span class="line-number">90</span><br><span class="line-number">91</span><br><span class="line-number">92</span><br><span class="line-number">93</span><br><span class="line-number">94</span><br><span class="line-number">95</span><br><span class="line-number">96</span><br><span class="line-number">97</span><br><span class="line-number">98</span><br><span class="line-number">99</span><br><span class="line-number">100</span><br><span class="line-number">101</span><br><span class="line-number">102</span><br><span class="line-number">103</span><br></div></div><h3 id="扩展-定制排序" tabindex="-1"><a class="header-anchor" href="#扩展-定制排序" aria-hidden="true">#</a> 扩展-定制排序</h3>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>arrays_</span><span class="token punctuation">;</span>
...
<blockquote>
<p>现在有一个类Book，属性有name和price，请使用Comparator来完成正序，倒序，和根据书本名字长短来排序</p>
</blockquote>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>arrays_</span><span class="token punctuation">;</span>
...
<li>
<p><code>cuurentTimeMillens</code>：返回当前时间距离1970年1月1日00:00的<strong>毫秒数</strong></p>
</li>
<li>
<p><s><code>gc</code>运行垃圾回收机制System.gc()</s> 这个平常建议不用</p>
</li>
</ul>
<h2 id="biginteger-bigdecimal" tabindex="-1"><a class="header-anchor" href="#biginteger-bigdecimal" aria-hidden="true">#</a> BigInteger BigDecimal</h2>
<p>这两个类能解决浮点数因为精度问题导致的(0.9999998)以及数值太大(99999999999999999)这类的问题</p>
<ul>
<li><code>BigInteger</code>适合<strong>保存比较大的整数</strong></li>
<li><code>BigDecimal</code>适合<strong>保存精度更高的浮点类型(小数)</strong></li>
</ul>
<h3 id="biginteger的使用" tabindex="-1"><a class="header-anchor" href="#biginteger的使用" aria-hidden="true">#</a> BigInteger的使用</h3>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>bignumber_</span><span class="token punctuation">;</span>
...
<span class="token comment">//</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"divide:"</span> <span class="token operator">+</span> bigDecimal<span class="token punctuation">.</span><span class="token function">divide</span><span class="token punctuation">(</span><span class="token class-name">BigDecimal</span><span class="token punctuation">.</span><span class="token function">valueOf</span><span class="token punctuation">(</span><span class="token number">2.1</span><span class="token punctuation">)</span><span class="token punctuation">,</span><span class="token class-name">BigDecimal</span><span class="token punctuation">.</span>ROUND_DOWN<span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br></div></div><h2 id="date、calendar、localdate" tabindex="-1"><a class="header-anchor" href="#date、calendar、localdate" aria-hidden="true">#</a> Date、Calendar、LocalDate</h2>
<p>这个。。。时间类要用到了再去查即可，一般都是format now Date 或者format后的值转成Date</p>
</template>
