<template><h2 id="异常的概念" tabindex="-1"><a class="header-anchor" href="#异常的概念" aria-hidden="true">#</a> 异常的概念</h2>
<blockquote>
<p>在说到异常前，来看一段代码：</p>
</blockquote>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>exception_</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br></div></div><p>上方代码结果：</p>
<p><img src="/images/JavaSE/11-Exception/image-20211103143937071.png" alt="image-20211103143937071" loading="lazy"></p>
<p>截下来使用try-catch来解决这个问题：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>exception_</span><span class="token punctuation">;</span>
...
<p><img src="/images/JavaSE/11-Exception/image-20211103145516146.png" alt="image-20211103145516146" loading="lazy"></p>
<p>可以看到，烦人的异常消失了，接下来仔细了解下它</p>
<h3 id="异常的解决方案-try-catch" tabindex="-1"><a class="header-anchor" href="#异常的解决方案-try-catch" aria-hidden="true">#</a> 异常的解决方案-Try-Catch</h3>
<h4 id="基本概念" tabindex="-1"><a class="header-anchor" href="#基本概念" aria-hidden="true">#</a> 基本概念</h4>
<p>Java语言中，将程序执行中发生的不正常情况称之为<em>异常</em>(<strong>开发过程中的语法错误和逻辑错误不是异常</strong>)</p>
<ul>
<li>程序执行过程中所发生的异常事件可分为两类
<ol>
<li><code>Error</code>(错误):<strong>Java虚拟机无法解决的严重问题</strong>，如：
<ul>
<li>JVM内部系统错误，资源耗尽等严重情况，比如：
<ul>
<li><code>Stack Overflow Error</code>栈溢出</li>
<li><code>OOM(out of memory)</code></li>
</ul>
</li>
<li><strong>ERROR是严重错误，程序会崩溃</strong></li>
<li>就相当于一个人得了癌症一样，是无法处理的(就目前科技来说)</li>
</ul>
</li>
<li><code>Exception</code>:其他原因变成错误或偶然的外在因素下导致的一般性问题，<strong>可以使用针对性代码进行处理</strong>，例如：
<ul>
<li>空指针访问</li>
<li>试图读取不存在的文件</li>
<li>网络连接中断等</li>
<li>Exception分为两大类：<strong>运行时异常</strong>[<em>程序运行时发生的异常</em>]和<strong>编译时异常</strong>[<em>编程时，由编译器检查出的异常</em>]</li>
<li>就相当于人得了牙疼 脚疼 手疼 感冒之类的病，可以通过对症下药解决问题</li>
</ul>
</li>
</ol>
</li>
<li>运行时异常，编译器检查不出来，一般是指编程时的逻辑错误，是程序员应该避免出现的异常
<code>Java.lang.RuntimeException</code>类及它的子类都是运行时异常</li>
<li>对于运行时异常，可以不做处理，因为这类异常很普遍，若全处理可能会对程序的可以毒性和运行效率产生影响</li>
<li>编译时异常，是编译器要求必须处置的异常</li>
</ul>
<p>上方的案例中，所出现的异常就是<em>运行时异常</em>，因为它在编译的时候并没有报任何错误，程序也是正常运行直至<code>res = num1/num2</code>时抛出异常</p>
<h2 id="异常体系图" tabindex="-1"><a class="header-anchor" href="#异常体系图" aria-hidden="true">#</a> 异常体系图</h2>
<h3 id="" tabindex="-1"><a class="header-anchor" href="#" aria-hidden="true">#</a> </h3>
<MermaidChart id="mermaid-64a57024" data-code="graph%20TB%0AStart%7B%E5%B8%B8%E8%A7%81%E5%BC%82%E5%B8%B8%E5%9B%BE%7D%0AA%5BThorwable%3Cbr%3E%E6%89%80%E6%9C%89%E5%BC%82%E5%B8%B8%E7%9A%84%E7%88%B6%E7%B1%BB%5D%0AA--%3E%0AB(Error%3Cbr%3E%E9%94%99%E8%AF%AF)%0AB--%3EStackOverflowError%0AB--%3EOutOFMemonryError%0AA--%3E%0AC%5BException%3Cbr%3E%E5%BC%82%E5%B8%B8%5D%0AC--%3ECA(RuntimeEXception%3Cbr%3E%E7%A8%8B%E5%BA%8F%E8%BF%90%E8%A1%8C%E6%97%B6%E5%8F%91%E7%94%9F%E7%9A%84%E5%BC%82%E5%B8%B8)%0ACA--%3ENumberFormatException%0ACA--%3ENullPointerException%0ACA--%3EIndexOutBoundsException%0ACA--%3EArrayStoreException%0ACA--%3EClassCastException%0ACA--%3E.......%0AC--%3ECB(%E7%A8%8B%E5%BA%8F%E7%BC%96%E8%AF%91%E6%97%B6%E5%8F%91%E7%94%9F%E7%9A%84%E5%BC%82%E5%B8%B8%3Cbr%3E%E7%9B%B4%E6%8E%A5%E7%BB%A7%E6%89%BF%E4%BA%8EException)%0ACB--%3EFIleNoutFountException%0ACB--%3E...%0A%0A"></MermaidChart><p><img src="/images/JavaSE/11-Exception/image-20211103160838379.png" alt="image-20211103160838379" loading="lazy"></p>
<p><img src="/images/JavaSE/11-Exception/image-20211103161052235.png" alt="image-20211103161052235" loading="lazy"></p>
<p>(使用IEDA自带工具绘制出的一部分异常体系图，展现了他们的继承关系（虚线表示实现了接口，实现表示继承了类）)</p>
<h2 id="常见的运行时异常" tabindex="-1"><a class="header-anchor" href="#常见的运行时异常" aria-hidden="true">#</a> 常见的运行时异常</h2>
<h3 id="nullpointerexception-空指针异常" tabindex="-1"><a class="header-anchor" href="#nullpointerexception-空指针异常" aria-hidden="true">#</a> NullPointerException 空指针异常</h3>
<p>该异常的继承关系图:</p>
<p><img src="/images/JavaSE/11-Exception/image-20211103162250515.png" alt="image-20211103162250515" loading="lazy"></p>
<blockquote>
<p>下方异常中没有表明出处的都是直接继承于RuntimeException</p>
</blockquote>
<p>当程序试图在需要对象地方使用null时，会抛出该异常</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>exception_</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">NullPointerException_</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><p>输出：</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h3 id="arithmeticexception-数学运算异常" tabindex="-1"><a class="header-anchor" href="#arithmeticexception-数学运算异常" aria-hidden="true">#</a> ArithmeticException 数学运算异常</h3>
<p>当出现异常的运算条件时，抛出此异常，例如：<em>一个整数除以零</em>时，抛出此类的一个实例：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>exception_</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h3 id="arrayindexoutofboundsexception-数组下标越界异常" tabindex="-1"><a class="header-anchor" href="#arrayindexoutofboundsexception-数组下标越界异常" aria-hidden="true">#</a> ArrayIndexOutOfBoundsException 数组下标越界异常</h3>
<p>该异常的继承关系图：</p>
<p><img src="/images/JavaSE/11-Exception/image-20211103162939406.png" alt="image-20211103162939406" loading="lazy"></p>
<p>用非法索引访问数组时抛出异常，如果索引值为负或者大于小于数组大小（arr.length-1），则该索引为非法索引：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>exception_</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h3 id="classcastexception-类型转换异常" tabindex="-1"><a class="header-anchor" href="#classcastexception-类型转换异常" aria-hidden="true">#</a> ClassCastException 类型转换异常</h3>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h3 id="numberformatexception-数字格式不正确异常" tabindex="-1"><a class="header-anchor" href="#numberformatexception-数字格式不正确异常" aria-hidden="true">#</a> NumberFormatException 数字格式不正确异常</h3>
<p>继承关系图：</p>
<p><img src="/images/JavaSE/11-Exception/image-20211103164117438.png" alt="image-20211103164117438" loading="lazy"></p>
<p>当应用程序试图将字符串转换成以重数组类型，但该字符串不能转换为适当格式时，抛出该异常(使用该异常可以确保最终输入的是数字)</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>exception_</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div><p>上方运行结果：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token number">123465</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><h2 id="常见的编译时异常" tabindex="-1"><a class="header-anchor" href="#常见的编译时异常" aria-hidden="true">#</a> 常见的编译时异常</h2>
...
<ol>
<li>一般来说，都是<code>try-catch-finally</code>和<code>throws</code>二选一</li>
<li>如果程序员没有显示的处理异常，默认是使用了<code>throws</code></li>
</ol>
<h3 id="try-catch-finally" tabindex="-1"><a class="header-anchor" href="#try-catch-finally" aria-hidden="true">#</a> try-catch-finally</h3>
<p>程序员在代码中捕获发生的异常， 自行处理</p>
<p>Java提供try和Catch块来处理异常，Try块用于包含可能出错的代码，Catch块用于处理Try块中发生的异常，可以根据需要在程序中有多个数量的try-catch块</p>
<p>处理机制：</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br></div></div><h4 id="try-catch方式处理异常-注意事项" tabindex="-1"><a class="header-anchor" href="#try-catch方式处理异常-注意事项" aria-hidden="true">#</a> Try-Catch方式处理异常-注意事项</h4>
<ol>
<li>如果异常<strong>发生了</strong>，则<strong>异常发生后面的代码不会执行，直接进入到catch块</strong></li>
<li>如果异常<strong>没有发生</strong>，则<strong>顺序执行try代码块，不会进入到catch</strong></li>
<li>如果希望<strong>不管是否发生异常</strong>，<strong>都执行某段代码块</strong>(如关闭连接，释放资源等)，则使用<code>final{}</code></li>
</ol>
<h3 id="throws" tabindex="-1"><a class="header-anchor" href="#throws" aria-hidden="true">#</a> throws</h3>
<p>将发生的异常抛出，交给调用者（方法）来处理，<strong>最顶级的处理者就是JVM</strong></p>
<p>处理机制：</p>
<MermaidChart id="mermaid-64a56166" data-code="graph%20TB%0AJVM%7BJVM%3Cbr%3E%E5%A4%84%E7%90%86%E5%BC%82%E5%B8%B8%E7%9A%84%E6%96%B9%E5%BC%8F-%3Cbr%3E1.%E8%BE%93%E5%87%BA%E5%BC%82%E5%B8%B8%E4%BF%A1%E6%81%AF%3Cbr%3E2.%E9%80%80%E5%87%BA%E7%A8%8B%E5%BA%8F%7D%0AJVM--%3E%7C%E8%B0%83%E7%94%A8%7CMain%0AMain--%3E%7C%E8%B0%83%E7%94%A8%7CF1%E6%96%B9%E6%B3%95%0AF1%E6%96%B9%E6%B3%95--%3E%7C%E8%B0%83%E7%94%A8%7CE(F2%E6%96%B9%E6%B3%95%3Cbr%3E%E6%8A%9B%E5%87%BA%E5%BC%82%E5%B8%B8)%0AE--%3E%7C%E4%BD%BF%E7%94%A8throws%E6%8A%9B%E5%87%BA%E5%BC%82%E5%B8%B8%7CF1%E6%96%B9%E6%B3%95%0AF1%E6%96%B9%E6%B3%95--%3E%7C%E8%87%AA%E8%A1%8C%E4%BD%BF%E7%94%A8trycatch%E5%A4%84%E7%90%86%E5%BC%82%E5%B8%B8%3Cbr%3E%E6%88%96%E8%80%85%E5%86%8D%E7%94%A8throws%E6%8A%9B%E7%BB%99%E4%B8%8A%E4%B8%80%E7%BA%A7%7CMain%0AMain--%3E%7C%E8%87%AA%E8%A1%8C%E4%BD%BF%E7%94%A8trycatch%E5%A4%84%E7%90%86%E5%BC%82%E5%B8%B8%3Cbr%3E%E6%88%96%E8%80%85%E5%86%8D%E7%94%A8throws%E6%8A%9B%E7%BB%99%E4%B8%8A%E4%B8%80%E7%BA%A7%7CJVM%0A"></MermaidChart><p>Throws基本介绍：</p>
<ol>
<li>如果一个方法（中的语句执行时）可能生成某种异常，但是并不能确定如何处理这种异常，由此方法应该显示的声明抛出异常，表明该方法将不对这些异常进行处理，而由该方法的<strong>调用者负责处理</strong></li>
<li>在方法中用throws语句可以声明抛出异常的列表，throws后面的异常类型可以是方法中产生的异常类型，也可以是它的父类</li>
</ol>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>throws_</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br></div></div><h4 id="throws使用细节" tabindex="-1"><a class="header-anchor" href="#throws使用细节" aria-hidden="true">#</a> Throws使用细节</h4>
<ol>
<li>
<p>对于编译异常，程序中必须处理，比如使用<code>try-catch</code>或<code>throws</code></p>
</li>
<li>
<p>对于运行时异常，程序中如果没有处理，默认就是Throws方法处理</p>
</li>
<li>
<p>子类重写父类方法时，对抛出异常的规定：子类重写的方法：<strong>所抛出的异常类型要么和父类抛出的异常一致，要么为父类抛出的异常类型的子类型</strong>，<strong><u>抛出的异常类型绝不能是父类异常的父类型或者跟父类异常无关的同级异常类型/子类型</u></strong></p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">Father</span><span class="token punctuation">{</span>
...
<span class="token comment">//    所抛出的异常类型要么和父类抛出的异常一致，要么为父类抛出的异常类型的子类型</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br></div></div><p><img src="/images/JavaSE/11-Exception/image-20211103174900422.png" alt="image-20211103174900422" loading="lazy"></p>
</li>
<li>
<p>在throws中，如果由方法try-catch，就相当于异常处理，就可以不必throws(二选一)</p>
</li>
</ol>
<h2 id="自定义异常" tabindex="-1"><a class="header-anchor" href="#自定义异常" aria-hidden="true">#</a> 自定义异常</h2>
<p>当程序中出现了某些“错误“，当该错误信息并没有在<code>Throwable</code>子类中描述，这个时候可以自己设计类异常，用于描述错误信息</p>
<h3 id="自定义异常的步骤" tabindex="-1"><a class="header-anchor" href="#自定义异常的步骤" aria-hidden="true">#</a> 自定义异常的步骤</h3>
<ol>
<li>定义类：自定义异常类名(程序员自己写)，继承<code>Exception</code>或者<code>RuntimeException</code></li>
<li>如果继承<code>Exception</code>，属于编译异常</li>
<li>如果继承<code>RuntimeException</code>，属于运行异常（一般来说自定义的异常都是继承于<code>RuntimeException</code>）</li>
</ol>
<blockquote>
<p>实例：当我们接收Person年龄对象时，要求范围在18~120之间，否则抛出一个自定义异常，并给出提示信息</p>
</blockquote>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>customException</span><span class="token punctuation">;</span>
...
<span class="token comment">//        构造器</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br></div></div><h2 id="throw和throws的对比" tabindex="-1"><a class="header-anchor" href="#throw和throws的对比" aria-hidden="true">#</a> throw和throws的对比</h2>
<table>
<thead>
<tr>
<th></th>
...
<th style="text-align:center">后面跟的东西</th>
</tr>
</thead>
<tbody>
<tr>
<td>trhows</td>
<td style="text-align:center">异常处理的一种方式</td>
<td style="text-align:center">方法声明处</td>
<td style="text-align:center">异常对象</td>
</tr>
<tr>
<td>throw</td>
<td style="text-align:center">手动生成异常对象的关键字</td>
<td style="text-align:center">方法体中</td>
<td style="text-align:center">异常对象(参数)</td>
</tr>
</tbody>
</table>
</template>
