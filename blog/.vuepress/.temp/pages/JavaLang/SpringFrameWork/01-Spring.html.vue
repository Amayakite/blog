<template><h2 id="spring的简介" tabindex="-1"><a class="header-anchor" href="#spring的简介" aria-hidden="true">#</a> Spring的简介</h2>
<blockquote>
...
<p>​  Spring提供了展现层<code>SpringMVC</code>和持久层<code>Spring JDBCTemplate</code>以及业务层事务管理等众多的企业级应用技术，还能整合开源世界众多著名的第三方框架和库，逐渐成为使用最多的JavaEE企业级应用开源框架</p>
<ul>
<li>
<p>控制反转：这里简单说下，就是反转Bean的创建权</p>
</li>
<li>
<p>面向切面编程：还记得我们的注解吗...</p>
</li>
<li>
<p>Spring是一个全栈的框架：前端后端都有解决方案</p>
</li>
<li>
<p>Web层：SpringMVC</p>
</li>
<li>
<p>DAO层：SpringJDBC模板</p>
</li>
<li>
<p>SpringDate：也是一个存放数据的东西</p>
</li>
</ul>
<p>PS：一张图让你明白Spring是干嘛用的：</p>
<p><img src="/images/SpringFrameWork/01-Spring/40f82edda3cc7cd97dc293bf3501213fb90e9145.jpg" alt="img" loading="lazy"></p>
<h3 id="spring的优势" tabindex="-1"><a class="header-anchor" href="#spring的优势" aria-hidden="true">#</a> Spring的优势</h3>
<ol>
<li>方便解耦，简化开发</li>
</ol>
<blockquote>
<p>通过SPring提供的IOC(控制反转)容器，可以将对象间的依赖关系交由SPring进行控制，避免硬编码所造成的过度耦合，用户也不必再为单例模式类、属性文件解析等这些很底层的需求编写代码，可以更专注于上层应用</p>
<p>举个例子：之前我们编写JavaWEB时，我们要和数据库之间进行操作时，需要借助一个相应的对象，这个对象是死的，每次都要NEW出来，例如跟user数据库联系需要一个User类</p>
<p>Spring就可以很好地解决这一点，具体学到了就知道了</p>
</blockquote>
<ol start="2">
<li>Aop编程的支持</li>
</ol>
<blockquote>
<p>通过Spring的Aop(面向切面编程)功能，方便进行面向切面编程，许多不容易用传统OOP实现的功能可以通过AOP轻松实现</p>
</blockquote>
<ol start="3">
<li>声明式事务的支持</li>
</ol>
<blockquote>
<p>可以将我们从单调烦闷的事务管理代码中解脱出来，通过声明方式灵活得进行事务管理，提高开发的效率</p>
<p>例如我们原先来控制JDBC的事务，我们需要：</p>
<p>autoCommit设为false，开启事务；commit提交事务；rollback回滚</p>
<p>但是我们实际的业务中可能有非常多的地方需要进行事务的控制，那么我们的大部分地方都需要些刚才的那些代码，非常痛苦</p>
<p>Spring就可以通过配置的方式一次性配置一片方法，自动地进行事务控制</p>
</blockquote>
<ol start="4">
<li>方便程序的测试</li>
</ol>
<blockquote>
<p>Spring可以集成我们常用的junit（@Test），可以更加方便地进行测试</p>
<p>用非容器依赖的编程方式进行几乎所有的测试工作，测试不再是昂贵的工作，而是随手可做的事情</p>
</blockquote>
<ol start="5">
<li>方便集成各种优秀的框架</li>
</ol>
<blockquote>
<p>Spring能够对各种优秀的框架(Struts、Hibernate、Hessian、Quartz等)的支持</p>
</blockquote>
<ol start="6">
<li>降低JavaEE API的使用难度</li>
</ol>
<blockquote>
<p>Spring 对于JavaEE API（JDBC、JavaMail（一个邮件库）、远程调用等进行了薄薄的封装，使得使用这些API的难度大大降低</p>
</blockquote>
<ol start="7">
<li>Java源码是经典学习范例</li>
</ol>
<blockquote>
<p>Spring的源代码设计精妙，结构清晰，匠心杜勇，处处体现着大师对Java设计模式灵活运用以及对Java技术的高深造诣，它的源代码无疑是Java技术的最佳实践范例</p>
</blockquote>
<h3 id="spring的体系结构" tabindex="-1"><a class="header-anchor" href="#spring的体系结构" aria-hidden="true">#</a> Spring的体系结构</h3>
<p>Spring框架至今已集成了20多个模块，这些模块分布在以下模块中：</p>
<ul>
...
<p><img src="https://img2018.cnblogs.com/blog/480452/201903/480452-20190318225849216-2097896352.png" alt="img" loading="lazy"></p>
<h3 id="spring程序开发步骤" tabindex="-1"><a class="header-anchor" href="#spring程序开发步骤" aria-hidden="true">#</a> Spring程序开发步骤</h3>
<p>在我们之前实现一个对数据库的操作是这样的：</p>
<MermaidChart id="mermaid-64a56926" data-code="graph%20LR%0AA%5BUSerDao%20userDao%20%3D%20new%20UserDaoImpl%5D--%3E%7CUserDaoImpl%7CB%5Bsave%E6%96%B9%E6%B3%95%3Cbr%3Eupdate%E6%96%B9%E6%B3%95...%5D%0A"></MermaidChart><p>Spring把这一步解耦成了如下内容：</p>
<p><img src="/images/SpringFrameWork/01-Spring/image-20211209155620653.png" alt="image-20211209155620653" loading="lazy"></p>
<ol>
<li>导入Spring开发包的基本实现坐标</li>
<li>编写Dao接口和实现类</li>
<li>创建SPring核心配置文件</li>
<li>在Spring配置文件中配置UserDaoImpl</li>
<li>使用SPring的API获取Bean实例</li>
</ol>
<h3 id="使用spring完成对dao的操作" tabindex="-1"><a class="header-anchor" href="#使用spring完成对dao的操作" aria-hidden="true">#</a> 使用SPring完成对Dao的操作</h3>
<p>我们首先创建一个空的Maven项目</p>
<p>然后我们加入Spring-context的依赖，这里直接去Maven仓库找即可，用最新的</p>
<p><a href="https://mvnrepository.com/artifact/org.springframework/spring-context" target="_blank" rel="noopener noreferrer">链接<ExternalLinkIcon/></a></p>
<p>我这里用的是5.3.13</p>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>接着，我们建立如下dao文件</p>
<p><img src="/images/SpringFrameWork/01-Spring/image-20211209160749233.png" alt="image-20211209160749233" loading="lazy"></p>
<p>UserDao接口只有一个方法</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>UserDaoImpl只做个简单的实现，并不去连接数据库</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">UserDaoImpl</span> <span class="token keyword">implements</span> <span class="token class-name">UserDao</span> <span class="token punctuation">{</span>
   ...
   <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>接着，我们在res文件夹中创建一个SPring的配置文件</p>
<p><img src="/images/SpringFrameWork/01-Spring/image-20211209161009456.png" alt="image-20211209161009456" loading="lazy"></p>
<p>文件名没有硬性规定，但是一般在开发中都会习惯性地设置为applicationContext</p>
<p>设置内容为(原理先不管)：</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><p>紧接着，我们创建一个测试类，写入如下方法，原理也先不管</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>然后我们创建测试文件(在impl文件中按下alt+insert快速创建) 下面测试类中的代码原理我们先不管</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">UserDaoImplTest</span> <span class="token punctuation">{</span>
   ...
   <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><p>输出结果，完美运行：</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>UserDaoImpl.save()
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>接下来我们回顾一下开发步骤</p>
<ol>
<li>导入坐标（Spring-context）</li>
<li>创建Bean（UserDao和UserDaoImpl）</li>
<li>创建applicationContext.xml</li>
<li>在配置文件中配置id和class路径</li>
<li>创建ApplicationContext对象</li>
<li>GetBean</li>
</ol>
<p>是不是还没搞明白，接下来我们一步一步地了解Spring</p>
<h2 id="spring的配置文件" tabindex="-1"><a class="header-anchor" href="#spring的配置文件" aria-hidden="true">#</a> Spring的配置文件</h2>
<h2 id="✨✨spring配置文件一览" tabindex="-1"><a class="header-anchor" href="#✨✨spring配置文件一览" aria-hidden="true">#</a> ✨✨Spring配置文件一览</h2>
<p>这里不是写给在读的人看的，这里是写给之后的我看的 如果你是直接看我的文章到这里的话，先略过这一步</p>
<p>来自<a href="https://blog.csdn.net/zxcbnm7089/article/details/105677523" target="_blank" rel="noopener noreferrer">这篇文章<ExternalLinkIcon/></a></p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!-- 注解包扫描 --></span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br></div></div><h3 id="bean标签的基本配置" tabindex="-1"><a class="header-anchor" href="#bean标签的基本配置" aria-hidden="true">#</a> Bean标签的基本配置</h3>
<p>我们刚刚在创建applicationContext的时候，默认是只有这些内容的</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token prolog">&lt;?xml version="1.0" encoding="UTF-8"?></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>beans</span> <span class="token attr-name">xmlns</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>http://www.springframework.org/schema/beans<span class="token punctuation">"</span></span>
      <span class="token attr-name"><span class="token namespace">xmlns:</span>xsi</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>http://www.w3.org/2001/XMLSchema-instance<span class="token punctuation">"</span></span>
      <span class="token attr-name"><span class="token namespace">xsi:</span>schemaLocation</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>http://www.springframework.org/schema/beans http://www.springframework.org/schema/beans/spring-beans.xsd<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>beans</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><p>我们在其中添加了一句话：</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>这玩意用于配置对象交由<strong>Spring</strong>来创建</p>
<p>默认情况下它调用的是类中的<strong>无参构造器</strong>（TIPS:反射创建对象默认就是调用无参构造器），如果没有无参构造器则不能创建成功</p>
<p>这个bean的基本属性有两点：</p>
<ul>
<li>id：Bean实例在Spring容器中的唯一标识，就像身份证一样，不可重复</li>
<li>class：Bean的全限定名称</li>
</ul>
<h4 id="bean标签的范围配置-scope" tabindex="-1"><a class="header-anchor" href="#bean标签的范围配置-scope" aria-hidden="true">#</a> Bean标签的范围配置-scope</h4>
<p>除了上述两个属性，我们还可以配置scope：对象的作用范围，取值如下</p>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td style="text-align:center"><strong>singleton</strong></td>
<td>单例的，默认值</td>
</tr>
<tr>
...
<td>Web项目中，Spring创建一个Bean对象，将对象存入到request域中<br />单次的请求域</td>
</tr>
<tr>
<td style="text-align:center">session</td>
<td>Web项目中，Spring创建一个Bean对象，将对象存储到session域中<br />单个会话的域</td>
</tr>
<tr>
<td style="text-align:center">global session</td>
<td>Web项目中，应用在Portlet环境，如果没有Portlet环境，nameglobal session等同于session</td>
</tr>
</tbody>
</table>
<p>接下来我们主要说明singleton和prototype（其他的几个之后再说）</p>
<p>其实测试非常简单，我们首先回顾下单例模式：</p>
<p>在学习JavaSE的时候，我们有一种创建对象的方式</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token class-name">Class</span> <span class="token class-name">A</span><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>我们通过getA调用返回的A始终是全局唯一的，这就是单例设计模式</p>
<p>接下来便写下代码测试下Spring这个singleton是否为单例：只需要判断其返回的对象的地址是否全部都相同</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div><p>结果和我们预想的一样，他们都是同一个对象</p>
<p>那么把scope改成prototype呢？接下来测试下</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>接着运行上面的代码，发现了如下结果：</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>(如果你运行的时候发现获取的两个com长得一模一样，不用担心，那是因为离太近操作系统分配的内存地址太近了，可以在他们中间放一些其他代码，就能看出区别了)</p>
<h4 id="singleton和prototype的创建时机的区别" tabindex="-1"><a class="header-anchor" href="#singleton和prototype的创建时机的区别" aria-hidden="true">#</a> singleton和prototype的创建时机的区别</h4>
<p>​  （TIPS：可以直接到最下面看总结）</p>
<p>​  到这里，你可能会有疑问，这两玩意连创建时机都不同的？</p>
<p>​  我们直接上代码说明吧</p>
<p>现在UserDaoImpl中加入一个无参构造，打印一句话出来：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token class-name">UserDaoImpl</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>接着将applicationContext的userBean修改成单例模式</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>bean</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>userDao<span class="token punctuation">"</span></span> 
      <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>com.MySpring.dao.impl.UserDaoImpl<span class="token punctuation">"</span></span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>然后在测试类中加入如下代码并运行：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">testScope</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>TestScope开始执行了
UserDaoImpl.UserDaoImpl()无参构造被调用了
创建app完毕
创建userDao1完毕
创建userDao2完毕
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>​    我们还没有获取到userBean的实例对象的时候，userDaoImpl的无参构造器就被调用了</p>
<pre><code>也就是说这个UserDaoImpl在扫描到ApplicationContext.xml的时候就通过反射调用无参构造器创建了一个实例对象出来
</code></pre>
<p>接下来我们将singleton替换为prototype</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>bean</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>userDao<span class="token punctuation">"</span></span> 
      <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>com.MySpring.dao.impl.UserDaoImpl<span class="token punctuation">"</span></span>
      <span class="token attr-name">scope</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>prototype<span class="token punctuation">"</span></span>
      <span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>bean</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>再试图运行下代码：</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>TestScope开始执行了
创建app完毕
UserDaoImpl.UserDaoImpl()无参构造被调用了
创建userDao1完毕
UserDaoImpl.UserDaoImpl()无参构造被调用了
创建userDao2完毕
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>可以发现，在prototype模式下，我们只有每次getBean的时候才会创建一个实例对象</p>
<p>总结：</p>
<ol>
<li>当scope的取值为<strong>singleton</strong>时
<ul>
<li>Bean的实例化个数：1个</li>
<li>Bean的实例化时机：当Spring核心文件被加载时，实例化配置的Bean实例</li>
<li>Bean的生命周期
<ul>
<li>对象创建：当应用加载，容器创建时，对象就创建了</li>
<li>对象运行：<strong>只要容器在，对象就一直活着</strong></li>
<li>对象销毁：<strong>当应用卸载时（应用结束时），销毁容器时，对象就被销毁了</strong></li>
</ul>
</li>
</ul>
</li>
<li>当scope的取值为<strong>prototype</strong>时
<ul>
<li>Bean的实例化个数：多个</li>
<li>Bean的实例化时机：当调用getBean()方法时实例化Bean
<ul>
<li>对象创建：当适用对象时，创建新的对象实例</li>
<li>对象运行：<strong>只要对象在使用中，就一直活着</strong></li>
<li>对象销毁：<strong>当对象长时间不用时，被Java的垃圾回收机制(Gc)回收</strong></li>
</ul>
</li>
</ul>
</li>
</ol>
<h3 id="bean生命周期配置的属性" tabindex="-1"><a class="header-anchor" href="#bean生命周期配置的属性" aria-hidden="true">#</a> Bean生命周期配置的属性</h3>
<p>我们可以自由的配置Bean生命周期中创建时和销毁时执行的东西</p>
<ul>
<li><code>init-method</code>：指令类中的初始化方法名称</li>
<li><code>destory-method</code>：制定类中销毁方法的名称</li>
</ul>
<p>使用方式：我们首先在UserDaoImpl中新增两个方法：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">UserDaoImpl</span> <span class="token keyword">implements</span> <span class="token class-name">UserDao</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>接着在applicationContext.xml配置的bean中额外添加如下内容</p>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>bean</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>这样就可以了，在创建和销毁这个Bean的实例的时候，都会调用其方法，接下来创建一个测试单元测试一下：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>但似乎运行结果少了个Destory的方法</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>TestScope开始执行了
创建app完毕
UserDaoImpl.UserDaoImpl()无参构造被调用了
=================INIT初始化方法被调用了
创建userDao1完毕
主程序结束
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>其实原因非常简单，平常这东西都是丢到tomcat上跑，tomcat在关闭之前会给其所有程序下达命令，Spring也会接收到，然后开始自身的销毁，我们这一个单元测试太快就结束了，它来不及的去销毁，所以就导致了如上情况发生</p>
<p>有一个可能可以调用成功我们destory的方法（不一定成功）</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">testLifeCycle</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"TestScope开始执行了"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token class-name">ApplicationContext</span> app <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">ClassPathXmlApplicationContext</span><span class="token punctuation">(</span><span class="token string">"applicationContext.xml"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><h3 id="配置文件中设定实例化的方式-无参、工厂静态、工厂实例" tabindex="-1"><a class="header-anchor" href="#配置文件中设定实例化的方式-无参、工厂静态、工厂实例" aria-hidden="true">#</a> 配置文件中设定实例化的方式（无参、工厂静态、工厂实例）</h3>
<p>Spring当让不可能只提供一个无参构造给我们</p>
<p>它总共提供了三种实例化方式供我们选择</p>
<ul>
<li><strong>无参构造</strong>方法实例化</li>
<li><strong>工厂静态</strong>方法实例化</li>
<li><strong>工厂实例</strong>方法实例化</li>
</ul>
<p>因为默认就是无参构造，这里就不做演示了</p>
<h4 id="为什么要通过工厂来创建实例" tabindex="-1"><a class="header-anchor" href="#为什么要通过工厂来创建实例" aria-hidden="true">#</a> 为什么要通过工厂来创建实例</h4>
<p>​  很简单，因为我们创建对象的时候，不一定是通过无参构造来创建的，而是通过有参构造，但是在Spring中无法直接传入参数（目前来说），所以就需要工厂来帮我们具体的执行创建对象</p>
<p>​  就比如说创建JDBC的实例，是一定要传入一个db.properties的实例对象的(Druid)，我们直接通过无参构造的方式无法实现动态的传入（例如在开发中和实际项目上线的时候，可能用的是两个sql数据库），所以就需要工厂来帮我们实现动态的传入指定的db.properti</p>
<h4 id="工厂静态" tabindex="-1"><a class="header-anchor" href="#工厂静态" aria-hidden="true">#</a> 工厂静态</h4>
<p>我们先新建一个工厂类 其中包含一个返回UserDaoImpl的实例对象的方法</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><p>然后修改下application</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>bean</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>userDao<span class="token punctuation">"</span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>bean</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><p>接着测试下：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">testLifeCycle</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    <span class="token class-name">ApplicationContext</span> app <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">ClassPathXmlApplicationContext</span><span class="token punctuation">(</span><span class="token string">"applicationContext.xml"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"创建app完毕"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>完美创建了，接下来我们使用工厂实例方法创建</p>
<h4 id="工厂实例" tabindex="-1"><a class="header-anchor" href="#工厂实例" aria-hidden="true">#</a> 工厂实例</h4>
<p>先说下，这和工厂静态的不同是：多了一个工厂的实例对象，我们以后可以方便的调用这个工厂</p>
<p>现在可能不太理解为啥要这样做，但是等以后学到Spring Boot 就知道了</p>
<p>首先，我们的工厂类要这样写：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">StaticFactory</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>然后按照这样配置applicationContext.xml</p>
...
<li>factory-bean：设置工厂的名称</li>
<li>factory-method：设置执行工厂中的哪个方法获取实例</li>
</ul>
<p>测试：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Test</span>
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">testLifeCycle</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
...
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>UserDaoImpl.UserDaoImpl()无参构造被调用了
创建app完毕
创建userDao1完毕
com.MySpring.dao.impl.UserDaoImpl@1bd4fdd
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><h3 id="配置文件-依赖注入" tabindex="-1"><a class="header-anchor" href="#配置文件-依赖注入" aria-hidden="true">#</a> 配置文件-依赖注入</h3>
<p>我们先来模拟一下实际WEB开发中文件的过程吧</p>
<p>首先我们需要有一个Services包，这个包内有相关接口和实现类，比如UserServices</p>
<p><img src="/images/SpringFrameWork/01-Spring/image-20211209204903649.png" alt="image-20211209204903649" loading="lazy"></p>
<p>编写一下接口：这里做最简单的模拟</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">UserService</span> <span class="token punctuation">{</span>
     <span class="token keyword">void</span> <span class="token function">save</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>然后给他一个实现类，实现类有如下内容：获取一个UserDao</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">UserServiceImpl</span> <span class="token keyword">implements</span> <span class="token class-name">UserService</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><p>然后在Demo目录下新建一个UserController，里面编写如下内容（就当成有用户访问就执行其中的内容）</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">UserController</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><p>然后在applicationContext中加入如下内容：</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>bean</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>userDao<span class="token punctuation">"</span></span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>com.MySpring.dao.impl.UserDaoImpl<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>bean</span><span class="token punctuation">></span></span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>然后运行一下，似乎是没问题的</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>UserDaoImpl.UserDaoImpl()无参构造被调用了
UserDaoImpl.UserDaoImpl()无参构造被调用了
UserDaoImpl.save()被调用了
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>但是仔细一想，不对啊，ApplicationContext被创建了两次、加载了两次配置文件？！</p>
<p>​  <code>UserDaoImpl.UserDaoImpl()无参构造被调用了</code> 这句话出现了两次，表示创建了两个UserDao</p>
<p>​  仔细捋一捋，目前UserService实例和UserDao实例都保存在Spring容器中，当前的做法是在容器外部分别获得UserDao实例和Userservice实例，然后在程序中进行结合</p>
<p><img src="/images/SpringFrameWork/01-Spring/image-20211209205819276.png" alt="image-20211209205819276" loading="lazy"></p>
<p>​  <strong>那么我们是否可以换一个思路，因为UserService和UserDao都在Spring容器中，而最终程序直接使用的是UserService，所以我们是否可以将UserDao设置在UserService内部？</strong></p>
<p>​  问题来了，我们该怎么把某个对象、某个数据给另外一个对象？</p>
<p>​  那么总得调用另外一个对象的某个方法，才能把这个玩意给他吧？</p>
<p>​  无非就是两种方法嘛</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div><p><img src="/images/SpringFrameWork/01-Spring/image-20211209210404022.png" alt="image-20211209210404022" loading="lazy"></p>
<h3 id="依赖注入的概念" tabindex="-1"><a class="header-anchor" href="#依赖注入的概念" aria-hidden="true">#</a> 依赖注入的概念</h3>
<p>​  在刚刚的案例中，我们得到的结论无非就是，在UserService中，需要一个UserDao，最笨的方法就是：在UserService中新建一个set方法，然后再到我们的操作层手动的将UserDao给set进去，然后再调用-----但是这样做的话，UserService的作用何在？我还不如直接调用UserDao得了</p>
<p>​  这时候，就要用到Spring的依赖注入了。</p>
<p>​  依赖注入（Dependency Injection），是Spring核心框架Ioc的具体实现</p>
<p>​  在编写程序时，通过Ioc控制反转，把对象的创建交给了Spring，但是代码中不可能会出现没有依赖的情况，Ioc解耦只是降低他们的依赖关系，但不会消除，例如：业务层仍会调用持久层的方法</p>
<p>​  那这种业务层和持久层的依赖关系，在使用Spring后，就让Spring来维护了</p>
<p>​  简单的说，就是坐等框架把持久层传入业务层，而不用我们自己去获取了</p>
<p>刚刚也说了，现在有两种方法可以把数据注入到UserService内部</p>
<ul>
<li>构造方法 有参构造</li>
<li>set方法</li>
</ul>
<p>我们先说Set方法吧</p>
<h4 id="通过set方法来进行配置注入" tabindex="-1"><a class="header-anchor" href="#通过set方法来进行配置注入" aria-hidden="true">#</a> 通过set方法来进行配置注入</h4>
<p>首先将UserService改成这样：就像正常的程序一样</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">UserServiceImpl</span> <span class="token keyword">implements</span> <span class="token class-name">UserService</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br></div></div><p>然后修改applicationContext.xml</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>bean</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>userDao<span class="token punctuation">"</span></span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>com.MySpring.dao.impl.UserDaoImpl<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>bean</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>bean</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>这里的property是这样的：</p>
<ul>
<li>
<p>name的值得是SetXXX中的XXX，XXX的首字母替换成小写后放到这里来，我们的是<code>setUserDao</code></p>
<ul>
<li>所以传入<code>userDao</code></li>
</ul>
</li>
<li>
<p>ref是要传入的值是谁，需要Spring容器中的Bean的ID</p>
<ul>
<li>所以我们传入之前定义的userDao</li>
</ul>
</li>
</ul>
<p>或者说如果感觉这样有点绕的话：</p>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>bean</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>是不是就清晰了</p>
<p>接下来我们回过头测试一下</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">UserController</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token class-name">ApplicationContext</span> app <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">ClassPathXmlApplicationContext</span><span class="token punctuation">(</span><span class="token string">"applicationContext.xml"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>UserDaoImpl.UserDaoImpl()无参构造被调用了
UserDaoImpl.save()
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>这下舒服了，只创建了一个UserDaoImpl，完美解决了资源浪费以及后面可能会出现的一系列问题</p>
<h5 id="set注入的两种方式" tabindex="-1"><a class="header-anchor" href="#set注入的两种方式" aria-hidden="true">#</a> Set注入的两种方式</h5>
<p>除了我们刚刚的那一种：</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>bean</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>userDao<span class="token punctuation">"</span></span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>com.MySpring.dao.impl.UserDaoImpl<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>bean</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>bean</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>userService<span class="token punctuation">"</span></span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>com.MySpring.services.impl.UserServiceImpl<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>bean</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>还有一种更简便的方式可以来注入内容：通过P命名空间来注入</p>
<p>​  P命名空间注入本质也是set方法注入，但比起上面的那个set方法注入更加方便，主要体现在配置文件中</p>
<p>分为两步：</p>
<ol>
<li>
<p>引入p命名空间：在beans标签中加入如下属性</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code>xmlns:p="http://www.springframework.org/schema/p"
...
<li>小tips：这里你直接输入一个<code>p:</code>，然后ieda会提示你引入，按下ctrl+enter即可自动引入步骤1中的属性</li>
</ul>
</li>
</ol>
<p>这里的<code>p:userDao-ref=&quot;userDao&quot;</code>大概是如下意思</p>
<ul>
<li><code>userDao-ref</code>要设定的属性</li>
<li><code>=userDao</code>设定的值</li>
</ul>
<p>这就是个语法糖（像JSp的JSTL那样），降低了我们的步骤</p>
<h4 id="通过构造函数来进行配置注入" tabindex="-1"><a class="header-anchor" href="#通过构造函数来进行配置注入" aria-hidden="true">#</a> 通过构造函数来进行配置注入</h4>
<p>我们把UserService改成如下内容：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">UserServiceImpl</span> <span class="token keyword">implements</span> <span class="token class-name">UserService</span> <span class="token punctuation">{</span>
    <span class="token keyword">private</span> <span class="token class-name">UserDao</span> userDao<span class="token punctuation">;</span>
 <span class="token comment">// 无论是在什么情况下，使用反射来创建对象一定要保留一个无参构造器</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br></div></div><p>然后在applicationContext.xml中添加如下内容：</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>bean</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>userDao<span class="token punctuation">"</span></span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>com.MySpring.dao.impl.UserDaoImpl<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>bean</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>bean</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>userService<span class="token punctuation">"</span></span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>com.MySpring.services.impl.UserServiceImpl<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>bean</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>这里construcotr-arg标签中的name表示要设置哪个属性（传入属性名）</p>
<p>ref表示引用Spring容器中的BeanID</p>
<p>然后测试一下</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">UserController</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>UserDaoImpl.UserDaoImpl()无参构造被调用了
UserDaoImpl.save()
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>这就是通过构造方法传值</p>
<h3 id="bean依赖注入支持的类型" tabindex="-1"><a class="header-anchor" href="#bean依赖注入支持的类型" aria-hidden="true">#</a> Bean依赖注入支持的类型</h3>
<p>除了我们刚刚用的通过传入BeanID的方式注入，Spring还支持普通数据类型、集合的注入</p>
<p>注入数据的三种数据类型</p>
<ul>
<li>普通数据类型</li>
<li>引用数据类型-BeanID</li>
...
<p>这里我们先来说下普通数据类型的注入</p>
<h4 id="普通数据类型的注入" tabindex="-1"><a class="header-anchor" href="#普通数据类型的注入" aria-hidden="true">#</a> 普通数据类型的注入</h4>
<p>我们先将UserService改成这样：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">UserServiceImpl</span> <span class="token keyword">implements</span> <span class="token class-name">UserService</span> <span class="token punctuation">{</span>
    <span class="token keyword">private</span> <span class="token class-name">UserDao</span> userDao<span class="token punctuation">;</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br></div></div><p>然后我们进行注入，普通属性使用value决定值即可，你也可以像注入userDao一样，把property换成constructor-arg来进行构造的注入，ref是引用注入，value是基本数据类型注入</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>bean</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>userService<span class="token punctuation">"</span></span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>com.MySpring.services.impl.UserServiceImpl<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>constructor-arg</span> <span class="token attr-name">name</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>ServerUserDao<span class="token punctuation">"</span></span> <span class="token attr-name">ref</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>userDao<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>constructor-arg</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>bean</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br></div></div><p>然后试图运行：</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>张三
25
UserDaoImpl.save()
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><h4 id="集合的注入-list、map、properties" tabindex="-1"><a class="header-anchor" href="#集合的注入-list、map、properties" aria-hidden="true">#</a> 集合的注入-List、Map、Properties</h4>
<p>我们先修改UserServiceImpl成这样：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">UserServiceImpl</span> <span class="token keyword">implements</span> <span class="token class-name">UserService</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br></div></div><p>然后编写下applicationContext.xml</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br></div></div><p>运行一下试试：</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code>[张三, 李四, 王老五]
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>结果和我们注入的一样，看起来没问题了，就是这样写太tm难受了</p>
<p>当让以后会使用AIO来进行解决（就像是@WebServlet那样）</p>
<h3 id="分模块开发-将配置文件变成多个-并引入" tabindex="-1"><a class="header-anchor" href="#分模块开发-将配置文件变成多个-并引入" aria-hidden="true">#</a> 分模块开发-将配置文件变成多个，并引入</h3>
<p>像刚刚那种样子，xml一大堆一大堆的，看起来非常痛苦，也不利于我们的后期维护</p>
<p>在实际开发过程中，这个量会远远比这个多得多，这样就导致Spring的配置繁杂且体积很大，所以，可以将部分配置拆解到其他配置文件在，而在Spring主配置文件通过import标签实现加载</p>
<p>例如我们现在把User单独的放置到<code>applicationContext-user.xml</code>中</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token prolog">&lt;?xml version="1.0" encoding="UTF-8"?></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>beans</span> <span class="token attr-name">xmlns</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>http://www.springframework.org/schema/beans<span class="token punctuation">"</span></span>
       <span class="token attr-name"><span class="token namespace">xmlns:</span>xsi</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>http://www.w3.org/2001/XMLSchema-instance<span class="token punctuation">"</span></span>
       <span class="token attr-name"><span class="token namespace">xsi:</span>schemaLocation</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>http://www.springframework.org/schema/beans http://www.springframework.org/schema/beans/spring-beans.xsd<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
    ...
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>bean</span><span class="token punctuation">></span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>beans</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br></div></div><p>然后在<code>applicationContext.xml</code>中添加一个标签即可(一般都是在最上面加)</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>当让这个玩意还可以细分的创建，例如<code>applicationContext-db-create-user.xml</code>之类的，这个标签<strong>支持链式加载</strong>，我们最终要写入到Java代码的只有<code>applicationContext.xml</code></p>
<h3 id="spring配置的总结" tabindex="-1"><a class="header-anchor" href="#spring配置的总结" aria-hidden="true">#</a> Spring配置的总结</h3>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>bean</span><span class="token punctuation">></span></span>标签
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><p>目前来说，Spring这玩意看起来非常难用，但是它是其他超好用的框架的垫脚石》。</p>
<h2 id="spring相关的api" tabindex="-1"><a class="header-anchor" href="#spring相关的api" aria-hidden="true">#</a> Spring相关的API</h2>
<h3 id="applicationcontext的继承体系" tabindex="-1"><a class="header-anchor" href="#applicationcontext的继承体系" aria-hidden="true">#</a> ApplicationContext的继承体系</h3>
<p>​  说起Spring 我们第一个当然要说这玩意啦~在我们写第一段SPring代码的时候，它就一直在那了</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token class-name">ApplicationContext</span> context <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">ClassPathXmlApplicationContext</span><span class="token punctuation">(</span><span class="token string">"applicationContext.xml"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><p>可以看到，我们使用多态的方式去定义它的，前面用的<code>ApplicationContext</code>作为编译类型，运行类型则是<code>ClassPathXmlApplicationContext</code>，从这一点我们可以轻松的看出他们两是父子关系</p>
<p>接下来看看类图，看看Application的上下都有哪些类和接口</p>
<p><img src="/images/SpringFrameWork/01-Spring/image-20211209234155136.png" alt="image-20211209234155136" loading="lazy"></p>
<p>首先看左下那两个，其中一个就是我们正在使用的<code>ClassPathXmlApplicationContext</code></p>
<p>他们两个继承了四个抽象类，然后顶上全都是接口</p>
<p>ApplicationContext也是一个接口</p>
<p>我们这里说下三个常用的实现类：</p>
<ul>
<li>ClassPathXmlApplicationContext
<ul>
<li>它是从类的根路径下加载配置文件 通常来说开发项目都是使用这种</li>
</ul>
</li>
<li>FileSystemXmlApplicationContext
<ul>
<li>它是从磁盘路径下加载配置文件，配置文件可以在磁盘的任意位置</li>
<li>new它的时候必须得指定绝对路径或者基于部署目录的相对路径（一般都是绝对路径）</li>
</ul>
</li>
<li>AnnotationConfigApplicationContext
<ul>
<li>使用注解来配置容器对象时，需要用此类来创建Spring容器，它用于读取注解</li>
<li>这个之后注解开发用的多</li>
</ul>
</li>
</ul>
<h3 id="getbean方法的使用" tabindex="-1"><a class="header-anchor" href="#getbean方法的使用" aria-hidden="true">#</a> getBean方法的使用</h3>
<p>我们看下源码：发现他有很多中重载方式</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token comment">//只传入一个String 返回一个Object</span>
