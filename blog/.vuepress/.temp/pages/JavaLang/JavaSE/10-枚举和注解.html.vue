<template><h2 id="枚举介绍" tabindex="-1"><a class="header-anchor" href="#枚举介绍" aria-hidden="true">#</a> 枚举介绍</h2>
<blockquote>
<p>开始前，先来看一个需求：创建季节（Season）对象，请设计并完成</p>
</blockquote>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>enum_</span><span class="token punctuation">;</span>
...
<span class="token keyword">class</span> <span class="token class-name">Season</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br></div></div><p>创建Season对象有如下几个特点：</p>
<ol>
<li>季节的值是有限的几个值(Spring,Summer,Autumn,Winter)</li>
<li>只读，不需要修改</li>
</ol>
<p>解决方案：枚举</p>
<h3 id="枚举的介绍" tabindex="-1"><a class="header-anchor" href="#枚举的介绍" aria-hidden="true">#</a> 枚举的介绍</h3>
<ol>
<li>枚举对应英文：<code>enumeration</code>，简写<code>enum</code></li>
<li>枚举是一组常量的集合</li>
<li>可以理解为：枚举属于一种特殊的类，里面只包含有一租有限定的特定对象</li>
</ol>
<h2 id="自定义类实现枚举" tabindex="-1"><a class="header-anchor" href="#自定义类实现枚举" aria-hidden="true">#</a> 自定义类实现枚举</h2>
<p>自定义类实现枚举-应用案例</p>
<ol>
<li>不需要提供setXXX方法，因为枚举对象值为只读</li>
<li>对美剧对象、属性使用final+static共同修饰，实现底层加载优化</li>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Enumeration02</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token class-name">Season</span><span class="token punctuation">.</span>AUTUMN<span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
...
<span class="token comment">//</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br></div></div><h2 id="enum关键字实现枚举" tabindex="-1"><a class="header-anchor" href="#enum关键字实现枚举" aria-hidden="true">#</a> enum关键字实现枚举</h2>
<p>想看结果</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>enum_</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Enumeration03</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token class-name">Season2</span><span class="token punctuation">.</span>SPRING<span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token class-name">Season2</span><span class="token punctuation">.</span>AUTUMN<span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token class-name">Season2</span><span class="token punctuation">.</span>WINTER<span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token class-name">Season2</span><span class="token punctuation">.</span>SUMMER<span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
...
<p>可以看到，这玩意很方便的就把之前的一大长条的public static final xxx =new xxx给替换掉了，接下来说说它的注意事项</p>
</blockquote>
<ol>
<li>
<p>当我们使用<code>enum</code>关键字开发一个枚举类时，默认会继承Enum类
使用javap-反编译来演示：</p>
<p><img src="/images/JavaSE/10-枚举和注解/image-20211102221045495.png" alt="image-20211102221045495" loading="lazy">可以看到底层实际上就是将这个类是一个<strong>final类</strong>，继承Enum类，并且，他之中的所有我们定义的常量对象都转换成了<code>public static final......</code>
在IEDA中可以通过<code>ctrl+H</code>来查看这个Enum类的一些细节，可以发现：</p>
<p>它的tostring：</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>public String toString() {
    return name;
}
...
<li>
<p>传统的<code>public static final Season SPRING = new Season(&quot;春天&quot;, &quot;温暖&quot;);</code>，简化成<code>SPRING(&quot;春天&quot;,&quot;温暖&quot;)</code>，这你必须要知道，它是调用哪个构造器</p>
</li>
<li>
...
<h3 id="enum常用方法说明" tabindex="-1"><a class="header-anchor" href="#enum常用方法说明" aria-hidden="true">#</a> enum常用方法说明</h3>
<p>当使用关键字enum时，会隐式继承Enum类，这样我们就可以使用Enum类的相关方法</p>
<p><img src="/images/JavaSE/10-枚举和注解/image-20211102222508104.png" alt="enum常用方法表" loading="lazy"></p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>enum_</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br></div></div><h3 id="enum使用细节" tabindex="-1"><a class="header-anchor" href="#enum使用细节" aria-hidden="true">#</a> ENUM使用细节</h3>
<ol>
<li><strong>使用enum关键字后，就不能再继承其他类了，因为enum会隐式继承Enum类，而Java是单继承机制</strong></li>
<li>枚举类和普通类一样，<strong>可以实现接口</strong>，如下所示：
<code>enum 枚举名 implements 接口1,接口2{}</code></li>
</ol>
<blockquote>
<p>嘛 感觉这Java中的枚举有点菜，不能像Typescript那样非常完美的定义enum(1,2,3)之类的来限制函数的传入值...</p>
</blockquote>
<h3 id="枚举的补充-配合switch来使用" tabindex="-1"><a class="header-anchor" href="#枚举的补充-配合switch来使用" aria-hidden="true">#</a> 枚举的补充：配合Switch来使用</h3>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">enum</span> <span class="token class-name">Color</span><span class="token punctuation">{</span>
...
<span class="token function">main</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br></div></div><h2 id="jdk内置的基本注解类" tabindex="-1"><a class="header-anchor" href="#jdk内置的基本注解类" aria-hidden="true">#</a> JDK内置的基本注解类</h2>
<blockquote>
<p>注解的理解</p>
</blockquote>
<ol>
<li>注解(Annotation) 也被称为元数据(Metadata)，用于修饰包，类，方法，属性，构造器，局部变量等数据信息</li>
<li>和注释代码一样，注解不影响程序逻辑，但注解可以被编译或运行，相当于嵌入在代码中的补充信息</li>
<li>在JavaSE中，注解的使用目的比较简单，例如标记过时的功能，忽略警告等，<strong>在JavaEE中注解占据了更重要的角色，例如用来配置应用程序的任何切面，代替JavaEE就版本中所遗留的繁冗代码和XML配置等。</strong></li>
</ol>
<h3 id="基本的annotation介绍" tabindex="-1"><a class="header-anchor" href="#基本的annotation介绍" aria-hidden="true">#</a> 基本的Annotation介绍</h3>
<p>使用Annotation时需要在其前面加@符号，并把该Annotation当成一个修饰符使用，用于修饰它支持的程序元素</p>
<p>三个基本的Annotation：</p>
<ol>
<li>
<p><code>@Override</code>:<strong>限定某个方法，是重写父类方法，该注解方法只能用于方法</strong>
这个不需要过多了解了，天天跟他打交道，方法的含义就是表示这玩意是重写了父类的方法</p>
<ul>
<li>@Override 表示指定重写父类的方法（从编译层面验证），如果父类没有能重写的方法或匹配不到相应的方法，则会报错</li>
<li>入股过不屑@Override注解，而父类任然有public void xxx(){},任然构成重写</li>
<li>@Override只能修饰方法，不能修饰其他类，包，属性等</li>
<li>查看@Override注解源码为<code>@Target(ElementType.METHOD)</code>，说明只能修饰方法</li>
<li>@Target是<strong>修饰注解的注解</strong>，称为元注解</li>
</ul>
</li>
<li>
<p><code>@Deprecated</code>:<strong>用于表示某个程序元素（类/方法等）已过时，可以修饰 方法 字段 包 参数 等等</strong></p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>anntation_</span><span class="token punctuation">;</span>
...
<span class="token keyword">class</span> <span class="token class-name">A</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br></div></div><p><img src="/images/JavaSE/10-枚举和注解/image-20211102234344147.png" alt="image-20211102234344147" loading="lazy"></p>
<p><img src="/images/JavaSE/10-枚举和注解/image-20211102234328409.png" alt="image-20211102234328409" loading="lazy"></p>
<p>dd</p>
</li>
<li>
<p><code>@SuppressWarnings</code>:抑制编译器警告
比如说现在有一段代码:</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>anntation_</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br></div></div><p><img src="/images/JavaSE/10-枚举和注解/image-20211102234854228.png" alt="image-20211102234854228" loading="lazy">编译器报了一堆警告，但是如果我认为这些警告不影响我的使用，就可以使用@SuppressWarnings让编译器强制不显示警告</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>anntation_</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br></div></div><p>关于SuppressWarnings 作用范围是和写的位置有关，比如放到main上面，就是对整个main生效</p>
<p><strong>当然，除非在非常明确自己在做什么，不然不要乱用@SuppressWarnings来抑制编译器警告</strong></p>
</li>
</ol>
<ul>
<li>
<p>补充：@interface 注解类，比如@override 就是继承至它，他可以定义一个注解类</p>
...
<td style="text-align:center">to suppress all warnings（抑制所有警告）</td>
</tr>
<tr>
<td style="text-align:center">boxing</td>
<td style="text-align:center">to suppress warnings relative to boxing/unboxing operations（要抑制与箱/非装箱操作相关的警告）</td>
</tr>
<tr>
<td style="text-align:center">cast</td>
<td style="text-align:center">to suppress warnings relative to cast operations（为了抑制与强制转换操作相关的警告）</td>
</tr>
<tr>
<td style="text-align:center">dep-ann</td>
<td style="text-align:center">to suppress warnings relative to deprecated annotation（要抑制相对于弃用注释的警告）</td>
</tr>
<tr>
<td style="text-align:center">deprecation</td>
<td style="text-align:center">to suppress warnings relative to deprecation（要抑制相对于弃用的警告）</td>
</tr>
<tr>
<td style="text-align:center">fallthrough</td>
<td style="text-align:center">to suppress warnings relative to missing breaks in switch statements（在switch语句中，抑制与缺失中断相关的警告）</td>
</tr>
<tr>
<td style="text-align:center">finally</td>
<td style="text-align:center">to suppress warnings relative to finally block that don’t return（为了抑制警告，相对于最终阻止不返回的警告）</td>
</tr>
<tr>
<td style="text-align:center">hiding</td>
<td style="text-align:center">to suppress warnings relative to locals that hide variable（为了抑制本地隐藏变量的警告）</td>
</tr>
<tr>
<td style="text-align:center">incomplete-switch</td>
<td style="text-align:center">to suppress warnings relative to missing entries in a switch statement (enum case)（为了在switch语句（enum案例）中抑制相对于缺失条目的警告）</td>
</tr>
<tr>
<td style="text-align:center">nls</td>
<td style="text-align:center">to suppress warnings relative to non-nls string literals（要抑制相对于非nls字符串字面量的警告）</td>
</tr>
<tr>
<td style="text-align:center">null</td>
<td style="text-align:center">to suppress warnings relative to null analysis（为了抑制与null分析相关的警告）</td>
</tr>
<tr>
<td style="text-align:center">rawtypes</td>
<td style="text-align:center">to suppress warnings relative to un-specific types when using generics on class params（在类params上使用泛型时，要抑制相对于非特异性类型的警告）</td>
</tr>
<tr>
<td style="text-align:center">restriction</td>
<td style="text-align:center">to suppress warnings relative to usage of discouraged or forbidden references（禁止使用警告或禁止引用的警告）</td>
</tr>
<tr>
<td style="text-align:center">serial</td>
<td style="text-align:center">to suppress warnings relative to missing serialVersionUID field for a serializable class（为了一个可串行化的类，为了抑制相对于缺失的serialVersionUID字段的警告）</td>
</tr>
<tr>
<td style="text-align:center">static-access</td>
<td style="text-align:center">o suppress warnings relative to incorrect static access（o抑制与不正确的静态访问相关的警告）</td>
</tr>
<tr>
<td style="text-align:center">synthetic-access</td>
<td style="text-align:center">to suppress warnings relative to unoptimized access from inner classes（相对于内部类的未优化访问，来抑制警告）</td>
</tr>
<tr>
<td style="text-align:center">unchecked</td>
<td style="text-align:center">to suppress warnings relative to unchecked operations（相对于不受约束的操作，抑制警告）</td>
</tr>
<tr>
<td style="text-align:center">unqualified-field-access</td>
<td style="text-align:center">to suppress warnings relative to field access unqualified（为了抑制与现场访问相关的警告）</td>
</tr>
<tr>
<td style="text-align:center">unused</td>
<td style="text-align:center">to suppress warnings relative to unused code（抑制没有使用过代码的警告）</td>
</tr>
</tbody>
</table>
<h2 id="元注解-对注解进行注解" tabindex="-1"><a class="header-anchor" href="#元注解-对注解进行注解" aria-hidden="true">#</a> 元注解：对注解进行注解</h2>
<p>JDK的元Annotation用于修饰其他的Annotation</p>
<p>元注解：本身作用不大，主要是在看源码的时候明白它是干什么的</p>
<ul>
<li>元注解的种类（使用不多，了解即可）
<ol>
<li><code>Retention</code> 指定注解的作用范围：三种：SOURCE，CLASS，RUNTIME</li>
<li><code>Target</code> 指定注解可以在哪些地方用</li>
<li><code>Documented</code> 指定该注解是否会在JavaDoc体现
比如看看String类的JavaDOC，可以看到里面那些写了已废弃的。。。</li>
<li><code>Inherited</code> 子类会继承父类注解
这个使用的特别少，简单说下：
被他修饰的annotation将自动具有继承性，如果某个类使用了@inherited修饰符，则其之类将自动具有该注解</li>
</ol>
</li>
</ul>
<h3 id="retention注解" tabindex="-1"><a class="header-anchor" href="#retention注解" aria-hidden="true">#</a> @Retention注解</h3>
<p>说明：</p>
<blockquote>
<p>只能用于修饰一个Annotation定义，用于指定该Annotation可以保留多长时间，@Retention包含一个RententionPolicy类型成员变量，使用@Retention时必须为该value成员变量指定值</p>
</blockquote>
<p>@Retention的三种值：</p>
<ol>
<li><code>RententionPolicy.SOURCE</code>编译器使用后，直接丢弃这种策略来源</li>
<li><code>RententionPolicy.CLASS</code> 编译器将把注解记录在class文件中，当运行java程序时，JVM不会保留注解，这是默认值</li>
<li><code>RententionPolicy.RUNTIME</code> 编译器把注释记录在Class文件中，当运行Java程序时，JVM会保留注解，程序可以通过反射来获取该值</li>
</ol>
<p><img src="/images/JavaSE/10-枚举和注解/image-20211103001631830.png" alt="image-20211103001631830" loading="lazy"></p>
<h3 id="target" tabindex="-1"><a class="header-anchor" href="#target" aria-hidden="true">#</a> @Target</h3>
<p>用于修饰annotation定义，用于指定被修饰的annotation能用于修饰哪些元素，@Target也包含一个名为Value的成员变量ElementType</p>
<p><img src="/images/JavaSE/10-枚举和注解/image-20211103001932462.png" alt="image-20211103001932462" loading="lazy"></p>
<p><img src="/images/JavaSE/10-枚举和注解/image-20211103002105765.png" alt="image-20211103002105765" loading="lazy"></p>
</template>
