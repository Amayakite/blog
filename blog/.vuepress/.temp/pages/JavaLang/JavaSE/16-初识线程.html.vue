<template><h2 id="线程介绍" tabindex="-1"><a class="header-anchor" href="#线程介绍" aria-hidden="true">#</a> 线程介绍</h2>
...
<li>再比如说，<strong>我现在打开了原神，一个进程就被创建了，当我关闭原神时，一个线程就销毁了，这就是线程</strong>
<img src="/images/JavaSE/16-初识线程/7a3dbc9d553886bf00a889a303fa8d857ee3659e.gif" alt="img" loading="lazy">
<ul>
<li>当然如果感觉抽象的话，可以打开任务管理器看看</li>
<li>我还没开原神时，我电脑上有这些线程
<img src="/images/JavaSE/16-初识线程/image-20211110225711675.png" alt="image-20211110225711675" loading="lazy"></li>
<li>当我打开原神时 可以看到任务管理器中多出了一个线程，名为launcher
<img src="/images/JavaSE/16-初识线程/image-20211110225747173.png" alt="image-20211110225747173" loading="lazy"></li>
<li>当我关闭原神时 这个线程就没了
<img src="/images/JavaSE/16-初识线程/image-20211110225829854.png" alt="image-20211110225829854" loading="lazy"></li>
...
<li><strong>一个进程可以拥有多个线程</strong>，比如：迅雷/百度云/阿里云/OneDrive/GoogleDrive...等，这些进程在同时下载/上传多个文件时，会开启多条线程，比如：当我使用阿里云同时上传多个文件：这其实就是创建了多个线程来同时进行，以让我的上传效率最大化
<img src="/images/JavaSE/16-初识线程/image-20211110231058750.png" alt="image-20211110231058750" loading="lazy"></li>
...
<p>并发</p>
<ul>
<li>同一时刻，<strong>多个任务交替执行</strong>，造成一种<code>貌似同时</code>的错觉，简单的说，单核CPU                                      实现的多任务就是并发  比方说：有个人再开车时打电话，你可能会认为它正在边开车边打电话，实际上它的大脑再某个瞬间只再做一件事情-要么正在操控方向盘开车，要么正在跟电话另一头的人说话(所以说我国法律规定开车的时候不能打电话，因为它在跟人交流的时候，就有可能忽略了踩刹车)
<img src="/images/JavaSE/16-初识线程/image-20211110231923321.png" alt="image-20211110231923321" loading="lazy"></li>
</ul>
</li>
<li>
<p>并行</p>
<ul>
<li>同一时刻，多个任务同时执行，多核CPU可以实现并行 比方说：一个人开车，一个人接电话，互不干扰，都在专心干自己的事情
<img src="/images/JavaSE/16-初识线程/image-20211110231939340.png" alt="image-20211110231939340" loading="lazy"></li>
</ul>
</li>
<li>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">CpuNumber</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>通过这两句话就可以轻松的获取电脑上可用的CPU的个数，当然原理先不谈</p>
</li>
</ul>
<h3 id="进程的详解" tabindex="-1"><a class="header-anchor" href="#进程的详解" aria-hidden="true">#</a> 进程的详解</h3>
<p>进程是操作系统对于一个正在运行的程序的抽象，进程是操作系统资源分配的基本单位，我们编写的源程序在被编译之后只不过是位于磁盘的静态的二进制数据，他们需要被加载到内存，运行在进程的上下文中。</p>
<p>操作系统通过<code>PCB</code>对于进程进行管理，PCB中包含了进程的<code>PID</code>，优先级，创建者，状态，进程占用CPU的时候，权限相关信息，进程的文件描述符表等信息，进程之间通过虚拟地址空间实现地址隔离保护，操作系统同样提供的<code>fork</code>系统调用就可以创建进程，当fork执行的时候子进程会复制父进程的页表，同时基于<code>Copy on Write</code>机制，父子进程拥有相同的内存镜像，子进程和父进程拥有相同的文件描述符表等信息。</p>
<p>因为进程需要的资源比较多，所以创建进程，进程的上下文切换效率比较低。但是也正是因为进程的这一个抽象，使得的操作系统实现了程序并发执行！！！。在<code>Linux</code>系统中，可以通过<code>ps</code>，<code>pstree</code>，<code>top</code>等指令查看系统当前进程。同样可以使用<code>jps</code>来查看<code>JVM</code>进程</p>
<p>当然，上面说的都是抽象的，下面说点实在的</p>
<h2 id="线程的概念-thread" tabindex="-1"><a class="header-anchor" href="#线程的概念-thread" aria-hidden="true">#</a> 线程的概念(Thread)</h2>
<p>由进程创建是进程的一个实体，进程可进一步细化为线程，一个进程可以拥有多个线程，线程是一个程序内部的一条执行路径。</p>
<p>若一个进程同一时间并行执行多个线程，就是支持多线程的</p>
<p>线程作为调度和执行的单位，每个线程拥有独立的运行栈和程序计数器（pc），线程切换的开销小</p>
<p>一个进程中的多个线程共享相同的内存单元/内存地址空间-它们从同一堆中分配对象，可以访问相同的变量和对象。这就使得线程间通信更简便、高效；但多个线程燥作共享的系統资源可能就会带来安全的隐患。</p>
<h2 id="线程基本使用" tabindex="-1"><a class="header-anchor" href="#线程基本使用" aria-hidden="true">#</a> 线程基本使用</h2>
<p>在Java中线程来使用有两种方式（有两种方式创建线程）：</p>
<ol>
<li>继承<code>Thread</code>类，重写run方法</li>
<li>实现<code>Runnable</code>接口，重写run方法</li>
</ol>
<p>先来看看<code>Thread</code>类把，首先看看它的构造图：</p>
<p><img src="/images/JavaSE/16-初识线程/image-20211110234756658.png" alt="image-20211110234756658" loading="lazy"></p>
<p>可以看到，<code>Thread</code>这个类，实际上也实现了<code>Runnable</code>这个接口，这之上还有个不知道是啥的接口(没啥用，先不管那个)</p>
<h2 id="thread" tabindex="-1"><a class="header-anchor" href="#thread" aria-hidden="true">#</a> Thread</h2>
<blockquote>
<p>下面使用线程来完成一个简单的案例</p>
<p>编写程序，开启一个线程，该线程每隔一秒，在控制台输出<code>喵喵，我是小猫咪</code></p>
</blockquote>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>trreaduse</span><span class="token punctuation">;</span>
...
<span class="token comment">//        让该线程休眠一秒钟</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br></div></div><blockquote>
<p>对上题进行改进：当输出80次<code>喵喵，我是小猫咪</code>，结束该线程</p>
</blockquote>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>trreaduse</span><span class="token punctuation">;</span>
...
<p>使用JConsole监控线程情况</p>
</blockquote>
<p>在这之前，我们再来回顾一下进程和线程，何为进程？</p>
<p>当我们的程序启动的时候，即：</p>
<p><img src="/images/JavaSE/16-初识线程/image-20211111115736057.png" alt="image-20211111115736057" loading="lazy"></p>
<p>运行这个程序的时候，就创建了一个进程，在启动了这个进程之后，它马上会进入到我们的主方法</p>
<p><strong>进入到主方法之后，其实这个进程就开启了一个线程，叫主线程</strong></p>
<p>在这个线程创建过后，我们又创建了一个<code>Cat</code>对象，这个对象可以当作线程来使用，因为它继承了<code>Thread</code>，所以在这个时候我们运行<code>cat.start()</code>的时候，它又启动了一个子线程，这个子线程还可以通过<code>Thread.currentThread().getName()</code>来获取其线程名：</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p>注意，<strong>main线程启动一个线程，主线程并不会因此而阻塞</strong>，剩余代码并不会在子线程内的方法执行完毕后再执行，而是会继续执行--<strong>这时主线程和子线程是交替执行</strong>(有点JavaScript中Promise的那种味道了)，比如：</p>
...
<span class="token comment">//...</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br></div></div><MermaidChart id="mermaid-64a567b0" data-code="graph%20TB%0A%E5%90%AF%E5%8A%A8%E7%A8%8B%E5%BA%8F--%3E%E5%88%9B%E5%BB%BA%E4%BA%86%E4%B8%80%E4%B8%AA%E8%BF%9B%E7%A8%8B--%3EA(%E5%BC%80%E5%90%AF%E4%BA%86main%E7%BA%BF%E7%A8%8B-%E4%B8%BB%E7%BA%BF%E7%A8%8B)%0AA--%3E%7CMain%E7%BA%BF%E7%A8%8B%E5%BC%80%E5%90%AF%E4%BA%86%E4%B8%80%E4%B8%AA%E6%96%B0%E7%9A%84%E7%BA%BF%E7%A8%8B-%E9%80%9A%E8%BF%87.start%E6%96%B9%E6%B3%95%7CB(Thread-0%E7%BA%BF%E7%A8%8B)%0A"></MermaidChart><p>再举个例子：我在今早玩原神的时候，我的胡桃（MD想抽个早柚就这么难吗）正在和丘丘人激情对A，假设我的胡桃就是主线程，丘丘人就是子线程，我在A它，它在A我，我们互不影响，并不会存在我A它的时候它没法A我，它A我的时候我没法A它</p>
<p>那么，如何让我能够实实在在的看到正在运行的线程呢？这就要用到<code>JConsole</code>了：</p>
<p>在这之前，将Sleep(两处)改成1000，让我们更直观的查看线程：</p>
<h3 id="jconsole的使用" tabindex="-1"><a class="header-anchor" href="#jconsole的使用" aria-hidden="true">#</a> jconsole的使用</h3>
<p>第一步，启动进程：</p>
<p><img src="/images/JavaSE/16-初识线程/image-20211111122854661.png" alt="image-20211111122854661" loading="lazy"></p>
<p>第二部，打开终端，输入<code>jconsole</code>并按回车运行</p>
<p><img src="/images/JavaSE/16-初识线程/image-20211111122940218.png" alt="image-20211111122940218" loading="lazy"></p>
<p>第三步：可以看到在<code>JConsole</code>中看到一个和我们**主线程所在类名相同(和文件名字一致)**的进程：直接连接，不管SSL证书什么的问题</p>
<p><img src="/images/JavaSE/16-初识线程/image-20211111123151227.png" alt="image-20211111123151227" loading="lazy"></p>
<p>连接上去后，可以清晰的看到我们此刻正有两个线程在跑，一个<code>main</code>一个<code>Thread-0</code>，而进程正是他们上方的线程坐标图</p>
<p><img src="/images/JavaSE/16-初识线程/image-20211111123730460.png" alt="image-20211111123730460" loading="lazy"></p>
<p>此时我们再将主线程(main线程)中的循环次数改成比子线程少30次，看看他们的运行情况：</p>
<p><img src="/images/JavaSE/16-初识线程/image-20211111124228581.png" alt="image-20211111124228581" loading="lazy"></p>
<p>可以看到，当主线程中的for循环结束完毕后，在<code>jconsole</code>的面板上<code>main</code>就消失了，说明它已经挂了，但是子线程仍然在运行，也可以在IDEA的控制台上看到后面输出的全都是子线程<code>Thread-0</code>中的语句(全都是它在跑)</p>
<p>当<code>Thread-0</code>进程结束时，可以看到整个进程也结束，此时尝试连接时连不上去的（进程已经挂了，这里的8760表示它的进程号）</p>
<p><img src="/images/JavaSE/16-初识线程/image-20211111131441880.png" alt="image-20211111131441880" loading="lazy"></p>
<p>由JConsole的帮助我i们可得出：</p>
<ol>
<li>
<p>当我们运行程序的时候就开启了一个**<code>进程</code>**</p>
</li>
<li>
<p>这个进程启动了一个主线程<code>main</code></p>
</li>
<li>
<p>这个<code>main</code>线程又启动了一个子线程<code>Thread-0</code></p>
</li>
<li>
<p>在主线程<code>main</code>中，因为我们设定了50次循环，即50s，所以在50s后这个<code>main</code>线程就结束了(退出了)</p>
</li>
<li>
<p>而子线程<code>Thread-0</code>这个线程因为我们设定的是80次，即80s，在主线程<code>main</code>指向完毕后它还没有执行完，所以它还在继续工作，所以造成这个**<code>进程</code>**还活着</p>
</li>
<li>
<p>等到子线程<code>Thread-0</code>的循环执行完毕后，他也挂了，<strong>此时进程中没有任何正在执行的线程，所以它也退出来了(结束了)</strong></p>
</li>
<li>
<p>在上一步进程退出来的时候，也可以明显的在<code>Jconsole</code>中看到，这个进程已经没有响应了，所以<code>JConsole</code>再次试图连接这个进程就会发现连接不到了，打个比方：</p>
<p>我打开了原神，开始锄大地，当我把一个区域（蒙德）全都锄完时候，我并不一定会退出游戏，而是继续去锄其他区域的怪，当我把全部区域的怪和资源都锄完了，我也无事可做，这就会造成我退出游戏，此时若再想去打怪，已经没法打了（我已经退出游戏了）</p>
</li>
<li>
<p>如果说在子线程中又创建了一个线程<code>Thread-1</code>，循环次数为120次，即120s，那么在<code>Thread-0</code>结束后（80s时），进程并不会退出，而是等到<code>Thread-1</code>的120s结束后才会退出</p>
</li>
<li>
<p>综上所述：<strong>如果我们的主线程结束了，但是还有其他的线程正在运行，这并不会造成我们的进程结束，直到我们的所有线程都执行完毕后（没有任何正在执行的线程时），进程才会退出</strong></p>
</li>
<li>
<p><strong>总结：只要程序中有正在运行的线程，那么程序就不会退出，当所有线程都执行完毕后，我们的程序才会退出（进程才会结束）</strong></p>
</li>
</ol>
<h2 id="start-的深入了解" tabindex="-1"><a class="header-anchor" href="#start-的深入了解" aria-hidden="true">#</a> start()的深入了解</h2>
<p>在刚刚开启线程的时候，可能会有疑惑的地方：调用<code>cat</code>的<code>run</code>方法不应该是直接<code>cat.run()</code>吗？为什么要用一个跟他八竿子打不着边的<code>start()</code> ，而不是调用<code>run()</code></p>
<p>接下来尝试下直接用主线程调用<code>run()</code>方法<code>cat.run()</code>：</p>
<p>然后运行程序，可以非常直观的看到输出：</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code><span class="token title important">cat.run()； //run方法就是一个普通的方法，没有正在的启动一个线程，所以主线程会将这个方法执行完毕才会继续执行之后的代码
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br></div></div><p>接下来通过start()的源码来分析下它是怎么个执行流程</p>
<h3 id="分析start的源码" tabindex="-1"><a class="header-anchor" href="#分析start的源码" aria-hidden="true">#</a> 分析Start的源码</h3>
<blockquote>
<p>先看看start()的源码</p>
</blockquote>
...
<li><code>native</code>表示是一个本地方法（底层方法），这个方式是直接由<code>JVM机</code>来调用的</li>
<li>**它的底层是C/C++**实现</li>
<li>真正实现多线程的效果，是<code>start0()</code>，而不是<code>run()</code>方法</li>
<li><strong>也就是说，在<code>start0()</code>里面，它用多线程的机制来调用我们的<code>run()</code>方法</strong></li>
</ol>
<p><strong><code>start()</code>方法调用<code>start0()</code>方法后，该线程并不会立马执行，只是将线程变为了可运行的状态（线程的状态后面会了解到），具体什么时候执行，取决于CPU，由CPU统一调度</strong></p>
<p><img src="/images/JavaSE/16-初识线程/image-20211111140729662.png" alt="image-20211111140729662" loading="lazy"></p>
<p>也就是说，线程的机制要真正的搞懂，其实是要涉及到操作系统之中的一些机制的</p>
<blockquote>
<p>扩展：Thread类中private native void start0();方法是一个底层调用方法直接调用操作系统的接口，这个属于历史问题，当时Java刚出来的时候，C语言号称“我就是程序”，所以Java就必须向大佬低头，要与C语言可以互通然后就出现了JVM的本地库接口 Java Native Interface 江湖人称JNI</p>
</blockquote>
<p>扩展：start0()的源码（看看就好）：</p>
<div class="language-c ext-c line-numbers-mode"><pre v-pre class="language-c"><code>hotspot thread<span class="token punctuation">.</span>cpp <span class="token operator">:</span>
...
<span class="token comment">// being called from a Java method synchronized on the Thread object.</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br></div></div><h2 id="实现runnable接口" tabindex="-1"><a class="header-anchor" href="#实现runnable接口" aria-hidden="true">#</a> 实现Runnable接口</h2>
<p>前面的代码中可以了解到，我们可以通过继承<code>Thread</code>来<strong>开发一个线程类</strong>，但实际上有个问题：</p>
<ul>
<li>
<p>Java是单继承的，在某些情况下一个类可能已经继承了某个父类，这时再用继承Thread类方法来创建线程显然是不可能的了</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">A</span> <span class="token keyword">extends</span> <span class="token class-name">B</span><span class="token punctuation">{</span><span class="token punctuation">}</span>
...
<p>所以Java设计者提供了另一个方式来创建线程，就是通过<code>Runnable</code>接口来创建线程</p>
<p>接下来使用<code>Runnable</code>来实现一个程序，该程序每隔一秒，可以在控制台输出<code>&quot;hi!&quot;</code>，当输出10次后，自动退出 Thread02.java</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>trreaduse</span><span class="token punctuation">;</span>
...
<span class="token comment">//            休眠1s</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br></div></div><p>可以看到，上面使用了<code>Thread</code>的有参构造，来完成的<code>strat()</code>的运行，这之中用了一种新的设计模式[代理模式]，接下来用代码来模拟一下这个代理模式是怎么个流程（这个也加静态代理）</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>trreaduse</span><span class="token punctuation">;</span>
...
<span class="token keyword">class</span> <span class="token class-name">ThreadProxy</span> <span class="token keyword">implements</span> <span class="token class-name">Runnable</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br></div></div><h3 id="线程的应用案例-多线程执行" tabindex="-1"><a class="header-anchor" href="#线程的应用案例-多线程执行" aria-hidden="true">#</a> 线程的应用案例-多线程执行</h3>
<p>一个程序，创建两个线程，一个线程每隔一秒输出&quot;hello world&quot;，输出10次，退出，另一个线程每一秒输出“hi”，输出5次，退出</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>trreaduse</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Thread03</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token keyword">new</span> <span class="token function">T3</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">start</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span><span class="token comment">// 线程1</span>
        <span class="token keyword">new</span> <span class="token function">T4</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">start</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span><span class="token comment">// 线程2</span>
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>

<span class="token keyword">class</span> T3 <span class="token keyword">extends</span> <span class="token class-name">Thread</span> <span class="token punctuation">{</span>
    <span class="token annotation punctuation">@Override</span>
    <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">run</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token keyword">class</span> T4 <span class="token keyword">extends</span> <span class="token class-name">Thread</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br></div></div><p><img src="/images/JavaSE/16-初识线程/image-20211111154344600.png" alt="image-20211111154344600" loading="lazy"></p>
<h3 id="一个经典的问题-多个线程同时操控一个变量" tabindex="-1"><a class="header-anchor" href="#一个经典的问题-多个线程同时操控一个变量" aria-hidden="true">#</a> 一个经典的问题-多个线程同时操控一个变量</h3>
<p>来看看下面这个代码在运行过程中会出现的问题：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>trreaduse</span><span class="token punctuation">;</span>
...
<span class="token comment">//        休眠50ms</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br><span class="line-number">62</span><br><span class="line-number">63</span><br><span class="line-number">64</span><br><span class="line-number">65</span><br><span class="line-number">66</span><br><span class="line-number">67</span><br><span class="line-number">68</span><br><span class="line-number">69</span><br><span class="line-number">70</span><br><span class="line-number">71</span><br><span class="line-number">72</span><br><span class="line-number">73</span><br><span class="line-number">74</span><br><span class="line-number">75</span><br><span class="line-number">76</span><br><span class="line-number">77</span><br><span class="line-number">78</span><br><span class="line-number">79</span><br></div></div><p>在解决这个问题之前，我们回顾下线程的基本特点：</p>
<h4 id="线程的终止" tabindex="-1"><a class="header-anchor" href="#线程的终止" aria-hidden="true">#</a> 线程的终止</h4>
<ol>
<li>当线程完成任务后，会自动退出
<img src="/images/JavaSE/16-初识线程/image-20211111161743729.png" alt="image-20211111161743729" loading="lazy"></li>
<li>还可以通过<strong>使用变量</strong>来<strong>控制run方法退出</strong>的方式停止线程，即通知方式</li>
</ol>
<p>通过变量来停止线程：案例：<em><code>启动一个线程t，要求在main线程中去停止线程t</code></em></p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>exit_</span><span class="token punctuation">;</span>
...
<span class="token keyword">class</span> <span class="token class-name">T</span> <span class="token keyword">extends</span> <span class="token class-name">Thread</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br></div></div><h2 id="线程常用的方法" tabindex="-1"><a class="header-anchor" href="#线程常用的方法" aria-hidden="true">#</a> 线程常用的方法</h2>
<h3 id="基本方法" tabindex="-1"><a class="header-anchor" href="#基本方法" aria-hidden="true">#</a> 基本方法</h3>
<ol>
<li><code>setName</code> 设置线程名称 使之与参数name相同</li>
<li><code>getName</code> 返回该线程的名称</li>
<li><code>start</code> 使该线程开始执行 Java虚拟机底层调用<code>start0</code>方法</li>
<li><code>run</code>调用线程对象的run方法</li>
<li><code>setPriority</code> 更该线程的优先级</li>
<li><code>getPriority</code> 获取线程的优先级</li>
<li><code>sleep</code> 在指定的毫秒数内让正在执行的线程休眠(暂停执行)</li>
<li><code>interrupt</code>中断线程(如果线程正在休眠 则让它继续执行（结束线程的<code>sleep()</code>，也就是<code>WATTING</code>状态）)</li>
<li><code>isAlive</code> 获取线程是否处于活动状态(<code>RUNNING</code>) 返回布尔值</li>
</ol>
<h4 id="注意事项和细节" tabindex="-1"><a class="header-anchor" href="#注意事项和细节" aria-hidden="true">#</a> 注意事项和细节</h4>
<ol>
<li><code>start</code>底层会创建新的线程,调用run,run就是一个简单的方法调用,不会启动新的线程</li>
<li>线程优先级的范围
<ol>
<li><code>Thread.MAX_PRIORITY</code> 最高优先级 10</li>
<li><code>Thread.MIN_PRIORITY</code>最低优先级 1</li>
<li><code>Thread.NORM_PRIORITY</code> 默认优先级 5</li>
</ol>
</li>
<li><code>interrupt</code> 中断线程 但并没有真正的结束线程 所以一般用于中断正在休眠的线程（结束线程内的<code>Thread.sleep()</code>状态）</li>
<li><code>sleep</code> 线程的静态方法 使当前线程休眠</li>
</ol>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>method</span><span class="token punctuation">;</span>
...
<span class="token comment">//            InterruptedException 是捕获到一个中断异常</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br></div></div><h3 id="礼让和插队" tabindex="-1"><a class="header-anchor" href="#礼让和插队" aria-hidden="true">#</a> 礼让和插队</h3>
<ol>
<li><code>yield</code> 线程的礼让。让出CPU，让其他线程执行，<strong>但礼让的时间不确定，所以也不一定礼让成功</strong>(礼让是由CPU来决定要不要进行的，理论来说，单个CPU中线程越多，越容易礼让成功)，要让哪个线程礼让，就在该线程run方法的某处加上(<code>Thread.yield()</code>)如果是main方法,直接调用<code>Thread.yield();</code></li>
<li><code>join</code> 线程的插队。插队的线程一旦插队成功，则肯定先执行插完插入的线程的所有任务(要让哪个线程插队，就调用哪个线程的join)</li>
</ol>
<p><img src="/images/JavaSE/16-初识线程/image-20211111200901431.png" alt="image-20211111200901431" loading="lazy"></p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>method</span><span class="token punctuation">;</span>
...
<span class="token keyword">class</span> T2 <span class="token keyword">extends</span> <span class="token class-name">Thread</span> <span class="token punctuation">{</span> <span class="token comment">//我们的自定义线程类</span>
    <span class="token annotation punctuation">@Override</span>
    <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">run</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">int</span> i <span class="token operator">=</span> <span class="token number">1</span><span class="token punctuation">;</span> i <span class="token operator">&lt;=</span> <span class="token number">20</span><span class="token punctuation">;</span> i<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
<span class="token comment">//            Thread.currentThread().getName() 获取当前线程的名称</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br></div></div><h3 id="用户线程和守护线程" tabindex="-1"><a class="header-anchor" href="#用户线程和守护线程" aria-hidden="true">#</a> 用户线程和守护线程</h3>
<ol>
<li>用户线程：也叫工作线程，当线程的任务执行完或通知的方式结束</li>
<li>守护线程：一般是为工作线程服务的,当所有的用户线程结束，守护线程自动结束</li>
<li>常见的守护线程：垃圾回收机制</li>
</ol>
<p>正常来说,当我们的主线程结束以后,若还有未能结束的子线程,则进程将要等到子线程执行完毕后才会退出,但是守护线程可以帮助我们让子线程在主线程结束时也一并结束</p>
<blockquote>
<p>下面先来看个没有守护进程的代码 普普通通 主线程执行10次后将不再执行 而子线程将会一直持续的执行下去</p>
</blockquote>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>method</span><span class="token punctuation">;</span>
...
<p>守护线程只能用户守护主线程,即无论我在哪里设置的守护线程,他的结束时间均为主线程结束</p>
<p>下面的代码中,我在<code>TestFace</code>中创建的守护线程并不会在它执行完毕后结束,而是直至主线程结束才会结束</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>method</span><span class="token punctuation">;</span>
...
<span class="token keyword">class</span> <span class="token class-name">TestFace</span> <span class="token keyword">extends</span> <span class="token class-name">Thread</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br></div></div><h2 id="线程的生命周期" tabindex="-1"><a class="header-anchor" href="#线程的生命周期" aria-hidden="true">#</a> 线程的生命周期</h2>
<p>JDK中使用了<code>Thread.State</code>枚举表现了线程的几种状态，线程可以处于以下状态之一</p>
<ul>
<li><code>NEW</code>尚未启动的线程处于此状态</li>
<li><code>RUNNABLE</code>在Java虚拟机中执行的线程处于此状态</li>
<li><code>BLOCKED</code>被阻塞等待监视器锁定的线程处于此状态</li>
<li><code>WAITING</code>正在等待另一个线程执行特定的动作的线程处于此状态</li>
<li><code>TIMED_WAITING</code>正在等待另一个线程执行动作到达指定等待时间的线程处于此状态</li>
<li><code>TERMINATED</code>已退出的线程处于此状态</li>
</ul>
<p>Ready和Running是属于内核的状态,由系统来决定它是处于Ready还是Running,只要知道,他们两都是处于<code>Runnable</code>状态下即可</p>
<p>完整版生命周期：</p>
<p><img src="/images/JavaSE/16-初识线程/Java线程生命周期-16367276068553.svg" alt="Java线程生命周期" loading="lazy"></p>
<p>简化版生命周期:</p>
<p><img src="/images/JavaSE/16-初识线程/生命周期-精简版-16367265796462.svg" alt="生命周期-精简版" loading="lazy"></p>
<blockquote>
<p>一个简单的查看状态的代码</p>
</blockquote>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>state_</span><span class="token punctuation">;</span>
...
<span class="token keyword">class</span> <span class="token class-name">T</span> <span class="token keyword">extends</span> <span class="token class-name">Thread</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br></div></div><h2 id="线程的同步" tabindex="-1"><a class="header-anchor" href="#线程的同步" aria-hidden="true">#</a> 线程的同步</h2>
<p>还记得前面的那个窗口买票的案例吗，三个窗口同时操控一个变量，正常情况下往往会出现预期之外的问题，而且无论是通过继承<code>Thread</code>方式或者实现<code>Runnable</code>的方式最终得到的效果都是一样的---&gt;都存在超卖的行为，且可以在卖票过程中发现某些时间段他们三同可能时卖出的是同一张票，这时就得通过线程的同步来解决问题了</p>
<h3 id="线程的同步机制" tabindex="-1"><a class="header-anchor" href="#线程的同步机制" aria-hidden="true">#</a> 线程的同步机制</h3>
<ol>
<li>在多线程编程，一些敏感数据不允许被多个线程同时访问，此时就可以使用线程同步技术，保证数据在任何时刻，最多只有一个线程访问，以保证数据的完整性</li>
<li>也可以理解为：<strong>线程同步，即当有一个线程在对内存进行操作时，其他线程都不可以对这个内存地址进行操作，知道该线程完成操作，其他线程才能对该内存地址进行操作</strong></li>
</ol>
<p>同步的核心理念就是：<strong>不管此时程序有多少个线程来操作这个数据，在同一时刻，只允许有一个线程来真正的对这个数据进行操作，其他的线程均在它的后面排队，直到这个线程执行完毕后，其他线程依次的进来操作</strong><s>我好像想到了什么奇怪的东西</s></p>
<h2 id="同步具体方法-synchronized-互斥锁" tabindex="-1"><a class="header-anchor" href="#同步具体方法-synchronized-互斥锁" aria-hidden="true">#</a> 同步具体方法-Synchronized(互斥锁)</h2>
<ol>
<li>
<p>同步代码块</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>synchronize <span class="token punctuation">(</span>对象<span class="token punctuation">)</span><span class="token punctuation">{</span> <span class="token comment">//得到对象的锁，才能同步操作代码</span>
...
<li>
<p><code>synchronized</code>还可以放在方法申明中，表示整个方法为同步方法</p>
...
<p>如何理解：</p>
<ul>
<li>就好像 某人上厕所先把门关上（上锁），完事后再出来（解锁），那么其他人就可以在使用厕所了</li>
<li><img src="/images/JavaSE/16-初识线程/image-20211112115843077.png" alt="image-20211112115843077" loading="lazy"></li>
</ul>
</li>
<li>
<p><strong>使用<code>synchronized</code>时，一定要确保操纵的方法或者数据是几个线程之间共享的！</strong></p>
</li>
</ol>
<p>使用<code>synchronized</code>来解决之前售票的问题</p>
<h3 id="synchronize锁-同步方法的实现" tabindex="-1"><a class="header-anchor" href="#synchronize锁-同步方法的实现" aria-hidden="true">#</a> synchronize锁-同步方法的实现</h3>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>sync_</span><span class="token punctuation">;</span>
...
<span class="token comment">//            休眠50ms</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br><span class="line-number">62</span><br><span class="line-number">63</span><br><span class="line-number">64</span><br><span class="line-number">65</span><br><span class="line-number">66</span><br><span class="line-number">67</span><br><span class="line-number">68</span><br><span class="line-number">69</span><br><span class="line-number">70</span><br><span class="line-number">71</span><br><span class="line-number">72</span><br><span class="line-number">73</span><br><span class="line-number">74</span><br><span class="line-number">75</span><br><span class="line-number">76</span><br><span class="line-number">77</span><br><span class="line-number">78</span><br><span class="line-number">79</span><br></div></div><h3 id="synchronize锁-代码块的实现" tabindex="-1"><a class="header-anchor" href="#synchronize锁-代码块的实现" aria-hidden="true">#</a> synchronize锁-代码块的实现</h3>
<p>可以很明显的感觉到放在代码块上比在同步方法效率貌似要高那么一丢丢（大概吧）</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">SellTicket</span> <span class="token keyword">implements</span> <span class="token class-name">Runnable</span> <span class="token punctuation">{</span>
    <span class="token keyword">private</span> <span class="token keyword">int</span> count <span class="token operator">=</span> <span class="token number">100</span><span class="token punctuation">;</span>
    <span class="token keyword">private</span> <span class="token keyword">boolean</span> loop <span class="token operator">=</span> <span class="token boolean">true</span><span class="token punctuation">;</span>
...
<span class="token comment">//    4 这个代码块上的()中不一定要放this，也可以是其他对象，但必须得保证线程之间访问的是同一个对象</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br></div></div><p><code>synchronized</code>就像是一个厕所，三个实例就像是三组急着要上厕所的人，想开厕所的门，就得有<strong>钥匙</strong>，厕所的门前自带一把钥匙，当一组人中的某个人抢到了钥匙，并进去上厕所（并在里面把门<strong>锁</strong>上），其他人将无法进入这个厕所，直到这个人出来，把钥匙插回门上，其他人才能继续使用这个厕所，然后三组人员又继续抢夺（拼手速一样）钥匙并进入，直到三组人全部上完厕所</p>
<p><img src="/images/JavaSE/16-初识线程/image-20211112133940722.png" alt="image-20211112133940722" loading="lazy"></p>
<p><code>synchronized</code>是非公平<strong>锁</strong>，也就是说，他之中并不存在什么顺序，多个线程调用，谁先抢到，谁先执行里面的内容，其他的人则后执行里面的内容，这样的好处是，操纵一个代码块的时候，始终是只让一个线程在操纵，就不会出现超卖等行为了</p>
<p>这把锁也叫对象互斥锁（一般叫互斥锁），接下来详细介绍下它</p>
<h3 id="互斥锁的原理" tabindex="-1"><a class="header-anchor" href="#互斥锁的原理" aria-hidden="true">#</a> 互斥锁的原理</h3>
<ol>
<li>
<p>Java在Java语言中，引入了对象互斥锁的概念，来保证共享数据操作的完整性</p>
</li>
<li>
<p>每个对象都应用于一个可称为“互斥锁”的标记，这个标记来保证在<strong>任一</strong>时刻，只能有一个线程来访问该对象</p>
</li>
<li>
<p>关键字<code>synchronized</code>来与对象的互斥锁联系。当某个对象用<code>synchronized</code>修饰时，表明该对象在<strong>任一</strong>时刻只能由一个线程访问</p>
</li>
<li>
<p>同步的局限性：<strong>导致程序的执行效率要降低</strong>，所以说锁并不是加的越多越好</p>
<p>就好像有100辆赛车要到赛道上跑一样，赛道本身是非常宽的，但是在赛道前有一个收费站，每次只能通过一辆赛车，也就是说，这个赛车通过收费站的时候还得一个一个出，所以就会在收费站这个地方行程一个瓶颈</p>
</li>
<li>
<p>同步方法（非<code>static</code>）的锁可以是this，也可以是其他对象（<strong>操纵的对象必须是同一个对象(同一个对象指的是多个线程之间操纵的必须是同一个数据，方法等)</strong>）</p>
<ul>
<li>
<p>同步方法</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">SellTicket</span> <span class="token keyword">implements</span> <span class="token class-name">Runnable</span> <span class="token punctuation">{</span>
...
<li>
<p>同步方法（<code>static</code>）的锁为当前类本身</p>
<ul>
<li>
<p>在静态同步方法</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">SellTicket01</span> <span class="token keyword">extends</span> <span class="token class-name">Thread</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">int</span> count <span class="token operator">=</span> <span class="token number">100</span><span class="token punctuation">;</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">boolean</span> loop <span class="token operator">=</span> <span class="token boolean">true</span><span class="token punctuation">;</span>
...
<li>
<p>在静态同步代码块（如果要指向this，应该指向这个类本身，而不是This）</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">SellTicket01</span> <span class="token keyword">extends</span> <span class="token class-name">Thread</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">int</span> count <span class="token operator">=</span> <span class="token number">100</span><span class="token punctuation">;</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">boolean</span> loop <span class="token operator">=</span> <span class="token boolean">true</span><span class="token punctuation">;</span>
...
<h3 id="互斥锁的注意事项和细节" tabindex="-1"><a class="header-anchor" href="#互斥锁的注意事项和细节" aria-hidden="true">#</a> 互斥锁的注意事项和细节</h3>
<ol>
<li>同步方法如果<strong>没有使用</strong><code>static</code>修饰：默认锁对象为<strong>this</strong></li>
<li>如果方法<strong>使用</strong><code>static</code>修饰：默认锁对象为为<strong>当前类.class</strong></li>
<li>实现的落地步骤
<ul>
<li>需要先分析上锁的代码</li>
<li>选择<strong>同步代码块</strong>或同步方法（尽量选择同步代码块）
<ul>
<li>同步的范围越小，效率越高</li>
</ul>
</li>
<li>要求多个线程的锁对象为同一个（对象）</li>
</ul>
</li>
</ol>
<h3 id="线程的死锁" tabindex="-1"><a class="header-anchor" href="#线程的死锁" aria-hidden="true">#</a> 线程的死锁</h3>
<p>多个线程抖占用了对方的锁资源，但不肯相让，导致了死锁，<strong>在编程中是一定要避免死锁的发生</strong></p>
<p>例如：</p>
<ul>
<li>母：你先完成作业，才让你玩手机</li>
<li>子/女：你先让我玩手机，我才完成作业</li>
</ul>
<p>接下来简单模拟下死锁</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>sync_</span><span class="token punctuation">;</span>
...
<span class="token keyword">class</span> <span class="token class-name">DeadLockDemo</span> <span class="token keyword">extends</span> <span class="token class-name">Thread</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br></div></div><h3 id="如何避免死锁" tabindex="-1"><a class="header-anchor" href="#如何避免死锁" aria-hidden="true">#</a> 如何避免死锁</h3>
<p>产生死锁的四个必要条件：</p>
<ol>
<li>互斥条件：一个资源每次只能被一个进程使用</li>
<li>请求与保持条件：一个进程因请求资源而堵塞时，对已获得的资源保持不放</li>
<li>不剥夺条件：进程已获得的资源，在未使用完成之前，不得强制剥夺</li>
<li>循环等待条件：若干个进程之间行程一种头尾相连的循环等待资源关系</li>
</ol>
<h2 id="lock锁" tabindex="-1"><a class="header-anchor" href="#lock锁" aria-hidden="true">#</a> Lock锁</h2>
<ul>
<li>从JDK5.0开始，Java提供了更强大的线程同步机制-通过显示定义同步锁对象来实现同步。同步锁使用<code>Lock</code>对象充当</li>
<li><code>java.util.concurrent.locks.Lock</code>接口是控制多个线程对共享资源进行访问的工具
<ul>
<li>提供了对共享资源的独占访问，每次只能有一个线程对<code>Lock</code>对象加锁，线程开始访问共享资源前应先获得<code>Lock</code>对象</li>
<li>记住这个<code>java.util.concurrent</code>，真正的多线程高并发全都是靠他来实现的...它的简称是<code>JUC</code></li>
</ul>
</li>
<li><code>ReentrantLock</code>（可重入锁）类实现了Lock，它拥有与<code>synchronized</code>相同的并发性和内存语义，在实现线程安全的控制中，比较常用的是<code>ReentrantLock</code>，可以显示加锁，释放锁</li>
<li>也就是说，<code>Lock</code>锁的出现很好的解决了<code>synchronized</code>是隐式调用的问题</li>
</ul>
<p>语法：</p>
...
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>lock_</span><span class="token punctuation">;</span>
...
<span class="token keyword">class</span> <span class="token class-name">TestLockDemo</span> <span class="token keyword">implements</span> <span class="token class-name">Runnable</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br></div></div><h2 id="synchronized和lock的对比" tabindex="-1"><a class="header-anchor" href="#synchronized和lock的对比" aria-hidden="true">#</a> Synchronized和Lock的对比</h2>
<table>
<thead>
<tr>
<th style="text-align:left"></th>
<th style="text-align:left">锁的可见性</th>
<th style="text-align:center">上锁的方式</th>
...
<td style="text-align:left">隐式锁，出了作用域自动释放</td>
<td style="text-align:center">代码块锁<br />方法锁</td>
<td style="text-align:center">JVM需要画一定的时间来调度线程</td>
</tr>
<tr>
<td style="text-align:left">Lock</td>
<td style="text-align:left">显示锁，需要手动开启和关闭锁</td>
<td style="text-align:center">只有代码块锁</td>
<td style="text-align:center">JVM将话费较少的时间来调度线程，性能更好<br />且具有更好的扩展性（提供更多的子类）</td>
</tr>
</tbody>
</table>
<p>他们的优先使用顺序：</p>
<p><code>Lock</code> <strong>&gt;</strong> <code>synchronized同步代码块</code>(已经进入了方法体，分配了相应的资源) <strong>&gt;</strong> <code>synchronized同步方法</code>(在方法体之外)</p>
<h2 id="如何释放锁" tabindex="-1"><a class="header-anchor" href="#如何释放锁" aria-hidden="true">#</a> 如何释放锁</h2>
<blockquote>
<p>下面的操作会释放锁</p>
</blockquote>
<ol>
<li>当线程的同步方法，同步代码块执行结束
例如：上厕所，完事出来</li>
<li>当前线程在同步代码块、同步方法中遇到<code>break</code>、<code>return</code>
例如：没有正常的完事，经理叫他修改bug，不得已出来</li>
<li>当前线程正在同步代码块，同步方法中出现了未处理的<code>Error</code>或<code>Exception</code>，导致异常结束
例如：没有正常的完事，发现忘带纸，不得已出来</li>
<li>当前线程在同步代码块、同步方法中执行了线程对象的<code>wait()</code>方法，当前线程暂停，并释放锁
例如：没有正常完事，觉得需要酝酿下，所以出来等会再进去</li>
</ol>
<blockquote>
<p>下面的方法不会释放锁</p>
</blockquote>
<ol>
<li>线程执行同步代码块或同步方法时，程序要调用<code>Thread.sleep()</code>、<code>Thread.yield()</code>方法暂停当前线程的执行，不会释放锁
案例：上厕所，太困了，在坑位上眯了一会</li>
<li>线程执行同步代码块时，其他线程调用了该线程的<code>suspend()</code>方法将该线程挂起，该线程不会释放锁
注意：应尽量避免使用<code>suspend()</code>和<code>resume()</code>来控制线程，方法不再推荐使用</li>
</ol>
<h3 id="扩展-小练" tabindex="-1"><a class="header-anchor" href="#扩展-小练" aria-hidden="true">#</a> 扩展-小练</h3>
<ol>
<li>
<p><code>HomeWork01.java</code></p>
<ol>
<li>在main方法中启动两个线程</li>
<li>在1个线程循环随机打印100以内的整数</li>
<li>直到第二个线程从键盘读取了“Q”命令</li>
</ol>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>work_</span><span class="token punctuation">;</span>
...
<span class="token keyword">class</span> <span class="token class-name">PrintWork02</span> <span class="token keyword">extends</span> <span class="token class-name">Thread</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br></div></div></li>
<li>
<p><code>HomeWork02.java</code></p>
<ol>
<li>有2个用户分别从同一个卡上取钱（总额：10000）</li>
<li>每次都取1000，当余额不足时，就不能取款了</li>
<li>不能出现超取现象</li>
</ol>
</li>
</ol>
<h2 id="线程协作-生产者消费者模式" tabindex="-1"><a class="header-anchor" href="#线程协作-生产者消费者模式" aria-hidden="true">#</a> 线程协作-生产者消费者模式</h2>
<p>先要了解的是，生产者消费者模式并不是我们的23大设计模式之一，是一个<strong>问题</strong>：</p>
<p>比如说：</p>
<ul>
<li>我是一个<strong>消费者</strong>，我现在去麦当劳吃东西，到了前台点餐</li>
<li>我点了一个脆皮炸鸡，此时如果店内有现成的炸鸡，他们将会把鸡直接给我，我结账，走人</li>
<li>但如果他们此时并没有一只炸好了的鸡，麦当劳的前台就会通知厨子(<strong>生产者</strong>)，让大厨去做好一只鸡来给我</li>
<li>我此时就要在店里面干等大厨做好了并让前台通知我：你的炸鸡好了，过来拿下</li>
</ul>
<p>把他们放到线程里面的话：</p>
<ol>
<li>生产者是一条线程</li>
<li>消费者是一条线程</li>
<li>生产者和消费者之间有一个产品，如果有产品的话就通知，没有的话就等待</li>
<li>这两个线程就相当于一种互相等待的状态（你等我，我等你）产生了一些协作，就是我们的生产者和消费者模式</li>
</ol>
<blockquote>
<p>应用场景：生产者和消费者问题</p>
</blockquote>
<ul>
<li>假设仓库中只能存放一件商品，生产者将生产出来的产品放入仓库，消费者将仓库中产品取走消费</li>
<li>如果仓库中没有产品，则生产者将产品放入仓库，否则停止生产等待，直到仓库中的产品被消费者取走为止</li>
<li>如果仓库中放有产品，则消费者可以将产品取走消费，否则停止消费并等待</li>
<li>直到仓库中再次放入产品为止</li>
</ul>
<MermaidChart id="mermaid-30089b3a" data-code="graph%20LR%0AA(Producer%3Cbr%3E%E7%94%9F%E4%BA%A7%E8%80%85)--%3E%E6%95%B0%E6%8D%AE%E7%BC%93%E5%86%B2%E5%8C%BA--%3EB(Consumer%3Cbr%3E%E6%B6%88%E8%B4%B9%E8%80%85)%0A"></MermaidChart><p>首先：<strong>这是一个线程同步问题，生产者和消费者共享一个资源，并且生产者和消费者之间相互依赖，互为条件</strong></p>
<ul>
<li>对于生产者，没有生产产品之前，要通知消费者等待，而生产了产品之后，又需要马上通知消费者消费</li>
<li>对于消费者，在消费之后，要通知生产者已经结束消费，需要生产新的产品以供消费</li>
<li>在生产者消费者问题中，仅有<code>synchronized</code>是不够的
<ul>
<li><code>synchronized</code>可阻止并发更新了同一个资源，实现了同步</li>
<li><code>synchronized</code>不能用来实现不同之间的线程消息传递（通信）</li>
</ul>
</li>
</ul>
<p>Java提供了几个方法解决线程之间通信的方法</p>
<h3 id="wait、notify-让线程可以通信-object类中的方法" tabindex="-1"><a class="header-anchor" href="#wait、notify-让线程可以通信-object类中的方法" aria-hidden="true">#</a> Wait、Notify--让线程可以通信（Object类中的方法）</h3>
<p>这也是Object类中之前没提起的最后两个方法，它们两个方法就是来解决线程之间通信的问题的</p>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td style="text-align:center"><code>wait()</code></td>
<td>表示线程一直<strong>等待</strong>，直到其他线程通知，与sleep不同，<strong>会释放锁</strong></td>
</tr>
<tr>
<td style="text-align:center"><code>wait(long timeout)</code></td>
<td>指定等待的毫秒数</td>
</tr>
<tr>
<td style="text-align:center"><code>notify()</code></td>
<td><strong>唤醒</strong>一个处于等待状态的线程</td>
</tr>
<tr>
<td style="text-align:center"><code>notifyAll()</code></td>
<td>唤醒同一个对象上所有调用wait()方法的线程，<strong>优先级别高的线程优先调度</strong></td>
</tr>
</tbody>
</table>
<p>注意：<strong>均是Object类的方法</strong>，都只能在同步方法或者同步代码块中使用
否则会抛出异常<code>IllegalMonitorStateException</code></p>
<p>接下来，使用它们来完成对生产消费者模式的管理（并发协作）</p>
<h3 id="生产消费者解决方式1-管程法" tabindex="-1"><a class="header-anchor" href="#生产消费者解决方式1-管程法" aria-hidden="true">#</a> 生产消费者解决方式1-管程法</h3>
<ul>
<li>生产者，负责胜场数据的模块（可能是方法，对象，线程，进程）</li>
<li>消费者，负责处理数据的模块（可能是方法，对象，线程，进程）</li>
<li>缓冲区：消费者不能直接使用生产者的数据，他们之间有个<code>缓冲区</code></li>
</ul>
<MermaidChart id="mermaid-30089372" data-code="graph%20LR%0AA(Producer%3Cbr%3E%E7%94%9F%E4%BA%A7%E8%80%85)--%3E%E6%95%B0%E6%8D%AE%E7%BC%93%E5%86%B2%E5%8C%BA--%3EB(Consumer%3Cbr%3E%E6%B6%88%E8%B4%B9%E8%80%85)%0A"></MermaidChart><p><strong>生产者将生产好的数据放入缓冲区，消费者从缓冲区拿出数据</strong></p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>wait_</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br><span class="line-number">45</span><br><span class="line-number">46</span><br><span class="line-number">47</span><br><span class="line-number">48</span><br><span class="line-number">49</span><br><span class="line-number">50</span><br><span class="line-number">51</span><br><span class="line-number">52</span><br><span class="line-number">53</span><br><span class="line-number">54</span><br><span class="line-number">55</span><br><span class="line-number">56</span><br><span class="line-number">57</span><br><span class="line-number">58</span><br><span class="line-number">59</span><br><span class="line-number">60</span><br><span class="line-number">61</span><br><span class="line-number">62</span><br><span class="line-number">63</span><br><span class="line-number">64</span><br><span class="line-number">65</span><br><span class="line-number">66</span><br><span class="line-number">67</span><br><span class="line-number">68</span><br><span class="line-number">69</span><br><span class="line-number">70</span><br><span class="line-number">71</span><br><span class="line-number">72</span><br><span class="line-number">73</span><br><span class="line-number">74</span><br><span class="line-number">75</span><br><span class="line-number">76</span><br><span class="line-number">77</span><br><span class="line-number">78</span><br><span class="line-number">79</span><br><span class="line-number">80</span><br><span class="line-number">81</span><br><span class="line-number">82</span><br><span class="line-number">83</span><br><span class="line-number">84</span><br><span class="line-number">85</span><br><span class="line-number">86</span><br><span class="line-number">87</span><br><span class="line-number">88</span><br><span class="line-number">89</span><br><span class="line-number">90</span><br><span class="line-number">91</span><br><span class="line-number">92</span><br></div></div><h2 id="wait-notify使用细节" tabindex="-1"><a class="header-anchor" href="#wait-notify使用细节" aria-hidden="true">#</a> Wait Notify使用细节</h2>
<ol>
<li>
<p>wait()、notify/notifyAll() 方法是Object的本地final方法，无法被重写。</p>
</li>
<li>
<p>wait()使当前线程阻塞，前提是 必须先获得锁，一般配合synchronized 关键字使用，即，一般在synchronized 同步代码块里使用 wait()、notify/notifyAll() 方法。</p>
</li>
<li>
<p>由于 wait()、notify/notifyAll() 在synchronized 代码块执行，说明当前线程一定是获取了锁的。</p>
</li>
</ol>
<ul>
<li>
...
<li>
<p><strong>也就是说，notify/notifyAll() 的执行只是唤醒沉睡的线程，而不会立即释放锁，锁的释放要看代码块的具体执行情况。所以在编程中，尽量在使用了notify/notifyAll() 后立即退出临界区，以唤醒其他线程让其获得锁</strong></p>
</li>
</ul>
<ol start="4">
<li>
...
<li>
<p>notify 和wait 的顺序不能错，如果A线程先执行notify方法，B线程在执行wait方法，那么B线程是无法被唤醒的。</p>
</li>
<li>
<p>notify 和 notifyAll的区别</p>
<ul>
<li>notify方法只唤醒一个等待（对象的）线程并使该线程开始执行。所以如果有多个线程等待一个对象，这个方法只会唤醒其中一个线程，选择哪个线程取决于操作系统对多线程管理的实现。</li>
<li>notifyAll 会唤醒所有等待(对象的)线程，尽管哪一个线程将会第一个处理取决于操作系统的实现。如果当前情况下有<strong>多个线程需要被唤醒</strong>，<strong>推荐使用notifyAll 方法</strong>。比如在生产者-消费者里面的使用，每次都需要唤醒所有的消费者或是生产者，以判断程序是否可以继续往下执行。</li>
</ul>
</li>
<li>
<p>在多线程中要测试某个条件的变化，使用if 还是while？</p>
<ul>
<li>要注意，notify唤醒沉睡的线程后，线程会接着上次的执行继续往下执行。</li>
<li>所以在进行条件判断时候，可以先把 wait 语句忽略不计来进行考虑；显然，要确保程序一定要执行，并且要保证程序直到满足一定的条件再执行，要使用while进行等待，直到满足条件才继续往下执行：</li>
</ul>
</li>
</ol>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">K</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br></div></div><h2 id="线程的第三种创建方式-callable接口" tabindex="-1"><a class="header-anchor" href="#线程的第三种创建方式-callable接口" aria-hidden="true">#</a> 线程的第三种创建方式-Callable接口</h2>
<p>这个玩意跟线程中一个重要的东西挂钩---<code>线程池</code></p>
<p>工作流程：</p>
<ol>
<li>实现<code>Callable</code>接口，<strong>需要</strong>返回值</li>
<li>重写<code>call</code>方法，需要抛出异常</li>
<li>创建目标对象</li>
...
<p>我相信无论是任何人，只要没有相关基础，看到下面的代码都会有点懵：本来一个run就能解决的事情，为什么要怎么麻烦的创建<code>线程池</code>？</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>sync_</span><span class="token punctuation">;</span>
...
<span class="token comment">//        指定返回值</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br><span class="line-number">44</span><br></div></div><p>接下来先看看这个Callable的源码：</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><h2 id="线程池的基本介绍" tabindex="-1"><a class="header-anchor" href="#线程池的基本介绍" aria-hidden="true">#</a> 线程池的基本介绍</h2>
<p>这里只是做个抛转引玉，实际上得到<code>JUC</code>才能真正的了解这些(前面的wait notify也是如此)</p>
<p>实际上线程池是个非常简单的东西：<strong>重复利用线程，防止一直new和销毁线程占用过多的资源</strong></p>
<ul>
<li>背景：经常创建和销毁，使用量特别大的资源，比如并发情况下的线程，对性能影响很大</li>
<li>思路：提前创建好多个线程，放入线程池中，使用时直接获取，使用完放回池中，可以避免频繁创建销毁，实现重复利用---类似于生活中的交通工具</li>
<li>好处：
<ul>
<li>提高响应速度（减少了创建新线程的时间）</li>
<li>降低资源损耗，重复利用线程池中的线程，不需要每次都再创建</li>
<li>便于线程管理等等</li>
</ul>
</li>
<li><code>corePoolSize</code> 核心池的大小</li>
<li><code>maximumPoolSize</code> 最大线程数</li>
<li><code>keepAliveTime</code> 线程没有任务时最多保存多长时间后会终止</li>
</ul>
<h3 id="使用线程池" tabindex="-1"><a class="header-anchor" href="#使用线程池" aria-hidden="true">#</a> 使用线程池</h3>
<ul>
<li>JDK5.0起提供了线程池相关API：<code>ExecutorService</code>和<code>Executors</code></li>
<li><code>ExcutorService</code> 真正的线程池接口
<ul>
...
<li><code>void shutdonw()</code>关闭连接池</li>
</ul>
</li>
<li><code>Executors</code> 工具类 线程池的工厂类，用于创建并返回不同类型的线程池</li>
</ul>
<p>接下来用线程池来制作一个简单的<code>Runnable</code>线程池</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>work_</span><span class="token punctuation">;</span>
...
<span class="token keyword">class</span> <span class="token class-name">MyThread</span> <span class="token keyword">implements</span> <span class="token class-name">Runnable</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br></div></div><p>当然，这玩意到这里也就浅尝即止了，因为再深入的话就得涉及到其他东西，等学完了IO，SQL之类的再继续搞线程。</p>
<p>在这之前，先把之前遗落的代码完善下：实现让坦克大战的敌人动起来，并且是几个敌人一起动</p>
</template>
