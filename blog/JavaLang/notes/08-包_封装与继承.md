...
![image-20211028154021074](/images/Java/08-包_封装与继承/image-20211028154021074.png)

![image-20211028154035337](/images/Java/08-包_封装与继承/image-20211028154035337.png)

直接创建一个 com.xiaoming,在 IEDA 中是这样显示的

![image-20211028154155943](/images/Java/08-包_封装与继承/image-20211028154155943.png)

在文件资源管理器是这样显示的

![image-20211028154210467](/images/Java/08-包_封装与继承/image-20211028154210467.png)

如果说想在文件夹内和资源管理器内有着一样的显示效果：这个取消勾选

![image-20211028154359571](/images/Java/08-包_封装与继承/image-20211028154359571.png)

![image-20211028154654120](/images/Java/08-包_封装与继承/image-20211028154654120.png)
...
![继承的本质](/images/Java/08-包_封装与继承/image-20211028181757838.png)
...
7. Java 中，Object 类是所有类的基类，万物基于 object 类 Object 自带一些方法，可以重写
   ![image-20211028174334475](/images/Java/08-包_封装与继承/image-20211028174334475.png)
...
7. Super 和 this 的比较
   ...
   | No | 区别点 | this | super | | :-: | :--------: | :-----------------------------------------------------------------
   | :------------------------------------------- | | 1 | 访问属性 | 访问本类中的属性，<br />如果本类中没有找到此属性则从父类中继续查找 | 访问父类中的属性 | | 2 |
   访问方法 | 访问本类中的此方法<br />如果本类中没有找到此方法则从父类中继续查找 | 直接访问父类中的方法 | | 3 | 调用构造器 | 调用本类构造器<br />必须放在构造器的首行 | 调用父类构造器<br />
   必须放在子类构造器的首行 | | 4 | 特殊 | 表示当前对象 | 子类中访问父类对象 |
...
![image-20211028215742098](/images/Java/08-包_封装与继承/image-20211028215742098.png)
...
![多态就像是披着羊皮的狼](/images/Java/08-包_封装与继承/image-20211028223335021.png)
...
![image-20211029174326680](/images/Java/08-包_封装与继承/image-20211029174326680.png)

更多细节建议看[老韩](https://www.bilibili.com/video/BV1fh411y7R8?p=331&spm_id_from=pageDriver)

### 实操-零钱通

![image-20211029221606199](/images/Java/08-包_封装与继承/image-20211029221606199.png)
...
![image-20211029222320380](/images/Java/08-包_封装与继承/image-20211029222320380.png)

![image-20211029222335605](/images/Java/08-包_封装与继承/image-20211029222335605.png)

![image-20211029222353757](/images/Java/08-包_封装与继承/image-20211029222353757.png)
...
![image-20211029232234203](/images/Java/08-包_封装与继承/image-20211029232234203.png)

![image-20211029232256342](/images/Java/08-包_封装与继承/image-20211029232256342.png)

![image-20211029232350507](/images/Java/08-包_封装与继承/image-20211029232350507.png)

![image-20211029232405349](/images/Java/08-包_封装与继承/image-20211029232405349.png)

![image-20211029232431663](/images/Java/08-包_封装与继承/image-20211029232431663.png)

![image-20211029232537896](/images/Java/08-包_封装与继承/image-20211029232537896.png)

![image-20211029232550129](/images/Java/08-包_封装与继承/image-20211029232550129.png)

![image-20211029232605574](/images/Java/08-包_封装与继承/image-20211029232605574.png)
