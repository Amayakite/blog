...
<p>Spring Cloud Ribbon是基于Netfix Ribbon<strong>实现的一套客户端负载均衡工具</strong></p>
<blockquote>
<p>简单来说，Ribbon是Netfix发布的开源项目，主要功能是提供客户端软件负载均衡算法服务调用，Ribbon客户端组件提供一系列完善配置项如超时连接，重试等，简单的说，就是在配置文件中列出Load Balancer（简称LB）后面的所有机器，Ribbon会自动帮组你基于某种规则（例如简单查询，随机连接等）去连接这些机器，我们很容易使用Ribbon实现自定义的负载均衡算法</p>
</blockquote>
<p>这玩意目前也进入了维护模式<a href="https://github.com/Netflix/ribbon/wiki/Getting-Started" target="_blank" rel="noopener noreferrer">https://github.com/Netflix/ribbon/wiki/Getting-Started<ExternalLinkIcon/></a></p>
<p><img src="/images/SpringCloud/05-Ribbon负载均衡服务调用/image-20220106175441991-16414628822851.png" alt="image-20220106175441991" loading="lazy"></p>
<p>虽然已经停止维护了，但是这玩意还是非常好用</p>
<p><img src="/images/SpringCloud/05-Ribbon负载均衡服务调用/image-20220106175553509.png" alt="image-20220106175553509" loading="lazy"></p>
<p>因为它比较主流和成熟（过去式，当然现在也是，蛮好用的据说），所以还是有必要学习下</p>
<p><img src="/images/SpringCloud/05-Ribbon负载均衡服务调用/image-20220106175752833.png" alt="image-20220106175752833" loading="lazy"></p>
<p>前面我们通过了负载均衡（Eureka那里）访问8001/8002</p>
<p>Ribbon最终要做的就是来让这个轮循变成别的</p>
<p>总结：Ribbon其实就是一个软负载均衡的<strong>客户端组件</strong>，它可以和其他所需请求的客户端结合使用，和Eureka结合只是其中的一个实例</p>
<p><img src="/images/SpringCloud/05-Ribbon负载均衡服务调用/image-20220106181120214.png" alt="image-20220106181120214" loading="lazy"></p>
<p><img src="/images/SpringCloud/05-Ribbon负载均衡服务调用/image-20220106181144789.png" alt="image-20220106181144789" loading="lazy"></p>
<p>Eureka自带一个Ribbon</p>
<p>当然 新版已经没有他了，而是loadbalancer（这两个都是同样的用法）</p>
<p><img src="/images/SpringCloud/05-Ribbon负载均衡服务调用/image-20220106181639702.png" alt="image-20220106181639702" loading="lazy"></p>
<h2 id="关于resttemplate的用法" tabindex="-1"><a class="header-anchor" href="#关于resttemplate的用法" aria-hidden="true">#</a> 关于RestTemplate的用法</h2>
<h3 id="xxxforentity" tabindex="-1"><a class="header-anchor" href="#xxxforentity" aria-hidden="true">#</a> xxxForEntity</h3>
<p><img src="/images/SpringCloud/05-Ribbon负载均衡服务调用/image-20220106214807667.png" alt="image-20220106214807667" loading="lazy"></p>
<p>例如：</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code>    <span class="token annotation punctuation">@PostMapping</span><span class="token punctuation">(</span><span class="token string">"/payment/create/{paymentName}"</span><span class="token punctuation">)</span>
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><h2 id="ribbon的使用" tabindex="-1"><a class="header-anchor" href="#ribbon的使用" aria-hidden="true">#</a> Ribbon的使用</h2>
<h3 id="较新版本需要手动安装依赖" tabindex="-1"><a class="header-anchor" href="#较新版本需要手动安装依赖" aria-hidden="true">#</a> 较新版本需要手动安装依赖</h3>
<p>由于比较新的版本已经没有这玩意了，所以需要手动导入下依赖</p>
<div class="language-xml ext-xml line-numbers-mode"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!-- https://mvnrepository.com/artifact/org.springframework.cloud/spring-cloud-starter-netflix-ribbon --></span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><p>通常情况下自己用最新的就行了，因为这啥玩意也不咋更新</p>
<p>这个玩意的类图：</p>
<p><img src="/images/SpringCloud/05-Ribbon负载均衡服务调用/image-20220106221245002.png" alt="image-20220106221245002" loading="lazy"></p>
<p>拥有如下规则</p>
<p><img src="/images/SpringCloud/05-Ribbon负载均衡服务调用/image-20220106221328331.png" alt="image-20220106221328331" loading="lazy"></p>
<p>有这些规则，默认是第一个</p>
<p>不过这已经过时了，新版本中并没有这个东西</p>
<p>还是说下 要自定义的话</p>
<p>建立一个和你main的class父级之上的</p>
<p><img src="/images/SpringCloud/05-Ribbon负载均衡服务调用/image-20220106224626426.png" alt="image-20220106224626426" loading="lazy"></p>
<p>在这里建立</p>
<p>然后写上这些</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><p>接着返回main，配置额外扫描，必须要这样配置，否则不生效</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><h2 id="新版本springboot使用loadbalancer完成负载均衡" tabindex="-1"><a class="header-anchor" href="#新版本springboot使用loadbalancer完成负载均衡" aria-hidden="true">#</a> 新版本SpringBoot使用LoadBalancer完成负载均衡</h2>
<p>springboot 2020版本 eureka删除了ribbon可以通过@LoadBalancerClient注解来改变LoadBalancer</p>
<p>参考文章：<a href="https://blog.csdn.net/weixin_50518271/article/details/111449560" target="_blank" rel="noopener noreferrer">https://blog.csdn.net/weixin_50518271/article/details/111449560<ExternalLinkIcon/></a></p>
<p>和这篇文章<a href="https://www.cnblogs.com/fb010001/p/14613428.html" target="_blank" rel="noopener noreferrer">https://www.cnblogs.com/fb010001/p/14613428.html<ExternalLinkIcon/></a></p>
<p>先看下面那篇文章</p>
<p>先说下 这玩意目前只有两个实现</p>
<p>第一个是随即实现，第二个是轮循实现</p>
<p><img src="/images/SpringCloud/05-Ribbon负载均衡服务调用/image-20220106232529165.png" alt="image-20220106232529165" loading="lazy"></p>
<p>而且还无法直接使用…..</p>
<p>必须自定义一个类</p>
<p>不能和application同级</p>
<p>这个类没有任何注解</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br></div></div><p>然后再到main中使用</p>
<div class="language-java ext-java line-numbers-mode"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@SpringBootApplication</span>
<span class="token annotation punctuation">@EnableEurekaClient</span>
<span class="token annotation punctuation">@LoadBalancerClient</span><span class="token punctuation">(</span>name <span class="token operator">=</span> <span class="token string">"CLOUD-PROVIDER-PAYMENT"</span><span class="token punctuation">,</span> configuration <span class="token operator">=</span> <span class="token class-name">CustomRandomLoadBalancerClient</span><span class="token punctuation">.</span><span class="token keyword">class</span><span class="token punctuation">)</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">CloudConsumerOrder80Application</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="highlight-lines"><br><br><div class="highlight-line">&nbsp;</div><br><br><br><br><br><br><br></div><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><h2 id="轮循算法是怎么实现的" tabindex="-1"><a class="header-anchor" href="#轮循算法是怎么实现的" aria-hidden="true">#</a> 轮循算法是怎么实现的</h2>
<p>结论：rest接口第几次请求%服务器集群总数量=实际调用服务下标位置，每次重启后rest重1开始计算</p>
<p><img src="/images/SpringCloud/05-Ribbon负载均衡服务调用/image-20220107000127620.png" alt="image-20220107000127620" loading="lazy"></p>
<p><img src="/images/SpringCloud/05-Ribbon负载均衡服务调用/image-20220107000308732.png" alt="image-20220107000308732" loading="lazy"></p>
<h2 id="如果要自定义loadbalancer负载均衡规则" tabindex="-1"><a class="header-anchor" href="#如果要自定义loadbalancer负载均衡规则" aria-hidden="true">#</a> 如果要自定义LoadBalancer负载均衡规则</h2>
<p>md我目前也没有办法，只能说 真要用上了的话，就去看Ribbon的各种负载均衡的源码 然后手动敲一个吧..</p>
<p>没准以后这玩意完善了,,,,或者说干脆之后用nginx之类的来搞搞吧，网上也没有看到太深入的教程</p>
</template>
